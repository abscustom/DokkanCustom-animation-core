...
entryEffectLife( spep_dam01,  55,  12,  0x80, -1,  0,  0,  0);
entryEffectLife( spep_dam01+4,  54,  8,  0x80, -1, 0,  0,  0);

shuchusen01 = entryEffectLife( ATK_01+21, 70, 2, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( ATK_01+21, shuchusen01, 1.0, 1.4);
...
spep_dam01 = ATK_01+21;
hit = entryEffectLife( spep_dam01, 67, 16, 0x100,  1,   0,  0,  0);--HIT
setEffRotateKey(spep_dam01, hit,rot);
setEffScaleKey(spep_dam01, hit,0.2,0.2);
setEffScaleKey(spep_dam01 + 6,hit,1.5,1.5);
setEffAlphaKey(spep_dam01,hit,255);
setEffAlphaKey(spep_dam01 + 6,hit,255);
setEffAlphaKey(spep_dam01 + 12,hit,0);
entryEffectLife( spep_dam01,  55,  12,  0x100, -1,  0,  0,  0);
entryEffectLife( spep_dam01+4,  54,  8,  0x100, -1, 0,  0,  0);
...
spep_dam02 = ATK_02+1;
entryEffectLife( spep_dam02,  55,  12,  0x100, 1,  0,  0,  0);
entryEffectLife( spep_dam02,  54,  8,  0x100, 1, 0,  0,  0);
shuchusen02 = entryEffectLife( ATK_02+1, 70, 2, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( ATK_02+1, shuchusen02, 1.0, 1.4);

-- ** 音 ** --
--飛び込んでくる
SE001 = playSeVer2( 0, 1019, "",44, 0, 22, -1);
setSeVolumeByWorkId( 0, SE001, 68 );
SE002 = playSeVer2( 0, 1117, "",74, 0, 44, -1);
setSeVolumeByWorkId( 0, SE002, 78 );

--蹴る
SE003 = playSeVer2( 16, 1189, "", 0, 0, 0, -1);
SE004 = playSeVer2( 22, 1001, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 22, SE004, 76 );
SE005 = playSeVer2( 26, 1010, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 26, SE005, 63 );
SE006 = playSeVer2( 28, 1110, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 28, SE006, 74 );

--銃撃つ
SE007 = playSeVer2( 54, 1028, "", 0, 0, 0, -1);
SE008 = playSeVer2( 54, 1149, "",72, 0, 8, -1);
SE009 = playSeVer2( 58, 1023, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 58, SE009, 75 );
