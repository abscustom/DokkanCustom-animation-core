...
--画面遷移
SE004 = playSeVer2( spep_0 + 234, 8, "", 0, 0, 0, -1);

--手握る
SE005 = playSeVer2( spep_0 + 520, 1189, "", 0, 0, 0, -1);
SE006 = playSeVer2( spep_0 + 528, 1006, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 528, SE006, 72 );
SE007 = playSeVer2( spep_0 + 528, 1007, "", 0, 0, 0, -1);

--決め
SE008 = playSeVer2( spep_0 + 532, 1369, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 532, SE008, 59 );


-- ** ボイス ** --
--「くっくっく ドラゴンボールか…」
playVoice( spep_0 + 2, 950 );
setVoiceVolume( spep_0 + 2, 950, 118 );

--「一刻もはやく７個すべてを手にいれ再び若さを手にいれたいものだ…」
playVoice( spep_0 + 236, 951 );
setVoiceVolume( spep_0 + 236, 951, 118 );


-- ** 終わり ** --
endPhase( spep_0 + MAX_FRAME_0 ); -- 718f
