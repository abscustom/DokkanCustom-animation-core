--4025780:超サイヤ人ベジータ(GT)_超ウルトラ元気玉(復活カウンター)
--sp_effect_a2_00201
...
SP_02 = 161427;  --ベジータアップ〜フィニッシュ ef_002
SP_03 = 161428;  --KO ef_003
...
if (_IS_PLAYER_SIDE_ == 1) then
    ...
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_0 + 1740 -13);        -- スキップかつ回避された時のスキップ先フレーム指定
           setupMovie(spep_0 + 1740 -13, SP_01, spep_0 + 1740 -13 + 2, 1);
       else
           skipFrame(0, spep_0 + 1984);      -- スキップ先フレーム指定
           setupMovie(spep_0 + 1984, SP_01, spep_0 + 1984 -1 + 2, 1);

          -- ** 音 ** --
          --元気玉地面飛んでいく
            SE069 = playSeVer2( spep_0 + 1984, 1044, "",spep_0 + 2050, 0, 40, -1);
            setSeVolumeByWorkId( spep_0 + 1984, SE069, 56 );            
            SE070 = playSeVer2( spep_0 + 1984, 1146, "", 0, 2, 0, -1);
            setSeVolumeByWorkId( spep_0 + 1984, SE070, 72 ); 
            setStartTimeMs( SE070,  800 );           
            SE071 = playSeVer2( spep_0 + 1984, 1202, "", 0, 2, 0, -1);
            setSeVolumeByWorkId( spep_0 + 1984, SE071, 158 );
            setPitch( spep_0 + 1984, SE071, -300 );
            setTimeStretch( SE071, 0.8, 30, 4 );
            setStartTimeMs( SE071,  800 );
            SE072 = playSeVer2( spep_0 + 1984, 1202, "", 0, 2, 0, -1);
            setSeVolumeByWorkId( spep_0 + 1984, SE072, 158 ); 
            setStartTimeMs( SE072,  433 );     
...
spep_0=0;
-- ** エフェクト等 ** --
first_f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0 );  --ベジータアップ〜フィニッシュ  ef_001
...
--[[
first_b = entryEffect( spep_0 + 0, SP_02, 0x80, -1, 0, 0, 0 );  --ベジータアップ〜フィニッシュ  ef_002
...
-- ** SE ** --
--環境音
SE001 = playSeVer2( spep_0 + 0, 1269, "",spep_0 + 1100, 0, 96, -1);
...
--瓦礫音
SE003 = playSeVer2( spep_0 + 208, 1168, "", 0, 12, 0, -1);
setSeVolumeByWorkId( spep_0 + 208, SE003, 46 );
setStartTimeMs( SE003,  983 );
SE009 = playSeVer2( spep_0 + 250, 1168, "", 0, 52, 0, -1);
setSeVolumeByWorkId( spep_0 + 250, SE009, 45 );
setStartTimeMs( SE009,  317 );
setPitch( spep_0 + 250, SE009, -200 );
setTimeStretch( SE009, 0.87, 30, 4 );
SE013 = playSeVer2( spep_0 + 376, 1168, "", 0, 44, 0, -1);
setSeVolumeByWorkId( spep_0 + 376, SE013, 33 );
setStartTimeMs( SE013,  1267 );

--元気玉溜める
SE004 = playSeVer2( spep_0 + 210, 1397, "",spep_0 + 1040, 30, 44, -1);
setSeVolumeByWorkId( spep_0 + 210, SE004, 66 );
setStartTimeMs( SE004,  583 );
SE006 = playSeVer2( spep_0 + 210, 1181, "",spep_0 + 1040, 30, 44, -1);
setSeVolumeByWorkId( spep_0 + 210, SE006, 63 );
SE007 = playSeVer2( spep_0 + 210, 1396, "",spep_0 + 1040, 30, 44, -1);
setSeVolumeByWorkId( spep_0 + 210, SE007, 224 );
setPitch( spep_0 + 210, SE007, -600 );
setTimeStretch( SE007, 0.6, 30, 4 );
SE008 = playSeVer2( spep_0 + 214, 1020, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 214, SE008, 11 );
SE010 = playSeVer2( spep_0 + 242, 1020, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 242, SE010, 20 );
SE011 = playSeVer2( spep_0 + 270, 1020, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 270, SE011, 20 );
SE012 = playSeVer2( spep_0 + 298, 1020, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 298, SE012, 20 );
SE014 = playSeVer2( spep_0 + 326, 1020, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 326, SE014, 20 );
SE015 = playSeVer2( spep_0 + 354, 1020, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 354, SE015, 20 );
SE016 = playSeVer2( spep_0 + 382, 1020, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 382, SE016, 20 );
...
--ベジータ力尽きる
SE005 = playSeVer2( spep_0 + 206, 1377, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 206, SE005, 126 );
...
SE030 = playSeVer2( spep_0 + 744, 1405, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 744, SE030, 180 );
...
-- ** ボイス ** --
--「フフフ…」
playVoice( spep_0 + 0, 581 );
setVoiceVolume( spep_0 + 0, 581, 100 );

--「貴様の負けだ」
playVoice( spep_0 + 93 -2, 582 );
setVoiceVolume( spep_0 + 93 -2, 582, 100 );

--「まだまだ死ねねえなあ　おめえを…やっつけるまではな…！」
playVoice( spep_0 + 285 -2, 583 );
setVoiceVolume( spep_0 + 285 -2, 583, 110 );

--「宇宙のみんな！　オラに元気を分けてくれー！！」
playVoice( spep_0 + 777 -2, 585 );
setVoiceVolume( spep_0 + 777 -2, 585, 110 );

--「サンキュー！宇宙のみんな！！」
playVoice( spep_0 + 1293 -2, 586 );
setVoiceVolume( spep_0 + 1293 -2, 586, 110 );

--「いくぜ！」
playVoice( spep_0 + 1468 -2, 587 );
setVoiceVolume( spep_0 + 1468 -2, 587, 110 );

--「てりゃあー！！」
playVoice( spep_0 + 1577 -2, 588 );
setVoiceVolume( spep_0 + 1577 -2, 588, 120 );
...
if(_IS_DODGE_ == 1) then
    ...
    setVoiceVolume( SP_dodge - 12, 588, 0 );
...
changeAnime( spep_0 + 1796 -a1, 1, 106);
...
SE071 = playSeVer2( spep_0 + 1906, 1202, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1906, SE071, 158 );
setPitch( spep_0 + 1906, SE071, -300 );
setTimeStretch( SE071, 0.8, 30, 4 );
SE072 = playSeVer2( spep_0 + 1928, 1202, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1928, SE072, 158 );           

--爆発する
SE073 = playSeVer2( spep_0 + 2010, 1144, "", 0, 24, 0, -1);
