--4029480:LR_超サイヤ人孫悟飯(青年期)_フィニッシュ(超成功)：親子三大かめはめ波
--sp_effect_a1_00453
--fi0018
...
if (_IS_PLAYER_SIDE_ == 1) then
    ...
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_0 + 318 -13 );        -- スキップかつ回避された時のスキップ先フレーム指定
           setupMovie(spep_0 + 318 -13, SP_01, spep_0 + 318 -13 + 2, 1);
       else
           skipFrame(0, spep_0 + 1414 );      -- スキップ先フレーム指定
           setupMovie(spep_0 + 1414 , SP_01, spep_0 + 1414 + 2, 1);

           --「波ーーー!!!」（３人）
           playVoice( spep_0 + 1414, 844 );
           setVoiceVolume( spep_0 + 1414, 844, 110 );
...
-- ** エフェクト等 ** --
base_f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0 );  --顔アップ〜KO(ef_001)
...
changeAnime( spep_0 + 316 + OFFSET_X, 1, 100 );
changeAnime( spep_0 + 356 + OFFSET_X, 1, 104 );
...
changeAnime( spep_0 + 1854 + OFFSET_X, 1, 105 );
...
-- ** ボイス ** --
--「かめはめ」（悟飯）
playVoice( spep_0 + 2, 835 );
setVoiceVolume( spep_0 + 2, 835, 110 );

--「波ーーー!!!」（悟飯）
SE_7_836 = playVoice( spep_0 + 242, 836 );
setVoiceVolume( spep_0 + 242, 836, 110 );

--「波ーーー!!!」（悟天）
SE_8_851 = playVoice( spep_0 + 262, 851 );
setVoiceVolume( spep_0 + 262, 851, 110 );
...
SE021 = playSeVer2( spep_0 + 358, 1161, "", 0, 0, 0, -1);
...
-- ** ボイス ** --
--「神龍お願い!助けて!」
playVoice( spep_0 + 390, 838 );
setVoiceVolume( spep_0 + 390, 838, 130 );

--「おめぇ達が持ってるパワーを全部使い切るんだ!!」
playVoice( spep_0 + 590, 839 );
setVoiceVolume( spep_0 + 590, 839, 110 );

--「後はもうねぇんだぞ!!」
playVoice( spep_0 + 868, 840 );
setVoiceVolume( spep_0 + 868, 840, 110 );

--「父さん!」
playVoice( spep_0 + 986, 841 );
setVoiceVolume( spep_0 + 986, 841, 110 );

--「お父さん!」
playVoice( spep_0 + 1056, 842 );
setVoiceVolume( spep_0 + 1056, 842, 110 );

--「かめはめ」（悟空）
playVoice( spep_0 + 1206, 843 );
setVoiceVolume( spep_0 + 1206, 843, 110 );

--「波ーーー!!!」（３人）
playVoice( spep_0 + 1410, 844 );
setVoiceVolume( spep_0 + 1410, 844, 110 );
