-- 4030500:LR_超ゴジータ_アクティブ必殺技：ソウルパニッシャー
-- sp_effect_b4_00369
-- ut0090
...
-- 味方側
SP_01  = 163631;  --   ef_001 スタート〜フィニッシュ
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           ...
           --光溢れ出す（一番聞こえてて欲しい音）
           SE059 = playSeVer2( spep_0 + 1188, 1336, "",spep_0 + 1446, 0, 20, -1);
           setTimeStretch( SE059, 1.25, 30, 4 );

           --敵ヒット
           SE060 = playSeVer2( spep_0 + 1188, 1130, "", 0, 0, 0, -1);
           setSeVolumeByWorkId( spep_0 + 1188, SE060, 66 );
           setTimeStretch( SE060, 0.89, 30, 4 );
           SE061 = playSeVer2( spep_0 + 1188, 1273, "", 0, 0, 0, -1);
           setPitch( spep_0 + 1188, SE061, -400 );
...
-- ** エフェクト等 ** --
base_0f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0); -- スタート〜フィニッシュ(ef_001)
...
changeAnime( spep_0 + 200 + OFFSET_X, 1, 117 );
...
changeAnime( spep_0 + 360 + OFFSET_X, 1, 108 );
changeAnime( spep_0 + 442 + OFFSET_X, 1, 105 );
...
setDisp( spep_0 + 532 + OFFSET_X, 1, 0 );
...
setMoveKey( spep_0 + 532 + OFFSET_X, 1, -16.1, -404 , 0 );

setScaleKey( spep_0 + 494 + OFFSET_X, 1, 2.4, 2.4 );
setScaleKey( spep_0 + 532 + OFFSET_X, 1, 2.4, 2.4 );

setRotateKey( spep_0 + 494 + OFFSET_X, 1, -19.8 );
setRotateKey( spep_0 + 532 + OFFSET_X, 1, -19.8 );
...
changeAnime( spep_0 + 1186 + OFFSET_X, 1, 108 );
changeAnime( spep_0 + 1240 + OFFSET_X, 1, 106 );
...
-- ** ボイス ** --
--「これが最強のフュージョンだ！！」
playVoice( spep_0 + 4, 929 );
setVoiceVolume( spep_0 + 4, 929, 128 );
...
-- ** ボイス ** --
--「地獄へ送り返してやる！！」
playVoice( spep_0 + 1004, 930 );
setVoiceVolume( spep_0 + 1004, 930, 128 );
