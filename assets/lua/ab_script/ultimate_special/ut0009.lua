...
if (_IS_PLAYER_SIDE_ == 1) then
    ...
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_0 + 240 -12);        -- スキップかつ回避された時のスキップ先フレーム指定
       else
           skipFrame(0, spep_1 + 234);      -- スキップ先フレーム指定
           
			playSe( spep_1 + 234, 1021 );
			setSeVolume( spep_1 + 234, 1021, 90 );
			playSe( spep_1 + 234, 1159 );
			SE1159 = setSeVolume( spep_1 + 234, 1159, 80 );
			setStartTimeMs( SE1159,  1500 );

			SE16 = playSe( spep_1 + 234, 1211 );
			setSeVolume( spep_1 + 234, 1211, 261 -10 );
			...
			SE17 = playSe( spep_1 + 234, 1176 );
			setSeVolume( spep_1 + 234, 1176, 42 -10 );
			...
			SE18 = playSe( spep_1 + 234, 1019 );
			setSeVolume( spep_1 + 234, 1019, 35 );
			...
			SE19 = playSe( spep_1 + 234, 1044 );
			setSeVolume( spep_1 + 234, 1044, 100 );
			...
			SE20 = playSe( spep_1 + 234, 1215 );
			setSeVolume( spep_1 + 234, 1215, 66 );
