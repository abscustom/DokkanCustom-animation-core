-- 1032550:LR_超サイヤ人4孫悟空(DAIMA)_アクティブ必殺：ゼンカイかめはめ波
-- sp_effect_b4_00413
-- ut0118
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
        ...
        if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_0 + 396 -13);   -- スキップかつ回避された時のスキップ先フレーム指定
           setupMovie(spep_0 + 396 -13, SP_01, spep_0 + 396 -13 + 2, 1);
        else
           skipFrame(0, spep_0 + 700);  -- スキップ先フレーム指定
           setupMovie(spep_0 + 700, SP_01, spep_0 + 700 -1 + 2, 1);

            --かめはめ波中
            SE019 = playSeVer2( spep_0 + 700+3, 1161, "", 0, 0, 0, -1);
            setSeVolumeByWorkId( spep_0 + 700+3, SE019, 76 );
...
changeAnime( spep_0 + 946 + OFFSET_X, 1, 106 );
changeAnime( spep_0 + 950 + OFFSET_X, 1, 108 );
...
-- ** ボイス ** --
--「か…め…は…め…」
playVoice( spep_0 + 102, 1134 );
setVoiceVolume( spep_0 + 102, 1134, 138 );	
...
--かめはめ波中
SE019 = playSeVer2( spep_0 + 650, 1161, "", 0, 0, 0, -1);
...
--悟空集中線
SE023 = playSeVer2( spep_0 + 756, 1303, "", 0, 0, 0, -1);
...
--かめはめ波飛んでいく
SE029 = playSeVer2( spep_0 + 998, 1304, "", 0, 0, 0, -1);
...
-- ** ボイス ** --
--「波ーーーっ！！！！」
playVoice( spep_0 + 416, 1135 );
setVoiceVolume( spep_0 + 416, 1135, 140 );
