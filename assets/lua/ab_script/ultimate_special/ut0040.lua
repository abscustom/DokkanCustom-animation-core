--1024930:メタルクウラ_生命エネルギー吸収(アクティブ)
--sp_effect_b4_00253
...
if (_IS_PLAYER_SIDE_ == 1) then
    ...
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_3 +150 -12);        -- スキップかつ回避された時のスキップ先フレーム指定
       else
           skipFrame(0, spep_6 + 0);      -- スキップ先フレーム指定
           SE017 = playSeVer2( spep_6 + 0, 1231, "", 0, 0, 0, -1);
           SE018 = playSeVer2( spep_6 + 0, 1243, "", 0, 0, 0, -1);
           SE019 = playSeVer2( spep_6 + 0, 1227, "", 0, 0, 0, -1);
           setSeVolumeByWorkId( spep_6 + 0, SE019, 73 );
           SE020 = playSeVer2( spep_6 + 0, 1176, "", 0, 0, 0, -1);
           setSeVolumeByWorkId( spep_6 + 0, SE020, 51 );
           SE021 = playSeVer2( spep_6 + 0, 1214, "", 0, 0, 0, -1);
           setSeVolumeByWorkId( spep_6 + 0, SE021, 73 );
           SE022 = playSeVer2( spep_6 + 0, 1243, "", 0, 0, 0, -1);
           SE023 = playSeVer2( spep_6 + 0, 1214, "", 0, 0, 0, -1);
           setSeVolumeByWorkId( spep_6 + 0, SE023, 68 );
