-- 1029440:LR_伝説の超サイヤ人ブロリー_アクティブ必殺技+フィールド展開：大地を砕く剛腕
-- sp_effect_b1_00293
-- ut0074
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_0 + 96 -13);   -- スキップかつ回避された時のスキップ先フレーム指定
           setupMovie(spep_0 + 96 -13, SP_01, spep_0 + 96 -13, 1);
       else
           skipFrame(0, spep_0 + 386);  -- スキップ先フレーム指定
           setupMovie(spep_0 + 386, SP_01, spep_0 + 386-1 + 2, 1);
           --地響き
           SE012 = playSeVer2( spep_0 + 389, 1226, "", 0, 0, 0, -1);
           setSeVolumeByWorkId( spep_0 + 389, SE012, 79 );

           --画面遷移
           SE020 = playSeVer2( spep_0 + 389, 1116, "",spep_0 + 432, 0, 28, -1);

           --溶岩音
           SE021 = playSeVer2( spep_0 + 389, 1165, "",spep_0 + 760, 100, 110, -1);
           setSeVolumeByWorkId( spep_0 + 389, SE021, 126 );
end
    else 
...
-- ** エフェクト等 ** --
base_0f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0); -- アクティブ必殺技+フィールド展開 前面(ef_001)
...
changeAnime( spep_0 + 106 + OFFSET_X, 1, 104 );
changeAnime( spep_0 + 108 + OFFSET_X, 1, 107 );
...
-- ** ボイス ** --
--「うおおお！！！」
SE_6_832 = playVoice( spep_0 + 0, 832 );
setVoiceVolume( spep_0 + 0, 832, 110 );
...
setVoiceVolume( spep_0 + 784, 833, 110 );
