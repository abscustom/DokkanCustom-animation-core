-- 4027990:LR_超サイヤ人ゴッドSSゴジータ_アクティブ必殺：オレにどこまでついてこれるかな？
-- sp_effect_b1_00274
-- ut0065
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_0 + 330 -13);   -- スキップかつ回避された時のスキップ先フレーム指定
       else
           skipFrame(0, spep_0 + 596 -1);  -- スキップ先フレーム指定

            --敵吹き飛ぶ２
            SE028 = playSeVer2( spep_0 + 596, 1014, "", 0, 0, 0, -1);
            setSeVolumeByWorkId( spep_0 + 596, SE028, 75 );
            SE029 = playSeVer2( spep_0 + 596, 1121, "",spep_0 + 684, 0, 14, -1);
            setSeVolumeByWorkId( spep_0 + 596, SE029, 59 );
            SE030 = playSeVer2( spep_0 + 596, 1183, "",spep_0 + 684, 0, 16, -1);
            SE031 = playSeVer2( spep_0 + 596, 1117, "", 0, 0, 0, -1);
