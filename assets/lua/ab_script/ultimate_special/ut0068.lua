-- 4028690:UR_トッポ(破壊神モード)_アクティブ必殺技：破壊玉
-- sp_effect_a2_00238
-- ut0068
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
        ...
        if(_IS_DODGE_ == 1) then
            skipFrame(0, spep_0 + 76 -13);   -- スキップかつ回避された時のスキップ先フレーム指定
            setupMovie(spep_0 + 76 -13, SP_01, spep_0 + 76 -13 + 2, 1);
        else
            skipFrame(0, spep_0 + 686 -1);  -- スキップ先フレーム指定
            setupMovie(spep_0 + 686 , SP_01, spep_0 + 686 -1 + 2, 1);

            --気玉発射
            SE031 = playSeVer2( spep_0 + 686, 1215, "", 0, 0, 0, -1);
            setStartTimeMs( SE031,  400 );
            SE027 = playSeVer2( spep_0 + 686, 1190, "", 0, 0, 0, -1);
            SE028 = playSeVer2( spep_0 + 686, 1193, "",spep_0 + 760, 0, 58, -1);
            SE029 = playSeVer2( spep_0 + 686, 1027, "", 0, 0, 0, -1);
            SE030 = playSeVer2( spep_0 + 686, 1213, "", 0, 0, 0, -1);
            setSeVolumeByWorkId( spep_0 + 686, SE030, 80 );

            --地響き
            SE032 = playSeVer2( spep_0 + 686, 1044, "", 0, 0, 0, -1);
            setSeVolumeByWorkId( spep_0 + 686, SE032, 110 );
        end
    else 
...
changeAnime( spep_0 + 686 + OFFSET_X, 1, 118 );
changeAnime( spep_0 + 760 + OFFSET_X, 1, 107 );
...
SE031 = playSeVer2( spep_0 + 660, 1215, "", 0, 0, 0, -1);
