-- 1029330: UR_アックマン_アクティブ必殺技：アクマイト光線
-- sp_effect_a1_00445
-- ut0073
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
        ...
        if(_IS_DODGE_ == 1) then
            skipFrame(0, spep_0 + 300 -13);   -- スキップかつ回避された時のスキップ先フレーム指定
        else
...
-- ** エフェクト等 ** --
base_0f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0); -- 冒頭〜ラスト：手前 (ef_001)
...
setAlphaKey( spep_0 + 550 + OFFSET_X, 1, 10 );
setAlphaKey( spep_0 + 552 + OFFSET_X, 1, 255 );
