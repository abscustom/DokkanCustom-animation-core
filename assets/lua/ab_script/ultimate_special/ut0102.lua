-- 1031470:LR_超サイヤ人4ゴジータ_アクティブ必殺：龍拳
-- sp_effect_b1_00338
-- ut0102
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_0 + 572 -13);   -- スキップかつ回避された時のスキップ先フレーム指定
       else
           skipFrame(0, spep_0 + 1244 -1);  -- スキップ先フレーム指定

           --叫びながら振りかぶる
           SE070 = playSeVer2( spep_0 + 1244, 1183, "", 0, 0, 0, -1);
           SE071 = playSeVer2( spep_0 + 1244, 1116, "", 0, 0, 0, -1);
...
KO = entryEffectLife( spep_1 + 0, SP_02, 3058, 0x80, -1, 0, 0, 0); -- KOループ用(ef_002)
setEffMoveKey( spep_1 + 0, KO, 0, 0 , 0);
setEffMoveKey( spep_1 + 3058, KO, 0, 0 , 0);
setEffScaleKey( spep_1 + 0, KO, 1.0, 1.0);
setEffScaleKey( spep_1 + 3058, KO, 1.0, 1.0);
setEffRotateKey( spep_1 + 0, KO, 0);
setEffRotateKey( spep_1 + 3058, KO, 0);
setEffAlphaKey( spep_1 + 0, KO, 255);
setEffAlphaKey( spep_1 + 3058, KO, 255);
...
setMoveKey( spep_0 + 72 + OFFSET_X, 1, 16, 314.2 , 0 );
...
setScaleKey( spep_0 + 72, 1, 0.22, 0.22 );
...
setRotateKey( spep_0 + 72, 1, 0 );

setBlendColor( spep_0 + 0, 1, 3, 1.0, 1.0, 1.0, 0.3 );
setBlendColor( spep_0 + 71 + OFFSET_X, 1, 3, 1.0, 1.0, 1.0, 0.3 );
setBlendColor( spep_0 + 72 + OFFSET_X, 1, 3, 0, 0, 0, 0.0 );


--敵の動き2
setDisp( spep_0 + 598 + OFFSET_X, 1, 1 );
setDisp( spep_0 + 634 + OFFSET_X, 1, 0 );

changeAnime( spep_0 + 598 + OFFSET_X, 1, 0 );
...
setMoveKey( spep_0 + 634 + OFFSET_X, 1, -273.2, 191.4 , 0 );
...
setScaleKey( spep_0 + 634 + OFFSET_X, 1, 0.1, 0.1 );
...
endPhase( spep_0 + MAX_FRAME_0 ); -- 終了フレーム 1748f（KO時 1880f）
