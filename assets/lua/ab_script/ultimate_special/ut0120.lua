--4032890:LR_超サイヤ人4孫悟空+超サイヤ人4べジータ_アクティブ必殺：超ウルトラ元気玉
--sp_effect_a2_00275
--ut0120
...
--エフェクト(味方)
SP_01 = 164392; --元気玉の中で敵が消えていく_ef_001
...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1) then
        ...
        if(_IS_DODGE_ == 1) then
            skipFrame(0, spep_0 + 170 -13); -- スキップかつ回避された時のスキップ先フレーム指定
            setupMovie(spep_0 + 170 -13, SP_01, spep_0 + 170 -13, 1);
        else
        skipFrame(0, spep_0 + 1880); -- スキップ先フレーム指定
        setupMovie(spep_0 + 1880, SP_01, spep_0 + 1880, 1);
        --スキップタイミング直前から再生するSE・ボイスがある場合はこちらに記載してください。
        --SE名
        --敵飲まれる
        SE063 = playSeVer2( spep_0 + 1880, 1159, "", 0, 0, 0, -1);
        setSeVolumeByWorkId( spep_0 + 1880, SE063, 83 );
        SE064 = playSeVer2( spep_0 + 1880, 1067, "", 0, 0, 0, -1);
        setSeVolumeByWorkId( spep_0 + 1880, SE064, 83 );
        SE065 = playSeVer2( spep_0 + 1880, 1258, "",spep_0 + 1936, 20, 60, -1);
        setSeVolumeByWorkId( spep_0 + 1880, SE065, 73 );
        end
    else
...
-- ** エフェクト等 ** --
base_0 = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0); -- 元気玉の中で敵が消えていく_ef_001
...
changeAnime( spep_0 + 1786 + OFFSET_X, 1, 106 );
...
--元気玉投げる
SE057 = playSeVer2( spep_0 + 1688, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1688, SE057, 73 );
SE058 = playSeVer2( spep_0 + 1688, 1193, "",spep_0 + 1828, 0, 64, -1);
SE059 = playSeVer2( spep_0 + 1688, 1278, "",spep_0 + 1798, 0, 42, -1);
SE060 = playSeVer2( spep_0 + 1688, 1226, "",spep_0 + 2052, 0, 96, -1);
--地面めりこむ
SE061 = playSeVer2( spep_0 + 1760, 1024, "", 0, 0, 0, -1);
SE062 = playSeVer2( spep_0 + 1760, 1188, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1760, SE062, 79 );
--敵飲まれる
SE063 = playSeVer2( spep_0 + 1798, 1159, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1798, SE063, 83 );
SE064 = playSeVer2( spep_0 + 1798, 1067, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1798, SE064, 83 );
SE065 = playSeVer2( spep_0 + 1818, 1258, "",spep_0 + 1936, 20, 60, -1);
setSeVolumeByWorkId( spep_0 + 1818, SE065, 73 );
--空に飛んでいく
SE066 = playSeVer2( spep_0 + 1896, 1044, "",spep_0 + 2054, 0, 40, -1);
setSeVolumeByWorkId( spep_0 + 1896, SE066, 56 );
SE067 = playSeVer2( spep_0 + 1896, 1011, "", 0, 0, 0, -1);
SE068 = playSeVer2( spep_0 + 1956, 1146, "", 0, 8, 0, -1);
setSeVolumeByWorkId( spep_0 + 1956, SE068, 72 );
setStartTimeMs( SE068, 1000 );
SE069 = playSeVer2( spep_0 + 1960, 1202, "", 0, 2, 0, -1);
setSeVolumeByWorkId( spep_0 + 1960, SE069, 158 );
setStartTimeMs( SE069, 833 );
setPitch( spep_0 + 1960, SE069, -300 );
setTimeStretch( SE069, 0.8, 30, 4 );
SE070 = playSeVer2( spep_0 + 1960, 1202, "", 0, 4, 0, -1);
setSeVolumeByWorkId( spep_0 + 1960, SE070, 158 );
setStartTimeMs( SE070, 500 );
--爆発する
SE071 = playSeVer2( spep_0 + 1998, 1144, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1998, SE071, 56 );
SE072 = playSeVer2( spep_0 + 2024, 1157, "", 0, 0, 0, -1);
SE073 = playSeVer2( spep_0 + 2024, 1069, "",spep_0 + 2052, 0, 14, -1);
SE074 = playSeVer2( spep_0 + 2024, 63, "", 0, 0, 0, -1);
SE075 = playSeVer2( spep_0 + 2062, 1156, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 2062, SE075, 79 );
SE076 = playSeVer2( spep_0 + 2062, 1126, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 2062, SE076, 58 );
setPitch( spep_0 + 2062, SE076, -200 );
setTimeStretch( SE076, 0.87, 30, 4 );
--画面遷移
SE077 = playSeVer2( spep_0 + 2108, 8, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 2108, SE077, 56 );
--環境音
SE078 = playSeVer2( spep_0 + 2108, 1305, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 2108, SE078, 73 );
