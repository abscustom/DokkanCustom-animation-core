...
if (_IS_PLAYER_SIDE_ == 1) then
    ...
    if (_IS_SKIP_ == 1) then
       ...
       if(_IS_DODGE_ == 1) then
           skipFrame(0, spep_1 + 58 -12);        -- スキップかつ回避された時のスキップ先フレーム指定
       else
           skipFrame(0, spep_4 + 60);      -- スキップ先フレーム指定
           playSe(  spep_4 + 60,  1027);
           setSeVolume(  spep_4 + 60,  1027,  150);
           playSe(  spep_4 + 80,  1033);
           setSeVolume(  spep_4 + 80,  1033,  200);
           SE001 = playSe( spep_4 + 60, 1072 );
           setSeVolumeByWorkId( spep_4 + 60, SE001, 316 );
