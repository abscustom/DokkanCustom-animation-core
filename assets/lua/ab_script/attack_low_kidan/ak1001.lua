...
spep_dam01 = ATK_01+21;
hit = entryEffectLife( spep_dam01, 65, 16, 0x100,  1,   0,  0,  0);--HIT
setEffRotateKey(spep_dam01, hit,rot);
setEffScaleKey(spep_dam01, hit,0.2,0.2);
setEffScaleKey(spep_dam01 + 6,hit,1,1);
...
--銃撃つ
SE006 = playSeVer2( 52, 1028, "", 0, 0, 0, -1);
SE007 = playSeVer2( 56, 1023, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 56, SE007, 75 );
