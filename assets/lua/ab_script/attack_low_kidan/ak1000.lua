...
setMoveKey( 14,  1,  800,  800,   0);      -- 画面中央
setMoveKey( 20,  1,  50,  50,   0);      -- 画面中央
-------------------------------------------------------
setEnvZoomEnable(25, 0);
entryEffectLife( ATK_01, 71, 60, 0x80,  -1,  0,  0,  0);--移動線
...
shuchusen01 = entryEffectLife( ATK_01+1, 70, 2, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( ATK_01+1, shuchusen01, 1.0, 1.4);
...
spep_dam02 = ATK_03+9;
entryEffectLife( spep_dam02,  55,  12,  0x80, -1,  0,  0,  0);
entryEffectLife( spep_dam02+4,  54,  8,  0x80, -1, 0,  0,  0);

shuchusen02 = entryEffectLife( ATK_03+9, 70, 2, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( ATK_03+9, shuchusen02, 1.0, 1.0);
...
spep_dam03 = ATK_03+29;
entryEffectLife( spep_dam03,  55,  12,  0x80, -1,  0,  0,  0);
entryEffectLife( spep_dam03+4,  54,  8,  0x80, -1, 0,  0,  0);
...
-- ** 音 ** --
--向かってくる
SE001 = playSeVer2( 0, 1117, "",60, 0, 34, -1);

--銃攻撃
SE002 = playSeVer2( 14, 1028, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 14, SE002, 87 );
SE003 = playSeVer2( 22, 1011, "", 0, 0, 0, 0.6);
SE003 = playSeVer2( 22, 1011, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 22, SE003, 74 );
SE004 = playSeVer2( 62, 1028, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 62, SE004, 86 );
SE005 = playSeVer2( 64, 1014, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( 64, SE005, 78 );
SE006 = playSeVer2( 76, 1028, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 76, SE006, 85 );
SE007 = playSeVer2( 80, 1023, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( 80, SE007, 75 );
...
-- 受け------------------------------------------
-- 味方移動（画面外へ)
entryEffectLife( ATK_03+28, 71, 30, 0x80,  -1,  0,  0,  0);--移動線
