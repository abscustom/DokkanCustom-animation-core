--サポ－トメモリー_サイヤ人の終わりなき闘い
--support_memory_40011
...
-- ** 音 ** --
--環境音
SE001 = playSeVer2( spep_0 + 156, 1269, "",spep_0 + 836, 76, 40, -1);
setSeVolumeByWorkId( spep_0 + 156, SE001, 25 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 280, 1018, "", 0, 0, 0, -1);

--構え振りかぶり
SE003 = playSeVer2( spep_0 + 340, 1004, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 340, SE003, 71 );

--砂埃
SE004 = playSeVer2( spep_0 + 364, 1188, "", 0, 26, 0, -1);
setSeVolumeByWorkId( spep_0 + 364, SE004, 63 );
setStartTimeMs( SE004,  167 );

--悟空構える
SE005 = playSeVer2( spep_0 + 370, 1189, "", 0, 0, 0, -1);
SE006 = playSeVer2( spep_0 + 370, 1233, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 370, SE006, 77 );
SE007 = playSeVer2( spep_0 + 378, 1006, "", 0, 0, 0, -1);

--セリフカットイン
SE008 = playSeVer2( spep_0 + 454, 44, "", 0, 0, 0, -1);

--構え振りかぶり
SE009 = playSeVer2( spep_0 + 530, 1004, "", 0, 0, 0, -1);

--砂埃
SE010 = playSeVer2( spep_0 + 550, 1188, "", 0, 26, 0, -1);
setStartTimeMs( SE010,  133 );

--ベジータ構える
SE011 = playSeVer2( spep_0 + 554, 1189, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 554, 1233, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 562, 1006, "", 0, 0, 0, -1);

--空気音
SE014 = playSeVer2( spep_0 + 638, 1175, "",spep_0 + 834, 0, 34, -1);
setSeVolumeByWorkId( spep_0 + 638, SE014, 25 );

--画面遷移
SE015 = playSeVer2( spep_0 + 638, 8, "", 0, 0, 0, -1);
