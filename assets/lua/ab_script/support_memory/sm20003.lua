...
--演出によって書き換えてください
--悟空ジャンプ
SE001 = playSe( spep_0 + 230, 1048 );
setSeVolumeByWorkId( spep_0 + 230, SE001, 85 );

--悟空ジャンプ
SE002 = playSe( spep_0 + 230, 1117 );
stopSe( spep_0 + 250, SE002, 12 );

--筋斗雲に乗る
SE003 = playSe( spep_0 + 262, 1294 );
stopSe( spep_0 + 282, SE003, 6 );

--筋斗雲に乗る
SE004 = playSe( spep_0 + 262, 1293 );
setSeVolumeByWorkId( spep_0 + 262, SE004, 81 );

--筋斗雲に乗る
SE005 = playSe( spep_0 + 262, 1007 );
setSeVolumeByWorkId( spep_0 + 262, SE005, 89 );

--悟空セリフカットイン
SE006 = playSe( spep_0 + 300, 1018 );

--ピッコロセリフカットイン
SE007 = playSe( spep_0 + 402, 44 );

--レーダー握る
SE008 = playSe( spep_0 + 522, 1189 );

--二人飛んでいく
SE009 = playSe( spep_0 + 606, 1182 );

--二人飛んでいく
SE010 = playSe( spep_0 + 610, 1278 );
setSeVolumeByWorkId( spep_0 + 610, SE010, 75 );

--二人飛んでいく
SE011 = playSe( spep_0 + 610, 9 );

--二人飛んでいく
SE012 = playSe( spep_0 + 610, 1019 );
setSeVolumeByWorkId( spep_0 + 610, SE012, 79 );

--二人飛んでいく
SE013 = playSe( spep_0 + 674, 1019 );
setSeVolumeByWorkId( spep_0 + 674, SE013, 79 );
