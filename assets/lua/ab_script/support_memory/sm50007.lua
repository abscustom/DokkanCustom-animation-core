...
--入り
SE001 = playSeVer2( spep_0 + 216 +10, 8, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 216 +10, SE001, 89 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 228 +16, 1018, "", 0, 0, 0, -1);

--ピッコロ落ちる
SE005 = playSeVer2( spep_0 + 488, 1121, "",spep_0 + 622, 18, 18, -1);
setSeVolumeByWorkId( spep_0 + 488, SE005, 50 );
setStartTimeMs( SE005,  783 );

--気づき
SE003 = playSeVer2( spep_0 + 320 +10, 48, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 320 +10, SE003, 65 );

--悟空セリフカットイン
SE004 = playSeVer2( spep_0 + 342 +16, 1048, "", 0, 0, 0, -1);

--ピッコロ離す
SE006 = playSeVer2( spep_0 + 466 +10, 1013, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 466 +10, 1003, "", 0, 0, 0, -1);

--爆発
SE008 = playSeVer2( spep_0 + 602, 1024, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 602, 1023, "", 0, 0, 0, -1);

--爆発２
SE010 = playSeVer2( spep_0 + 710, 1159, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 710, SE010, 79 );
SE011 = playSeVer2( spep_0 + 710, 1067, "", 0, 0, 0, -1);

--ピッコロ吹き飛ぶ
SE012 = playSeVer2( spep_0 + 796 +10, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 796 +10, SE012, 68 );
SE013 = playSeVer2( spep_0 + 796 +10, 1183, "",spep_0 + 930, 0, 52, -1);

--ラストセリフ
SE014 = playSeVer2( spep_0 + 920 +10, 20, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 920 +10, SE014, 73 );
SE015 = playSeVer2( spep_0 + 922 +10, 1004, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 922 +10, SE015, 71 );
