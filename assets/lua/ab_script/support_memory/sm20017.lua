...
a = 16
--セリフカットイン
SE001 = playSeVer2( spep_0 + a + 228, 1018, "", 0, 0, 0, -1);

--クリリン起き上がる
SE002 = playSeVer2( spep_0 + a + 298, 1013, "", 0, 0, 0, -1);

--ポット開く
SE003 = playSeVer2( spep_0 + a + 414, 91, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + a + 414, SE003, 79 );

--悟空歩き出す
SE004 = playSeVer2( spep_0 + a + 480, 1106, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + a + 506, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + a + 506, SE005, 117 );

--風が吹く
SE006 = playSeVer2( spep_0 + a + 550, 1332, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + a + 550, SE006, 73 );

--セリフカットイン
SE007 = playSeVer2( spep_0 + a + 628, 1048, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + a + 758, 44, "", 0, 0, 0, -1);

--集中線
SE009 = playSeVer2( spep_0 + a + 828, 20, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_0 + a + 828, 12, "", 0, 0, 0, -1);
