...
-- ** 音 ** --
--ハッチャン歩く
SE001 = playSeVer2( spep_0 + 260, 1182, "",spep_0 + 290, 0, 20, -1);
setSeVolumeByWorkId( spep_0 + 260, SE001, 73 );
SE002 = playSeVer2( spep_0 + 260, 1192, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 308, 1182, "",spep_0 + 338, 0, 20, -1);
setSeVolumeByWorkId( spep_0 + 308, SE004, 71 );
SE005 = playSeVer2( spep_0 + 308, 1192, "", 0, 0, 0, -1);

--セリフカットイン
SE003 = playSeVer2( spep_0 + 260, 1018, "", 0, 0, 0, -1);

--セリフカットイン２
SE006 = playSeVer2( spep_0 + 378, 1048, "", 0, 0, 0, -1);

--画面遷移
SE007 = playSeVer2( spep_0 + 470, 1232, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 470, SE007, 73 );

--セリフカットイン３
SE008 = playSeVer2( spep_0 + 588, 44, "", 0, 0, 0, -1);

--ラストセリフカットイン
SE009 = playSeVer2( spep_0 + 702, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 702, SE009, 166 );
SE010 = playSeVer2( spep_0 + 702, 13, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 702, SE010, 67 );
