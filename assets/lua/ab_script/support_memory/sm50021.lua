...
-- ** 音 ** --
--飛んでる音
SE001 = playSeVer2( spep_0 + 212, 1019, "", 0, 46, 0, -1);
setSeVolumeByWorkId( spep_0 + 212, SE001, 63 );
SE002 = playSeVer2( spep_0 + 250, 1183, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 250, SE002, 59 );
setTimeStretch( SE002, 1.17, 30, 4 );
SE003 = playSeVer2( spep_0 + 276, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 276, SE003, 63 );
SE004 = playSeVer2( spep_0 + 340, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 340, SE004, 63 );
SE005 = playSeVer2( spep_0 + 404, 1019, "",spep_0 + 468, 0, 50, -1);
setSeVolumeByWorkId( spep_0 + 404, SE005, 63 );

--飛び回る
SE006 = playSeVer2( spep_0 + 402, 1117, "", 0, 26, 0, -1);
SE007 = playSeVer2( spep_0 + 442, 1277, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 446, 1508, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 446, SE008, 73 );

--セリフカットイン
SE009 = playSeVer2( spep_0 + 516, 1018, "", 0, 0, 0, -1);

--画面遷移
SE010 = playSeVer2( spep_0 + 730, 1232, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 730, SE010, 71 );

--飛んでる音
SE011 = playSeVer2( spep_0 + 738, 1433, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 744, 1508, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 744, SE012, 71 );
SE013 = playSeVer2( spep_0 + 744, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 744, SE013, 50 );
SE014 = playSeVer2( spep_0 + 768, 1431, "",spep_0 + 866, 0, 22, -1);
setSeVolumeByWorkId( spep_0 + 768, SE014, 130 );
SE015 = playSeVer2( spep_0 + 808, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 808, SE015, 50 );
SE016 = playSeVer2( spep_0 + 872, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 872, SE016, 50 );
