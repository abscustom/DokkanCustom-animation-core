--サポートメモリー_ギニューのスーパーファイティングポーズ
...
--演出によって書き換えてください
--環境音
SE001 = playSe( spep_0 + 202, 1269 );
setSeVolumeByWorkId( spep_0 + 202, SE001, 25 );

--セリフカットイン
SE002 = playSe( spep_0 + 242, 1018 );

--ギニューポーズ
SE003 = playSe( spep_0 + 320, 1051 );

--ギニューポーズ
SE004 = playSe( spep_0 + 320, 19 );
setSeVolumeByWorkId( spep_0 + 320, SE004, 73 );

--悟空セリフカットイン
SE005 = playSe( spep_0 + 440, 44 );

--バカ！逆だ！
SE006 = playSe( spep_0 + 516, 1048 );

--バカ！逆だ！
SE007 = playSe( spep_0 + 516, 1052 );
setSeVolumeByWorkId( spep_0 + 496, SE007, 81 );

--足組み替える
SE008 = playSe( spep_0 + 674, 4 );

--足組み替える
SE009 = playSe( spep_0 + 676, 1106 );
setSeVolumeByWorkId( spep_0 + 676, SE009, 178 );

--足組み替える
SE010 = playSe( spep_0 + 676, 1108 );
setSeVolumeByWorkId( spep_0 + 676, SE010, 178 );
