...
-- ** 音 ** --
--筋斗雲くる
SE001 = playSeVer2( spep_0 + 236, 1327, "",spep_0 + 298, 40, 10, -1);
setSeVolumeByWorkId( spep_0 + 236, SE001, 73 );
SE002 = playSeVer2( spep_0 + 236, 1239, "",spep_0 + 298, 32, 10, -1);
setPitch( spep_0 + 236, SE002, 300 );
setTimeStretch( SE002, 1.2, 10, 1 );
SE003 = playSeVer2( spep_0 + 246, 63, "",spep_0 + 298, 0, 10, -1);
SE004 = playSeVer2( spep_0 + 268, 1323, "",spep_0 + 300, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 268, SE004, 85 );

--セリフカットイン
SE005 = playSeVer2( spep_0 + 352, 1018, "", 0, 0, 0, -1);

--悟空ジャンプ
SE006 = playSeVer2( spep_0 + 548, 1117, "",spep_0 + 612, 0, 36, -1);
setSeVolumeByWorkId( spep_0 + 548, SE006, 79 );
SE007 = playSeVer2( spep_0 + 548, 1048, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 548, SE007, 76 );

--筋斗雲に乗る
SE008 = playSeVer2( spep_0 + 588, 1293, "", 0, 0, 0, -1);

--筋斗雲で飛んでいく
SE009 = playSeVer2( spep_0 + 648, 1327, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 648, SE009, 82 );
setTimeStretch( SE009, 1.54, 10, 1 );
SE010 = playSeVer2( spep_0 + 648, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 648, SE010, 47 );
SE011 = playSeVer2( spep_0 + 648, 63, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 648, 1239, "",spep_0 + 800, 0, 8, -1);
setPitch( spep_0 + 648, SE012, 300 );
setTimeStretch( SE012, 1.3, 30, 4 );
SE013 = playSeVer2( spep_0 + 658, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 658, SE013, 63 );
SE014 = playSeVer2( spep_0 + 722, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 722, SE014, 63 );
SE015 = playSeVer2( spep_0 + 730, 44, "", 0, 0, 0, -1);
SE016 = playSeVer2( spep_0 + 777, 1239, "", 0, 0, 0, -1);
setPitch( spep_0 + 774, SE016, 300 );
setTimeStretch( SE016, 1.3, 30, 4 );
SE017 = playSeVer2( spep_0 + 786, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 786, SE017, 63 );
SE018 = playSeVer2( spep_0 + 850, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 850, SE018, 63 );

--加速
SE019 = playSeVer2( spep_0 + 878, 1258, "",spep_0 + 914, 0, 18, -1);
setSeVolumeByWorkId( spep_0 + 878, SE019, 48 );
SE020 = playSeVer2( spep_0 + 878, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 878, SE020, 71 );
