...
--演出によって書き換えてください
--セリフカットイン
SE001 = playSeVer2( spep_0 + 280, 1018, "", 0, 0, 0, -1);
SE002 = playSeVer2( spep_0 + 506, 1048, "", 0, 0, 0, -1);

--腕あげる
SE003 = playSeVer2( spep_0 + 622, 1003, "", 0, 0, 0, -1);

--ピッコロ凄む
SE004 = playSeVer2( spep_0 + 712, 1278, "",spep_0 + 810, 0, 34, -1);
setPitch( spep_0 + 712, SE004, 400 );
setTimeStretch( SE004, 1.27, 10, 1 );

--変身させる
SE005 = playSeVer2( spep_0 + 786, 1329, "",spep_0 + 956, 8, 70, -1);
setSeVolumeByWorkId( spep_0 + 786, SE005, 129 );
setStartTimeMs( SE005,  1033 );
setPitch( spep_0 + 786, SE005, 500 );
setTimeStretch( SE005, 1.33, 10, 1 );

--悟飯光出す
SE006 = playSeVer2( spep_0 + 728, 1215, "",spep_0 + 780, 0, 2, -1);
SE007 = playSeVer2( spep_0 + 756, 1225, "", spep_0 + 784, 0, 2, -1);
setPitch( spep_0 + 756, SE007, -700 );
setTimeStretch( SE007, 0.53, 10, 1 );
SE008 = playSeVer2( spep_0 + 756, 1265, "",spep_0 + 820, 0, 26, -1);

--変身させる
SE009 = playSeVer2( spep_0 + 784, 1154, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_0 + 784, 1035, "",spep_0 + 864, 0, 40, -1);
SE011 = playSeVer2( spep_0 + 784, 1231, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 784, SE011, 130 );
SE012 = playSeVer2( spep_0 + 796, 1248, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 796, SE012, 70 );
setTimeStretch( SE012, 1.53, 30, 4 );

--土煙
SE013 = playSeVer2( spep_0 + 928, 1182, "", 0, 28, 0, -1);
SE014 = playSeVer2( spep_0 + 928, 1014, "", 0, 28, 0, -1);

--セリフカットイン
SE015 = playSeVer2( spep_0 + 1004, 1042, "", 0, 0, 0, -1);
