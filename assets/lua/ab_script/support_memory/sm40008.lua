...
-- ** 音 ** --
--環境音
SE001 = playSeVer2( spep_0 + 228, 1269, "", 0, 66, 0, -1);
setSeVolumeByWorkId( spep_0 + 228, SE001, 25 );
--セリフカットイン
SE002 = playSeVer2( spep_0 + 270, 1018, "", 0, 0, 0, -1);
--画面遷移
SE003 = playSeVer2( spep_0 + 478, 1232, "", 0, 0, 0, -1);
--風力音
SE004 = playSeVer2( spep_0 + 478, 1175, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 478, SE004, 38 );
--セリフカットイン
SE005 = playSeVer2( spep_0 + 570, 1048, "", 0, 0, 0, -1);
--がっかり
SE006 = playSeVer2( spep_0 + 758, 7, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 758, 1280, "", 0, 0, 0, -1);
--手を広げる
SE008 = playSeVer2( spep_0 + 882, 1373, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 882, SE008, 140 );
SE009 = playSeVer2( spep_0 + 894, 1259, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 894, SE009, 68 );
setTimeStretch( SE009, 2, 30, 4 );
SE010 = playSeVer2( spep_0 + 896, 1068, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 896, SE010, 65 );
SE011 = playSeVer2( spep_0 + 896, 1371, "",spep_0 + 1130, 0, 66, -1);
setSeVolumeByWorkId( spep_0 + 896, SE011, 60 );
SE012 = playSeVer2( spep_0 + 896, 1374, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 896, SE012, 76 );
SE013 = playSeVer2( spep_0 + 896, 1264, "", 0, 0, 0, -1);
setPitch( spep_0 + 896, SE013, -800 );
