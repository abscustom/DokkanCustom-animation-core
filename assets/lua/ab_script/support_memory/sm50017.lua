--サポ－トメモリー_強くてやさしいお父さん
--support_memory_50017
...
--環境音
SE001 = playSeVer2( spep_0 + 188, 1269, "", 0, 54, 0, -1);
setSeVolumeByWorkId( spep_0 + 188, SE001, 25 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 242, 1018, "", 0, 0, 0, -1);
SE003 = playSeVer2( spep_0 + 360, 1048, "", 0, 0, 0, -1);

--悟飯痛がる
SE004 = playSeVer2( spep_0 + 456, 1299, "",spep_0 + 540, 0, 46, -1);
setSeVolumeByWorkId( spep_0 + 456, SE004, 146 );

--画面遷移
SE005 = playSeVer2( spep_0 + 512, 1232, "", 0, 0, 0, -1);

--悟飯うなづく
SE006 = playSeVer2( spep_0 + 768, 4, "", 0, 0, 0, -1);
