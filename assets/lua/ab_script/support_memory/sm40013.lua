...
--手繋ぐ
SE002 = playSeVer2( spep_0 + 408, 1113, "", 0, 0, 0, -1);
setPitch( spep_0 + 408, SE002, 300 );
setTimeStretch( SE002, 1.2, 30, 4 );
SE003 = playSeVer2( spep_0 + 412, 34, "",spep_0 + 422, 0, 6, -1);
--頭かたむける
SE004 = playSeVer2( spep_0 + 486, 1112, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 546, 1112, "", 0, 0, 0, -1);
--両手繋ぐ
SE006 = playSeVer2( spep_0 + 584, 1436, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 584, SE006, 158 );
SE007 = playSeVer2( spep_0 + 602, 1494, "", 0, 34, 0, -1);
setSeVolumeByWorkId( spep_0 + 602, SE007, 63 );
setPitch( spep_0 + 602, SE007, -300 );
