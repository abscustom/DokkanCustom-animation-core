--サポートメモリー_クリリン驚異のパワーアップ
--support_memory_20013
...
--SE
--セリフカットイン
SE001 = playSeVer2( spep_0 + 278, 1018, "", 0, 0, 0, -1);

--頭にてをおく
SE002 = playSeVer2( spep_0 + 442, 1013, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 442, SE002, 65 );

--エネルギー注入
SE003 = playSeVer2( spep_0 + 454, 48, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 454, SE003, 68 );
setPitch( spep_0 + 454, SE003, -600 );
setTimeStretch( SE003, 1.2, 10, 1 );
SE004 = playSeVer2( spep_0 + 454, 1210, "",spep_0 + 684, 0, 18, -1);
setSeVolumeByWorkId( spep_0 + 454, SE004, 66 );
setPitch( spep_0 + 454, SE004, -600 );
setTimeStretch( SE004, 1, 10, 1 );

--腕光る
SE005 = playSeVer2( spep_0 + 612, 1240, "",spep_0 + 678, 0, 16, -1);

--クリリン覚醒
SE006 = playSeVer2( spep_0 + 672, 1290, "", 0, 2, 0, -1);
setSeVolumeByWorkId( spep_0 + 672, SE006, 87 );
setStartTimeMs( SE006,  133 );
setPitch( spep_0 + 672, SE006, 300 );
setTimeStretch( SE006, 1.2, 10, 1 );
SE007 = playSeVer2( spep_0 + 668, 1283, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 668, SE007, 63 );
setPitch( spep_0 + 668, SE007, 900 );
setTimeStretch( SE007, 1.6, 10, 1 );
SE008 = playSeVer2( spep_0 + 668, 1265, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 682, 1311, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_0 + 682, 1278, "",spep_0 + 906, 0, 106, -1);
setSeVolumeByWorkId( spep_0 + 682, SE010, 71 );
SE011 = playSeVer2( spep_0 + 758, 1240, "",spep_0 + 940, 0, 42, -1);

--クリリンテンション上げ
SE012 = playSeVer2( spep_0 + 904, 57, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 904, 1264, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 904, SE013, 67 );
