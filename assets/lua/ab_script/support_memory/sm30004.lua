--サポートメモリー　心をひとつに！ピッコロとデンデ
--support_memory_30004
...
--環境音
SE001 = playSe( spep_0 + 228, 1269 );
setSeVolumeByWorkId( spep_0 + 228, SE001, 16 );
stopSe( spep_0 + 600, SE001, 0 );

--ピッコロ顔上げ
SE002 = playSe( spep_0 + 246, 1003 );
setSeVolumeByWorkId( spep_0 + 246, SE002, 85 );

--デンデ顔上げ
SE003 = playSe( spep_0 + 356, 1048 );
setSeVolumeByWorkId( spep_0 + 356, SE003, 80 );

--ピッコロオーラ
SE004 = playSe( spep_0 + 458, 1307 );
setSeVolumeByWorkId( spep_0 + 458, SE004, 126 );
setPitch( spep_0 + 458, SE004, 200 );
setTimeStretch( SE004, 1.13, 10, 1 );

--デンデオーラ
SE005 = playSe( spep_0 + 496, 1307 );
setSeVolumeByWorkId( spep_0 + 496, SE005, 126 );
setPitch( spep_0 + 496, SE005, 200 );
setTimeStretch( SE005, 1.13, 10, 1 );

--2人カットイン
SE006 = playSe( spep_0 + 528, 1018 );

--ビーム発射
SE007 = playSe( spep_0 + 592, 1004 );
setSeVolumeByWorkId( spep_0 + 592, SE007, 72 );

--ビーム発射
SE008 = playSe( spep_0 + 596, 1227 );

--ビーム発射
SE009 = playSe( spep_0 + 602, 1311 );
stopSe( spep_0 + 624, SE009, 8 );

--ビーム発射
SE010 = playSe( spep_0 + 620, 1022 );
setSeVolumeByWorkId( spep_0 + 620, SE010, 65 );

--ビーム発射
SE011 = playSe( spep_0 + 624, 1249 );

--境界線爆発
SE012 = playSe( spep_0 + 680, 1067 );
setSeVolumeByWorkId( spep_0 + 680, SE012, 79 );

--境界線爆発
SE013 = playSe( spep_0 + 680, 20 );
setSeVolumeByWorkId( spep_0 + 680, SE013, 64 );
