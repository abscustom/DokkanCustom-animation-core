...
-- ** 音 ** --
--環境音
SE001 = playSeVer2( spep_0 + 170, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 170, SE001, 25 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 270, 1018, "", 0, 0, 0, -1);
SE003 = playSeVer2( spep_0 + 446, 1048, "", 0, 0, 0, -1);

--OKマーク
SE004 = playSeVer2( spep_0 + 516, 4, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 516, 1189, "", 0, 0, 0, -1);

--セリフカットイン
SE006 = playSeVer2( spep_0 + 650, 44, "", 0, 0, 0, -1);

--ラストセリフカットイン
SE007 = playSeVer2( spep_0 + 752, 1112, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 752, 1432, "", 0, 0, 0, -1);
