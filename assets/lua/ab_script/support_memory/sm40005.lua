--サポートメモリー　トランクスとマイの再会
--support_memory_40005
...
--演出によって書き換えてください
--環境音
SE001 = playSeVer2( spep_0 + 178, 1269, "", 0, 44, 0, -1);
setSeVolumeByWorkId( spep_0 + 178, SE001, 32 );

--セリフカットイン１
SE002 = playSeVer2( spep_0 + 232, 1018, "", 0, 0, 0, -1);

--セリフカットイン２
SE003 = playSeVer2( spep_0 + 366, 1189, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 366, SE003, 85 );
SE004 = playSeVer2( spep_0 + 366, 1048, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 366, SE004, 85 );

--セリフカットイン3
SE005 = playSeVer2( spep_0 + 482, 44, "", 0, 0, 0, -1);

--て握る
SE006 = playSeVer2( spep_0 + 484, 1233, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 484, SE006, 72 );
SE007 = playSeVer2( spep_0 + 494, 1012, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 494, SE007, 76 );

--頬染める
SE008 = playSeVer2( spep_0 + 536, 1112, "", 0, 0, 0, -1);

--髪なでる
SE009 = playSeVer2( spep_0 + 700, 1333, "",spep_0 + 724, 0, 12, -1);
setSeVolumeByWorkId( spep_0 + 700, SE009, 206 );
SE010 = playSeVer2( spep_0 + 722, 1331, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 722, SE010, 162 );

--セリフカットイン4
SE011 = playSeVer2( spep_0 + 856, 12, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 856, SE011, 69 );
SE012 = playSeVer2( spep_0 + 856, 1232, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 856, SE012, 89 );
