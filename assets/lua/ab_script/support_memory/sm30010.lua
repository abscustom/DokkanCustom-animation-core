...
-- ** 音 ** --
--セリフカットイン
SE001 = playSeVer2( spep_0 + 260, 1018, "", 0, 0, 0, -1);
--ギル焦る
SE002 = playSeVer2( spep_0 + 428, 1416, "",spep_0 + 456, 4, 6, -1);
setSeVolumeByWorkId( spep_0 + 428, SE002, 150 );
setStartTimeMs( SE002,  867 );
setPitch( spep_0 + 428, SE002, 200 );
setTimeStretch( SE002, 1.13, 30, 4 );
SE003 = playSeVer2( spep_0 + 410, 1048, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 410, SE003, 86 );
SE004 = playSeVer2( spep_0 + 418, 1273, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 418, SE004, 63 );
SE005 = playSeVer2( spep_0 + 424, 1416, "",spep_0 + 444, 0, 8, -1);
setSeVolumeByWorkId( spep_0 + 424, SE005, 150 );
setPitch( spep_0 + 424, SE005, 200 );
setTimeStretch( SE005, 1.13, 30, 4 );
SE006 = playSeVer2( spep_0 + 448, 1416, "",spep_0 + 474, 0, 8, -1);
setSeVolumeByWorkId( spep_0 + 448, SE006, 130 );
--セリフカットイン
SE007 = playSeVer2( spep_0 + 522, 44, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 652, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 652, SE008, 123 );
--パン近づく
SE009 = playSeVer2( spep_0 + 740, 1117, "", 0, 8, 0, -1);
setSeVolumeByWorkId( spep_0 + 740, SE009, 67 );
setStartTimeMs( SE009,  200 );
SE010 = playSeVer2( spep_0 + 736, 63, "",spep_0 + 812, 0, 14, -1);
--バンダナ巻く
SE011 = playSeVer2( spep_0 + 840, 1331, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 914, 1333, "",spep_0 + 956, 0, 12, -1);
--キス
SE013 = playSeVer2( spep_0 + 988, 1113, "", 0, 0, 0, -1);
--ギル照れる
SE014 = playSeVer2( spep_0 + 1134, 25, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1134, SE014, 60 );
setPitch( spep_0 + 1134, SE014, 300 );
setTimeStretch( SE014, 1.95, 30, 4 );
SE015 = playSeVer2( spep_0 + 1134, 24, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1134, SE015, 94 );
SE016 = playSeVer2( spep_0 + 1134, 1280, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1134, SE016, 417 );
setPitch( spep_0 + 1134, SE016, -1100 );
