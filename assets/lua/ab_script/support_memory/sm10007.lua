...
-- ** 音 ** --
--セリフカットイン	
SE001 = playSeVer2( spep_0 + 274, 1018, "", 0, 0, 0, -1);
--指さす
SE002 = playSeVer2( spep_0 + 330, 1003, "", 0, 0, 0, -1);
--セリフカットイン	
SE003 = playSeVer2( spep_0 + 366, 44, "", 0, 0, 0, -1);
--仮面外す
SE004 = playSeVer2( spep_0 + 374, 1331, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 474, 409, "",spep_0 + 502, 0, 4, -1);
setSeVolumeByWorkId( spep_0 + 474, SE005, 64 );
setPitch( spep_0 + 474, SE005, 400 );
setTimeStretch( SE005, 1.27, 30, 4 );
SE006 = playSeVer2( spep_0 + 476, 29, "", 0, 0, 0, -1);
--セリフカットイン	
SE007 = playSeVer2( spep_0 + 530, 1048, "", 0, 0, 0, -1);
--震える
SE008 = playSeVer2( spep_0 + 648, 1330, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 648, SE008, 38 );
--踏み出す
SE009 = playSeVer2( spep_0 + 696, 1106, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 696, SE009, 141 );
--走り出す
SE010 = playSeVer2( spep_0 + 754, 1117, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 754, SE010, 71 );
SE011 = playSeVer2( spep_0 + 758, 7, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 766, 1108, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 778, 1108, "", 0, 0, 0, -1);
SE014 = playSeVer2( spep_0 + 788, 1108, "", 0, 0, 0, -1);
SE015 = playSeVer2( spep_0 + 800, 1108, "", 0, 0, 0, -1);
SE016 = playSeVer2( spep_0 + 810, 1108, "", 0, 0, 0, -1);
--飛びつく
SE017 = playSeVer2( spep_0 + 822, 1277, "",spep_0 + 870, 0, 6, -1);
SE018 = playSeVer2( spep_0 + 824, 63, "",spep_0 + 874, 0, 14, -1);
--抱きつく
SE019 = playSeVer2( spep_0 + 840, 1233, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 840, SE019, 58 );
SE020 = playSeVer2( spep_0 + 850, 1012, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 850, SE020, 71 );
SE021 = playSeVer2( spep_0 + 852, 1007, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 852, SE021, 72 );
--慌てる
SE022 = playSeVer2( spep_0 + 866, 37, "",spep_0 + 906, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 866, SE022, 71 );
SE023 = playSeVer2( spep_0 + 882, 37, "",spep_0 + 922, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 882, SE023, 71 );
SE024 = playSeVer2( spep_0 + 902, 37, "",spep_0 + 942, 0, 8, -1);
setSeVolumeByWorkId( spep_0 + 902, SE024, 71 );
