...
--演出によって書き換えてください
--飛び出す
SE001 = playSeVer2( spep_0 + 286 +12, 1013, "", 0, 0, 0, -1);

--足音
SE002 = playSeVer2( spep_0 + 304 +12, 1108, "", 0, 0, 0, -1);
SE003 = playSeVer2( spep_0 + 314 +12, 1107, "", 0, 0, 0, -1);

--セリフカットイン
SE004 = playSeVer2( spep_0 + 358 + 12, 1018, "", 0, 0, 0, -1);

--目をまるくする
SE005 = playSeVer2( spep_0 + 494 +12, 1113, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 494 +12, SE005, 79 );
SE006 = playSeVer2( spep_0 + 522 +12, 1113, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 522 +12, SE006, 79 );

--セリフカットイン
SE007 = playSeVer2( spep_0 + 542 +12, 1048, "", 0, 0, 0, -1);

--そっぽむく
SE008 = playSeVer2( spep_0 + 782 +12, 1108, "", 0, 0, 0, -1);

--振り返る
SE009 = playSeVer2( spep_0 + 836 +12, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 836 +12, SE009, 63 );

--風が吹く
SE010 = playSeVer2( spep_0 + 928 +12, 1259, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 928 +12, SE010, 56 );
SE011 = playSeVer2( spep_0 + 928 +12, 1278, "",spep_0 + 1048, 0, 52, -1);
setSeVolumeByWorkId( spep_0 + 928 +12, SE011, 65 );

--セリフカットイン
SE012 = playSeVer2( spep_0 + 1030 +12, 44, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 1030 +12, 1115, "",spep_0 + 1130, 0, 38, -1);
