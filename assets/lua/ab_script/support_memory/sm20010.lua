...
--演出によって書き換えてください
--環境音
SE001 = playSeVer2( spep_0 + 204, 1349, "", 0, 54, 0, -1);
setSeVolumeByWorkId( spep_0 + 204, SE001, 32 );
--setStartTimeMs( SE001,  350 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 312, 1018, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 312, SE002, 66 );

--トランクスうなづく
SE003 = playSeVer2( spep_0 + 366, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 366, SE003, 74 );

--トランクス歩く
SE004 = playSeVer2( spep_0 + 420, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 420, SE004, 127 );
SE005 = playSeVer2( spep_0 + 468, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 468, SE005, 133 );

--振り向く
SE006 = playSeVer2( spep_0 + 506, 1048, "",spep_0 + 522, 0, 8, -1);
setSeVolumeByWorkId( spep_0 + 506, SE006, 80 );

--トランクス歩く
SE007 = playSeVer2( spep_0 + 526, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 526, SE007, 143 );
SE008 = playSeVer2( spep_0 + 530, 1106, "", 0, 0, 0, -1);

--ベジータピース
SE009 = playSeVer2( spep_0 + 594, 4, "",spep_0 + 608, 0, 6, -1);

--風が吹く、そして髪がなびく
SE010 = playSeVer2( spep_0 + 658, 1332, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 658, SE010, 42 );
SE011 = playSeVer2( spep_0 + 692, 1332, "", 0, 4, 0, -1);
