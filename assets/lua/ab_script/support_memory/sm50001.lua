--サポートメモリー　飛ばせハイヤードラゴン！
--support_memory_50001
...
--演出によって書き換えてください
--仙豆放り込む
SE001 = playSe( spep_0 + 302, 1189 );
setSeVolumeByWorkId( spep_0 + 302, SE001, 72 );

--もぐもぐ
SE002 = playSe( spep_0 + 340, 1071 );
setPitch( spep_0 + 340, SE002, -800 );
setTimeStretch( SE002, 0.47, 10, 1 );
stopSe( spep_0 + 380, SE002, 0 );

--目キリッ
SE003 = playSe( spep_0 + 396, 48 );	
setTimeStretch( SE003, 0.76, 10, 1 );

--ダッシュ
SE004 = playSe( spep_0+18 + 396, 1182 );
setSeVolumeByWorkId( spep_0+18 + 396, SE004, 77 );
SE005 = playSe( spep_0+18 + 396, 9 );
setSeVolumeByWorkId( spep_0+18 + 396, SE005, 72 );
setTimeStretch( SE005, 1.25, 10, 1 );
SE006 = playSe( spep_0+18 + 400, 1019 );
SE006_2 = playSe( spep_0+18 + 462, 1019 );
SE006_3 = playSe( spep_0+18 + 528, 1019 );
SE006_4 = playSe( spep_0+18 + 592, 1019 );
SE006_5 = playSe( spep_0+18 + 656, 1019 );
SE006_6 = playSe( spep_0+18 + 720, 1019 );
SE006_7 = playSe( spep_0+18 + 784, 1019 );

--悟飯アップ
SE007 = playSe( spep_0+28 + 448, 1167 );
setSeVolumeByWorkId( spep_0+28 + 448, SE007, 26 );	
setTimeStretch( SE007, 1.67, 10, 1 );
SE008 = playSe( spep_0+28 + 448, 1183 );
setSeVolumeByWorkId( spep_0+28 + 448, SE008, 66 );				

--画面切り替え
SE009 = playSe( spep_0+13 + 518, 1072 );
stopSe( spep_0+13 + 560, SE009, 10 );


--最後ビューン
SE010 = playSe( spep_0+13 + 566, 1183 );
setSeVolumeByWorkId( spep_0+13 + 566, SE010, 60 );
SE011 = playSe( spep_0+13 + 574, 1116 );
stopSe( spep_0+13 + 604, SE011, 26 );
