...
-- ** 音 ** --
--コントローラー潰す
SE007 = playSeVer2( spep_0 + 388, 1189, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 398, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 398, SE008, 178 );
SE009 = playSeVer2( spep_0 + 398, 1439, "",spep_0 + 458, 0, 32, -1);
SE010 = playSeVer2( spep_0 + 400, 1041, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 400, SE010, 52 );

--18号驚く
SE011 = playSeVer2( spep_0 + 442, 48, "", 0, 0, 0, -1);

--セリフカットイン
SE012 = playSeVer2( spep_0 + 486, 1018, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 654, 1048, "", 0, 0, 0, -1);
