...
--演出によって書き換えてください
--ブラック手を差し出す
SE001 = playSeVer2( spep_0 + 312, 1003, "", 0, 0, 0, -1);
--ザマス手を差し出す
SE002 = playSeVer2( spep_0 + 430, 4, "", 0, 0, 0, -1);
--握手
SE003 = playSeVer2( spep_0 + 494, 1294, "",spep_0 + 518, 0, 8, -1);
SE004 = playSeVer2( spep_0 + 496, 1107, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 496, SE004, 126 );
SE005 = playSeVer2( spep_0 + 498, 1111, "",spep_0 + 514, 0, 6, -1);
setSeVolumeByWorkId( spep_0 + 498, SE005, 126 );
--画面遷移
SE006 = playSeVer2( spep_0 + 552, 8, "", 0, 0, 0, -1);
--ポタラゆれる
SE007 = playSeVer2( spep_0 + 628, 1372, "",spep_0 + 676, 0, 20, -1);
setSeVolumeByWorkId( spep_0 + 628, SE007, 200 );
--画面遷移
SE008 = playSeVer2( spep_0 + 690, 1232, "", 0, 0, 0, -1);
--ポタラゆれる
SE009 = playSeVer2( spep_0 + 740, 1372, "",spep_0 + 788, 0, 20, -1);
setSeVolumeByWorkId( spep_0 + 740, SE009, 184 );
--腕ひろげる
SE010 = playSeVer2( spep_0 + 868, 1004, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 868, SE010, 59 );
--ハグ
SE011 = playSeVer2( spep_0 + 898, 1018, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 924, 1332, "",spep_0 + 952, 0, 8, -1);
SE013 = playSeVer2( spep_0 + 928, 1007, "", 0, 0, 0, -1);
