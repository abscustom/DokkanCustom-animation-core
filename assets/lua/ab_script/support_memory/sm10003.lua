...
-- ** 音 ** --
--甲羅置く
SE001 = playSeVer2( spep_0 + 330, 1009, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 330, SE001, 85 );
SE002 = playSeVer2( spep_0 + 330, 1395, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 330, SE002, 80 );
SE003 = playSeVer2( spep_0 + 330, 1170, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 330, SE003, 89 );

--甲羅置く2
SE004 = playSeVer2( spep_0 + 350, 1009, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 350, SE004, 83 );
SE005 = playSeVer2( spep_0 + 350, 1395, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 350, SE005, 77 );
SE006 = playSeVer2( spep_0 + 350, 1170, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 350, SE006, 68 );

--セリフカットイン
SE007 = playSeVer2( spep_0 + 376, 1048, "", 0, 0, 0, -1);

--かがむ
SE008 = playSeVer2( spep_0 + 500, 1189, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 500, 1013, "", 0, 0, 0, -1);

--飛び上がる
SE010 = playSeVer2( spep_0 + 530, 1116, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_0 + 530, 1207, "", 0, 0, 0, -1);
setTimeStretch( SE011, 1.25, 10, 1 );
SE012 = playSeVer2( spep_0 + 530, 1117, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 530, 1011, "", 0, 0, 0, -1);

--画面遷移
SE014 = playSeVer2( spep_0 + 648, 44, "", 0, 0, 0, -1);

--飛行中
SE015 = playSeVer2( spep_0 + 650, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 650, SE015, 47 );

--セリフカットイン
SE016 = playSeVer2( spep_0 + 676, 1018, "", 0, 0, 0, -1);

--飛行中
SE017 = playSeVer2( spep_0 + 714, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 714, SE017, 47 );
SE018 = playSeVer2( spep_0 + 778, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 778, SE018, 47 );
SE019 = playSeVer2( spep_0 + 842, 1019, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 842, SE019, 47 );
