...
--セリフカットイン
SE001 = playSeVer2( spep_0 + 252, 1018, "", 0, 0, 0, -1);

--エネルギー分け与える
SE002 = playSeVer2( spep_0 + 360, 1400, "",spep_0 + 816, 0, 36, -1);
setSeVolumeByWorkId( spep_0 + 360, SE002, 126 );

--セリフカットイン
SE003 = playSeVer2( spep_0 + 592, 1048, "", 0, 0, 0, -1);

--画面遷移
SE004 = playSeVer2( spep_0 + 652, 1072, "", 0, 0, 0, -1);

--エネルギー与え終わり
SE005 = playSeVer2( spep_0 + 784, 1026, "", 0, 0, 0, -1);
SE006 = playSeVer2( spep_0 + 784, 1338, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 784, SE006, 79 );
SE007 = playSeVer2( spep_0 + 784, 1371, "",spep_0 + 992, 0, 164, -1);
SE008 = playSeVer2( spep_0 + 810, 1175, "",spep_0 + 998, 0, 114, -1);
setSeVolumeByWorkId( spep_0 + 810, SE008, 35 );
SE009 = playSeVer2( spep_0 + 834, 1332, "", 0, 0, 0, -1);

--悟空叫ぶ
SE010 = playSeVer2( spep_0 + 930, 20, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 930, SE010, 63 );
SE011 = playSeVer2( spep_0 + 930, 1264, "",spep_0 + 1070, 0, 96, -1);
setSeVolumeByWorkId( spep_0 + 930, SE011, 81 );

--瞬間移動
SE012 = playSeVer2( spep_0 + 986, 1245, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 986, SE012, 73 );
SE013 = playSeVer2( spep_0 + 994, 1109, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 994, SE013, 141 );
