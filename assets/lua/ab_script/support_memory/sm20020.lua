...
-- ** 音 ** --
--飛行音
SE001 = playSeVer2( spep_0 + 222, 1019, "", 0, 0, 0, -1);
SE003 = playSeVer2( spep_0 + 286, 1019, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 350, 1019, "", 0, 0, 0, -1);
SE006 = playSeVer2( spep_0 + 414, 1019, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 478, 1019, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 542, 1019, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_0 + 606, 1019, "",spep_0 + 676, 0, 50, -1);

--セリフカットイン
SE002 = playSeVer2( spep_0 + 242, 1018, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 346, 1048, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 490, 1189, "", 0, 0, 0, -1);

--環境音
SE010 = playSeVer2( spep_0 + 576, 1269, "", 0, 84, 0, -1);
setSeVolumeByWorkId( spep_0 + 576, SE010, 25 );
SE013 = playSeVer2( spep_0 + 664, 1350, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 664, SE013, 60 );

--画面遷移
SE012 = playSeVer2( spep_0 + 626, 8, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 626, SE012, 71 );

--悟空うであげる
SE014 = playSeVer2( spep_0 + 718, 1003, "", 0, 0, 0, -1);
SE015 = playSeVer2( spep_0 + 722, 1006, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 722, SE015, 71 );
SE016 = playSeVer2( spep_0 + 722, 1062, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 722, SE016, 66 );

--ウーブ腕あげる
SE017 = playSeVer2( spep_0 + 804, 1189, "", 0, 0, 0, -1);
SE018 = playSeVer2( spep_0 + 810, 1006, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 810, SE018, 69 );
SE019 = playSeVer2( spep_0 + 810, 1062, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 810, SE019, 68 );
setPitch( spep_0 + 810, SE019, 200 );
setTimeStretch( SE019, 1.13, 30, 4 );

--笑う
SE020 = playSeVer2( spep_0 + 948, 1257, "", 0, 0, 0, -1);
