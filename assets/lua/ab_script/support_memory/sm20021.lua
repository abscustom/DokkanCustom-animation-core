--サポートメモリー_バーダックとカカロット
--support_memory_20021
...
--環境音
SE001 = playSeVer2( spep_0 + 192, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 192, SE001, 25 );

--飛んでくる
SE002 = playSeVer2( spep_0 + 192, 1019, "", 0, 0, 0, -1);
SE003 = playSeVer2( spep_0 + 192, 1278, "",spep_0 + 458, 0, 84, -1);
setSeVolumeByWorkId( spep_0 + 192, SE003, 45 );
SE004 = playSeVer2( spep_0 + 256, 1019, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 318, 1019, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 382, 1019, "",spep_0 + 444, 0, 44, -1);

--邂逅する
SE006 = playSeVer2( spep_0 + 348, 1072, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 362, 1271, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 380, 1237, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 380, SE009, 63 );
setPitch( spep_0 + 380, SE009, 600 );	setTimeStretch( SE009, 1.4, 30, 4 );
SE010 = playSeVer2( spep_0 + 380, 1237, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 380, SE010, 63 );
setPitch( spep_0 + 380, SE010, -100 );	setTimeStretch( SE010, 0.93, 30, 4 );

--二人うつる
SE011 = playSeVer2( spep_0 + 462, 8, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 468, 1042, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 468, SE012, 79 );

--セリフカットイン
SE013 = playSeVer2( spep_0 + 548, 1018, "", 0, 0, 0, -1);

--画面遷移
SE014 = playSeVer2( spep_0 + 694, 44, "", 0, 0, 0, -1);

--飛び立つ
SE015 = playSeVer2( spep_0 + 758, 1452, "", 0, 0, 0, -1);
SE016 = playSeVer2( spep_0 + 758, 1277, "", 0, 0, 0, -1);
SE017 = playSeVer2( spep_0 + 770, 1019, "", 0, 0, 0, -1);
