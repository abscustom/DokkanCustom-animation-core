...
--演出によって書き換えてください
--環境音
SE001 = playSe( spep_0 + 212, 1269 );
setSeVolumeByWorkId( spep_0 + 212, SE001, 33 );

--環境音
SE002 = playSe( spep_0 + 224, 1175 );
setSeVolumeByWorkId( spep_0 + 224, SE002, 36 );

--ベジータセリフカットイン
SE003 = playSe( spep_0 + 268, 1018 );

--みんな気付く
SE004 = playSe( spep_0 + 430, 48 );
stopSe( spep_0 + 472, SE004, 22 );

--トランクスセリフカットイン	
SE005 = playSe( spep_0 + 466, 1048 );

--ベジータセリフカットイン
SE006 = playSe( spep_0 + 586, 20 );
