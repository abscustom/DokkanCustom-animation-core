...
--演出によって書き換えてください
--セリフカットイン
SE001 = playSeVer2( spep_0 + 276, 1018, "", 0, 0, 0, -1);

--腕伸ばす
SE002 = playSeVer2( spep_0 + 324, 1189, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 324, SE002, 85 );

--神龍出現
SE003 = playSeVer2( spep_0 + 494, 1229, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 494, 1226, "",spep_0 + 688, 0, 98, -1);
setSeVolumeByWorkId( spep_0 + 494, SE004, 27 );
SE005 = playSeVer2( spep_0 + 494, 1175, "",spep_0 + 688, 0, 106, -1);
setSeVolumeByWorkId( spep_0 + 494, SE005, 39 );

--神龍うなづく
SE006 = playSeVer2( spep_0 + 518, 1223, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 518, 1200, "",spep_0 + 686, 0, 94, -1);

--雷打たれる
SE008 = playSeVer2( spep_0 + 644, 1231, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 648, 1153, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 648, SE009, 75 );

--悟空小さくなる
SE010 = playSeVer2( spep_0 + 710, 1195, "", 0, 6, 0, -1);
setStartTimeMs( SE010,  683 );
SE011 = playSeVer2( spep_0 + 702, 1224, "",spep_0 + 738, 0, 16, -1);
setSeVolumeByWorkId( spep_0 + 702, SE011, 85 );
SE012 = playSeVer2( spep_0 + 702, 1122, "",spep_0 + 764, 0, 28, -1);
setSeVolumeByWorkId( spep_0 + 702, SE012, 78 );
SE013 = playSeVer2( spep_0 + 710, 1194, "",spep_0 + 984, 0, 42, -1);
SE014 = playSeVer2( spep_0 + 710, 1147, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 710, SE014, 64 );
SE015 = playSeVer2( spep_0 + 714, 1240, "",spep_0 + 986, 0, 44, -1);
setTimeStretch( SE015, 2, 10, 1 );
SE016 = playSeVer2( spep_0 + 714, 1271, "",spep_0 + 986, 0, 44, -1);
setPitch( spep_0 + 714, SE016, 1000 );
setTimeStretch( SE016, 1.67, 10, 1 );
SE017 = playSeVer2( spep_0 + 916, 1148, "",spep_0 + 986, 0, 44, -1);
setSeVolumeByWorkId( spep_0 + 916, SE017, 63 );

--悟空手を見る
SE018 = playSeVer2( spep_0 + 990, 1003, "", 0, 0, 0, -1);

--セリフカットイン
SE019 = playSeVer2( spep_0 + 996, 44, "", 0, 0, 0, -1);
