...
-- ** 音 ** --
--水でもがく
SE001 = playSeVer2( spep_0 + 198, 1470, "",spep_0 + 666, 42, 26, -1);
SE002 = playSeVer2( spep_0 + 222, 1163, "", 0, 0, 0, -1);

--セリフカットイン
SE003 = playSeVer2( spep_0 + 246, 1048, "", 0, 0, 0, -1);

--水でもがく
SE004 = playSeVer2( spep_0 + 306, 1163, "", 0, 0, 0, -1);
setPitch( spep_0 + 306, SE004, -300 );
setTimeStretch( SE004, 0.8, 30, 4 );

--セリフカットイン
SE005 = playSeVer2( spep_0 + 368, 1018, "", 0, 0, 0, -1);

--沈む
SE006 = playSeVer2( spep_0 + 658, 1471, "", 0, 20, 0, -1);
setSeVolumeByWorkId( spep_0 + 658, SE006, 146 );
setStartTimeMs( SE006,  533 );
SE007 = playSeVer2( spep_0 + 644, 1163, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 656, 1471, "",spep_0 + 766, 0, 54, -1);
SE009 = playSeVer2( spep_0 + 666, 7, "", 0, 0, 0, -1);
