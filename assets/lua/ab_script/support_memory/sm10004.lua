...
-- ** 音 ** --
--セリフカットイン
SE001 = playSeVer2( spep_0 + 294, 1018, "", 0, 0, 0, -1);

--拳握る
SE002 = playSeVer2( spep_0 + 496, 1003, "", 0, 0, 0, -1);

--セリフカットイン
SE003 = playSeVer2( spep_0 + 530, 1048, "", 0, 0, 0, -1);

--ピッコロ赤背景
SE004 = playSeVer2( spep_0 + 574, 1399, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 574, SE004, 240 );
SE005 = playSeVer2( spep_0 + 574, 1264, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 574, SE005, 62 );
setPitch( spep_0 + 574, SE005, -500 );
setTimeStretch( SE005, 0.67, 30, 4 );

--壁激突
SE006 = playSeVer2( spep_0 + 682, 1168, "", 0, 12, 0, -1);
setSeVolumeByWorkId( spep_0 + 682, SE006, 65 );
setStartTimeMs( SE006,  967 );

--ピッコロ振りかぶる
SE007 = playSeVer2( spep_0 + 628, 1116, "",spep_0 + 668, 0, 14, -1);
setSeVolumeByWorkId( spep_0 + 628, SE007, 71 );
SE008 = playSeVer2( spep_0 + 662, 1004, "", 0, 0, 0, -1);

--パンチ
SE009 = playSeVer2( spep_0 + 676, 1120, "", 0, 0, 0, -1);

--壁激突
SE010 = playSeVer2( spep_0 + 684, 1159, "", 0, 0, 0, -1);
