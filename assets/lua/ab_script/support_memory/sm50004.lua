...
--オーラ
SE001 = playSeVer2( spep_0 + 192, 1181, "", 0, 50, 0, -1);
setSeVolumeByWorkId( spep_0 + 192, SE001, 132 );

SE002 = playSeVer2( spep_0 + 192, 1287, "", 0, 50, 0, -1);
setSeVolumeByWorkId( spep_0 + 192, SE002, 28 );

SE003 = playSeVer2( spep_0 + 192, 1226, "", 0, 50, 0, -1);
setSeVolumeByWorkId( spep_0 + 192, SE003, 9 );

SE004 = playSeVer2( spep_0 + 192, 1227, "", 0, 50, 0, -1);
setSeVolumeByWorkId( spep_0 + 192, SE004, 54 );

--ビルスセリフカットイン
SE005 = playSeVer2( spep_0 + 300, 19, "", 0, 14, 0, -1);
SE006 = playSeVer2( spep_0 + 304, 4, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 304, 1048, "", 0, 0, 0, -1);

--悟空セリフカットイン
SE008 = playSeVer2( spep_0 + 428, 44, "", 0, 0, 0, -1);

--陽の光
SE009 = playSeVer2( spep_0 + 610, 1263, "", 0, 0, 0, -1);

--ビルスセリフカットイン２
SE010 = playSeVer2( spep_0 + 644, 1048, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_0 + 644, 4, "", 0, 0, 0, -1);

--ラスト決め
SE012 = playSeVer2( spep_0 + 728, 1018, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 728, 3, "", 0, 0, 0, -1);
