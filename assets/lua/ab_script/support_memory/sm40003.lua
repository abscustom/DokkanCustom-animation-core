--サポートメモリー　全王のありがたいお言葉
--support_memory_40003
...
--演出によって書き換えてください
--セリフカットイン
SE001 = playSe( spep_0 + 254, 1018 );
setSeVolumeByWorkId( spep_0 + 254, SE001, 79 );

--ハイタッチ
SE002 = playSe( spep_0 + 328, 1113 );

--回る
SE003 = playSe( spep_0 + 342, 1112 );

--片方ささえる
SE004 = playSe( spep_0 + 416, 1003 );
setSeVolumeByWorkId( spep_0 + 416, SE004, 72 );

--ピタッ
SE005 = playSe( spep_0 + 460, 1113 );

--大きく回る
SE006 = playSe( spep_0 + 502, 44 );

--手離す
SE007 = playSe( spep_0 + 568, 1113 );
setSeVolumeByWorkId( spep_0 + 568, SE007, 80 );

--ラスト覗き込む
SE008 = playSe( spep_0 + 620, 1112 );
setPitch( spep_0 + 620, SE008, 400 );
