...
--演出によって書き換えてください
--神龍登場
SE001 = playSeVer2( spep_0 + 242, 1017, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 242, SE001, 85 );

--神龍登場
SE002 = playSeVer2( spep_0 + 242, 1011, "", 0, 0, 0, -1);

--神龍登場
SE003 = playSeVer2( spep_0 + 242, 1278, "", 0, 0, 0, -1);

--神龍登場
SE004 = playSeVer2( spep_0 + 242, 1314, "",spep_0 + 400, 0, 120, -1);

--神龍登場
SE005 = playSeVer2( spep_0 + 248, 1227, "", 0, 0, 0, -1);

--セリフカットイン
SE006 = playSeVer2( spep_0 + 470, 1018, "", 0, 0, 0, -1);

--風が吹く
SE007 = playSeVer2( spep_0 + 600, 1332, "", 0, 0, 0, -1);

--風が吹く
SE008 = playSeVer2( spep_0 + 632, 1332, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 632, SE008, 82 );

--ドラゴンボール光る
SE009 = playSeVer2( spep_0 + 650, 32, "", 0, 0, 0, -1);

--ドラゴンボール光る
SE010 = playSeVer2( spep_0 + 684, 1042, "", 0, 0, 0, -1);
