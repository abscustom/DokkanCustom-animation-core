...
--環境音
SE001 = playSe( spep_0 + 268, 1175 );
setSeVolumeByWorkId( spep_0 + 268, SE001, 15 );
setTimeStretch( SE001, 1.15, 10, 1 );

--拳握る
SE002 = playSe( spep_0 + 284, 1003 );
setSeVolumeByWorkId( spep_0 + 284, SE002, 60 );

--環境音
SE003 = playSe( spep_0 + 284, 1288 );
setSeVolumeByWorkId( spep_0 + 284, SE003, 60 );

--拳握る
SE004 = playSe( spep_0 + 308, 1013 );
setSeVolumeByWorkId( spep_0 + 308, SE004, 70 );

--環境音
SE005 = playSe( spep_0 + 334, 1278 );
setSeVolumeByWorkId( spep_0 + 334, SE005, 2.5 );
setSeVolumeByWorkId( spep_0 + 338, SE005, 5 );
setSeVolumeByWorkId( spep_0 + 342, SE005, 7.5 );
setSeVolumeByWorkId( spep_0 + 346, SE005, 10 );
setSeVolumeByWorkId( spep_0 + 350, SE005, 12.5 );
setSeVolumeByWorkId( spep_0 + 354, SE005, 15 );
setSeVolumeByWorkId( spep_0 + 358, SE005, 17.5 );
setSeVolumeByWorkId( spep_0 + 362, SE005, 20 );
setSeVolumeByWorkId( spep_0 + 366, SE005, 22.5 );
setSeVolumeByWorkId( spep_0 + 370, SE005, 25 );
setSeVolumeByWorkId( spep_0 + 374, SE005, 27.5 );
setSeVolumeByWorkId( spep_0 + 378, SE005, 30 );
setSeVolumeByWorkId( spep_0 + 381, SE005, 31 );
setSeVolumeByWorkId( spep_0 + 384, SE005, 32 );

--平和的な音
SE006 = playSe( spep_0 + 378, 13 );
setSeVolumeByWorkId( spep_0 + 378, SE006, 48 );
setPitch( spep_0 + 378, SE006, 200 );
setTimeStretch( SE006, 1.13, 10, 1 );

--平和的な音
SE007 = playSe( spep_0 + 378, 1139 );
setSeVolumeByWorkId( spep_0 + 378, SE007, 52 );
stopSe( spep_0 + 404, SE007, 16 );

--平和的な音
SE008 = playSe( spep_0 + 406, 1139 );
setSeVolumeByWorkId( spep_0 + 406, SE008, 38 );
stopSe( spep_0 + 426, SE008, 24 );

--カメラ遷移
SE009 = playSe( spep_0 + 550, 1072 );
setSeVolumeByWorkId( spep_0 + 550, SE009, 70 );

--カメラ遷移２
SE010 = playSe( spep_0 + 644, 1003 );
setSeVolumeByWorkId( spep_0 + 644, SE010, 52 );
setPitch( spep_0 + 644, SE010, 200 );
