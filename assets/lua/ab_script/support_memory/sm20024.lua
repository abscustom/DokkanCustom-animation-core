...
-- ** 音 ** --
--環境音
SE001 = playSeVer2( spep_0 + 229, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 229, SE001, 25 );
--セリフカットイン
SE002 = playSeVer2( spep_0 + 264, 1018, "", 0, 0, 0, -1);
--握手
SE003 = playSeVer2( spep_0 + 395, 1013, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 395, SE003, 63 );
--セリフカットイン
SE004 = playSeVer2( spep_0 + 430, 1048, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 498, 44, "", 0, 0, 0, -1);
--あたまなでる
SE006 = playSeVer2( spep_0 + 524, 1331, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 524, SE006, 71 );
--笑顔になる
SE007 = playSeVer2( spep_0 + 729, 1112, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 729, SE007, 68 );
SE008 = playSeVer2( spep_0 + 729, 1115, "",spep_0 + 891, 0, 93, -1);
setSeVolumeByWorkId( spep_0 + 729, SE008, 72 );
--セリフカットイン
SE009 = playSeVer2( spep_0 + 921, 4, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_0 + 921, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 921, SE010, 68 );
