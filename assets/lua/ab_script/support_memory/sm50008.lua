...
--演出によって書き換えてください
--マグマ
SE001 = playSeVer2( spep_0 + 244, 1229, "",spep_0 + 418, 0, 94, -1);
setSeVolumeByWorkId( spep_0 + 244, SE001, 79 );
SE002 = playSeVer2( spep_0 + 244, 1166, "",spep_0 + 418, 0, 94, -1);
setSeVolumeByWorkId( spep_0 + 244, SE002, 63 );
SE003 = playSeVer2( spep_0 + 244, 1268, "",spep_0 + 418, 0, 94, -1);

--飛び上がる
SE004 = playSeVer2( spep_0 + 258, 1117, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 290, 44, "", 0, 0, 0, -1);

--飛行中
SE006 = playSeVer2( spep_0 + 334, 1019, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 398, 1019, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 462, 1019, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 526, 1019, "",spep_0 + 590, 0, 44, -1);

--環境音
SE010 = playSeVer2( spep_0 + 526, 1269, "", 0, 46, 0, -1);
setSeVolumeByWorkId( spep_0 + 526, SE010, 20 );

--マント翻る
SE011 = playSeVer2( spep_0 + 660, 1332, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 690, 1332, "", 0, 18, 0, -1);
setSeVolumeByWorkId( spep_0 + 690, SE012, 63 );

--セリフカットイン
SE013 = playSeVer2( spep_0 + 770, 1018, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 770, SE013, 79 );
SE014 = playSeVer2( spep_0 + 890, 1048, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 890, SE014, 73 );

--マント翻る
SE015 = playSeVer2( spep_0 + 938, 1332, "", 0, 0, 0, -1);
SE016 = playSeVer2( spep_0 + 960, 1333, "", 0, 0, 0, -1);

--腕上げる
SE017 = playSeVer2( spep_0 + 1058, 1189, "", 0, 0, 0, -1);
