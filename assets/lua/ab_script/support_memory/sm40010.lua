...
--セリフカットイン２
SE002 = playSeVer2( spep_0 + 390, 1048, "", 0, 0, 0, -1);

--超サイヤ人（？）に
SE003 = playSeVer2( spep_0 + 424, 1371, "",spep_0 + 724, 0, 100, -1);
setSeVolumeByWorkId( spep_0 + 424, SE003, 78 );
setPitch( spep_0 + 424, SE003, 500 );
setTimeStretch( SE003, 1.33, 30, 4 );
SE004 = playSeVer2( spep_0 + 424, 1379, "", 0, 0, 0, -1);
setPitch( spep_0 + 424, SE004, 400 );
setTimeStretch( SE004, 1.27, 30, 4 );
SE005 = playSeVer2( spep_0 + 424, 1181, "",spep_0 + 634, 0, 40, -1);
setSeVolumeByWorkId( spep_0 + 424, SE005, 168 );
SE006 = playSeVer2( spep_0 + 424, 1035, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 424, SE006, 62 );

--セリフカットイン３
SE007 = playSeVer2( spep_0 + 528, 1014, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 528, SE007, 74 );
SE008 = playSeVer2( spep_0 + 528, 1051, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 528, SE008, 65 );

--敵持ち上げる
SE009 = playSeVer2( spep_0 + 588, 1237, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 588, SE009, 84 );
SE010 = playSeVer2( spep_0 + 588, 1068, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 588, SE010, 70 );

--画面遷移
SE011 = playSeVer2( spep_0 + 702, 1232, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 702, SE011, 66 );

--ラスト決め
SE012 = playSeVer2( spep_0 + 784, 20, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 784, SE012, 68 );
SE013 = playSeVer2( spep_0 + 784, 1062, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 784, SE013, 74 );
