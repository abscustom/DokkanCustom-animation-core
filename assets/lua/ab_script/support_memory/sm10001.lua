...
--演出によって書き換えてください
--ウーロンダッシュ
SE001 = playSe( spep_0 + 222, 1108 );
setSeVolumeByWorkId( spep_0 + 222, SE001, 51 );

SE002 = playSe( spep_0 + 236, 1108 );
setSeVolumeByWorkId( spep_0 + 236, SE002, 52 );

SE003 = playSe( spep_0 + 252, 1108 );
setSeVolumeByWorkId( spep_0 + 252, SE003, 65 );

SE004 = playSe( spep_0 + 252, 1108 );
setSeVolumeByWorkId( spep_0 + 252, SE004, 65 );

SE005 = playSe( spep_0 + 270, 1108 );
setSeVolumeByWorkId( spep_0 + 270, SE005, 65 );

SE006 = playSe( spep_0 + 284, 1108 );
SE007 = playSe( spep_0 + 298, 1108 );

--踏みつけ
SE008 = playSe( spep_0 + 320, 1246 );
setSeVolumeByWorkId( spep_0 + 320, SE008, 70 );
setTimeStretch( SE008, 0.83, 10, 1 );

SE009 = playSe( spep_0 + 320, 1112 );
setSeVolumeByWorkId( spep_0 + 320, SE009, 79 );
stopSe( spep_0 + 330, SE009, 10 );
setPitch( spep_0 + 320, SE009, -500 );
setTimeStretch( SE009, 0.67, 10, 1 );

--ジャンプ
SE010 = playSe( spep_0 + 332, 1117 );
stopSe( spep_0 + 350, SE010, 36 );

--セリフカットイン
SE011 = playSe( spep_0 + 374, 1018 );
setSeVolumeByWorkId( spep_0 + 374, SE011, 79 );
