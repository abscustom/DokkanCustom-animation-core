...
--入り
SE001 = playSeVer2( spep_0 + 262, 1116, "",spep_0 + 310, 0, 24, -1);
setSeVolumeByWorkId( spep_0 + 262, SE001, 72 );

--セリフカットイン	
SE002 = playSeVer2( spep_0 + 374, 1048, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 374, SE002, 79 );
SE006 = playSeVer2( spep_0 + 558, 1048, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 814, 1048, "", 0, 0, 0, -1);
SE020 = playSeVer2( spep_0 + 1214, 1018, "", 0, 0, 0, -1);

--アップ
SE003 = playSeVer2( spep_0 + 480, 1038, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 480, 1342, "",spep_0 + 560, 0, 34, -1);
setSeVolumeByWorkId( spep_0 + 480, SE004, 93 );
SE005 = playSeVer2( spep_0 + 494, 1294, "", 0, 0, 0, -1);

--ズームアウト
SE007 = playSeVer2( spep_0 + 788, 1232, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 788, SE007, 84 );

--腕を後ろに向ける	
SE009 = playSeVer2( spep_0 + 936, 1003, "", 0, 0, 0, -1);

--気弾撃つ
SE010 = playSeVer2( spep_0 + 986, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 986, SE010, 74 );
SE011 = playSeVer2( spep_0 + 986, 1145, "",spep_0 + 1094, 0, 84, -1);
setSeVolumeByWorkId( spep_0 + 986, SE011, 79 );
SE012 = playSeVer2( spep_0 + 986, 1028, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 990, 1109, "", 0, 0, 0, -1);
SE014 = playSeVer2( spep_0 + 996, 1017, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 996, SE014, 86 );

--気弾壁貫く
SE015 = playSeVer2( spep_0 + 1058, 1133, "", 0, 0, 0, -1);
SE016 = playSeVer2( spep_0 + 1058, 1177, "", 0, 0, 0, -1);
SE017 = playSeVer2( spep_0 + 1058, 1146, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 1058, SE017, 68 );

--画面遷移
SE018 = playSeVer2( spep_0 + 1128 - 2, 8, "", 0, 0, 0, -1);

--気弾跡
SE019 = playSeVer2( spep_0 + 1142 - 2, 1168, "", 0, 0, 0, -1);
