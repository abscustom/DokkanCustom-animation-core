...
--環境音
SE001 = playSeVer2( spep_0 + 228, 1226, "", 0, 34, 0, -1);
setSeVolumeByWorkId( spep_0 + 228, SE001, 20 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 244, 1048, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 244, SE002, 72 );

--クウラ移動音
SE005 = playSeVer2( spep_0 + 416, 1242, "",spep_0 + 540, 14, 40, -1);
setSeVolumeByWorkId( spep_0 + 416, SE005, 30 );
setStartTimeMs( SE005,  617 );

SE003 = playSeVer2( spep_0 + 330, 1242, "", 0, 12, 0, -1);
setSeVolumeByWorkId( spep_0 + 330, SE003, 29 );
setStartTimeMs( SE003,  650 );

SE004 = playSeVer2( spep_0 + 334, 1240, "",spep_0 + 534, 0, 38, -1);
setPitch( spep_0 + 334, SE004, -1000 );
setTimeStretch( SE004, 0.33, 10, 1 );

--セリフカットイン
SE006 = playSeVer2( spep_0 + 396, 1018, "", 0, 0, 0, -1);

--クウラ移動音
SE007 = playSeVer2( spep_0 + 526, 1242, "", 0, 14, 0, -1);
setSeVolumeByWorkId( spep_0 + 526, SE007, 25 );
setStartTimeMs( SE007,  633 );
SE008 = playSeVer2( spep_0 + 528, 1240, "", 0, 0, 0, -1);
setPitch( spep_0 + 528, SE008, -1000 );
setTimeStretch( SE008, 0.33, 30, 4 );
SE009 = playSeVer2( spep_0 + 624, 1242, "", 0, 12, 0, -1);
setSeVolumeByWorkId( spep_0 + 624, SE009, 26 );
setStartTimeMs( SE009,  650 );
SE010 = playSeVer2( spep_0 + 722, 1242, "",spep_0 + 840, 12, 44, -1);
setSeVolumeByWorkId( spep_0 + 722, SE010, 27 );
setStartTimeMs( SE010,  650 );

--環境音
SE011 = playSeVer2( spep_0 + 768, 1226, "", 0, 34, 0, -1);
setSeVolumeByWorkId( spep_0 + 768, SE011, 20 );

--クウラ移動音
SE012 = playSeVer2( spep_0 + 810, 1242, "",spep_0 + 940, 14, 42, -1);
setSeVolumeByWorkId( spep_0 + 810, SE012, 27 );
setStartTimeMs( SE012,  633 );
SE013 = playSeVer2( spep_0 + 800, 1240, "",spep_0 + 1016, 0, 34, -1);
setPitch( spep_0 + 800, SE013, -1000 );
setTimeStretch( SE013, 0.33, 30, 4 );
SE014 = playSeVer2( spep_0 + 900, 1242, "",spep_0 + 970, 12, 42, -1);
setSeVolumeByWorkId( spep_0 + 900, SE014, 27 );
setStartTimeMs( SE014,  633 );

--クウラ回転
SE015 = playSeVer2( spep_0 + 962, 1128, "",spep_0 + 1044, 24, 28, -1);
setSeVolumeByWorkId( spep_0 + 962, SE015, 68 );
setStartTimeMs( SE015,  1183 );
setPitch( spep_0 + 962, SE015, -1200 );
setTimeStretch( SE015, 0.2, 10, 1 );
SE016 = playSeVer2( spep_0 + 956, 1191, "",spep_0 + 1010, 18, 18, -1);
setSeVolumeByWorkId( spep_0 + 956, SE016, 63 );
setStartTimeMs( SE016,  167 );
setPitch( spep_0 + 956, SE016, -700 );
setTimeStretch( SE016, 0.53, 10, 1 );

--最後キメ
SE017 = playSeVer2( spep_0 + 1068, 20, "", 0, 0, 0, -1);
