...
--環境音
SE001 = playSeVer2( spep_0 + 202, 1269, "", 0, 56, 0, -1);
setSeVolumeByWorkId( spep_0 + 202, SE001, 63 );

--悟空歩く１
SE002 = playSeVer2( spep_0 + 246, 1107, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 246, SE002, 184 );

--悟空歩く１
SE003 = playSeVer2( spep_0 + 246, 1106, "", 0, 0, 0, -1);

--悟空歩く２
SE004 = playSeVer2( spep_0 + 296, 1107, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 296, SE004, 180 );

--悟空歩く２
SE005 = playSeVer2( spep_0 + 296, 1106, "", 0, 0, 0, -1);

--チライセリフカットイン
SE006 = playSeVer2( spep_0 + 364, 44, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 364, SE006, 90 );

--チライ乗り出す
SE007 = playSeVer2( spep_0 + 440, 1003, "", 0, 0, 0, -1);

--チライ乗り出す
SE008 = playSeVer2( spep_0 + 440, 1013, "", 0, 0, 0, -1);

--悟空振り返る
SE009 = playSeVer2( spep_0 + 516, 1004, "", 0, 0, 0, -1);

--構える
SE010 = playSeVer2( spep_0 + 618, 1233, "", 0, 0, 0, -1);

--構える
SE011 = playSeVer2( spep_0 + 630, 1006, "",spep_0 + 646, 0, 8, -1);
setSeVolumeByWorkId( spep_0 + 630, SE011, 56 );

--悟空セリフカットイン
SE012 = playSeVer2( spep_0 + 654, 1026, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 654, SE012, 71 );

--悟空セリフカットイン
SE013 = playSeVer2( spep_0 + 658, 1018, "", 0, 0, 0, -1);
