...
--格闘音
SE001 = playSeVer2( spep_0 + 220, 1425, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 220, SE001, 76 );
SE002 = playSeVer2( spep_0 + 306, 1425, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 306, SE002, 73 );

--歓声
SE003 = playSeVer2( spep_0 + 418, 39, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 418, SE003, 65 );

--セリフカットイン
SE004 = playSeVer2( spep_0 + 418, 1018, "", 0, 0, 0, -1);

--歓声
SE005 = playSeVer2( spep_0 + 494, 39, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 494, SE005, 67 );

--セリフカットイン
SE006 = playSeVer2( spep_0 + 596, 1048, "", 0, 0, 0, -1);

--歓声
SE007 = playSeVer2( spep_0 + 508, 39, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 508, SE007, 59 );

--立つ
SE008 = playSeVer2( spep_0 + 674, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 674, SE008, 68 );

--歓声
SE009 = playSeVer2( spep_0 + 710, 39, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 710, SE009, 38 );

--走ってくる
SE010 = playSeVer2( spep_0 + 758, 1106, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 758, SE010, 200 );
SE011 = playSeVer2( spep_0 + 766, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 766, SE011, 195 );

--歓声
SE012 = playSeVer2( spep_0 + 818, 39, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 818, SE012, 21 );
SE013 = playSeVer2( spep_0 + 926, 39, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 926, SE013, 25 );

--セリフカットイン
SE014 = playSeVer2( spep_0 + 970, 44, "", 0, 0, 0, -1);

--歓声
SE020 = playSeVer2( spep_0 + 600, 39, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 600, SE007, 52 );
