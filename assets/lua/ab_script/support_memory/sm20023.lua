...
--環境音
SE001 = playSeVer2( spep_0 + 184, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 184, SE001, 25 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 290, 1018, "", 0, 0, 0, -1);

--カメラパン
SE003 = playSeVer2( spep_0 + 380, 44, "", 0, 0, 0, -1);
setTimeStretch( SE003, 1.23, 30, 4 );

--セリフカットイン
SE004 = playSeVer2( spep_0 + 510, 1433, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 602, 1048, "", 0, 0, 0, -1);
