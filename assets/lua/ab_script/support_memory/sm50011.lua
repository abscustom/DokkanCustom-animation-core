...
-- ** 音 ** --
--環境音
SE001 = playSeVer2( spep_0 + 188, 1269, "", 0, 72, 0, -1);
setSeVolumeByWorkId( spep_0 + 188, SE001, 68 );

--ビルスオーラ
SE002 = playSeVer2( spep_0 + 208, 1175, "",spep_0 + 410, 0, 52, -1);
setSeVolumeByWorkId( spep_0 + 208, SE002, 78 );
SE003 = playSeVer2( spep_0 + 208, 1228, "",spep_0 + 404, 56, 48, -1);
setPitch( spep_0 + 208, SE003, -540 );
setTimeStretch( SE003, 0.72, 30, 4 );

--セリフカットイン１
SE004 = playSeVer2( spep_0 + 388, 1048, "", 0, 0, 0, -1);

--セリフカットイン２
SE005 = playSeVer2( spep_0 + 456, 44, "", 0, 0, 0, -1);

--セリフカットイン３
SE006 = playSeVer2( spep_0 + 734, 1003, "", 0, 0, 0, -1);

--セリフカットイン４
SE007 = playSeVer2( spep_0 + 832, 1048, "", 0, 0, 0, -1);
setPitch( spep_0 + 832, SE007, -400 );
setTimeStretch( SE007, 0.73, 30, 4 );
SE008 = playSeVer2( spep_0 + 832, 1331, "",spep_0 + 904, 0, 34, -1);

--セリフカットイン５
SE009 = playSeVer2( spep_0 + 1052, 1018, "", 0, 0, 0, -1);
