...
--演出によって書き換えてください
--飛行音
SE001 = playSe( spep_0 + 200, 1227 );
setSeVolumeByWorkId( spep_0 + 200, SE001, 71 );
stopSe( spep_0 + 588, SE001, 104 );

--飛行音
SE002 = playSe( spep_0 + 224, 1175 );
setSeVolumeByWorkId( spep_0 + 224, SE002, 25 );

--セリフカットイン
SE003 = playSe( spep_0 + 244, 44 );

--飛行音
SE004 = playSe( spep_0 + 590, 1227 );
setStartTimeMs( SE004,  4200 );

--飛行音
SE005 = playSe( spep_0 + 576, 1278 );
setSeVolumeByWorkId( spep_0 + 576, SE005, 41 );

--セリフカットイン２
SE006 = playSe( spep_0 + 578, 1048 );
setSeVolumeByWorkId( spep_0 + 578, SE006, 84 );

--セリフカットイン３
SE007 = playSe( spep_0 + 740, 1018 );
