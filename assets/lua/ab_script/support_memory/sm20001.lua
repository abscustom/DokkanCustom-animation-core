...
--拳握る
SE001 = playSe( spep_0 + 242, 1233 );
setSeVolumeByWorkId( spep_0 + 242, SE001, 43 );
setPitch( spep_0 + 242, SE001, -400 );
setTimeStretch( SE001, 0.73, 10, 1 );

--画面遷移
SE002 = playSe( spep_0 + 316, 8 );
setSeVolumeByWorkId( spep_0 + 316, SE002, 60 );

--セリフカットイン
SE003 = playSe( spep_0 + 440, 1018 );

--ラスト決め
SE004 = playSe( spep_0 + 514, 1072 );
setSeVolumeByWorkId( spep_0 + 514, SE004, 79 );

--ラスト決め
SE005 = playSe( spep_0 + 552, 1237 );
setSeVolumeByWorkId( spep_0 + 552, SE005, 81 );

--ラスト決め
SE006 = playSe( spep_0 + 552, 1068 );
setSeVolumeByWorkId( spep_0 + 552, SE006, 72 );
