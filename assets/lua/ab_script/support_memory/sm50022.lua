...
-- ** 音 ** --
--環境音
SE001 = playSeVer2( spep_0 + 210, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 210, SE001, 25 );
SE002 = playSeVer2( spep_0 + 218, 1175, "",spep_0 + 496, 0, 150, -1);
setSeVolumeByWorkId( spep_0 + 218, SE002, 33 );

--握りつぶす
SE004 = playSeVer2( spep_0 + 539, 1469, "",spep_0 + 578, 0, 16, -1);
SE005 = playSeVer2( spep_0 + 542, 1389, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 542, SE005, 75 );
SE003 = playSeVer2( spep_0 + 544, 1439, "",spep_0 + 601, 7, 23, -1);
setSeVolumeByWorkId( spep_0 + 544, SE003, 134 );
setStartTimeMs( SE003,  517 );

--セリフカットイン
SE006 = playSeVer2( spep_0 + 648, 1018, "", 0, 0, 0, -1);
