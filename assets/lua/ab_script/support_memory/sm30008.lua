...
--ボール光る
SE001 = playSeVer2( spep_0 + 268, 1239, "", 0, 10, 0, -1); 
setSeVolumeByWorkId( spep_0 + 268, SE001, 85 );
setStartTimeMs( SE001,  3283 );
E002 = playSeVer2( spep_0 + 268, 1374, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 268, SE002, 71 );

--煙たちあがる
SE003 = playSeVer2( spep_0 + 334, 1214, "", spep_0 + 556, 0, 50, -1);
setSeVolumeByWorkId( spep_0 + 334, SE003, 129 );

--煙中
SE004 = playSeVer2( spep_0 + 586, 1227, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 586, SE004, 53 );
setPitch( spep_0 + 586, SE004, -600 ); 
setTimeStretch( SE004, 0.6, 10, 1 );
SE005 = playSeVer2( spep_0 + 586, 44, "", 0, 0, 0, -1);
setPitch( spep_0 + 586, SE005, -600 );
setTimeStretch( SE005, 0.6, 10, 1 );
SE006 = playSeVer2( spep_0 + 586, 1398, "",spep_0 + 1190, 0, 66, -1);
setSeVolumeByWorkId( spep_0 + 586, SE006, 67 );
setPitch( spep_0 + 586, SE006, -600 );
setTimeStretch( SE006, 0.6, 10, 1 );

--セリフカットイン
SE007 = playSeVer2( spep_0 + 684, 1018, "", 0, 0, 0, -1);

--セリフカットイン
SE008 = playSeVer2( spep_0 + 760, 1048, "", 0, 0, 0, -1);

--集中線
SE009 = playSeVer2( spep_0 + 976, 20, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_0 + 976, 1137, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 976, SE010, 71 );
