...
--パンちゃん飛び出す
SE001 = playSeVer2( spep_0 + 242, 1432, "", 0, 0, 0, -1);
SE002 = playSeVer2( spep_0 + 260, 1048, "", 0, 0, 0, -1);

--悟空とトランクス驚く
SE003 = playSeVer2( spep_0 + 342, 13, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 342, SE003, 68 );
setPitch( spep_0 + 342, SE003, 100 );
setTimeStretch( SE003, 1.07, 30, 4 );
SE004 = playSeVer2( spep_0 + 350, 48, "", 0, 0, 0, -1);

--セリフカットイン
SE005 = playSeVer2( spep_0 + 456, 1018, "", 0, 0, 0, -1);

--セリフカットイン
SE006 = playSeVer2( spep_0 + 598, 44, "", 0, 0, 0, -1);

--パン手をあげる
SE007 = playSeVer2( spep_0 + 620, 1003, "", 0, 0, 0, -1);

--ボタン押す
SE008 = playSeVer2( spep_0 + 734, 6, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 734, 22, "",spep_0 + 768, 0, 20, -1);

--飛び立つ
SE010 = playSeVer2( spep_0 + 818, 1158, "",spep_0 + 1012, 0, 10, -1);
SE011 = playSeVer2( spep_0 + 822, 1024, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 822, SE011, 83 );
SE012 = playSeVer2( spep_0 + 822, 1314, "",spep_0 + 1006, 0, 6, -1);
setSeVolumeByWorkId( spep_0 + 822, SE012, 80 );
SE013 = playSeVer2( spep_0 + 822, 1226, "",spep_0 + 1008, 0, 6, -1);
setSeVolumeByWorkId( spep_0 + 822, SE013, 71 );

--室内
SE014 = playSeVer2( spep_0 + 998, 1314, "", 0, 0, 0, -1);
setBandpassFilter( spep_0 + 998, SE014, 24, 400 );
SE015 = playSeVer2( spep_0 + 998, 1226, "", 0, 0, 0, -1);
setBandpassFilter( spep_0 + 998, SE015, 24, 400 );
SE016 = playSeVer2( spep_0 + 998, 1042, "", 0, 0, 0, -1);
