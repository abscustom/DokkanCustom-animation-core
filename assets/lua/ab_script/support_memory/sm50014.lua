...
--セリフカットイン
SE001 = playSeVer2( spep_0 + 272, 1018, "", 0, 0, 0, -1);

--両手ぐー作る
SE002 = playSeVer2( spep_0 + 320, 1003, "", 0, 0, 0, -1);


--拳にぎる
SE003 = playSeVer2( spep_0 + 382, 1189, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 396, 1007, "", 0, 0, 0, -1);



--歩み寄る
SE005 = playSeVer2( spep_0 + 502, 1106, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 502, SE005, 146 );
SE006 = playSeVer2( spep_0 + 502, 1048, "", 0, 0, 0, -1);

--悟空寄る
SE007 = playSeVer2( spep_0 + 552, 44, "",spep_0 + 604, 0, 24, -1);

--チチあきれる
SE008 = playSeVer2( spep_0 + 708, 1280, "", 0, 0, 0, -1);
