...
-- ** 音 ** --
--剣持つ
SE001 = playSeVer2( spep_0 + 264, 1150, "", 0, 4, 0, -1);
setSeVolumeByWorkId( spep_0 + 264, SE001, 81 );
setStartTimeMs( SE001,  533 );
setBandpassFilter( spep_0 + 264, SE001, 530, 24000 );
SE002 = playSeVer2( spep_0 + 270, 1013, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 270, SE002, 58 );

--投げる
SE003 = playSeVer2( spep_0 + 298, 1003, "", 0, 0, 0, -1);

--剣キャッチ
SE004 = playSeVer2( spep_0 + 328, 1061, "",spep_0 + 350, 0, 8, -1);
setSeVolumeByWorkId( spep_0 + 328, SE004, 62 );
SE005 = playSeVer2( spep_0 + 332, 1006, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 332, SE005, 52 );

--セリフカットイン
SE006 = playSeVer2( spep_0 + 362, 1018, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 442, 1048, "", 0, 0, 0, -1);

--剣持あげる
SE008 = playSeVer2( spep_0 + 590, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 590, SE008, 146 );
SE009 = playSeVer2( spep_0 + 592, 1013, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 592, SE009, 73 );
