...
--環境音
SE001 = playSeVer2( spep_0 + 190, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 190, SE001, 25 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 268, 1018, "", 0, 0, 0, -1);

--浮き上がる
SE003 = playSeVer2( spep_0 + 452, 1295, "",spep_0 + 638, 0, 16, -1);
setSeVolumeByWorkId( spep_0 + 452, SE003, 52 );
setTimeStretch( SE003, 2, 30, 4 );
SE004 = playSeVer2( spep_0 + 452, 1356, "",spep_0 + 828, 0, 46, -1);
setPitch( spep_0 + 452, SE004, -1200 );
setTimeStretch( SE004, 0.2, 30, 4 );
SE005 = playSeVer2( spep_0 + 452, 44, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 452, SE005, 75 );

--1048_A54_短いダッシュ音のようなもの_16kHz.wav
SE006 = playSeVer2( spep_0 + 540, 1048, "", 0, 0, 0, -1);

--消える
SE007 = playSeVer2( spep_0 + 756, 1263, "",spep_0 + 858, 0, 52, -1);
SE008 = playSeVer2( spep_0 + 768, 1467, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 778, 1171, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 778, SE009, 52 );
