...
--演出によって書き換えてください
--環境音
SE001 = playSe( spep_0 + 198, 1269 );
setSeVolumeByWorkId( spep_0 + 198, SE001, 25 );

--セリフカットイン
SE002 = playSe( spep_0 + 236, 1018 );
setSeVolumeByWorkId( spep_0 + 236, SE002, 85 );

--画面切り替え
SE003 = playSe( spep_0 + 372, 1072 );
setSeVolumeByWorkId( spep_0 + 372, SE003, 20 );
setSeVolumeByWorkId( spep_0 + 375, SE003, 40 );
setSeVolumeByWorkId( spep_0 + 378, SE003, 60 );
setSeVolumeByWorkId( spep_0 + 381, SE003, 80 );
setSeVolumeByWorkId( spep_0 + 384, SE003, 100 );
setStartTimeMs( SE003,  283 );

--最後決め
SE004 = playSe( spep_0 + 560, 20 );

--最後決め
SE005 = playSe( spep_0 + 560, 1188 );
setSeVolumeByWorkId( spep_0 + 560, SE005, 92 );
