...
--演出によって書き換えてください
--環境音
SE001 = playSeVer2( spep_0 + 214, 1269, "", 0, 44, 0, -1);
setSeVolumeByWorkId( spep_0 + 214, SE001, 35 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 236, 1018, "", 0, 0, 0, -1);

--ベジータそっぽむく
SE003 = playSeVer2( spep_0 + 446, 4, "", 0, 0, 0, -1);

--ベジータそっぽむく
SE004 = playSeVer2( spep_0 + 446, 1013, "", 0, 0, 0, -1);

--ブルマセリフカットイン
SE005 = playSeVer2( spep_0 + 488, 44, "", 0, 0, 0, -1);

--ブルマセリフカットイン
SE006 = playSeVer2( spep_0 + 488, 1115, "",spep_0 + 648, 0, 64, -1);
setPitch( spep_0 + 488, SE006, 400 );
setTimeStretch( SE006, 1.27, 10, 1 );

--ブルマセリフカットイン
SE007 = playSeVer2( spep_0 + 488, 46, "", 0, 0, 0, -1);

--ベジータセリフカットイン
SE008 = playSeVer2( spep_0 + 660, 20, "", 0, 0, 0, -1);

--ベジータセリフカットイン
SE009 = playSeVer2( spep_0 + 660, 45, "", 0, 0, 0, -1);
