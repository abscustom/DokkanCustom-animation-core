...
-- ** 音 ** --
--写真舞い降りる
SE001 = playSeVer2( spep_0 + 204, 1119, "", 0, 4, 0, -1);
setStartTimeMs( SE001,  767 );
SE002 = playSeVer2( spep_0 + 226, 1331, "", 0, 0, 0, -1);

--写真つかむ
SE003 = playSeVer2( spep_0 + 310, 1189, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 310, 1111, "",spep_0 + 308, 0, 8, -1);

--環境音
SE005 = playSeVer2( spep_0 + 326, 1175, "",spep_0 + 628, 0, 152, -1);
setSeVolumeByWorkId( spep_0 + 326, SE005, 46 );

--目開く
SE006 = playSeVer2( spep_0 + 404, 8, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 404, SE006, 78 );

--ビーデル飛んでくる
SE007 = playSeVer2( spep_0 + 484, 63, "",spep_0 + 558, 0, 26, -1);

--セリフカットイン
SE008 = playSeVer2( spep_0 + 602, 1018, "", 0, 0, 0, -1);

--リュック抱きしめる
SE009 = playSeVer2( spep_0 + 676, 1263, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_0 + 692, 1331, "", 0, 0, 0, -1);

--写真キラキラ音
SE011 = playSeVer2( spep_0 + 774, 1288, "", 0, 94, 0, -1);
SE012 = playSeVer2( spep_0 + 824, 44, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 824, SE012, 75 );
setTimeStretch( SE012, 1.35, 30, 4 );
