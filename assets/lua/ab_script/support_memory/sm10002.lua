...
--環境音
SE001 = playSeVer2( spep_0 + 222, 1349, "", 0, 54, 0, -1);
setSeVolumeByWorkId( spep_0 + 202, SE001, 32 );

--セリフカットイン
SE002 = playSeVer2( spep_0 + 270, 1048, "", 0, 0, 0, -1);

SE003 = playSeVer2( spep_0 + 270, 1189, "", 0, 0, 0, -1);

SE004 = playSeVer2( spep_0 + 270, 1237, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 250, SE004, 59 );

--チチセリフカットイン
SE005 = playSeVer2( spep_0 + 378, 44, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 358, SE005, 72 );

--悟空セリフカットイン
SE006 = playSeVer2( spep_0 + 482, 1189, "", 0, 0, 0, -1);

--腕下ろす
SE007 = playSeVer2( spep_0 + 648, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 628, SE007, 66 );

--向き合う
SE008 = playSeVer2( spep_0 + 780, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 760, SE008, 164 );

SE009 = playSeVer2( spep_0 + 782, 1107, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 762, SE009, 168 );

--セリフカットイン
SE010 = playSeVer2( spep_0 + 824, 1018, "", 0, 0, 0, -1);

--最後チチセリフ
SE011 = playSeVer2( spep_0 + 962, 1042, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 962, 1115, "",spep_0 + 1060, 0, 34, -1);
