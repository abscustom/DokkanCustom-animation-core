...
--セリフカットイン
SE001 = playSeVer2( spep_0 + 270, 1018, "", 0, 0, 0, -1);
SE002 = playSeVer2( spep_0 + 424, 1048, "", 0, 0, 0, -1);

--環境音
SE003 = playSeVer2( spep_0 + 426, 1175, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 426, SE003, 35 );

--頭光る
SE004 = playSeVer2( spep_0 + 660, 36, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 660, SE004, 60 );
SE005 = playSeVer2( spep_0 + 660, 46, "",spep_0 + 756, 0, 64, -1);
SE006 = playSeVer2( spep_0 + 660, 1115, "",spep_0 + 790, 0, 80, -1);

--満月に
SE007 = playSeVer2( spep_0 + 748, 57, "",spep_0 + 890, 0, 88, -1);
SE008 = playSeVer2( spep_0 + 748, 1398, "",spep_0 + 1010, 0, 50, -1);

--敵ハイライト
SE009 = playSeVer2( spep_0 + 822, 1264, "",spep_0 + 990, 0, 106, -1);
setSeVolumeByWorkId( spep_0 + 822, SE009, 66 );

--変身とける
SE010 = playSeVer2( spep_0 + 986, 1017, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 986, SE010, 71 );
SE011 = playSeVer2( spep_0 + 986, 31, "", 0, 0, 0, -1);

--まばたき
SE012 = playSeVer2( spep_0 + 1044, 1113, "", 0, 0, 0, -1);
