...
entryEffect( spep_0 + 188, SP_02, 0x100, -1, 0, 0, 0, 3000 );  --サポートメモリー映像
...
--演出によって書き換えてください
--命名
SE001 = playSeVer2( spep_0 + 268, 1003, "", 0, 0, 0, -1);
SE002 = playSeVer2( spep_0 + 268, 1018, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 268, SE002, 77 );

--ベジータ集中線
SE003 = playSeVer2( spep_0 + 354, 20, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 354, 48, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 354, SE004, 68 );

--セリフカットイン
SE005 = playSeVer2( spep_0 + 440, 44, "", 0, 0, 0, -1);

--画面遷移
SE006 = playSeVer2( spep_0 + 554, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 554, SE006, 115 );

--ブラ笑顔になる
SE007 = playSeVer2( spep_0 + 610, 1115, "",spep_0 + 754, 0, 70, -1);
setPitch( spep_0 + 610, SE007, 400 );
setTimeStretch( SE007, 1.27, 10, 1 );
SE008 = playSeVer2( spep_0 + 610, 34, "", 0, 0, 0, -1);

--セリフカットイン
SE009 = playSeVer2( spep_0 + 672, 1048, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 672, SE009, 79 );

--まんざらでもない
SE010 = playSeVer2( spep_0 + 768, 1072, "", 0, 12, 0, -1);
setSeVolumeByWorkId( spep_0 + 768, SE010, 76 );
setStartTimeMs( SE010,  317 );

--ブラ笑顔
SE011 = playSeVer2( spep_0 + 894, 1221, "",spep_0 + 960, 0, 20, -1);
SE012 = playSeVer2( spep_0 + 894, 1042, "", 0, 0, 0, -1);
