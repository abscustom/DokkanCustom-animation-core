...
--ボージャック抱きしめる
SE001 = playSeVer2( spep_0 + 276, 1012, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 276, SE001, 85 );
SE002 = playSeVer2( spep_0 + 276, 1330, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 276, SE002, 126 );
setPitch( spep_0 + 276, SE002, -600 );
setTimeStretch( SE002, 0.6, 10, 1 );
SE003 = playSeVer2( spep_0 + 276, 1009, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 280, 1007, "", 0, 0, 0, -1);

--悟飯苦しむ
SE005 = playSeVer2( spep_0 + 392, 1233, "", 0, 0, 0, -1);
SE006 = playSeVer2( spep_0 + 396, 1330, "", 0, 0, 0, -1);
setPitch( spep_0 + 396, SE006, 500 );
setTimeStretch( SE006, 1.33, 10, 1 );
SE007 = playSeVer2( spep_0 + 402, 1006, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 402, 1003, "", 0, 0, 0, -1);

--セリフカットイン
SE009 = playSeVer2( spep_0 + 474, 1018, "", 0, 0, 0, -1);

--悟飯苦しむ
SE010 = playSeVer2( spep_0 + 482, 1330, "", 0, 34, 0, -1);
setSeVolumeByWorkId( spep_0 + 482, SE010, 68 );

--悟飯気絶する
SE011 = playSeVer2( spep_0 + 606, 4, "", 0, 0, 0, -1);

--悟空耐えかねる
SE012 = playSeVer2( spep_0 + 632, 1332, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 632, 1300, "", 0, 0, 0, -1);
SE014 = playSeVer2( spep_0 + 652, 1116, "",spep_0 + 694, 0, 24, -1);
SE015 = playSeVer2( spep_0 + 676, 20, "", 0, 0, 0, -1);

--光刺す
SE016 = playSeVer2( spep_0 + 830, 1266, "",spep_0 + 950, 26, 52, -1);
setStartTimeMs( SE016,  433 );

--瞬間移動
SE017 = playSeVer2( spep_0 + 814, 1109, "", 0, 0, 0, -1);

--光刺す
SE018 = playSeVer2( spep_0 + 842, 44, "", 0, 12, 0, -1);
setSeVolumeByWorkId( spep_0 + 842, SE018, 120 );
setPitch( spep_0 + 842, SE018, -600 );
setTimeStretch( SE018, 0.6, 30, 4 );
SE019 = playSeVer2( spep_0 + 842, 1354, "", 0, 24, 0, -1);
setSeVolumeByWorkId( spep_0 + 842, SE019, 53 );
SE020 = playSeVer2( spep_0 + 854, 1305, "",spep_0 + 962, 0, 50, -1);
setSeVolumeByWorkId( spep_0 + 854, SE020, 180 );
setPitch( spep_0 + 854, SE020, 900 );
setTimeStretch( SE020, 1.6, 30, 4 );
SE021 = playSeVer2( spep_0 + 890, 1042, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 890, SE021, 140 );
setPitch( spep_0 + 890, SE021, 400 );
setTimeStretch( SE021, 1.27, 30, 4 );

--死角から殴る
SE022 = playSeVer2( spep_0 + 966, 1009, "", 0, 0, 0, -1);
SE023 = playSeVer2( spep_0 + 966, 1190, "", 0, 0, 0, -1);
SE024 = playSeVer2( spep_0 + 966, 1137, "", 0, 26, 0, -1);
SE025 = playSeVer2( spep_0 + 968, 1187, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 968, SE025, 75 );
SE026 = playSeVer2( spep_0 + 976, 1035, "",spep_0 + 1062, 0, 44, -1);
setSeVolumeByWorkId( spep_0 + 976, SE026, 76 );
setPitch( spep_0 + 976, SE026, -500 );
setTimeStretch( SE026, 0.67, 10, 1 );
