...
--カメラパン
SE001 = playSeVer2( spep_0 + 280, 44, "", 0, 0, 0, -1);
SE002 = playSeVer2( spep_0 + 280, 1175, "",spep_0 + 640, 0, 110, -1);
setSeVolumeByWorkId( spep_0 + 280, SE002, 40 );

--セリフカットイン
SE003 = playSeVer2( spep_0 + 286, 1018, "", 0, 0, 0, -1);

--画面遷移
SE004 = playSeVer2( spep_0 + 564, 1232, "", 0, 0, 0, -1);

--クラッカーならす
SE005 = playSeVer2( spep_0 + 608, 1028, "", 0, 0, 0, -1);
setTimeStretch( SE005, 1.16, 30, 4 );
setBandpassFilter	( spep_0 + 608, SE005, 1200, 24000 );
SE006 = playSeVer2( spep_0 + 608, 1030, "",spep_0 + 640, 0, 14, -1);
--クラッカーかかる
SE007 = playSeVer2( spep_0 + 658, 1029, "", 678, 0, 4, -1);
setBandpassFilter	( spep_0 + 658, SE007, 430, 24000 );
SE008 = playSeVer2( spep_0 + 658, 1013, "",spep_0 + 678, 0, 4, -1);
setBandpassFilter	( spep_0 + 658, SE008, 430, 24000 );
SE009 = playSeVer2( spep_0 + 672, 1029, "", 684, 0, 4, -1);
setBandpassFilter	( spep_0 + 672, SE009, 430, 24000 );
SE010 = playSeVer2( spep_0 + 672, 1013, "",spep_0 + 682, 0, 4, -1);
setBandpassFilter	( spep_0 + 672, SE010, 430, 24000 );
SE011 = playSeVer2( spep_0 + 676, 1029, "", 686, 0, 4, -1);
setBandpassFilter	( spep_0 + 676, SE011, 430, 24000 );
SE012 = playSeVer2( spep_0 + 678, 1029, "", 698, 0, 4, -1);
setBandpassFilter	( spep_0 + 678, SE012, 430, 24000 );
SE013 = playSeVer2( spep_0 + 678, 1013, "",spep_0 + 696, 0, 4, -1);
setSeVolumeByWorkId( spep_0 + 678, SE013, 71 );
setBandpassFilter	( spep_0 + 678, SE013, 430, 24000 );
SE015 = playSeVer2( spep_0 + 688, 1013, "",spep_0 + 708, 0, 4, -1);
setSeVolumeByWorkId( spep_0 + 688, SE015, 56 );
setBandpassFilter	( spep_0 + 688, SE015, 430, 24000 );
SE016 = playSeVer2( spep_0 + 692, 1029, "", 724, 0, 4, -1);
setSeVolumeByWorkId( spep_0 + 692, SE016, 76 );
setBandpassFilter	( spep_0 + 692, SE016, 430, 24000 );
SE017 = playSeVer2( spep_0 + 692, 1013, "",spep_0 + 724, 0, 4, -1);
setSeVolumeByWorkId( spep_0 + 692, SE017, 68 );
setBandpassFilter	( spep_0 + 692, SE017, 430, 24000 );
SE018 = playSeVer2( spep_0 + 696, 1029, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 696, SE018, 71 );
setBandpassFilter	( spep_0 + 696, SE018, 430, 24000 );

--ベロ出す
SE019 = playSeVer2( spep_0 + 768, 1199, "",spep_0 + 830, 0, 16, -1);
setPitch( spep_0 + 768, SE019, 200 );
setTimeStretch( SE019, 1.13, 30, 4 );
SE020 = playSeVer2( spep_0 + 768, 1112, "", 0, 0, 0, -1);

--消える
SE021 = playSeVer2( spep_0 + 818, 1014, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 818, SE021, 71 );
SE022 = playSeVer2( spep_0 + 820, 31, "", 0, 0, 0, -1);

--笑う
SE023 = playSeVer2( spep_0 + 900, 4, "", 0, 0, 0, -1);
SE024 = playSeVer2( spep_0 + 920, 4, "", 0, 0, 0, -1);
SE025 = playSeVer2( spep_0 + 942, 4, "", 0, 0, 0, -1);
SE026 = playSeVer2( spep_0 + 960, 4, "", 0, 0, 0, -1);
