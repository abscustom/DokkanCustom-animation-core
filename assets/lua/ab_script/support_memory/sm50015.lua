...
-- ** 音 ** --
--爆発
SE001 = playSeVer2( spep_0 + 206, 1068, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 206, SE001, 78 );
SE002 = playSeVer2( spep_0 + 206, 1305, "", 0, 0, 0, -1);
SE003 = playSeVer2( spep_0 + 216, 1188, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 216, SE003, 77 );
SE005 = playSeVer2( spep_0 + 250, 1069, "", 0, 4, 0, -1);
setSeVolumeByWorkId( spep_0 + 250, SE005, 63 );
setStartTimeMs( SE005,  200 );

--地響き
SE004 = playSeVer2( spep_0 + 216, 1226, "",spep_0 + 700, 0, 24, -1);

--光差し込む
SE006 = playSeVer2( spep_0 + 380, 1263, "", 0, 0, 0, -1);

--ブロリーとパラガス手をつなぐ
SE007 = playSeVer2( spep_0 + 486, 1168, "", 0, 42, 0, -1);
setSeVolumeByWorkId( spep_0 + 486, SE007, 71 );
SE008 = playSeVer2( spep_0 + 494, 8, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 512, 1018, "", 0, 0, 0, -1);

--ラスト爆発
SE010 = playSeVer2( spep_0 + 680, 1157, "",spep_0 + 746, 0, 24, -1);
SE011 = playSeVer2( spep_0 + 682, 1128, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 682, SE011, 67 );
setPitch( spep_0 + 682, SE011, -1200 );
setTimeStretch( SE011, 0.2, 30, 4 );
SE012 = playSeVer2( spep_0 + 682, 1069, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 702, 1156, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 702, SE013, 71 );
SE014 = playSeVer2( spep_0 + 706, 1067, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 706, SE014, 73 );

--二人流れてくる
SE015 = playSeVer2( spep_0 + 750, 1396, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 750, SE015, 58 );
SE016 = playSeVer2( spep_0 + 802, 1271, "", 0, 0, 0, -1);
