...
--リッチ化ヒットエフェクト
--rot : エフェクトの角度
--hit_kinds : ヒット火花の種類(0~4まで);
function hitEffect01(flame,rot,hit_kinds)
        flame = flame-1;
        hit = entryEffectLife( flame,  63+hit_kinds, 10, 0, 1,  0,  0, 0);--HIT
        setEffScaleKey(flame,hit,1.0,1.0);
        setEffScaleKey(flame + 10,hit,3.0,3.0);
        setEffAlphaKey(flame,hit,255);
        setEffAlphaKey(flame + 10,hit,0);
        shock = entryEffect( flame,  54,  0,  1,  0,  -10,  0);
        setEffAlphaKey(flame + 4,shock,255);
        setEffAlphaKey(flame + 10,shock,0);
        frash = entryEffectLife( flame, 52, 6, 0,  1,  0,  0, 0);
        setEffRotateKey(flame,frash,rot);
        setEffScaleKey(flame,frash,1.1,1.1);
end
...
shuchusen = entryEffectLife( ATK_01, 70, 79, 0x00,  -1, 0,  0,  0);   -- 集中線
...
kaisinn = entryEffect( ATK_02+29, 1110, 0x80,      -1,  0,  0,  0);   -- 会心の最後のエフェクト
        ...
        -----------------------
        entryEffectLife( ATK_01, 71, 85, 0x80,  -1,  0,  0,  0);--移動線
        ...
        shuchusen01 = entryEffect( ATK_01+21,  70,  0,  1,  0,  0,  0);
        setEffScaleKey(ATK_01+21,shuchusen01,1.1,1.1);

        shock01 = entryEffect( ATK_01+21,  54,  0,  1,  0,  -10,  0);
        setEffAlphaKey(ATK_01+21 + 4,shock01,255);
        setEffAlphaKey(ATK_01+21 + 10,shock01,0);        
        ...
        shuchusen02 = entryEffect( ATK_02+30,  70,  0,  1,  0,  0,  0);
        setEffScaleKey(ATK_02+30,shuchusen02,1.1,1.1);

        shock02 = entryEffect( ATK_02+30,  54,  0,  1,  0,  -10,  0);
        setEffAlphaKey(ATK_02+30 + 4,shock02,255);
        setEffAlphaKey(ATK_02+30 + 10,shock02,0);      
        changeAnime(  ATK_02+30,  1,  104);--モーション

        ------------------
        else
        entryEffectLife( ATK_01, 71, 120, 0x80,  -1,  0,  0,  0);--移動線
        ...
        --ダメージ
        spep_dam01 = ATK_01+21;
        --SE1=playSe( spep_dam01,1001);--SE
        hit01 = entryEffectLife( spep_dam01,  64, 10, 0, 1,  0,  0, 0);--HIT
        setEffScaleKey(spep_dam01,hit01,1.0,1.0);
        setEffScaleKey(spep_dam01 + 10,hit01,3.0,3.0);
        setEffAlphaKey(spep_dam01,hit01,255);
        setEffAlphaKey(spep_dam01 + 10,hit01,0);
        shock01 = entryEffect( spep_dam01,  54,  0,  1,  0,  0,  0);
        setEffAlphaKey(spep_dam01,shock01,255);
        setEffAlphaKey(spep_dam01 + 10,shock01,255);
        setEffAlphaKey(spep_dam01 + 20,shock01,0);
        entryEffectLife( spep_dam01, 51, 6, 0,  -1,  0,  0, 0);
        ...
        changeAnime(  ATK_02,  0,  13);--パンチ
        --SE2=playSe( ATK_02+1,1001);--SE
        hitEffect01(ATK_02+1,0,0);
        ...
        hitEffect01(ATK_02+7,120,2); -- HIT
        ...
        hitEffect01(ATK_02+10,180,3); -- HIT
        ...
        --stopSe( ATK_02+12, SE4, 4 );
        hitEffect01(ATK_02+12,240,4); -- HIT
        setDamage(  ATK_02+12,  1,  0);--ダメージ振動等
        ...
        hitEffect01(ATK_02+14,300,2); -- HIT
        ...
        hitEffect01(ATK_02+20,60,1); -- HIT
        setDamage(  ATK_02+20,  1,  0);--ダメージ振動等
        ...
        hitEffect01(ATK_02+24,120,3); -- HIT
        setDamage(  ATK_02+24,  1,  0);--ダメージ振動等
        ...
        -- entryEffect(  ATK_02+30,  70,  1,  -1,  0,  0,  0);
        -- entryEffect(  ATK_02+30,  908,  1,  1,  0,  0,  0);

        --ダメージ
        spep_dam02 = ATK_02+30 -1;
        hit02 = entryEffectLife( spep_dam02,  60, 10, 0, 1,  0,  0, 20);--HIT
        setEffScaleKey(spep_dam02,hit02,1.0,1.0);
        setEffScaleKey(spep_dam02 + 10,hit02,3.0,3.0);
        setEffAlphaKey(spep_dam02,hit02,255);
        setEffAlphaKey(spep_dam02 + 10,hit02,0);
        shock02 = entryEffect( spep_dam02,  54,  0,  1,  0,  0,  0);
        setEffScaleKey(spep_dam02,shock02,1.0,1.0);
        setEffScaleKey(spep_dam02 + 20,shock02,3.0,3.0);
        setEffAlphaKey(spep_dam02,shock02,255);
        setEffAlphaKey(spep_dam02 + 10,shock02,255);
        setEffAlphaKey(spep_dam02 + 20,shock02,0);
        shock03 = entryEffect( spep_dam02,  56,  0,  1,  0,  0,  0);
        setEffAlphaKey(spep_dam02,shock03,255);
        setEffAlphaKey(spep_dam02 + 20,shock03,0);
        entryEffectLife( spep_dam02, 51, 4, 0,  0,  -1,  100, 0);

        -- ** 音 ** --
        --初手キック
        SE001 = playSeVer2( 18, 1003, "", 0, 0, 0, -1);
        SE002 = playSeVer2( 28, 1009, "", 0, 0, 0, -1);
        SE003 = playSeVer2( 28, 1110, "", 0, 0, 0, -1);

        --向かっていく
        SE004 = playSeVer2( 38, 1117, "",80, 0, 20, -1);
        SE005 = playSeVer2( 38, 1277, "",72, 0, 14, -1);
        
        --連打
        SE006 = playSeVer2( 56, 1010, "", 0, 0, 0, -1);
        SE007 = playSeVer2( 56, 1110, "",80, 0, 10, -1);
        SE008 = playSeVer2( 62, 1110, "",86, 0, 10, -1);
        setSeVolumeByWorkId( 62, SE008, 79 );
        SE009 = playSeVer2( 68, 1110, "",92, 0, 10, -1);
        SE010 = playSeVer2( 68, 1000, "", 0, 0, 0, -1);
        SE011 = playSeVer2( 76, 1110, "", 0, 0, 0, -1);
        SE012 = playSeVer2( 76, 1187, "",140, 0, 44, -1);
        setSeVolumeByWorkId( 76, SE012, 79 );
        
        --敵構える
        SE013 = playSeVer2( 106, 1013, "", 0, 0, 0, -1);
