--ID未定:魔人ベジータ_ファイナルエクスプロージョン(アクティブスキル)_エネミー側(全体攻撃)
--sp_effect_a7_00052
--sp3063
...
--エフェクト(敵)
SP_01r= 164428  ;-- 開始 構えからセリフ(ef_001_r)
SP_02r= 159267  ;-- 爆発技発動(ef_002_r)
...
-- ** エフェクト等 ** --
fast = entryEffect( spep_0 + 0, SP_01r, 0x80, -1, 0, 0, 0 ); 
setEffMoveKey( spep_0 + 0, fast, 0, 0, 0 );
setEffMoveKey( spep_0 + MAX_FRAME_0, fast, 0, 0, 0 );
setEffScaleKey( spep_0 + 0, fast, -1.0, 1.0 );
setEffScaleKey( spep_0 + MAX_FRAME_0, fast, -1.0, 1.0 );
setEffRotateKey( spep_0 + 0, fast, 0 );
setEffRotateKey( spep_0 + MAX_FRAME_0, fast, 0 );
setEffAlphaKey( spep_0 + 0, fast, 255 );
setEffAlphaKey( spep_0 + MAX_FRAME_0, fast, 255 );

-- ** 黒背景 ** --
entryFadeBg( spep_0 , 0, MAX_FRAME_0 +2, 0,  0, 0, 0, 255 );  --黒 背景
...
-- ** 次の準備 ** --
spep_1 = spep_0 + MAX_FRAME_0;  --1036f
...
-- ** エフェクト等 ** --
activate = entryEffect( spep_1 + 0, SP_02r, 0x80, -1, 0, 0, 0 ); 
setEffMoveKey( spep_1 + 0, activate, 0, 0, 0 );
setEffMoveKey( spep_1 + MAX_FRAME_1, activate, 0, 0, 0 );
setEffScaleKey( spep_1 + 0, activate, -1.0, 1.0 );
setEffScaleKey( spep_1 + MAX_FRAME_1, activate, -1.0, 1.0 );
setEffRotateKey( spep_1 + 0, activate, 0 );
setEffRotateKey( spep_1 + MAX_FRAME_1, activate, 0 );
setEffAlphaKey( spep_1 + 0, activate, 255 );
setEffAlphaKey( spep_1 + MAX_FRAME_1, activate, 255 );

-- ** 黒背景 ** --
entryFadeBg( spep_0 , 0, MAX_FRAME_1 +2, 0,  0, 0, 0, 255 );  --黒 背景
...
-- ** 次の準備 ** --
spep_2 = spep_1 + MAX_FRAME_1;  --254f
...
setEffMoveKey( spep_2 + MAX_FRAME_2, explosion, 0, 0, 0 );
setEffScaleKey( spep_2 + 0, explosion, -1.0, 1.0 );
setEffScaleKey( spep_2 + MAX_FRAME_2, explosion, -1.0, 1.0 );
setEffRotateKey( spep_2 + 0, explosion, 0 );
setEffRotateKey( spep_2 + MAX_FRAME_2, explosion, 0 );
setEffAlphaKey( spep_2 + 0, explosion, 255 );
setEffAlphaKey( spep_2 + MAX_FRAME_2, explosion, 255 );

-- ** 黒背景 ** --
entryFadeBg( spep_0 , 0, MAX_FRAME_2 +2, 0,  0, 0, 0, 255 );  --黒 背景
...
-- ** ダメージ表示 ** --
dealDamage( spep_2 + 0 ); -- ダメージ表示フレーム
endPhase( spep_2 + MAX_FRAME_2 -4); -- 終了フレーム  96f -4
...
setEffMoveKey( spep_z + MAX_FRAME_Z, finish_f, 0, 0, 0 );
setEffScaleKey( spep_z + 0, finish_f, 1.0, 1.0 );
setEffScaleKey( spep_z + MAX_FRAME_Z, finish_f, 1.0, 1.0 );
setEffRotateKey( spep_z + 0, finish_f, 0 );
setEffRotateKey( spep_z + MAX_FRAME_Z, finish_f, 0 );
setEffAlphaKey( spep_z + 0, finish_f, 255 );
setEffAlphaKey( spep_z + MAX_FRAME_Z, finish_f, 255 );

-- ** エフェクト等 ** --
finish_b = entryEffect( spep_z + 0, SP_05, 0x80, -1, 0, 0, 0 ); 
setEffMoveKey( spep_z + 0, finish_b, 0, 0, 0 );
setEffMoveKey( spep_z + MAX_FRAME_Z, finish_b, 0, 0, 0 );
setEffScaleKey( spep_z + 0, finish_b, 1.0, 1.0 );
setEffScaleKey( spep_z + MAX_FRAME_Z, finish_b, 1.0, 1.0 );
setEffRotateKey( spep_z + 0, finish_b, 0 );
setEffRotateKey( spep_z + MAX_FRAME_Z, finish_b, 0 );
setEffAlphaKey( spep_z + 0, finish_b, 255 );
setEffAlphaKey( spep_z + MAX_FRAME_Z, finish_b, 255 );
...
setMoveKey( spep_z-3 + 5, 1, 207.1, -17.8 , 0 );
setMoveKey( spep_z-3 + 6, 1, 202.3, -13.3 , 0 );
setMoveKey( spep_z-3 + 7, 1, 202.3, -13.3 , 0 );
setMoveKey( spep_z-3 + 8, 1, 193.4, 28.7 , 0 );
setMoveKey( spep_z-3 + 9, 1, 193.4, 28.7 , 0 );
...
setScaleKey( spep_z-3 + 4, 1, 1.32, 1.32 );
setScaleKey( spep_z-3 + 5, 1, 1.32, 1.32 );
setScaleKey( spep_z-3 + 6, 1, 1.32, 1.32 );
setScaleKey( spep_z-3 + 7, 1, 1.32, 1.32 );
setScaleKey( spep_z-3 + 8, 1, 1.32, 1.32 );
setScaleKey( spep_z-3 + 9, 1, 1.32, 1.32 );
setScaleKey( spep_z-3 + 37, 1, 1.32, 1.32 );
setScaleKey( spep_z-3 + 38, 1, 2.42, 2.42 );
setScaleKey( spep_z-1 + 132, 1, 2.42, 2.42 );

setRotateKey( spep_z + 0, 1, -2.3 );
setRotateKey( spep_z-3 + 4, 1, -2.3 );
setRotateKey( spep_z-3 + 5, 1, -2.3 );
setRotateKey( spep_z-3 + 6, 1, -2.3 );
setRotateKey( spep_z-3 + 7, 1, -2.3 );
setRotateKey( spep_z-3 + 8, 1, -2.3 );
setRotateKey( spep_z-3 + 9, 1, -2.3 );
