--1032650:UR_超サイヤ人2孫悟飯(少年期)_必殺技_超かめはめ波
--sp_effect_a1_00508
--sp2950
...
--エフェクト(味方・敵共通)
SP_01  = 164110;  --ef_001 かめはめ波～ズオッ
SP_02b = 164111;  --ef_002b ガッの背景
...
start = entryEffect( spep_1 + 0, SP_01, 0x80, -1, 0, 0, 0); -- かめはめ波～ズオッ(ef_001)
...
--オーラ
SE002 = playSeVer2( spep_1 + 4, 1147, "",spep_1 + 182, 0, 26, -1);
setSeVolumeByWorkId( spep_1 + 4, SE002, 71 );
SE003 = playSeVer2( spep_1 + 4, 1036, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_1 + 28, 1036, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_1 + 52, 1036, "", 0, 0, 0, -1);
SE006 = playSeVer2( spep_1 + 76, 1036, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_1 + 100, 1036, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_1 + 124, 1036, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_1 + 148, 1036, "", 0, 0, 0, -1);
--かめはめ波発射
SE010 = playSeVer2( spep_1 + 154, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 154, SE010, 89 );
SE011 = playSeVer2( spep_1 + 154, 1146, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_1 + 154, 1213, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 154, SE012, 73 );
setTimeStretch( SE012, 1.05, 30, 4 );
SE013 = playSeVer2( spep_1 + 154, 1223, "", 0, 0, 0, -1);

-- ** 次の準備 ** --
spep_N = spep_1 + MAX_FRAME_1;--550
...
--気弾飛んでいく
SE014 = playSeVer2( spep_1 + 264, 1145, "", 0, 0, 0, -1);
SE015 = playSeVer2( spep_1 + 264, 1258, "", 0, 0, 0, -1);
setTimeStretch( SE015, 1.25, 30, 4 );
SE016 = playSeVer2( spep_1 + 264, 1211, "",spep_1 + 458, 0, 60, -1);
setSeVolumeByWorkId( spep_1 + 264, SE016, 178 );
SE017 = playSeVer2( spep_1 + 264, 1021, "", 0, 0, 0, -1);
--画面遷移
SE018 = playSeVer2( spep_1 + 382, 1509, "", 0, 0, 0, -1);
...
SE017 = playSeVer2( spep_1 + 264, 1021, "", 0, 0, 0, -1);
--画面遷移
SE018 = playSeVer2( spep_1 + 384, 1509, "", 0, 0, 0, -1);
