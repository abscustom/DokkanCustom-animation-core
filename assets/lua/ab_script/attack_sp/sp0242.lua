...
-- ** 集中線 ** --
shuchusen = entryEffectLife( SP_start+ 170 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( SP_start+ 170 + 0, shuchusen, 90, 20 );

setEffMoveKey( SP_start+ 170 + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( SP_start+ 170 + 90, shuchusen, 0, 0 , 0 );

setEffScaleKey( SP_start+ 170 + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( SP_start+ 170 + 90, shuchusen, 1.6, 1.6 );

setEffRotateKey( SP_start+ 170 + 0, shuchusen, 0 );
setEffRotateKey( SP_start+ 170 + 90, shuchusen, 0 );

setEffAlphaKey( SP_start+ 170 + 0, shuchusen, 255 );
setEffAlphaKey( SP_start+ 170 + 90, shuchusen, 255 );
...
-- ** 次の準備 ** --
entryFade( SP_start+ 170 + 82, 6, 6, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
