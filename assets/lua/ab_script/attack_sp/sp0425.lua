...
playSe( 30, SE_05);
speff = entryEffect( 30, 1507, 0, -1, 0, 0, 0); -- カード
...
playSe( 30, SE_05);
speff = entryEffect( 30, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( 30, SE_05);
speff = entryEffect( 30, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
...
SE001 = playSe( spep_1, 43);
SE002 = playSe( spep_1+20, SE_03);
SE003 = playSe( spep_1+40, SE_03);
...
SE005 = playSe( spep_2+40, SE_07);

------------------------------------------------------
--リクームイレイザーガン発射 230-285
------------------------------------------------------

SE006 = playSe( spep_3, 43);
SE007 = playSe( spep_3+18, SE_07);
