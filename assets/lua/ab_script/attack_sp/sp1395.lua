...
se_1004 = playSe( spep_0 + 59, 1004 );
setSeVolume( spep_0 + 59, 1004, 79 );
se_1046 = playSe( spep_0 + 59, 1046 );
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge, se_1018, 0 );
    stopSe( SP_dodge, se_1072, 0 );
    stopSe( SP_dodge, se_1172, 0 );
    stopSe( SP_dodge, se_1126, 0 );
    stopSe( SP_dodge, se_1004, 0 );
    stopSe( SP_dodge, se_1046, 0 );
    stopSe( SP_dodge, se05, 0 );
