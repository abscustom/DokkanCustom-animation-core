...
--エフェクト(味方)
SP_01 = 162273; --悟空（少年）が敵と対峙する～走ってジャンプ	ef_001
SP_01b = 162274; --悟空（少年）が敵と対峙する～走ってジャンプ	ef_001b
SP_02 = 162275; --月をバックにジャンプした悟空（少年）～パーで叩いて敵が吹っ飛ぶ	ef_002
...
base_0f = entryEffect( spep_0 + 0, SP_01, 0x80, -1, 0, 0, 0); -- ef_001
