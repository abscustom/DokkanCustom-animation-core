...
-- ** 集中線 ** --
shuchusen = entryEffectLife( SP_start+ 160 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( SP_start+ 160 + 0, shuchusen, 90, 20 );

setEffMoveKey( SP_start+ 160 + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( SP_start+ 160 + 90, shuchusen, 0, 0 , 0 );

setEffScaleKey( SP_start+ 160 + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( SP_start+ 160 + 90, shuchusen, 1.6, 1.6 );

setEffRotateKey( SP_start+ 160 + 0, shuchusen, 0 );
setEffRotateKey( SP_start+ 160 + 90, shuchusen, 0 );

setEffAlphaKey( SP_start+ 160 + 0, shuchusen, 255 );
setEffAlphaKey( SP_start+ 160 + 90, shuchusen, 255 );
...
playSe( SP_start+ 160, SE_05);
speff = entryEffect( SP_start+ 160, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( SP_start+ 160, SE_05);
speff = entryEffect( SP_start+ 160, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
...
-- ** 次の準備 ** --
entryFade( SP_start+ 160 + 82, 6, 6, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
