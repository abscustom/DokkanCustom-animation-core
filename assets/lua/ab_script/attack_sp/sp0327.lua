...
setMoveKey(   SP_ATK_0+4,   0,    0, 0,   80);
setMoveKey(   SP_ATK_0+5,   0,    0, 0,   80);
...
setScaleKey(   SP_ATK_0+4,   0, 1.5, 1.5);
setScaleKey(   SP_ATK_0+5,   0, 1.5, 1.5);

setRotateKey( SP_ATK_0,   0,  0 );
setRotateKey( SP_ATK_0+1,   0,  0 );
setRotateKey( SP_ATK_0+2,   0,  0 );
setRotateKey( SP_ATK_0+3,   0,  0 );
setRotateKey( SP_ATK_0+4,   0,  0 );
setRotateKey( SP_ATK_0+5,   0,  0 );
...
-- ** 次の準備 ** --
entryFade( Card + 82, 6, 6, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
