-- 1001691: パーフェクトセル_太陽系破壊かめはめ波(極限あり)
-- sp_effect_a1_00017
...
entryFade( 162, 3, 6, 6, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE001 = playSe(tyo2+170+64, SE_06);
------------------------------------------------------
-- カメハメハ発射(tyo2+110F)
------------------------------------------------------
