...
-- 書き文字エントリー
-- 書き文字エントリー
ctgogo = entryEffectLife( tamauestart+87, 190006, 85, 0x100, -1, 0, 100 -120, 515.5);    -- ゴゴゴゴ --95
...
playSe( cardcutin, SE_05);
speff = entryEffect( cardcutin, 1507, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( cardcutin, SE_05);
speff = entryEffect( cardcutin, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( cardcutin, SE_05);
speff = entryEffect( cardcutin, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end

entryFade( cardcutin+85 -2, 3, 2+2+2, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
bakuha = entryEffect( expl2 ,SP_08, 0, -1, 0, 0, 0);
...
entryFade( cardcutin+85, 3, 2+2, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
