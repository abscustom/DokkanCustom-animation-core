...
-- ** 音 ** --
SE002 = playSe( spep_1+8,1030);--344
setSeVolume( spep_1+8,1030, 70 );
SE003 = playSe( spep_1+18,1025);--354
setSeVolume( spep_1+18,1025, 70 );
SE004 = playSe( spep_1+28,1030);--364
setSeVolume( spep_1+28,1030, 70 );
SE005 = playSe( spep_1+38,1025);--374
...
-- ** 集中線 ** --
shuchusen2 = entryEffectLife( spep_4 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_4 + 0, shuchusen2, 90, 20 );
setEffMoveKey( spep_4 + 0, shuchusen2, 0, 0 , 0 );
setEffMoveKey( spep_4 + 90, shuchusen2, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, shuchusen2, 1.6, 1.6 );
setEffScaleKey( spep_4 + 90, shuchusen2, 1.6, 1.6 );
...
setEffScaleKey(spep_8,explosoin,1.0 +0.1,1.0 +0.1);
setEffScaleKey(spep_8+240,explosoin,1.0 +0.1,1.0 +0.1);
