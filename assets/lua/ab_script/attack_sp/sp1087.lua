...
entryFade(BUFFER+250, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
SE0001 = playSe( BUFFER+260, SE_07);
...
setScaleKey( BUFFER+280,   0, 0.31, 0.31);
setScaleKey( BUFFER+289+5,   0, 0.31, 0.31);
--playSe( 300, SE_06);
...
--回避しなかった場合_SE
playSe( SP_ATK01+35+diff01, SE_09); --eff01
playSe( SP_ATK01+43+diff01, SE_08); --eff02
playSe( SP_ATK01+50+diff01, SE_08); --eff02
playSe( SP_ATK01+57+diff01, SE_09); --eff03
playSe( SP_ATK01+65+diff01, SE_08); --eff04
playSe( SP_ATK01+72+diff01, SE_09); --eff05
playSe( SP_ATK01+76+diff01, SE_08); --eff06
playSe( SP_ATK01+80+diff01, SE_08); --eff07
playSe( SP_ATK01+91+diff01+diff02, SE_09);--eff08
playSe( SP_ATK01+91+diff01+diff02, SE_08);--eff08
...
setVisibleUI(5, 0);
manba1 = entryEffectLife(  5, SP_01r,25, 0,  -1,  0,  0,  -54); -- オーラ
manba2 = entryEffect(  30, SP_02r, 0,  -1,  0,  0,  -54); -- オーラ
playSe( 40, SE_06);
--setEffAlphaKey(54, manba1, 255);
--setEffAlphaKey(54, manba2, 255);
...
manba3 = entryEffectLife(  80, SP_08r, 90, 0,  -1,  0,  0,  -54); -- オーラ
--setEffAlphaKey(54, manba1, 0);
--setEffAlphaKey(54, manba2, 0);
...
setDisp( BUFFER+280, 0, 1);
setScaleKey( BUFFER+280,   0, 0.31, 0.31);
setScaleKey( BUFFER+289,   0, 0.31, 0.31);
--playSe( 300, SE_06);
