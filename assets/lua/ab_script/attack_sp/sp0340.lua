...
SE001 = playSe( spep_4+0, SE_06);
SE002 = playSe( spep_4+56, SE_06);
SE003 = playSe( spep_4+100, SE_07);
...
entryFade( spep_9+90+70, 9,  10, 1, 8, 8, 8, 255);             -- black fade

endPhase(spep_9+100+70);
else
