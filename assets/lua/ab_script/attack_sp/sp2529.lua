--9215741:孫悟空&ベジータ_超元気玉(チャージ満タン)_敵側
--sp_effect_a2_00202
--sp2529
...
--エフェクト(味方)
SP_01 = 161417;  --投げるまで  ef_001(ムービー用)
SP_01r = 161440;  --投げるまで  ef_001
SP_02r = 161441;  --着弾　手前 ef_002
...
-- ** エフェクト等 ** --
first = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0 );  --投げるまで  ef_001
...
-- ** SE ** --
--気が集まる
SE001 = playSeVer2( spep_0 + 0, 1185, "", 0, 0, 0, 0.5);
...
-- ** エフェクト等 ** --
-- ** エフェクト等 ** --
hidan_f0 = entryEffectLife( spep_1 + 0-1, SP_02r, 2, 0x100, -1, 0, 0, 0 );  --着弾　手前  ef_002
...
hidan_f = entryEffect( spep_1 + 0, SP_02r, 0x100, -1, 0, 0, 0 );  --着弾　手前  ef_002
...
SE030 = playSeVer2( spep_1 + 176, 1354, "", 0, 0, 0, 0.5);
