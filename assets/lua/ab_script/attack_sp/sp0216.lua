...
--文字エントリー
ctgogo=entryEffectLife(SP_start+90,190006,70,0x100,-1,80,520);--ゴゴゴ
setEffMoveKey(SP_start+90,ctgogo,80,520,0);
setEffMoveKey(SP_start+160,ctgogo,80,520,0);
setEffScaleKey(SP_start+90, ctgogo, 0.7, 0.7);
setEffScaleKey(SP_start+160, ctgogo, 0.7, 0.7);
...
SE001 = playSe( SP_start+ 260, SE_07);
...
SE002 = playSe( SP_start+ 300, SE_07);
...
SE003 = playSe( SP_start+ 390, SE_06);
...
entryFade( SP_start+ 462, 4,  12, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade


SE004 = playSe( SP_start+ 455, SE_09);
-- 敵吹っ飛ぶモーション
