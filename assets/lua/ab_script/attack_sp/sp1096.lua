--1010660:超サイヤ人孫悟空(天使)(超界王拳)_必殺技：超界王拳かめはめ波
--sp_effect_a1_00071
--sp1096
...
setScaleKey( spep_2 + 17, 1, 1.58, 1.58 );
--setScaleKey( spep_2 + 18, 1, 1, 1 );
...
------------------------------------------------------
spep_10=spep_9+58;
entryFadeBg( spep_10, 0, 114, 0, 10, 10, 10, 180);          -- ベース暗め　背景
