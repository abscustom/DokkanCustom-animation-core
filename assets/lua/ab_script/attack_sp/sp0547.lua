-- 1016810:超サイヤ人孫悟飯(青年期)&超サイヤ人孫悟天(幼年期)_兄弟かめはめ波(超必殺)
-- sp_effect_a1_00160
-- sp0547
...
se4 = playSe( spep_1 + 42,  SE_04);  --悟飯カットイン
...
-- ** 白フェード ** --
entryFade( spep_5 + 70, 18, 10, 10, fcolor_r, fcolor_g, fcolor_b, 255 );  -- white fade
