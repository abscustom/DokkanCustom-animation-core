...
-- ** 次の準備 ** --
entryFade( 166 - 8, 6, 4, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
--entryFade( 170 + 82, 6, 6, 2, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( 166 +80, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
a1 = 20;
--球道
SE001 = playSe( 278 +a1, 9 );
setSeVolume( 278 +a1, 9, 70 );
SE002 = playSe( 278 +a1, 1117 );
