...
--エフェクト(味方・敵共通)
SP_01  = 164072;  --ef_001 ３倍界王拳のかめはめ波の構え～カッ
SP_02b = 164073;  --ef_002 ガッの背景
...
-- ** 音 ** --
--構える
SE002 = playSeVer2( spep_0 + 80, 1233, "", 0, 0, 0, -1);

--オーラ
SE003 = playSeVer2( spep_0 + 86, 1226, "",spep_1 + 432, 0, 34, -1);
setSeVolumeByWorkId( spep_0 + 86, SE003, 52 );
SE004 = playSeVer2( spep_0 + 86, 1176, "",spep_1 + 434, 0, 34, -1);
setSeVolumeByWorkId( spep_0 + 86, SE004, 61 );
...
start = entryEffect( spep_1 + 0, SP_01, 0x80, -1, 0, 0, 0); -- ３倍界王拳のかめはめ波の構え～カッ(ef_001)
...
-- ** 音 ** --
--画面遷移
SE005 = playSeVer2( spep_1 + 76, 8, "", 0, 0, 0, -1);

--かめはめ波発射
SE006 = playSeVer2( spep_1 + 282, 1027, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_1 + 282, 1145, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_1 + 282, 1022, "", 0, 0, 0, -1);
...
-- ** 音 ** --
--敵ヒット
SE009 = playSeVer2( spep_1 + 390, 1179, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_1 + 390, 1023, "", 0, 0, 0, -1);

--画面遷移
SE011 = playSeVer2( spep_1 + 498, 1509, "", 0, 8, 0, -1);
setStartTimeMs( SE011,  233 );

-- ** 次の準備 ** --
spep_N = spep_1 + MAX_FRAME_1;
...
-- 背景差し替えがある場合のみ
finish_1b = entryEffectLife( spep_N + 0, SP_02b , spep_N + 108, 0x80, -1, 0, 0, 0 );  --ガッの背景(ef_002)
