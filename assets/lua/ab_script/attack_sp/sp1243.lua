...
-- ** 黒背景 ** --
entryFadeBg( spep_2 + 0, 0, 130 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景
...
-- ** 黒背景 ** --
entryFadeBg( spep_3 + 0, 0, 140 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景
...
-- ** 黒背景 ** --
entryFadeBg( spep_5 + 0, 0, 120 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景
...
-- ** 黒背景 ** --
entryFadeBg( spep_6 + 0, 0, 100 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景
...
-- ** 黒背景 ** --
entryFadeBg( spep_7 + 0, 0, 160 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景
...
-- ** 黒背景 ** --
entryFadeBg( spep_8 + 0, 0, 180 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景
