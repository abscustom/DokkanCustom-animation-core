-- 4027300: LR_超サイヤ人トランクス(未来）_超必殺技：シャイニングスラッシュ_スタンバイ後
-- sp_effect_b2_00058
-- sp2609
...
-- 共通
SP_001 = 162260;  -- 開始、敵と向かい合う～カードカットインまで ef_001
SP_002 = 162262;  -- カードカットイン～フィニッシュ ef_002
...
--オーラ
SE002 = playSeVer2( spep_0 + 0, 1181, "",spep_0 + 122, 0, 16, -1);
setSeVolumeByWorkId( spep_0 + 0, SE002, 158 );
SE003 = playSeVer2( spep_0 + 0, 1407, "",spep_0 + 120, 0, 12, -1);

--ズーム
SE004 = playSeVer2( spep_0 + 2, 1232, "", 0, 0, 0, -1);

--瞬間移動
SE006 = playSeVer2( spep_0 + 100, 1109, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 130, 1109, "", spep_0 + 174, 0, 4, -1);
...
--飛び込んでくる
SE008 = playSeVer2( spep_0 + 144, 1116, "",spep_0 + 200, 0, 24, -1);
SE009 = playSeVer2( spep_0 + 144, 1117, "",spep_0 + 200, 0, 22, -1);

--オーラ
SE010 = playSeVer2( spep_0 + 146, 1181, "",spep_0 + 464, 26, 18, -1);
SE011 = playSeVer2( spep_0 + 146, 1407, "",spep_0 + 462, 28, 16, -1);
SE002_02 = playSeVer2( spep_0 + 300, 1181, "",spep_0 + 458, 0, 34, -1);
setSeVolumeByWorkId( spep_0 + 300, SE002_02, 158 );
SE003_02 = playSeVer2( spep_0 + 300, 1407, "",spep_0 + 458, 0, 34, -1);

--斬る
SE012 = playSeVer2( spep_0 + 166, 1004, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_0 + 176, 1143, "", 0, 0, 0, -1);
SE014 = playSeVer2( spep_0 + 176, 1153, "",spep_0 + 214, 0, 16, -1);
setSeVolumeByWorkId( spep_0 + 178, SE014, 79 );
SE015 = playSeVer2( spep_0 + 180, 1032, "", 0, 0, 0, -1);

--振りかぶる
SE016 = playSeVer2( spep_0 + 210, 1003, "", 0, 0, 0, -1);

--連続斬り１
SE017 = playSeVer2( spep_0 + 234, 1189, "", 0, 0, 0, -1);
SE018 = playSeVer2( spep_0 + 244, 1141, "", 0, 0, 0, -1);
SE019 = playSeVer2( spep_0 + 244, 1032, "", 0, 0, 0, -1);
SE020 = playSeVer2( spep_0 + 244, 1009, "", 0, 0, 0, -1);
stopSeIfDoubleSpeed( spep_0 + 244, SE020 );

--連続斬り２
SE021 = playSeVer2( spep_0 + 260, 1141, "", 0, 0, 0, -1);
SE022 = playSeVer2( spep_0 + 260, 1031, "", 0, 0, 0, -1);
SE023 = playSeVer2( spep_0 + 260, 1010, "", 0, 0, 0, -1);
stopSeIfDoubleSpeed( spep_0 + 260, SE023 );

--連続斬り３
SE024 = playSeVer2( spep_0 + 274, 1141, "", 0, 0, 0, -1);
SE025 = playSeVer2( spep_0 + 274, 1032, "", 0, 0, 0, -1);
SE026 = playSeVer2( spep_0 + 274, 1009, "", 0, 0, 0, -1);
stopSeIfDoubleSpeed( spep_0 + 274, SE026 );

--横斬り
SE027 = playSeVer2( spep_0 + 294, 1189, "", 0, 0, 0, -1);
SE028 = playSeVer2( spep_0 + 300, 1143, "", spep_0 + 348, 0, 2, -1);
SE029 = playSeVer2( spep_0 + 300, 1032, "", 0, 0, 0, -1);
SE030 = playSeVer2( spep_0 + 300, 1187, "",spep_0 + 366, 0, 44, -1);
setSeVolumeByWorkId( spep_0 + 300, SE030, 65 );

--斬り返し
SE031 = playSeVer2( spep_0 + 348, 1032, "", 0, 0, 0, -1);
SE032 = playSeVer2( spep_0 + 348, 1187, "",spep_0 + 414, 0, 44, -1);
setSeVolumeByWorkId( spep_0 + 348, SE032, 65 );
SE033 = playSeVer2( spep_0 + 348, 1169, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 348, SE033, 79 );
SE034 = playSeVer2( spep_0 + 350, 1061, "", 0, 0, 0, -1);
SE035 = playSeVer2( spep_0 + 354, 1141, "", 0, 0, 0, -1);

--振りかぶる
SE036 = playSeVer2( spep_0 + 384, 1004, "",spep_0 + 418, 0, 18, -1);

--蹴り飛ばす
SE037 = playSeVer2( spep_0 + 410, 1187, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_0 + 410, 1010, "", 0, 0, 0, -1);

--敵飛んでいく
SE039 = playSeVer2( spep_0 + 420, 1121, "",spep_0 + 484, 0, 20, -1);

--壁激突
SE040 = playSeVer2( spep_0 + 464, 1159, "",spep_0 + 512 + 14, 0, 14, -1);

--壁破壊して敵とんでいく
SE041 = playSeVer2( spep_0 + 492, 1068, "",spep_0 + 512 + 14, 0, 12, -1);
SE042 = playSeVer2( spep_0 + 492, 1027, "",spep_0 + 512 + 16, 0, 14, -1);
...
-- ** 音 ** --
--向かってくる
SE044 = playSeVer2( spep_2 + 0, 1182, "", 0, 0, 0, -1);
SE045 = playSeVer2( spep_2 + 0, 1117, "", 0, 0, 0, -1);
SE046 = playSeVer2( spep_2 + 0, 1116, "",spep_2 + 52, 0, 14, -1);

--斬る
SE047 = playSeVer2( spep_2 + 74, 1319, "",spep_2 + 200, 8, 28, -1);
setSeVolumeByWorkId( spep_2 + 74, SE047, 66 );
setStartTimeMs( SE043,  300 );

--振りかぶる
SE048 = playSeVer2( spep_2 + 60, 1004, "", 0, 0, 0, -1);

--斬る
SE049 = playSeVer2( spep_2 + 74, 1032, "", 0, 0, 0, -1);
SE050 = playSeVer2( spep_2 + 74, 1187, "", 0, 0, 0, -1);
SE051 = playSeVer2( spep_2 + 78, 1143, "", 0, 0, 0, -1);
SE052 = playSeVer2( spep_2 + 86, 1141, "", 0, 0, 0, -1);

--画面遷移
SE053 = playSeVer2( spep_2 + 86, 8, "", 0, 0, 0, -1);

--構えて向かっていく
SE054 = playSeVer2( spep_2 + 152, 1314, "",spep_2 + 234, 0, 34, -1);
SE055 = playSeVer2( spep_2 + 152, 1116, "",spep_2 + 206, 0, 28, -1);

--突き刺す
SE056 = playSeVer2( spep_2 + 202, 1061, "", 0, 0, 0, -1);
SE057 = playSeVer2( spep_2 + 206, 1120, "", 0, 0, 0, -1);
SE058 = playSeVer2( spep_2 + 210, 1143, "", 0, 0, 0, -1);

--爆発
SE059 = playSeVer2( spep_2 + 242, 1067, "", 0, 0, 0, -1);
SE060 = playSeVer2( spep_2 + 242, 1024, "", 0, 0, 0, -1);

--風圧
SE061 = playSeVer2( spep_2 + 242, 1427, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 242, SE061, 50 );
