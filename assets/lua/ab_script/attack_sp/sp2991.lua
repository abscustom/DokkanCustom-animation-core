...
-- ** エフェクト等 ** --
start_f = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0); -- 左右ずつ手を広げFF構えて発射(ef_001r)
...
changeAnime( spep_0 + 684 + OFFSET_X, 1, 4 );
changeAnime( spep_0 + 692 + OFFSET_X, 1, 6 );
...
changeAnime( spep_0 + 856 + OFFSET_X, 1, 8 );
changeAnime( spep_0 + 880 + OFFSET_X, 1, 6 );
...
--カメラ回転
SE013 = playSeVer2( spep_0 + 84, 1175, "",spep_0 + 344, 0, 56, 0.6);
setSeVolumeByWorkId( spep_0 + 84, SE013, 35 );
SE015 = playSeVer2( spep_0 + 108, 63, "", 0, 0, 0, 0.6);
...
endPhase( spep_0 + MAX_FRAME_0 ); -- 1088(KO時 1412F)
