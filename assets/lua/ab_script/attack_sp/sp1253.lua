...
SE43_1 = playSe( spep_0 + 102, 43 );  --瞬間移動
...
-- ** 音 ** --
SE43_2 = playSe( spep_1 + 12, 43 );  --瞬間移動
...
stopSe( SP_dodge - 12, SE43_1, 0 );
stopSe( SP_dodge - 12, SE43_2, 0 );
