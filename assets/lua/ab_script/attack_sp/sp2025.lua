--1019990:超サイヤ人ゴッドSS孫悟空(界王拳)&超サイヤ人ゴッドSSベジータ(進化)_かめはめ波&ファイナルフラッシュ
--sp_effect_a1_00242
--sp2025
...
setScaleKey( spep_0 -3 + 204, 1, 2.4, 2.4 );
...
setRotateKey( spep_0 -3 + 204, 1, 2.2 );
...
setMoveKey( spep_2 -3 + 110, 1, -2.2, 12.8 , 0 );
...
setScaleKey( spep_2 -3 + 110, 1, 0.45, 0.45 );
...
setRotateKey( spep_2 -3 + 110, 1, -381.5 );
