...
-- ** 音 ** --
SE002 = playSe( spep_1+0, 1013);
SE003 = playSe( spep_1+20+tyousei1, 1012);
...
playSe( spep_12, SE_05);
speff = entryEffect( spep_12, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( spep_12, SE_05);
speff = entryEffect( spep_12, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
