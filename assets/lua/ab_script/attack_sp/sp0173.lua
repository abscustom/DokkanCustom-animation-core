...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    playSe( SP_start2 + 166, SE_05);
    speff = entryEffect( SP_start2 + 166, 1507, 0, -1, 0, 0, 0); -- カード
    setEffReplaceTexture( speff, 1, 1);
    setEffReplaceTexture( speff, 2, 0); -- カード差し替え
    setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
elseif(_SPECIAL_SKILL_LEVEL_ == 1) then
    ...
    playSe( SP_start2 + 166, SE_05);
    speff = entryEffect( SP_start2 + 166, 1120, 0, -1, 0, 0, 0); -- カード
    setEffReplaceTexture( speff, 1, 1);
    setEffReplaceTexture( speff, 2, 0); -- カード差し替え
    setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
elseif(_SPECIAL_SKILL_LEVEL_ == 2) then
    ...
    playSe( SP_start2 + 166, SE_05);
    speff = entryEffect( SP_start2 + 166, 1121, 0, -1, 0, 0, 0); -- カード
    setEffReplaceTexture( speff, 1, 1);
    setEffReplaceTexture( speff, 2, 0); -- カード差し替え
    setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
...
-- ** 集中線 ** --
shuchusen = entryEffectLife( SP_start2 + 166, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( SP_start2 + 166, shuchusen, 90, 20 );
setEffMoveKey( SP_start2 + 166, shuchusen, 0, 0 , 0 );
setEffMoveKey( SP_start2 + 256, shuchusen, 0, 0 , 0 );
setEffScaleKey( SP_start2 + 166, shuchusen, 1.6, 1.6 );
setEffScaleKey( SP_start2 + 256, shuchusen, 1.6, 1.6 );
setEffRotateKey( SP_start2 + 166, shuchusen, 0 );
setEffRotateKey( SP_start2 + 256, shuchusen, 0 );
setEffAlphaKey( SP_start2 + 166, shuchusen, 255 );
setEffAlphaKey( SP_start2 + 256, shuchusen, 255 );

-- ** 音 ** --
--playSe( SP_start2+ 166, SE_05);

-- ** 白背景 ** --
entryFadeBg( SP_start2 + 166, 0, 96, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景

-- ** 白フェード ** --
entryFade( SP_start2 + 166, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( SP_start2 + 246, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
SE001 = playSe( SP_start2+ 260+116, 1042);
...
SE002 = playSe( SP_start+ 260, SE_07);
...
SE003 = playSe( SP_start+ 300, SE_07);
...
SE004 = playSe( SP_start3+ SP_start+ 390, SE_06);
...
setScaleKey( SP_start3+ SP_start+ 632,    0,  0.5, 0.5);
