...
damage1 = entryEffect( spep_3,   SP_03,   0x80,     -1,  0,  0,  0,-50);   -- ef_002
...
ryusen2 = entryEffectLife( spep_3+37, 921, 50, 0x80,  -1,  0,  0,  0,-100); -- 流線斜め
...
entryFade( spep_5-6, 4, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- ** 集中線 ** --
shuchusenx = entryEffectLife( spep_5 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_5 + 0, shuchusenx, 90, 20 );

setEffMoveKey( spep_5 + 0, shuchusenx, 0, 0 , 0 );
setEffMoveKey( spep_5 + 90, shuchusenx, 0, 0 , 0 );

setEffScaleKey( spep_5 + 0, shuchusenx, 1.6, 1.6 );
setEffScaleKey( spep_5 + 90, shuchusenx, 1.6, 1.6 );

setEffRotateKey( spep_5 + 0, shuchusenx, 0 );
setEffRotateKey( spep_5 + 90, shuchusenx, 0 );

setEffAlphaKey( spep_5 + 0, shuchusenx, 255 );
setEffAlphaKey( spep_5 + 90, shuchusenx, 255 );
...
entryFade( spep_8-4, 4, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( spep_9-8, 4, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
