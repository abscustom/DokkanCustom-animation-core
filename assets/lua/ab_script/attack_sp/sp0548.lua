--1016871：LR_超サイヤ人ブロリー_必殺技：ブラッディースマッシュ
--sp_effect_b4_00093
--sp0548
...
-- ** 音 ** --
SE001 = playSe( spep_0 + 60, 1042 );  --発射前
SE002 = playSe( spep_0 + 90, 1017 );  --気弾発射
SE003 = playSe( spep_0 + 106, 1019 );  --気弾迫る
...
-- ** 音 ** --
SE004 = playSe( spep_1 + 40, 1023 );  --爆発
...
--白フェード
entryFade( spep_1 + 110, 0, 4, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
entryFade( spep_3 + 80, 8, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
