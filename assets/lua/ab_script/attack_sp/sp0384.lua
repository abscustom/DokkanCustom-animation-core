...
b = 50;
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -190 -b, 300);    -- ゴゴゴ・・・
...
kame_hand = entryEffect( 70, SP_01, 0x80,  0,  300, -43 +30, 23 -20);   -- 手のカメハメ波部
setEffScaleKey( 70, kame_hand, 0.5, 0.5);
