...
-- ** 白背景 ** --
entryFadeBg( 170 + 0, 0, 96 -2, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景

-- ** 白フェード ** --
entryFade( 170 + 0 -4, 0, 2+4, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( 170 + 80, 6, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
