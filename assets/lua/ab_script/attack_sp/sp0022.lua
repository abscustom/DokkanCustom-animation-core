...
entryFade( 164, 2, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -210, 300);    -- ゴゴゴ・・・
...
entryFade( 254, 2, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
setEffReplaceTexture( speff, 2, 0);                         -- カード差し替え
--setEffReplaceTexture( speff, 5, 4);                                  -- 技名テクスチャ差し替え
SE_CUT = playSe( SP_ATK_1+22, SE_12);

spname = entryEffect( SP_ATK_1+10, 1508,  0,  -1,  0,  0,  0);               -- かめはめ波文字
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え

entryFade( SP_ATK_1, 3, 4, 4, fcolor_r, fcolor_g, fcolor_b, 90);     -- white fade
...
setMoveKey(  SP_ATK_2+80,    0,   -1000,  0,   -50);

entryFade( SP_ATK_2+5, 3, 2, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
entryFade( SP_ATK_2+88, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( SP_ATK_3+27, 10,  8, 10, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
