...
setEffAlphaKey( SP_ATK02+112, ct, 255);
...
--setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え
spname = entryEffectLife( SP_ATK_1+10, 1508, 38, 0,  -1,  0,  0,  0);               -- かめはめ波文字
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え
...
playSe( SP_ATK02+4, SE_11);
shuchusen = entryEffectLife( SP_ATK02+4, 906, 112, 0x00,  -1, 0,  0,  0);   -- 集中線
entryEffect( SP_ATK02+4, 1600,  0x00,  -1,  0,30, -130);   -- ひび割れ
