...
-- ** 音 ** --
SE0 = playSe( spep_0 , 1109 );  --ダッシュ
SE1 = playSe( spep_0+10 , 1109 );  --ダッシュ
SE2 = playSe( spep_0+20 , 1109 );  --ダッシュ
SE3 = playSe( spep_0+30 , 1109 );  --ダッシュ
...
--白フェード
--entryFade( spep_2+84, 0,  2, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( spep_4 + 80, 8, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
