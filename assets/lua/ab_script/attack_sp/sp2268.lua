--1023030:URベジータ_ジェノサイドブレイカー_sp2268
--sp_effect_a3_00084
...
--味方側
SP_01 = 158045;  --対峙  ef_001a
SP_02 = 158046;  --蹴り_手前   ef_002a
SP_03 = 158048;  --蹴り_中    ef_002b
SP_04 = 158049;  --蹴り_奥    ef_002c
SP_05 = 158050;  --突進_手前   ef_003a
SP_06 = 158052;  --突進_中    ef_003b
SP_07 = 158053;  --突進_奥    ef_003c
SP_08 = 158054;  --手刀_手前   ef_004a
SP_09 = 158056;  --手刀_中    ef_004b
SP_10 = 158057;  --手刀_奥    ef_004c
SP_11 = 158058;  --手刀余韻_手前 ef_005a
SP_12 = 158059;  --手刀余韻_奥  ef_005b
SP_13 = 158060;  --手構え_手前  ef_006a
SP_14 = 158061;  --手構え_奥   ef_006b
SP_15 = 158062;  --ベジータ笑   ef_007a
SP_16 = 158063;  --発射_手前   ef_008a
SP_17 = 158064;  --発射_中    ef_008b
SP_18 = 158065;  --発射_奥    ef_008c

--敵側
SP_02r = 158047;  --蹴り_手前   ef_002a_r
SP_05r = 158051;  --突進_手前   ef_003a_r
SP_08r = 158055;  --手刀_手前   ef_004a_r
SP_16r = 158307;  --発射_手前;   --ef_008a_r
...
--画面遷移
SE015 = playSeVer2( spep_4 + 78, 8, "", 0, 0, 0, -1);
...
-- ** エフェクト等 ** --
form_f = entryEffectLife( spep_5 + 0, SP_11, 40, 0x100, -1, 0, 0, 0 );  --手刀余韻_手前   ef_005a
setEffMoveKey( spep_5 + 0, form_f, 0, 0 , 0 );
setEffMoveKey( spep_5 + 40, form_f, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, form_f, 1.0, 1.0 );
setEffScaleKey( spep_5 + 40, form_f, 1.0, 1.0 );
setEffRotateKey( spep_5 + 0, form_f, 0 );
setEffRotateKey( spep_5 + 40, form_f, 0 );
setEffAlphaKey( spep_5 + 0, form_f, 255 );
setEffAlphaKey( spep_5 + 40 -1, form_f, 255 );
setEffAlphaKey( spep_5 + 40, form_f, 0 );

form_b = entryEffectLife( spep_5 + 0, SP_12, 40, 0x80, -1, 0, 0, 0 );  --手刀余韻_奥 ef_005b
setEffMoveKey( spep_5 + 0, form_b, 0, 0 , 0 );
setEffMoveKey( spep_5 + 40, form_b, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, form_b, 1.0, 1.0 );
setEffScaleKey( spep_5 + 40, form_b, 1.0, 1.0 );
setEffRotateKey( spep_5 + 0, form_b, 0 );
setEffRotateKey( spep_5 + 40, form_b, 0 );
setEffAlphaKey( spep_5 + 0, form_b, 255 );
setEffAlphaKey( spep_5 + 40 -1, form_b, 255 );
setEffAlphaKey( spep_5 + 40, form_b, 0 );
...
setMoveKey( spep_5 + 0, 1, -15.4, 179.2 , 0 );
setMoveKey( spep_5 + 1, 1, -20.3, 160.3 , 0 );
setMoveKey( spep_5 + 2, 1, -22.8, 150.6 , 0 );
setMoveKey( spep_5 -3 + 6, 1, -24.7, 143.1 , 0 );
setMoveKey( spep_5 -3 + 8, 1, -26.4, 136.6 , 0 );
setMoveKey( spep_5 -3 + 10, 1, -27.9, 130.9 , 0 );
setMoveKey( spep_5 -3 + 12, 1, -29.2, 125.7 , 0 );
setMoveKey( spep_5 -3 + 14, 1, -30.5, 120.9 , 0 );
setMoveKey( spep_5 -3 + 16, 1, -31.6, 116.4 , 0 );
setMoveKey( spep_5 -3 + 18, 1, -32.7, 112.1 , 0 );
setMoveKey( spep_5 -3 + 20, 1, -33.8, 108.1 , 0 );
setMoveKey( spep_5 -3 + 22, 1, -34.8, 104.3 , 0 );
setMoveKey( spep_5 -3 + 24, 1, -35.7, 100.7 , 0 );
setMoveKey( spep_5 -3 + 26, 1, -36.6, 97.3 , 0 );
setMoveKey( spep_5 -3 + 28, 1, -37.4, 94 , 0 );
setMoveKey( spep_5 -3 + 30, 1, -38.3, 90.8 , 0 );
setMoveKey( spep_5 -3 + 32, 1, -39, 87.8 , 0 );
setMoveKey( spep_5 -3 + 34, 1, -39.8, 84.9 , 0 );
setMoveKey( spep_5 -3 + 36, 1, -40.5, 82.2 , 0 );
setMoveKey( spep_5 -3 + 38, 1, -41.2, 79.6 , 0 );
setMoveKey( spep_5 -3 + 40, 1, -41.8, 77.2 , 0 );
setMoveKey( spep_5 -3 + 42, 1, -42.4, 75 , 0 );
--setMoveKey( spep_5 -3 + 43, 1, -42.4, 75 , 0 );

setScaleKey( spep_5 + 0, 1, 3.2, 3.2 );
setScaleKey( spep_5 -3 + 42, 1, 3.2, 3.2 );
--setScaleKey( spep_5 -3 + 43, 1, 3.2, 3.2 );

setRotateKey( spep_5 + 0, 1, 115 );
setRotateKey( spep_5 + 1, 1, 115.5 );
setRotateKey( spep_5 + 2, 1, 115.8 );
setRotateKey( spep_5 -3 + 6, 1, 116 );
setRotateKey( spep_5 -3 + 8, 1, 116.2 );
setRotateKey( spep_5 -3 + 10, 1, 116.3 );
setRotateKey( spep_5 -3 + 12, 1, 116.5 );
setRotateKey( spep_5 -3 + 14, 1, 116.6 );
setRotateKey( spep_5 -3 + 16, 1, 116.7 );
setRotateKey( spep_5 -3 + 18, 1, 116.8 );
setRotateKey( spep_5 -3 + 20, 1, 116.9 );
setRotateKey( spep_5 -3 + 22, 1, 117 );
setRotateKey( spep_5 -3 + 24, 1, 117.1 );
setRotateKey( spep_5 -3 + 26, 1, 117.2 );
setRotateKey( spep_5 -3 + 28, 1, 117.3 );
setRotateKey( spep_5 -3 + 30, 1, 117.4 );
setRotateKey( spep_5 -3 + 32, 1, 117.5 );
setRotateKey( spep_5 -3 + 34, 1, 117.6 );
setRotateKey( spep_5 -3 + 36, 1, 117.6 );
setRotateKey( spep_5 -3 + 38, 1, 117.7 );
setRotateKey( spep_5 -3 + 40, 1, 117.8 );
setRotateKey( spep_5 -3 + 42, 1, 117.8 );
--setRotateKey( spep_5 -3 + 43, 1, 117.8 );
...
-- ** エフェクト等 ** --
tame_f = entryEffectLife( spep_6 + 0, SP_13, 40, 0x100, -1, 0, 0, 0 );  --手構え_手前    ef_006a
setEffMoveKey( spep_6 + 0, tame_f, 0, 0 , 0 );
setEffMoveKey( spep_6 + 40, tame_f, 0, 0 , 0 );
setEffScaleKey( spep_6 + 0, tame_f, 1.0, 1.0 );
setEffScaleKey( spep_6 + 40, tame_f, 1.0, 1.0 );
setEffRotateKey( spep_6 + 0, tame_f, 0 );
setEffRotateKey( spep_6 + 40, tame_f, 0 );
setEffAlphaKey( spep_6 + 0, tame_f, 255 );
setEffAlphaKey( spep_6 + 40 -1, tame_f, 255 );
setEffAlphaKey( spep_6 + 40, tame_f, 0 );

tame_b = entryEffectLife( spep_6 + 0, SP_14, 40, 0x80, -1, 0, 0, 0 );  --手構え_奥  ef_006b
setEffMoveKey( spep_6 + 0, tame_b, 0, 0 , 0 );
setEffMoveKey( spep_6 + 40, tame_b, 0, 0 , 0 );
setEffScaleKey( spep_6 + 0, tame_b, 1.0, 1.0 );
setEffScaleKey( spep_6 + 40, tame_b, 1.0, 1.0 );
setEffRotateKey( spep_6 + 0, tame_b, 0 );
setEffRotateKey( spep_6 + 40, tame_b, 0 );
setEffAlphaKey( spep_6 + 0, tame_b, 255 );
setEffAlphaKey( spep_6 + 40 -1, tame_b, 255 );
setEffAlphaKey( spep_6 + 40, tame_b, 0 );

-- ** 敵キャラクター ** --
--setDisp( spep_6 + 0, 1, 1 );
setDisp( spep_6 -3 + 43, 1, 0 );
changeAnime( spep_6 + 0, 1, 107 );

setMoveKey( spep_6 + 0, 1, 28, 266.2 , 0 );
setMoveKey( spep_6 + 1, 1, 28, 259.5 , 0 );
setMoveKey( spep_6 + 2, 1, 28, 253.4 , 0 );
setMoveKey( spep_6 -3 + 6, 1, 28, 248 , 0 );
setMoveKey( spep_6 -3 + 8, 1, 28, 243 , 0 );
setMoveKey( spep_6 -3 + 10, 1, 28, 238.5 , 0 );
setMoveKey( spep_6 -3 + 12, 1, 28, 234.4 , 0 );
setMoveKey( spep_6 -3 + 14, 1, 28, 230.7 , 0 );
setMoveKey( spep_6 -3 + 16, 1, 28, 227.3 , 0 );
setMoveKey( spep_6 -3 + 18, 1, 28, 224.2 , 0 );
setMoveKey( spep_6 -3 + 20, 1, 28, 221.4 , 0 );
setMoveKey( spep_6 -3 + 22, 1, 28, 218.8 , 0 );
setMoveKey( spep_6 -3 + 24, 1, 28, 216.5 , 0 );
setMoveKey( spep_6 -3 + 26, 1, 28, 214.4 , 0 );
setMoveKey( spep_6 -3 + 28, 1, 28, 212.6 , 0 );
setMoveKey( spep_6 -3 + 30, 1, 28, 211 , 0 );
setMoveKey( spep_6 -3 + 32, 1, 28, 209.6 , 0 );
setMoveKey( spep_6 -3 + 34, 1, 28, 208.4 , 0 );
setMoveKey( spep_6 -3 + 36, 1, 28, 207.5 , 0 );
setMoveKey( spep_6 -3 + 38, 1, 28, 206.8 , 0 );
setMoveKey( spep_6 -3 + 40, 1, 28, 206.3 , 0 );
setMoveKey( spep_6 -3 + 42, 1, 28.1, 206.1 , 0 );
setMoveKey( spep_6 -3 + 43, 1, 28.1, 206.1 , 0 );

setScaleKey( spep_6 + 0, 1, 3, 3 );
setScaleKey( spep_6 -3 + 43, 1, 3, 3 );

setRotateKey( spep_6 + 0, 1, 90 );
setRotateKey( spep_6 -3 + 43, 1, 90 );

-- ** 集中線 ** --
shuchusen4 = entryEffectLife( spep_6 + 26 -1, 906, 14, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_6 + 26 -1, shuchusen4, 90, 20 );
setEffMoveKey( spep_6 + 26 -1, shuchusen4, 0, 0 , 0 );
setEffMoveKey( spep_6 + 40 -1, shuchusen4, 0, 0 , 0 );
setEffScaleKey( spep_6 + 26 -1, shuchusen4, 1.4, 1.4 );
setEffScaleKey( spep_6 + 40 -1, shuchusen4, 1.4, 1.4 );
setEffRotateKey( spep_6 + 26 -1, shuchusen4, 0 );
setEffRotateKey( spep_6 + 40 -1, shuchusen4, 0 );
setEffAlphaKey( spep_6 + 26 -1, shuchusen4, 255 );
setEffAlphaKey( spep_6 + 40 -1, shuchusen4, 255 );

-- ** 音 ** --
--手を向ける
SE015 = playSeVer2( spep_6 + 14, 1003, "", 0, 0, 0, -1);

SE016 = playSeVer2( spep_6 + 16, 1006, "",spep_6 + 40 + 2, 0, 6, -1);
setPitch( spep_6 + 16, SE016, -300 );
setTimeStretch( SE016, 0.8, 30, 4 );

-- ** 黒背景 ** --
entryFadeBg( spep_6 + 0, 0, 40 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景
