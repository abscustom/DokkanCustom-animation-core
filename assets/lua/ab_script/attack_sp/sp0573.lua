...
-- ** 書き文字エントリー ** --
ctgogo = entryEffectLife( spep_x + 16,  190006, 68, 0x100, -1, 0, 0.9, 515.5 ); --ゴゴゴ
setEffShake( spep_x + 16, ctgogo, 68, 10 );

setEffMoveKey( spep_x + 16, ctgogo, 0.9, 515.5 , 0 );
setEffMoveKey( spep_x + 84, ctgogo, 0.9, 515.5 , 0 );
...
-- ** 音 ** --
SE001 = playSe( spep_2 + 38 -10, 1109 );  --瞬間移動
