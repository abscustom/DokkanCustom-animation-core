--1023290:SSR_超サイヤ人3ゴハンクス(ゼノ)_必殺技：超爆裂砲火斬
--sp_effect_a1_00326
--sp2289
...
--エフェクト(味方)
SP_01  = 158542; -- 登場〜構えて気弾溜め (ef_001)
SP_02  = 158544; --	気弾を放つ (ef_002)
SP_03  = 158546; --	決めゼリフ時_集中線 (ef_003)
SP_04  = 158547; --	決めゼリフ時_ポーズ (ef_004)
SP_05  = 158548; --	突進して斬撃 (ef_005)

--エフェクト(敵)
SP_01x = 158543; --	登場〜構えて気弾溜め：敵側反転 (ef_001r)
SP_02x = 158545; --	気弾を放つ：敵側反転 (ef_002r)
SP_03x = 158546; --	決めゼリフ時_集中線 (ef_003)
SP_04x = 158547; --	決めゼリフ時_ポーズ (ef_004)
SP_05x = 158548; --	突進して斬撃 (ef_005)
...
-- ** 音 ** --
--気溜め
playSe( spep_0 +0, 1151 );

--気溜め
SE0 = playSe( spep_0 +2, 1186 );
...
--気溜め
SE0X1 = playSe( spep_0 +6, 1020 );
setSeVolume( spep_0 +6, 1020, 75);

--気溜め
SE1 = playSe( spep_0 +10, 1175 );
...
--気溜め
SE0X2 = playSe( spep_0 +24, 1020 );
setSeVolume( spep_0 +24, 1020, 75);

--腕を振り下ろす
SE2 = playSe( spep_0 +34, 1003 );
...
-- ** 音 ** --
--気溜め
playSe( spep_0 +46, 1020 );
setSeVolume( spep_0 +46, 1020, 75);

--気溜め
playSe( spep_0 +68, 1020 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
kidan_f = entryEffect( spep_1 + 0, SP_02, 0x100, -1, 0, 0, 0 );  --気弾を放つ(ef_002)
...
-- ** エフェクト等 ** --
kidan_b = entryEffect( spep_1 + 0, SP_03, 0x80, -1, 0, 0, 0 );  --決めゼリフ時_集中線(ef_003)
...
--気弾３連
playSe( spep_1 +34, 1002 );

--気弾３連
playSe( spep_1 +50, 1002 );

--気弾３連
playSe( spep_1 +64, 1002 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
tame = entryEffect( spep_2 + 0, SP_04, 0x100, -1, 0, 0, 0 );  --決めゼリフ時_ポーズ(ef_004)
...
------------------------------------------------------
-- ** エフェクト等 ** --
zangeki = entryEffect( spep_4 + 0, SP_05, 0x80, -1, 0, 0, 0 );  --突進して斬撃(ef_005)
...
-- ** 音 ** --
--ダッシュ
SE3 = playSe( spep_4 +0, 8 );
stopSe( spep_4 +56, SE3, 0 );

--ダッシュ
SE4 = playSe( spep_4 +12, 44 );
stopSe( spep_4 +56, SE4, 0 );

--剣攻撃
playSe( spep_4 +56, 1032 );
setSeVolume( spep_4 +56, 1032, 65 );

--剣攻撃
playSe( spep_4 +56, 1061 );
setSeVolume( spep_4 +56, 1061, 85 );

--剣攻撃
playSe( spep_4 +70, 1141 );
...
-- ** エフェクト等 ** --
tame_a = entryEffect( spep_0 + 0, SP_01x, 0x100, -1, 0, 0, 0 );  --登場〜構えて気弾溜め(ef_001)
setEffMoveKey( spep_0 + 0, tame_a, 0, 0 , 0 );
setEffMoveKey( spep_0 + 80, tame_a, 0, 0 , 0 );
setEffScaleKey( spep_0 + 0, tame_a, 1.0, 1.0 );
setEffScaleKey( spep_0 + 80, tame_a, 1.0, 1.0 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
kidan_f = entryEffect( spep_1 + 0, SP_02x, 0x100, -1, 0, 0, 0 );  --登場〜構えて気弾溜め(ef_002r)
setEffMoveKey( spep_1 + 0, kidan_f, 0, 0 , 0 );
setEffMoveKey( spep_1 + 100, kidan_f, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, kidan_f, 1.0, 1.0 );
setEffScaleKey( spep_1 + 100, kidan_f, 1.0, 1.0 );
...
-- ** エフェクト等 ** --
kidan_b = entryEffect( spep_1 + 0, SP_03x, 0x80, -1, 0, 0, 0 );  --決めゼリフ時_集中線(ef_003)
setEffMoveKey( spep_1 + 0, kidan_b, 0, 0 , 0 );
setEffMoveKey( spep_1 + 100, kidan_b, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, kidan_b, 1.0, 1.0 );
setEffScaleKey( spep_1 + 100, kidan_b, 1.0, 1.0 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
tame = entryEffect( spep_2 + 0, SP_04x, 0x100, -1, 0, 0, 0 );  --決めゼリフ時_ポーズ(ef_004)
setEffMoveKey( spep_2 + 0, tame, 0, 0 , 0 );
setEffMoveKey( spep_2 + 100, tame, 0, 0 , 0 );
setEffScaleKey( spep_2 + 0, tame, -1.0, 1.0 );
setEffScaleKey( spep_2 + 100, tame, -1.0, 1.0 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
zangeki = entryEffect( spep_4 + 0, SP_05x, 0x80, -1, 0, 0, 0 );  --突進して斬撃(ef_005)
setEffMoveKey( spep_4 + 0, zangeki, 0, 0 , 0 );
setEffMoveKey( spep_4 + 120, zangeki, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, zangeki, -1.0, 1.0 );
setEffScaleKey( spep_4 + 120, zangeki, -1.0, 1.0 );
