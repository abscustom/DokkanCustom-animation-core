...
SE003 = playSe( spep_5+21, 1009);
SE004 = playSe( spep_5+41, 1010);
SE005 = playSe( spep_5+57, 1010);
SE006 = playSe( spep_5+85, 1010);
...
-- ** 集中線 ** --
shuchusenz = entryEffectLife( spep_6 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_6 + 0, shuchusenz, 90, 20 );
setEffMoveKey( spep_6 + 0, shuchusenz, 0, 0 , 0 );
setEffMoveKey( spep_6 + 90, shuchusenz, 0, 0 , 0 );
setEffScaleKey( spep_6 + 0, shuchusenz, 1.6, 1.6 );
setEffScaleKey( spep_6 + 90, shuchusenz, 1.6, 1.6 );
setEffRotateKey( spep_6 + 0, shuchusenz, 0 );
setEffRotateKey( spep_6 + 90, shuchusenz, 0 );
setEffAlphaKey( spep_6 + 0, shuchusenz, 255 );
setEffAlphaKey( spep_6 + 90, shuchusenz, 255 );
