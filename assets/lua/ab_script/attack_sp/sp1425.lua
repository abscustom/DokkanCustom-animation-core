...
se_1020_2 = playSe( spep_0 + 199, 1020 );
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge - 12, SE_0005, 0 );
    stopSe( SP_dodge - 12, se_1231, 0 );
    stopSe( SP_dodge - 12, se_1020_1, 0 );
    stopSe( SP_dodge - 12, se_1020_2, 0 );
