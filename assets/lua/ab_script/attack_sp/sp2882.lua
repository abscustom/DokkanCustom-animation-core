--4022430(エネミーID未定):UR_超サイヤ人4ゴジータ_必殺技B：分身かめはめ波_エネミー側
--sp_effect_a1_00495
--sp2882
...
--エフェクト(敵)
SP_01r  = 163975;  --ef_001r 登場〜瞬間移動〜敵蹴り落とす
SP_01b  = 163976;  --ef_001b 登場〜瞬間移動〜敵蹴り落とす
SP_02r  = 163977;  --ef_002r 敵墜落〜分身〜クラッカー〜笑う
SP_02b  = 163978;  --ef_002b 敵墜落〜分身〜クラッカー〜笑う
...
-- ** エフェクト等 ** --
finish_f = entryEffect( spep_2 + 0, SP_02r, 0x100, -1, 0, 0, 0); -- 敵墜落〜分身〜クラッカー〜笑う(ef_002r)
...
finish_b = entryEffect( spep_2 + 0, SP_02b, 0x80, -1, 0, 0, 0); -- 敵墜落〜分身〜クラッカー〜笑う(ef_002b)
...
--画面遷移
SE034 = playSeVer2( spep_2 + 290, 1232, "", 0, 0, 0, -1);

--環境音
SE035 = playSeVer2( spep_2 + 290, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 290, SE035, 25 );

--クラッカーなる
SE036 = playSeVer2( spep_2 + 328, 1028, "", 0, 0, 0, -1);
SE037 = playSeVer2( spep_2 + 328, 1030, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_2 + 340, 1029, "", 0, 0, 0, -1);
SE039 = playSeVer2( spep_2 + 340, 1013, "",spep_2 + 358, 0, 6, -1);
SE040 = playSeVer2( spep_2 + 346, 1029, "", 0, 0, 0, -1);
SE041 = playSeVer2( spep_2 + 346, 1013, "",spep_2 + 362, 0, 4, -1);

--笑う
SE042 = playSeVer2( spep_2 + 386, 37, "",spep_2 + 422, 0, 10, -1);
SE043 = playSeVer2( spep_2 + 386, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 386, SE043, 81 );
SE044 = playSeVer2( spep_2 + 394, 37, "",spep_2 + 430, 0, 10, -1);
SE045 = playSeVer2( spep_2 + 394, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 394, SE045, 65 );
SE046 = playSeVer2( spep_2 + 418, 4, "", 0, 0, 0, -1);
SE047 = playSeVer2( spep_2 + 440, 4, "", 0, 0, 0, -1);
SE048 = playSeVer2( spep_2 + 462, 4, "", 0, 0, 0, -1);
SE049 = playSeVer2( spep_2 + 480, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 480, SE049, 79 );
SE050 = playSeVer2( spep_2 + 498, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 498, SE050, 71 );
SE051 = playSeVer2( spep_2 + 518, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 518, SE051, 63 );
SE052 = playSeVer2( spep_2 + 536, 4, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 536, SE052, 56 );

-- ** ダメージ表示 ** --
dealDamage( spep_2 + 420 ); -- ダメージ表示フレーム
endPhase( spep_2 + MAX_FRAME_2 -4 ); -- 終了フレーム  580f -4
