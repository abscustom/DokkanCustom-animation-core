...
-- ** 集中線 ** --
shuchusenz = entryEffectLife( spep_4 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_4 + 0, shuchusenz, 90, 20 );
setEffMoveKey( spep_4 + 0, shuchusenz, 0, 0 , 0 );
setEffMoveKey( spep_4 + 90, shuchusenz, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, shuchusenz, 1.6, 1.6 );
setEffScaleKey( spep_4 + 90, shuchusenz, 1.6, 1.6 );
setEffRotateKey( spep_4 + 0, shuchusenz, 0 );
setEffRotateKey( spep_4 + 90, shuchusenz, 0 );
setEffAlphaKey( spep_4 + 0, shuchusenz, 255 );
setEffAlphaKey( spep_4 + 90, shuchusenz, 255 );
...
-- 書き文字エントリー
ctgogo = entryEffectLife( spep_6+90, 190006, 70, 0x100, -1, 0, -100, 500);    -- ゴゴゴゴ
