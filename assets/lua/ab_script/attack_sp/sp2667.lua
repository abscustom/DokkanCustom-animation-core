...
entryFade( 570 + 0, 0, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  -- white fade カットインタイミングをムービーに合わせるため
...
-- ** エフェクト等 ** --
SP_02 = entryEffect( spep_2 + 0 -2, SP_002, 0x100, -1, 0, 0, 0 );
setEffMoveKey( spep_2 + 0 -2, SP_02, 0, 0 , 0 );
setEffMoveKey( spep_2 + MAX_FRAME_2 -2, SP_02, 0, 0 , 0 );
setEffScaleKey( spep_2 + 0 -2, SP_02, 1.0, 1.0 );
setEffScaleKey( spep_2 + MAX_FRAME_2 -2, SP_02, 1.0, 1.0 );
setEffRotateKey( spep_2 + 0 -2, SP_02, 0 );
setEffRotateKey( spep_2 + MAX_FRAME_2 -2, SP_02, 0 );
setEffAlphaKey( spep_2 + 0 -2, SP_02, 255 );
setEffAlphaKey( spep_2 + MAX_FRAME_2 -2, SP_02, 255 );
...
changeAnime( spep_0 + 324 + OFFSET_X, 1,0 );
changeAnime( spep_0 + 364 + OFFSET_X, 1,2 );
changeAnime( spep_0 + 380 + OFFSET_X, 1,6 );
changeAnime( spep_0 + 402 + OFFSET_X, 1,8 );
changeAnime( spep_0 + 434 + OFFSET_X, 1,6 );
changeAnime( spep_0 + 470 + OFFSET_X, 1,8 );
changeAnime( spep_0 + 504 + OFFSET_X, 1,6 );
changeAnime( spep_0 + 536 + OFFSET_X, 1,8 );
