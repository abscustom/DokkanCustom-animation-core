...
-- 書き文字エントリー --
ctgogo = entryEffectLife( spep_3 + 12, 190006, 72, 0x100, -1, 0, -30, 520);    --ゴゴゴゴ

setEffMoveKey( spep_3 + 12, ctgogo, -30, 520, 0 );
setEffMoveKey( spep_3 + 84, ctgogo, -30, 520, 0 );
