-- 9029570: UR_ベジータ_アクティブ必殺技：汚い花火(敵側)
-- sp_effect_a9_00134
-- sp2761
...
-- 敵側
SP_01r = 163236; -- 前面 敵側 ef_001r
SP_01br = 163237; -- 背面 敵側 ef_001br
...
-- ** エフェクト等 ** --
base_0f = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0); -- 前面 敵側(ef_001r)
...
base_0b = entryEffect( spep_0 + 0, SP_01br, 0x80, -1, 0, 0, 0); -- 背面 敵側(ef_001br)
...
changeAnime( spep_0 + 276 + OFFSET_X, 1, 5 );
...
setSeVolumeByWorkId( spep_0 + 70, SE006, 71 );
...
setSeVolumeByWorkId( spep_0 + 76, SE008, 141 );
SE009 = playSeVer2( spep_0 + 76, 1188, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 76, SE009, 78 );

-- ** ボイス ** --
--「にがすか！！！！」
--SE_6_848 = playVoice( spep_0 + 20, 848 );
--setVoiceVolume( spep_0 + 20, 848, 110 );
