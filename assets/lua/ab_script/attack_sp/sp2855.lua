--1031180:UR_超サイヤ人ゴッドSS孫悟空(界王拳)_必殺技：界王拳 ゴッドかめはめ波
--sp_effect_a1_00485
--sp2855
...
--エフェクト(味方)
SP_01 = 163807;  -- 冒頭 ef_001
SP_02 = 163808;  -- 足元アップ〜フィニッシュ：前 ef_002
SP_02b = 163809;  -- 足元アップ〜フィニッシュ：後 ef_002b
...
--[[
-- ** エフェクト等 ** --
start_f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0); -- 冒頭(ef_001)
...
--オーラ
SE001 = playSeVer2( spep_0 + 0, 1181, "",spep_0 + 118, 0, 18, -1);
setSeVolumeByWorkId( spep_0 + 0, SE001, 126 );
SE002 = playSeVer2( spep_0 + 0, 1176, "",spep_0 + 118, 0, 16, -1);
...
setSeVolumeByWorkId( spep_0 + 66, SE007, 40 );
SE008 = playSeVer2( spep_0 + 90, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 90, SE008, 40 );
...
--向かっていく
SE010 = playSeVer2( spep_1 + 90, 1000, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_1 + 90, 1182, "", 0, 0, 0, -1);
...
--向かっていく
SE013 = playSeVer2( spep_2 + 14, 1277, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 14, SE013, 136 );
...
--パンチヒット
SE014 = playSeVer2( spep_2 + 48, 1009, "", 0, 0, 0, -1);
SE015 = playSeVer2( spep_2 + 48, 1187, "", 0, 0, 0, -1);

--オーラ
SE016 = playSeVer2( spep_2 + 48, 1176, "",spep_2 + 212, 0, 22, -1);
setSeVolumeByWorkId( spep_2 + 48, SE016, 50 );
SE017 = playSeVer2( spep_2 + 54, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 54, SE017, 40 );
SE018 = playSeVer2( spep_2 + 78, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 78, SE018, 40 );
SE019 = playSeVer2( spep_2 + 104, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 104, SE019, 40 );

--振りかぶる
SE020 = playSeVer2( spep_2 + 108, 1116, "",spep_2 + 150, 0, 18, -1);

--オーラ
SE021 = playSeVer2( spep_2 + 126, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 126, SE021, 40 );

--腹パン
SE022 = playSeVer2( spep_2 + 140, 1153, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 140, SE022, 80 );
SE023 = playSeVer2( spep_2 + 140, 1359, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 140, SE023, 80 );
SE024 = playSeVer2( spep_2 + 146, 1110, "", 0, 0, 0, -1);

--殴り飛ばす
SE025 = playSeVer2( spep_2 + 180, 1189, "", 0, 0, 0, -1);
SE026 = playSeVer2( spep_2 + 186, 1120, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 186, SE026, 80 );
SE027 = playSeVer2( spep_2 + 186, 1187, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 186, SE027, 80 );

--かめはめ波溜め
SE028 = playSeVer2( spep_2 + 284, 1210, "",spep_2 + 420, 20, 18, -1);
setStartTimeMs( SE028,  1567 );

--敵飛んでいく
SE029 = playSeVer2( spep_2 + 192, 1427, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 192, SE029, 71 );
SE030 = playSeVer2( spep_2 + 192, 1121, "",spep_2 + 368, 0, 110, -1);
setSeVolumeByWorkId( spep_2 + 192, SE030, 63 );

--オーラ
SE031 = playSeVer2( spep_2 + 242, 1176, "",spep_2 + 430, 0, 22, -1);
setSeVolumeByWorkId( spep_2 + 242, SE031, 50 );
SE032 = playSeVer2( spep_2 + 250, 1036, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 250, SE032, 40 );

--足踏み込む
SE033 = playSeVer2( spep_2 + 264, 1192, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 264, SE033, 168 );

--オーラ
SE034 = playSeVer2( spep_2 + 274, 1036, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 274, SE034, 40 );

--かめはめ波溜め
SE035 = playSeVer2( spep_2 + 284, 1209, "", 0, 0, 0, -1);

--オーラ
SE036 = playSeVer2( spep_2 + 298, 1036, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 298, SE036, 40 );
SE037 = playSeVer2( spep_2 + 322, 1036, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 322, SE037, 40 );
SE038 = playSeVer2( spep_2 + 346, 1036, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 346, SE038, 40 );
SE039 = playSeVer2( spep_2 + 370, 1036, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 370, SE039, 40 );
SE040 = playSeVer2( spep_2 + 394, 1036, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 394, SE040, 40 );

--かめはめ波発射
SE041 = playSeVer2( spep_2 + 396, 1133, "", 0, 0, 0, -1);
SE042 = playSeVer2( spep_2 + 396, 1213, "", 0, 0, 0, -1);
SE043 = playSeVer2( spep_2 + 396, 1146, "", 0, 0, 0, -1);

--かめはめ波中
SE044 = playSeVer2( spep_2 + 450, 1211, "",spep_2 + 762, 0, 44, -1);
setSeVolumeByWorkId( spep_2 + 450, SE044, 232 );
SE045 = playSeVer2( spep_2 + 486, 1161, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 486, SE045, 79 );

--気弾ける
SE046 = playSeVer2( spep_2 + 504, 1068, "", 0, 0, 0, -1);

--敵ヒット
SE047 = playSeVer2( spep_2 + 610, 1258, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 610, SE047, 87 );
SE048 = playSeVer2( spep_2 + 618, 1159, "",spep_2 + 792, 0, 82, -1);
setSeVolumeByWorkId( spep_2 + 618, SE048, 76 );

--爆発
SE049 = playSeVer2( spep_2 + 702, 1023, "", 0, 0, 0, -1);
SE050 = playSeVer2( spep_2 + 714, 1067, "", 0, 0, 0, -1);

-- ** ダメージ表示 ** --
dealDamage( spep_2 + 720); -- ダメージ表示フレーム
endPhase( spep_2 + MAX_FRAME_2 -4); -- 838F
