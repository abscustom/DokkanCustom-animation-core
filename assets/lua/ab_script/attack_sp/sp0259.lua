...
------------------------------------------------------
-- ** カードカットイン ** --
speff2 = entryEffectLife( 170 , 1507, 90, 0x100, -1, 0, 0, 0 );   -- カード
...
entryFade( 462, 5,  7, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( SP_ATK_3+27, 9,  3, 10, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
