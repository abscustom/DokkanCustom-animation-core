...
-- ** 音 ** --
SE001 = playSe( spep_5,SE_06);--ビームを撃つ
SE002 = playSe( spep_5+62,SE_07);--ビームが強くなる
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe(SP_dodge-14,SE001,0);--音を止める ※止めたい音がある場合
    stopSe(SP_dodge-14,SE002,0);--音を止める ※止めたい音がある場合
