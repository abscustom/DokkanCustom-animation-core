--1011030：ハイパーメガリルド_ハイパーメガリルドパンチ
--sp_effect_a8_00026
--sp1103
...
-- ** 白フェード ** --
entryFade( spep_1 + 116, 0, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
spep_4=spep_3+120 ;
entryFade( spep_4-8, 5, 4, 8, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( spep_5-10, 4, 6, 8, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( spep_6-8, 5, 4, 8, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
