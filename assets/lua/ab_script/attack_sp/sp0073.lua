...
playSe( 170, SE_05);
speff = entryEffectLife( 170, 1507,  90, 0x100, -1,  0,  0,  0);   -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0);                         -- カード差し替え
setEffReplaceTexture( speff, 5, 4);                                  -- 技名テクスチャ差し替え

spname = entryEffectLife( 170, 1508,  90, 0x100, -1,  0,  0,  0);               -- かめはめ波文字
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え


-- ** 白フェード ** --
entryFade( 166 + 0, 0, 4, 2, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
setMoveKey(  300,    0,   -100,  0,   0);setVisibleUI(69, 0);
...
speff = entryEffectLife(  SP_ATK_1, 1507, 90, 0x100, -1, 0, 0, 0);   -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0);                         -- カード差し替え
setEffReplaceTexture( speff, 5, 4);                                  -- 技名テクスチャ差し替え
playSe( SP_ATK_1+22, SE_12);

spname = entryEffectLife( SP_ATK_1, 1508, 90, 0x100, -1, 0, 0, 0);               -- かめはめ波文字
setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え
