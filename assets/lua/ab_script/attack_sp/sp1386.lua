...
--アッパー
SE030_re = playSeVer2( spep_0 + 405, 1004, "", 0, 0, 0, -1);
SE031_re = playSeVer2( spep_0 + 409, 1116, "",spep_0 + 439, 0, 14, -1);
SE032_re = playSeVer2( spep_0 + 421, 1182, "",spep_0 + 445, 0, 14, -1);
setSeVolumeByWorkId( spep_0 + 421, SE032_re, 126 );
SE033_re = playSeVer2( spep_0 + 421, 1190, "", spep_0 + 474, 0, 10, -1);
SE034_re = playSeVer2( spep_0 + 421, 1156, "", spep_0 + 474, 0, 10, -1);
