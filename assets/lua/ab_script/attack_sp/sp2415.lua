...
--味方側
SP_01 = 160309;  --宇宙船が開きチライが登場    ef_001
SP_02 = 160310;  --チライが宇宙船から着地しっ画面に迫って走ってくる    ef_002
SP_03 = 160311;  --敵の背中に銃を突きつける    ef_003
SP_04 = 160312;  --敵の背中に銃を突きつける    ef_003_b
SP_05 = 160314;  --銃の発射準備  ef_004
SP_06 = 160315;  --銃の発射準備  ef_004_b
SP_07 = 160317;  --銃を撃つ前のチライのアップシーン    ef_005
SP_08 = 160319;  --銃を撃つ→敵が吹っ飛ぶ ef_006
SP_09 = 160320;  --銃を撃つ→敵が吹っ飛ぶ ef_006_b
SP_10 = 160322;  --チライのOKポーズをとってフィニッシュ ef_007

--敵側
SP_03r = 160313;  --敵の背中に銃を突きつける    ef_003r
SP_06r = 160316;  --銃の発射準備  ef_004_b_r
SP_07r = 160318;  --銃を撃つ前のチライのアップシーン    ef_005r
SP_09r = 160321;  --銃を撃つ→敵が吹っ飛ぶ ef_006_b_r
...
--画面遷移
SE024 = playSeVer2( spep_6 + 104, 8, "", 0, 0, 0, -1);
...
------------------------------------------------------
-- チライのOKポーズをとってフィニッシュ(116F)
------------------------------------------------------
--spep_7 = 0;

-- ** エフェクト等 ** --
finish = entryEffect( spep_7 + 0, SP_10, 0x100, -1, 0, 0, 0 );  --チライのOKポーズをとってフィニッシュ ef_007
setEffMoveKey( spep_7 + 0, finish, 0, 0 , 0 );
setEffMoveKey( spep_7 + 116, finish, 0, 0 , 0 );
setEffScaleKey( spep_7 + 0, finish, 1.0, 1.0 );
setEffScaleKey( spep_7 + 116, finish, 1.0, 1.0 );
setEffRotateKey( spep_7 + 0, finish, 0 );
setEffRotateKey( spep_7 + 116, finish, 0 );
setEffAlphaKey( spep_7 + 0, finish, 255 );
setEffAlphaKey( spep_7 + 116, finish, 255 );

-- ** 音 ** --
--OKポーズ
SE025 = playSeVer2( spep_7 + 34, 1003, "", 0, 0, 0, -1);

--最後決め
SE026 = playSeVer2( spep_7 + 54, 1042, "", 0, 0, 0, -1);
