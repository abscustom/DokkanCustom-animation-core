...
-- ** 集中線 ** --
shuchusenct = entryEffectLife( spep_2, 906, 94, 0x100,  -1, 0,  0,  0); -- 集中線ct
...
-- ** 白フェード
entryFade( spep_2+89, 3, 5, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam2 = entryEffect( spep_5, SP_04,   0x100, -1,  0,  0,  0);   -- 迫るかめはめ波
...
SP_dodge = spep_5 + 12; --エンドフェイズのフレーム数を置き換える
