...
ef_002 = 157031;    -- 発射
ef_003 = 157032;    -- 命中
ef_003_1 = 157033;  -- 命中（流線）
ef_004 = 157034;    -- カードカットイン
ef_005 = 157089;    -- カードカットイン極限１
ef_006 = 157090;    -- カードカットイン極限２
-- ef_004 = 
ef_101 = 157035;    -- 敵側　溜め
ef_102 = 157036;    -- 敵側　発射
...
playSe( spep_1, SE_05);
cutin_1 = entryEffectLife( spep_1 + 0, ef_004, 92, 0x100, -1, 0, 0, 0 );
setEffMoveKey( spep_1 + 0, cutin_1, 0, 0 , 0 );
setEffMoveKey( spep_1 + 92, cutin_1, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, cutin_1, 1.0, 1.0 );
setEffScaleKey( spep_1 + 92, cutin_1, 1.0, 1.0 );
setEffRotateKey( spep_1 + 0, cutin_1, 0 );
setEffRotateKey( spep_1 + 92, cutin_1, 0 );
setEffAlphaKey( spep_1 + 0, cutin_1, 255 );
setEffAlphaKey( spep_1 + 92, cutin_1, 255 );

elseif(_SPECIAL_SKILL_LEVEL_ == 1) then
print ("_SPECIAL_SKILL_LEVEL_ == 1");
playSe( spep_1, SE_05);
cutin_2 = entryEffectLife( spep_1 + 0, ef_005, 92, 0x100, -1, 0, 0, 0 );
setEffMoveKey( spep_1 + 0, cutin_2, 0, 0 , 0 );
setEffMoveKey( spep_1 + 92, cutin_2, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, cutin_2, 1.0, 1.0 );
setEffScaleKey( spep_1 + 92, cutin_2, 1.0, 1.0 );
setEffRotateKey( spep_1 + 0, cutin_2, 0 );
setEffRotateKey( spep_1 + 92, cutin_2, 0 );
setEffAlphaKey( spep_1 + 0, cutin_2, 255 );
setEffAlphaKey( spep_1 + 92, cutin_2, 255 );

elseif(_SPECIAL_SKILL_LEVEL_ == 2) then
print ("_SPECIAL_SKILL_LEVEL_ == 2");
playSe( spep_1, SE_05);
cutin_3 = entryEffectLife( spep_1 + 0, ef_006, 92, 0x100, -1, 0, 0, 0 );
setEffMoveKey( spep_1 + 0, cutin_3, 0, 0 , 0 );
setEffMoveKey( spep_1 + 92, cutin_3, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, cutin_3, 1.0, 1.0 );
setEffScaleKey( spep_1 + 92, cutin_3, 1.0, 1.0 );
setEffRotateKey( spep_1 + 0, cutin_3, 0 );
setEffRotateKey( spep_1 + 92, cutin_3, 0 );
setEffAlphaKey( spep_1 + 0, cutin_3, 255 );
setEffAlphaKey( spep_1 + 92, cutin_3, 255 );
end
