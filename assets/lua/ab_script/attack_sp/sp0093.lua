...
kame_hand = entryEffect( 70, SP_01, 0x100,      -1,  0,  0 +30,  0);   -- 手のカメハメ波部
setEffMoveKey(70, kame_hand, 0 +30, 0, 0 );
setEffMoveKey(110, kame_hand, 0 +30, 0, 0 );
setEffMoveKey(118, kame_hand, 0 +30, 0+20, 0 );
setEffMoveKey(170, kame_hand, 0 +30, 0+20, 0 );
...
setEffMoveKey( 90, ct, -220, 250 , 0 );
setEffMoveKey( 130, ct, -220, 250 , 0 );
...
SE006 = playSe( SP_ATK_2+90, SE_06);
