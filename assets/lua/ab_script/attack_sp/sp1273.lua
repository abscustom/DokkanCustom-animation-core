...
--SE
SE004 = playSe( spep_0 + 28, SE_04 );  --ゴゴゴ
SE043 = playSe( spep_0 + 118, 43 );  --瞬間移動
...
--SE
SE043_2 = playSe( spep_1 + 20, 43 );  --瞬間移動
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe(SP_dodge-14,SE043,0);
    stopSe(SP_dodge-14,SE043_2,0);
