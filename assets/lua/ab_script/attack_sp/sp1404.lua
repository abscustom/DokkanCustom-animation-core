...
--ブロリー突進
SE01 = playSe( spep_0 + 85, 44 ); 
SE02 = playSe( spep_0 + 85, 1182 ); 
...
SE03 = playSe( spep_0 + 117, 1003 ); 
setSeVolume( spep_0 + 117, 1003, 63 );
SE04 = playSe( spep_0 + 120, 4 ); 
SE05 = playSe( spep_0 + 123, 1106 ); 
setSeVolume( spep_0 + 123, 1106, 178 );
SE06 = playSe( spep_0 + 129, 1111 ); 
setSeVolume( spep_0 + 129, 1111, 79 );
SE07 = playSe( spep_0 + 130, 1107 ); 
...
stopSe( SP_dodge - 12, SE07, 0 );
stopSe( SP_dodge - 12, SE08, 0 );
stopSe( SP_dodge - 12, SE09, 0 );
...
-- ** 音 ** --
--ブロリー止めに入る
stopSe( spep_c + 24, SE16, 0 );
--銃口が光る
playSe( spep_c + 7, 15 ); 
setSeVolume( spep_c + 7, 15, 0 );
playSe( spep_c + 88, 1042 ); 
