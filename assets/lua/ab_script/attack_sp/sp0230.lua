...
entryFade( 170 -6, 2, 6, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
entryFade( 255 -2, 3, 2+4+2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
kamehame_beam2 = entryEffect( 370, SP_03,   0x80, -1,  0,  160,  0, -1000);   -- 迫るかめはめ波
...
sen1 = entryEffectLife( 369, 921, 99, 0x80,  -1,  0,  0,  0, -2000); -- 流線斜め
