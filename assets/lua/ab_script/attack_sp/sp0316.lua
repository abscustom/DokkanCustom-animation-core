--1010160:魔人ベジータ_超必殺技：ファイナルエクスプロージョン
--sp_effect_a7_00015
--sp0316
...
start_b = entryEffect( 0,   SP_03,   0x40+0x100,   0,  300,  0, 200);--煙手前(ループ)
setEffScaleKey( 0, start_b, 1.1, 1.0);
setEffScaleKey( 100, start_b, 1.1, 1.0);
...
start2_b = entryEffect( spep_1,   SP_03,   0x40+0x100,   0,  300,  0, 200);--煙手前(ループ)
setEffScaleKey( 0, start2_b, 1.1, 1.0);
setEffScaleKey( 100, start2_b, 1.1, 1.0);
...
entryFade( spep_2+93, 3, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE002 =  playSe( spep_4+60, 1060);--320
...
iwas = entryEffect( spep_6+1, SP_13, 0,  -1,  0,  0,  0);   -- 小さい岩が上昇
...
bejita = entryEffect( spep_2, SP_08r, 0,  -1,  0,  0,  0); 
...
-- ** 音 ** --
SE_CUTIN = playSe( spep_3 + 0, SE_05 );
...
shuchusen = entryEffect( SP_ATK_4, 906, 0x00,  -1, 0,  0,  0);   -- 集中線
