...
-- ** 集中線 ** --
shuchusen2 = entryEffectLife( spep_x + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_x + 0, shuchusen2, 90, 20 );

setEffMoveKey( spep_x + 0, shuchusen2, 0, 0 , 0 );
setEffMoveKey( spep_x + 90, shuchusen2, 0, 0 , 0 );

setEffScaleKey( spep_x + 0, shuchusen2, 1.6, 1.6 );
setEffScaleKey( spep_x + 90, shuchusen2, 1.6, 1.6 );

setEffRotateKey( spep_x + 0, shuchusen2, 0 );
setEffRotateKey( spep_x + 90, shuchusen2, 0 );

setEffAlphaKey( spep_x + 0, shuchusen2, 255 );
setEffAlphaKey( spep_x + 90, shuchusen2, 255 );
...
-- ** 次の準備 ** --
entryFade( spep_x + 80, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
-- ** エフェクト等 ** --
...
SE001 = playSe( 375, SE_07);

SE002 = playSe( 535, SE_07);
