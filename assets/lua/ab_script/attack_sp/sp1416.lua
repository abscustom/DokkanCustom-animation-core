...
-- ** 音 ** --
SE_1035 = playSe( spep_0 + 0, 1035 );
SE_1018 = playSe( spep_0 + 12, 1018 );
playSe( spep_0 + 35, 1036 );
playSe( spep_0 + 59, 1036 );
playSe( spep_0 + 83, 1036 );
SE_1036_02 = playSe( spep_0 + 107, 1036 );
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge - 12, SE_1035, 0 );
    stopSe( SP_dodge - 12, SE_1018, 0 );
    stopSe( SP_dodge - 12, SE_1036_02, 0 );
