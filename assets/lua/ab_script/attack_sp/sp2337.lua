--1022350:悟空＆ベジータ_かめはめ波＆ビッグ・バン・アタック
--sp_effect_a1_00342
...
SP_03 = 159078;--ベジータ放ち
SP_04 = 159080;--悟空瞬間移動
SP_05 = 159082;--かめはめ波正面
SP_06 = 159083;--爆発


SP_01r = 159075;--溜め
SP_02r = 159077;--構え
SP_03r = 159079;--ベジータ放ち
SP_04r = 159081;--悟空瞬間移動
SP_05r = 159082;--かめはめ波正面
SP_06r = 159083;--爆発
...
-- 書き文字エントリー --
gogogo = entryEffectLife( spep_1+14, 190006, 70, 0x100, -1, 0, 80, 500); -- ゴゴゴゴゴ
...
SE002 = playSe( spep_3+96, SE_09); -- ヒット音
...
-- 書き文字エントリー --
gogogo = entryEffectLife( spep_1+14, 190006, 70, 0x100, -1, 0, 80, 450); -- ゴゴゴゴゴ
setEffScaleKey( spep_1+14, gogogo, -0.8, 0.8);
setEffAlphaKey( spep_1+14, gogogo, 255);
