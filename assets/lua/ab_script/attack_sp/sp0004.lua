...
setMoveKey(  SP_ATK_2+80,    0,   -1100,  0,   -20);
...
SE006 = playSe( SP_ATK_3+12, SE_01);
...
SE007 = playSe( SP_ATK_3+27, SE_09);
...
SP_dodge = 186; --エンドフェイズのフレーム数を置き換える
