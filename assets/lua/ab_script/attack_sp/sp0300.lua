...
SE003 = playSe( spep_5, SE_04);
SE004 = playSe( spep_5+80, SE_10);
...
entryFade( spep_5+105 -2, 4,  14, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
