...
entryFade( 60, 6, 10, 5, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
...
playSe( spep_a, SE_05);
speff = entryEffect( spep_a, 1507, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( spep_a, SE_05);
speff = entryEffect( spep_a, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( spep_a, SE_05);
speff = entryEffect( spep_a, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
...
-- ** 集中線 ** --
shuchusen = entryEffectLife( spep_a + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_a + 0, shuchusen, 90, 20 );

setEffMoveKey( spep_a + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( spep_a + 90, shuchusen, 0, 0 , 0 );

setEffScaleKey( spep_a + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( spep_a + 90, shuchusen, 1.6, 1.6 );

setEffRotateKey( spep_a + 0, shuchusen, 0 );
setEffRotateKey( spep_a + 90, shuchusen, 0 );

setEffAlphaKey( spep_a + 0, shuchusen, 255 );
setEffAlphaKey( spep_a + 90, shuchusen, 255 );
