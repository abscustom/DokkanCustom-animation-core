...
SE_0007_01 = playSe( SP_start+ 265, SE_07);
...
SE_0007_02 = playSe( SP_start+ 300, SE_07);
...
SE_0006 = playSe( SP_start+ 390, SE_06);
...
SE_0009 = playSe( SP_start+ 455, SE_09);
-- 敵吹っ飛ぶモーション
...
entryFade( SP_start+ 462, 6, 11, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
stopSe( SP_dodge - 12, SE_0007_01, 0);
stopSe( SP_dodge - 12, SE_0007_02, 0);
stopSe( SP_dodge - 12, SE_0006, 0);
...
-- ** 白背景 ** --
entryFadeBg( SP_start+  170 + 0, 0, 96, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景
