...
speff_1 = entryEffect(  90,   1505,   0,     -1,  0,  0,  0);   -- eff_006 (セリフ)
setEffReplaceTexture( speff_1, 4, 5);                           -- セリフ差し替え
...
SE1=playSe( spep_2 , 1003);
gogo = playSe( spep_2+53, 1044);
SE2=playSe( spep_2+54 , SE_06);
