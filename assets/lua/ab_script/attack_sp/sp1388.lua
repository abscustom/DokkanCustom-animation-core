--4017970:超サイヤ人ゴッドSSゴジータ_スターダストフォール
...
-- ** 音 ** --
--ゴゴゴ
SE0_1 = playSe( spep_x + 16, 1018 ); 

--気溜め
SE0_2 = playSe( spep_0 + 4, 1035 );
setSeVolume( spep_0 + 4, 1035, 110 );
SE0_3 =playSe( spep_0 + 4, 1024 );
setSeVolume( spep_0 + 4, 1024, 89 );
SE0_4 = playSe( spep_0 + 4, 9 );
...
stopSe(SP_dodge - 12, SE0_1, 0 );
stopSe(SP_dodge - 12, SE0_2, 0 );
stopSe(SP_dodge - 12, SE0_3, 0 );
stopSe(SP_dodge - 12, SE0_4, 0 );
...
-- ** 音 ** --
--初撃パンチ
SE009 = playSeVer2( spep_0 + 126, 1126, "",spep_0 + 258, 6, 98, -1);	
setSeVolumeByWorkId( spep_0 + 126, SE009, 16 );	
setStartTimeMs( SE009,  550 );
SE010 = playSeVer2( spep_0 + 112, 1189, "", 0, 0, 0, -1);	
setSeVolumeByWorkId( spep_0 + 112, SE010, 112 );	
SE011 = playSeVer2( spep_0 + 126, 22, "", 0, 6, 0, -1);	
setSeVolumeByWorkId( spep_0 + 126, SE011, 99 );	
setStartTimeMs( SE011,  217 );
SE012 = playSeVer2( spep_0 + 118, 1120, "", 0, 0, 0, -1);	
setSeVolumeByWorkId( spep_0 + 118, SE012, 80 );	
SE013 = playSeVer2( spep_0 + 118, 1190, "",spep_0 + 196, 0, 61, -1);	
setSeVolumeByWorkId( spep_0 + 118, SE013, 112 );	
...
--叩き落とし
SE033 = playSe( spep_1 + 247, 1014 );
setSeVolume( spep_1 +  247, 1014, 81 );
SE034 = playSe( spep_1 + 249, 1187 );
setSeVolume( spep_1 +  249, 1187, 81 );
SE035 = playSe( spep_1 + 249, 1159 );
...
stopSe( spep_2 + 0, SE033, 10 );
stopSe( spep_2 + 0, SE034, 10 );
stopSe( spep_2 + 0, SE035, 10 );
...
-- ** 音 ** --
--スターダストフォール
SE045 = playSeVer2( spep_4 + 2, 1406, "",0, 0, 0, -1);
setSeVolumeByWorkId( spep_4 + 2, SE045, 100 );
