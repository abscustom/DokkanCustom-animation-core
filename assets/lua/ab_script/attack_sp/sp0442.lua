...
-- 書き文字エントリー
ctgogo = entryEffectLife( spep5+33, 190006, 70, 0x100, -1, 0, 110,530, 0);    -- ゴゴゴゴ
...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    playSe( spep6, SE_05);
    speff = entryEffect( spep6, 1120, 0, -1, 0, 0, 0); -- カード
    setEffReplaceTexture( speff, 1, 1);
    setEffReplaceTexture( speff, 2, 0); -- カード差し替え
    setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
    ...
    playSe( spep6, SE_05);
    speff = entryEffect( spep6, 1121, 0, -1, 0, 0, 0); -- カード
    setEffReplaceTexture( speff, 1, 1);
    setEffReplaceTexture( speff, 2, 0); -- カード差し替え
    setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
    end
    
    shuchusen = entryEffectLife( spep6, 906, 90, 0x100,  -1, 0,  0,  0);  --集中線
    
    setEffMoveKey(  spep6,  shuchusen,  0,  0);
    setEffScaleKey(  spep6,  shuchusen,  1.0,  1.0);
    setEffRotateKey(  spep6,  shuchusen,  0);
    setEffAlphaKey(  spep6,  shuchusen,  255);
    setEffMoveKey(  spep6+90,  shuchusen,  0,  0);
    setEffScaleKey(  spep6+90,  shuchusen,  1.0,  1.0);
    setEffRotateKey(  spep6+90,  shuchusen,  0);
    setEffAlphaKey(  spep6+90,  shuchusen,  255);
