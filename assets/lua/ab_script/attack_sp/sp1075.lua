...
-- ** 白フェード ** --
entryFade( SP_long+SP_start+ 169, 0, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( SP_long+SP_start+ 253, 6, 6, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
entryFade( SP_long+SP_start+ 255, 3, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
