...
entryFade( 106, 3, 11, 2, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
stopSe( SP_dodge - 6, SE01, 0);
stopSe( SP_dodge + 6, SE02, 0);
stopSe( SP_dodge - 6, SE03, 0);
