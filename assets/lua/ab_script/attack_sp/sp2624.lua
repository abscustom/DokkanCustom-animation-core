--1027580:LR_ピラフ&シュウ&マイ_必殺技：ローリングスマッシュ
--sp_effect_a9_00112
--sp2624
...
base_0b = entryEffect( spep_0 + 0, SP_01b, 0x80, -1, 0, 0, 0); -- ef_001
...
--指さす
SE006 = playSeVer2( spep_0 + 64, 1045, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 64, SE006, 93 );
SE007 = playSeVer2( spep_0 + 64, 1170, "", 0, 0, 0, -1);

--飛び上がる
SE008 = playSeVer2( spep_0 + 152, 1012, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 152, 1027, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_0 + 152, 1152, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 152, SE010, 71 );
SE011 = playSeVer2( spep_0 + 152, 1326, "",spep_0 + 214, 0, 34, -1);
...
-- ** 音 ** --
--まるくなる
SE012 = playSeVer2( spep_0 + 196, 1260, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 196, SE012, 135 );
SE013 = playSeVer2( spep_0 + 204, 1151, "", 0, 0, 0, -1);

--飛んでいく
SE014 = playSeVer2( spep_0 + 234, 1027, "",spep_0 + 266, 0, 8, -1);
SE015 = playSeVer2( spep_0 + 234, 1193, "",spep_0 + 266, 0, 8, -1);
SE016 = playSeVer2( spep_0 + 234, 1121, "",spep_0 + 266, 0, 8, -1);
...
-- ** 音 ** --
--回転しながら飛んでくる
SE018 = playSeVer2( spep_1 + 0, 1182, "", spep_1 + 90, 0, 10, -1);
SE021 = playSeVer2( spep_1 + 0, 1326, "",spep_1 + 116, 0, 16, -1);
setSeVolumeByWorkId( spep_1 + 0, SE021, 94 );
SE022 = playSeVer2( spep_1 + 0, 1399, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 0, SE022, 153 );
SE023 = playSeVer2( spep_1 + 24, 1167, "", 0, 0, 0, 0.5);
setSeVolumeByWorkId( spep_1 + 24, SE023, 49 );
setTimeStretch( SE023, 1.4, 30, 4 );
SE019 = playSeVer2( spep_1 + 0, 1409, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 0, SE019, 237 );
SE020 = playSeVer2( spep_1 + 0, 1403, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 0, SE020, 176 );

--敵ヒット
SE024 = playSeVer2( spep_1 + 92, 1187, "", 0, 0, 0, -1);
SE025 = playSeVer2( spep_1 + 92, 1120, "", 0, 0, 0, -1);

--画面割れる
SE026 = playSeVer2( spep_1 + 116, 1054, "", 0, 0, 0, -1);
SE027 = playSeVer2( spep_1 + 116, 1025, "", 0, 0, 0, -1);
...
base_0b = entryEffect( spep_0 + 0, SP_01br, 0x80, -1, 0, 0, 0); -- ef_001
setEffMoveKey( spep_0 + 0, base_0b, 0, 0 , 0);
setEffMoveKey( spep_0 + MAX_FRAME_0, base_0b, 0, 0 , 0);
setEffScaleKey( spep_0 + 0, base_0b, -1.0, 1.0);
setEffScaleKey( spep_0 + MAX_FRAME_0, base_0b, -1.0, 1.0);
