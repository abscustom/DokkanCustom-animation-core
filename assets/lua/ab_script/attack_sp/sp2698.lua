--4028390:LR_ガンマ1号&ガンマ2号/ガンマ1号_フィニッシュ：決死の全エネルギー放出（エネミー側）
--sp_effect_a9_00121
--sp2698
...
--エフェクト(味方)
SP_01  = 162677; -- ef_001
SP_01b = 162678; -- ef_001b

--エフェクト(てき)
SP_01r  = 162693; -- ef_001r
...
base_b = entryEffect( spep_0 + 0, SP_01b, 0x80, -1, 0, 0, 0 ); --敵よりも背面 (ef_001b)
...
setMoveKey( spep_0 + 396 + OFFSET_X, 1, 140.9, 105.8 , 0 );

setScaleKey( spep_0 + 346 + OFFSET_X, 1, 0.8, 0.8 );
setScaleKey( spep_0 + 396 + OFFSET_X, 1, 0.8, 0.8 );

setRotateKey( spep_0 + 346 + OFFSET_X, 1, -9.3 );
setRotateKey( spep_0 + 396 + OFFSET_X, 1, -9.3 );
...
setMoveKey( spep_0 + 562 + OFFSET_X, 1, 20, -19.8 , 0 );
...
setScaleKey( spep_0 + 562 + OFFSET_X, 1, 1.21, 1.21 );

setRotateKey( spep_0 + 526 + OFFSET_X, 1, -9.3 );
setRotateKey( spep_0 + 562 + OFFSET_X, 1, -9.3 );
...
-- ** ダメージ表示 ** --
-- hideKoScreen();
dealDamage( spep_0 + 1156 );
endPhase( spep_0 + MAX_FRAME_0 ); -- 1256
...
-- ** エフェクト等 ** --
base_f = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0 ); --敵よりも前面 (ef_001)
setEffMoveKey( spep_0 + 0, base_f, 0, 0 , 0 );
setEffMoveKey( spep_0 + MAX_FRAME_0, base_f, 0, 0 , 0 );
setEffScaleKey( spep_0 + 0, base_f, -1.0, 1.0 );
setEffScaleKey( spep_0 + MAX_FRAME_0, base_f, -1.0, 1.0 );
...
changeAnime( spep_0 + 346 + OFFSET_X, 1, 17 );
...
changeAnime( spep_0 + 526 + OFFSET_X, 1, 18 );
...
changeAnime( spep_0 + 620 + OFFSET_X, 1, 18 );
