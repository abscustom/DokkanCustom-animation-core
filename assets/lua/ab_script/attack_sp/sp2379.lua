...
--エフェクト(味方)
SP_01 = 159811; --	開幕ダッシュ	ef_001
SP_01b = 159812; --	開幕ダッシュ　裏	ef_001_back
SP_02 = 159815; --	ジャコ跳躍	ef_002
SP_02b = 159816; --	ジャコ跳躍　裏	ef_002_back
SP_03 = 159819; --	ジャコキック	ef_003
SP_03b = 159820; --	ジャコキック　裏	ef_003_back
SP_04 = 159823; --	ジャコビーム	ef_004
SP_04b = 159824; --	ジャコビーム　裏	ef_004_back
SP_05 = 159827; --	ジャコフィニッシュ	ef_005

--エフェクト(てき)
SP_01r = 159813; --	開幕ダッシュ　敵側	ef_001_re
SP_01br = 159814; --	開幕ダッシュ　敵側　裏	ef_001_back_re
SP_02r = 159817; --	ジャコ跳躍　敵側	ef_002_re
SP_02br = 159818; --	ジャコ跳躍　敵側　裏	ef_002_back_re
SP_03r = 159821; --	ジャコキック　敵側	ef_003_re
SP_03br = 159822; --	ジャコキック　敵側　裏	ef_003_back_re
SP_04r = 159825; --	ジャコビーム　敵側	ef_004_re
SP_04br = 159826; --	ジャコビーム　敵側　裏	ef_004_back_re
SP_05r = 159828; --	ジャコフィニッシュ　敵側	ef_005_re
...
-- setMoveKey( spep_2 -5 + 140, 1, -11.1, -134.1 , 0 );
...
setRotateKey( spep_2 -5 + 140, 1, -47 );


-- ** 音 ** --
--空中回転
SE020 = playSeVer2( spep_2 + 0, 1117, "", 0, 0, 0, -1);
SE021 = playSeVer2( spep_2 + 0, 1266, "",spep_2 + 200, 0, 66, -1);

--顔カットイン
SE022 = playSeVer2( spep_2 + 10, 1018, "", 0, 0, 0, -1);

--空中回転
SE023 = playSeVer2( spep_2 + 10, 1119, "", 0, 0, 0, -1);
...
-- ** 音 ** --
--背後から蹴る
SE025 = playSeVer2( spep_3 + 40, 1003, "", 0, 0, 0, -1);
SE026 = playSeVer2( spep_3 + 54, 1187, "",spep_3 + 124, 0, 10, -1);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_4f = entryEffect( spep_4 + 0, SP_04, 0x100, -1, 0, 0, 0); --ジャコビーム	ef_004
setEffMoveKey( spep_4 + 0, base_4f, 0, 0 , 0);
setEffMoveKey( spep_4 + 152 -4, base_4f, 0, 0 , 0);
setEffScaleKey( spep_4 + 0, base_4f, 1.0, 1.0);
setEffScaleKey( spep_4 + 152 -4, base_4f, 1.0, 1.0);
setEffRotateKey( spep_4 + 0, base_4f, 0);
setEffRotateKey( spep_4 + 152 -4, base_4f, 0);
setEffAlphaKey( spep_4 + 0, base_4f, 255);
setEffAlphaKey( spep_4 + 152 -5, base_4f, 255);
setEffAlphaKey( spep_4 + 152 -4, base_4f, 0);

base_4b = entryEffect( spep_4 + 0, SP_04b, 0x80, -1, 0, 0, 0); --ジャコビーム　裏	ef_004_back
setEffMoveKey( spep_4 + 0, base_4b, 0, 0 , 0);
setEffMoveKey( spep_4 + 152 -4, base_4b, 0, 0 , 0);
setEffScaleKey( spep_4 + 0, base_4b, 1.0, 1.0);
setEffScaleKey( spep_4 + 152 -4, base_4b, 1.0, 1.0);
setEffRotateKey( spep_4 + 0, base_4b, 0);
setEffRotateKey( spep_4 + 152 -4, base_4b, 0);
setEffAlphaKey( spep_4 + 0, base_4b, 255);
setEffAlphaKey( spep_4 + 152 -5, base_4b, 255);
setEffAlphaKey( spep_4 + 152 -4, base_4b, 0);

-- ** 黒背景 ** --
entryFadeBg( spep_4 + 0, 0, 152 -5, 0, 0, 0, 0, 255);  --黒　背景


-- ** 敵キャラクター ** --
setDisp( spep_4 -3 + 46, 1, 1 );
setDisp( spep_4 -4 + 152, 1, 0 );

changeAnime( spep_4 -3 + 0, 1, 108 );

setMoveKey( spep_4 -3 + 46, 1, -580, -53 , 0 );
setMoveKey( spep_4 -3 + 48, 1, -555.1, -53.1 , 0 );
setMoveKey( spep_4 -3 + 50, 1, -530.1, -53.2 , 0 );
setMoveKey( spep_4 -3 + 52, 1, -505.2, -53.3 , 0 );
setMoveKey( spep_4 -3 + 54, 1, -480.2, -53.4 , 0 );
setMoveKey( spep_4 -3 + 56, 1, -455.3, -53.5 , 0 );
setMoveKey( spep_4 -3 + 58, 1, -430.4, -53.7 , 0 );
setMoveKey( spep_4 -3 + 60, 1, -405.4, -53.8 , 0 );
setMoveKey( spep_4 -3 + 62, 1, -380.5, -53.9 , 0 );
setMoveKey( spep_4 -3 + 64, 1, -355.5, -54 , 0 );
setMoveKey( spep_4 -3 + 66, 1, -330.6, -54.1 , 0 );
setMoveKey( spep_4 -3 + 68, 1, -279.6, 5.8 , 0 );
setMoveKey( spep_4 -3 + 70, 1, -258.7, -106.4 , 0 );
setMoveKey( spep_4 -3 + 72, 1, -306.8, -80.5 , 0 );
setMoveKey( spep_4 -3 + 74, 1, -194.8, -54.6 , 0 );
setMoveKey( spep_4 -3 + 76, 1, -232.9, -33.7 , 0 );
setMoveKey( spep_4 -3 + 78, 1, -159.9, -38.8 , 0 );
setMoveKey( spep_4 -3 + 80, 1, -150, -87 , 0 );
setMoveKey( spep_4 -3 + 82, 1, -141.1, -39.1 , 0 );
setMoveKey( spep_4 -3 + 84, 1, -112.8, -44.5 , 0 );
setMoveKey( spep_4 -3 + 86, 1, -84.5, -50 , 0 );
setMoveKey( spep_4 -3 + 88, 1, -56.2, -55.4 , 0 );
setMoveKey( spep_4 -3 + 90, 1, -5.3, 4.5 , 0 );
setMoveKey( spep_4 -3 + 92, 1, 15.6, -107.7 , 0 );
setMoveKey( spep_4 -3 + 94, 1, -32.4, -81.8 , 0 );
setMoveKey( spep_4 -3 + 96, 1, 79.5, -55.9 , 0 );
setMoveKey( spep_4 -3 + 98, 1, 41.5, -35 , 0 );
setMoveKey( spep_4 -3 + 100, 1, 114.4, -40.1 , 0 );
setMoveKey( spep_4 -3 + 102, 1, 124.4, -88.2 , 0 );
setMoveKey( spep_4 -3 + 104, 1, 133.3, -40.4 , 0 );
setMoveKey( spep_4 -3 + 106, 1, 161.6, -45.8 , 0 );
setMoveKey( spep_4 -3 + 108, 1, 189.9, -51.3 , 0 );
setMoveKey( spep_4 -3 + 110, 1, 218.1, -56.7 , 0 );
setMoveKey( spep_4 -3 + 112, 1, 269.1, 3.2 , 0 );
setMoveKey( spep_4 -3 + 114, 1, 290, -109 , 0 );
setMoveKey( spep_4 -3 + 116, 1, 241.9, -83.1 , 0 );
setMoveKey( spep_4 -3 + 118, 1, 353.9, -57.2 , 0 );
setMoveKey( spep_4 -3 + 120, 1, 315.8, -36.3 , 0 );
setMoveKey( spep_4 -3 + 122, 1, 388.8, -41.4 , 0 );
setMoveKey( spep_4 -3 + 124, 1, 398.7, -89.5 , 0 );
setMoveKey( spep_4 -3 + 126, 1, 407.6, -41.7 , 0 );
setMoveKey( spep_4 -3 + 128, 1, 438.6, -21.8 , 0 );
setMoveKey( spep_4 -3 + 130, 1, 474.3, -39.9 , 0 );
setMoveKey( spep_4 -3 + 132, 1, 485.1, -52.5 , 0 );
setMoveKey( spep_4 -3 + 134, 1, 519.1, -49.1 , 0 );
setMoveKey( spep_4 -3 + 136, 1, 526.3, -47.7 , 0 );
setMoveKey( spep_4 -3 + 138, 1, 557.3, -42.4 , 0 );
setMoveKey( spep_4 -3 + 140, 1, 582.2, -42.5 , 0 );
setMoveKey( spep_4 -3 + 142, 1, 607.2, -42.6 , 0 );
setMoveKey( spep_4 -3 + 144, 1, 632.1, -42.7 , 0 );
setMoveKey( spep_4 -3 + 146, 1, 657.1, -42.8 , 0 );
setMoveKey( spep_4 -3 + 148, 1, 682, -43 , 0 );
setMoveKey( spep_4 -4 + 152, 1, 682, -43 , 0 );

setScaleKey( spep_4 -3 + 46, 1, 2.9, 2.9 );
setScaleKey( spep_4 -4 + 152, 1, 2.9, 2.9 );

setRotateKey( spep_4 -3 + 46, 1, 88.7 );
setRotateKey( spep_4 -3 + 48, 1, 88.9 );
setRotateKey( spep_4 -3 + 50, 1, 89.1 );
setRotateKey( spep_4 -3 + 52, 1, 89.3 );
setRotateKey( spep_4 -3 + 54, 1, 89.4 );
setRotateKey( spep_4 -3 + 56, 1, 89.6 );
setRotateKey( spep_4 -3 + 58, 1, 89.8 );
setRotateKey( spep_4 -3 + 60, 1, 90 );
setRotateKey( spep_4 -3 + 62, 1, 90.2 );
setRotateKey( spep_4 -3 + 64, 1, 90.4 );
setRotateKey( spep_4 -3 + 66, 1, 90.5 );
setRotateKey( spep_4 -3 + 68, 1, 90.7 );
setRotateKey( spep_4 -3 + 70, 1, 90.9 );
setRotateKey( spep_4 -3 + 72, 1, 91.1 );
setRotateKey( spep_4 -3 + 74, 1, 91.3 );
setRotateKey( spep_4 -3 + 76, 1, 91.5 );
setRotateKey( spep_4 -3 + 78, 1, 91.7 );
setRotateKey( spep_4 -3 + 80, 1, 91.8 );
setRotateKey( spep_4 -3 + 82, 1, 92 );
setRotateKey( spep_4 -3 + 84, 1, 92.2 );
setRotateKey( spep_4 -3 + 86, 1, 92.4 );
setRotateKey( spep_4 -3 + 88, 1, 92.6 );
setRotateKey( spep_4 -3 + 90, 1, 92.8 );
setRotateKey( spep_4 -3 + 92, 1, 93 );
setRotateKey( spep_4 -3 + 94, 1, 93.1 );
setRotateKey( spep_4 -3 + 96, 1, 93.3 );
setRotateKey( spep_4 -3 + 98, 1, 93.5 );
setRotateKey( spep_4 -3 + 100, 1, 93.7 );
setRotateKey( spep_4 -3 + 102, 1, 93.9 );
setRotateKey( spep_4 -3 + 104, 1, 94.1 );
setRotateKey( spep_4 -3 + 106, 1, 94.3 );
setRotateKey( spep_4 -3 + 108, 1, 94.4 );
setRotateKey( spep_4 -3 + 110, 1, 94.6 );
setRotateKey( spep_4 -3 + 112, 1, 94.8 );
setRotateKey( spep_4 -3 + 114, 1, 95 );
setRotateKey( spep_4 -3 + 116, 1, 95.2 );
setRotateKey( spep_4 -3 + 118, 1, 95.4 );
setRotateKey( spep_4 -3 + 120, 1, 95.6 );
setRotateKey( spep_4 -3 + 122, 1, 95.7 );
setRotateKey( spep_4 -3 + 124, 1, 95.9 );
setRotateKey( spep_4 -3 + 126, 1, 96.1 );
setRotateKey( spep_4 -3 + 128, 1, 96.3 );
setRotateKey( spep_4 -3 + 130, 1, 96.5 );
setRotateKey( spep_4 -3 + 132, 1, 96.7 );
setRotateKey( spep_4 -3 + 134, 1, 96.9 );
setRotateKey( spep_4 -3 + 136, 1, 97 );
setRotateKey( spep_4 -3 + 138, 1, 97.2 );
setRotateKey( spep_4 -3 + 140, 1, 97.4 );
setRotateKey( spep_4 -3 + 142, 1, 97.6 );
setRotateKey( spep_4 -3 + 144, 1, 97.8 );
setRotateKey( spep_4 -3 + 146, 1, 98 );
setRotateKey( spep_4 -3 + 148, 1, 98.2 );
setRotateKey( spep_4 -4 + 152, 1, 98.2 );


-- ** 音 ** --
--土煙
SE028 = playSeVer2( spep_4 + 116, 1168, "", 0, 18, 0, -1);
setStartTimeMs( SE028,  1617 );

--体で着地
SE029 = playSeVer2( spep_4 + 20, 1007, "", 0, 0, 0, -1);
SE030 = playSeVer2( spep_4 + 24, 1012, "", 0, 0, 0, -1);
SE031 = playSeVer2( spep_4 + 28, 1192, "", 0, 0, 0, -1);

--地面すべる
SE032 = playSeVer2( spep_4 + 28, 1044, "",spep_4 + 180, 0, 26, -1);
setSeVolumeByWorkId( spep_4 + 28, SE032, 79 );
SE033 = playSeVer2( spep_4 + 28, 1241, "", 0, 0, 0, 0.6);

--銃撃つ１
SE034 = playSeVer2( spep_4 + 60, 1016, "", 0, 0, 0, -1);
SE035 = playSeVer2( spep_4 + 60, 1155, "",spep_4 + 94, 0, 10, 0.6);
SE036 = playSeVer2( spep_4 + 60, 1335, "",spep_4 + 94, 0, 10, 0.6);

--銃撃つ２
SE037 = playSeVer2( spep_4 + 80, 1016, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_4 + 80, 1155, "",spep_4 + 120, 0, 10, 0.6);

--銃撃つ３
SE039 = playSeVer2( spep_4 + 94, 1335, "",spep_4 + 132, 0, 14, 0.6);
SE040 = playSeVer2( spep_4 + 100, 1016, "", 0, 0, 0, -1);
SE041 = playSeVer2( spep_4 + 100, 1155, "", 0, 0, 0, -1);
...
setEffAlphaKey( spep_5 + 180 -4, base_5, 255);

-- ** 黒背景 ** --
entryFadeBg( spep_5 + 0, 0, 180 -4, 0, 0, 0, 0, 255);  --黒　背景


-- ** 音 ** --
--起き上がる
SE042 = playSeVer2( spep_5 + 0, 1003, "", 0, 0, 0, -1);
SE043 = playSeVer2( spep_5 + 24, 1108, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_5 + 24, SE043, 221 );

--最後決め
SE044 = playSeVer2( spep_5 + 74, 1189, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_5 + 74, SE044, 127 );
SE045 = playSeVer2( spep_5 + 82, 12, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_5 + 82, SE045, 84 );


-- ** ダメージ表示 ** --
dealDamage( spep_5 + 80); -- ダメージ表示フレーム
endPhase( spep_5 + 180 -8); -- 終了フレーム
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_4f = entryEffect( spep_4 + 0, SP_04r, 0x100, -1, 0, 0, 0); --ジャコビーム	ef_004
setEffMoveKey( spep_4 + 0, base_4f, 0, 0 , 0);
setEffMoveKey( spep_4 + 152 -4, base_4f, 0, 0 , 0);
setEffScaleKey( spep_4 + 0, base_4f, -1.0, 1.0);
setEffScaleKey( spep_4 + 152 -4, base_4f, -1.0, 1.0);
...
base_4b = entryEffect( spep_4 + 0, SP_04br, 0x80, -1, 0, 0, 0); --ジャコビーム　裏	ef_004_back
setEffMoveKey( spep_4 + 0, base_4b, 0, 0 , 0);
setEffMoveKey( spep_4 + 152 -4, base_4b, 0, 0 , 0);
setEffScaleKey( spep_4 + 0, base_4b, -1.0, 1.0);
setEffScaleKey( spep_4 + 152 -4, base_4b, -1.0, 1.0);
...
changeAnime( spep_4 -3 + 0, 1, 8 );

setMoveKey( spep_4 -3 + 46, 1, -580 * -1, -53 , 0 );
setMoveKey( spep_4 -3 + 48, 1, -555.1 * -1, -53.1 , 0 );
setMoveKey( spep_4 -3 + 50, 1, -530.1 * -1, -53.2 , 0 );
setMoveKey( spep_4 -3 + 52, 1, -505.2 * -1, -53.3 , 0 );
setMoveKey( spep_4 -3 + 54, 1, -480.2 * -1, -53.4 , 0 );
setMoveKey( spep_4 -3 + 56, 1, -455.3 * -1, -53.5 , 0 );
setMoveKey( spep_4 -3 + 58, 1, -430.4 * -1, -53.7 , 0 );
setMoveKey( spep_4 -3 + 60, 1, -405.4 * -1, -53.8 , 0 );
setMoveKey( spep_4 -3 + 62, 1, -380.5 * -1, -53.9 , 0 );
setMoveKey( spep_4 -3 + 64, 1, -355.5 * -1, -54 , 0 );
setMoveKey( spep_4 -3 + 66, 1, -330.6 * -1, -54.1 , 0 );
setMoveKey( spep_4 -3 + 68, 1, -279.6 * -1, 5.8 , 0 );
setMoveKey( spep_4 -3 + 70, 1, -258.7 * -1, -106.4 , 0 );
setMoveKey( spep_4 -3 + 72, 1, -306.8 * -1, -80.5 , 0 );
setMoveKey( spep_4 -3 + 74, 1, -194.8 * -1, -54.6 , 0 );
setMoveKey( spep_4 -3 + 76, 1, -232.9 * -1, -33.7 , 0 );
setMoveKey( spep_4 -3 + 78, 1, -159.9 * -1, -38.8 , 0 );
setMoveKey( spep_4 -3 + 80, 1, -150 * -1, -87 , 0 );
setMoveKey( spep_4 -3 + 82, 1, -141.1 * -1, -39.1 , 0 );
setMoveKey( spep_4 -3 + 84, 1, -112.8 * -1, -44.5 , 0 );
setMoveKey( spep_4 -3 + 86, 1, -84.5 * -1, -50 , 0 );
setMoveKey( spep_4 -3 + 88, 1, -56.2 * -1, -55.4 , 0 );
setMoveKey( spep_4 -3 + 90, 1, -5.3 * -1, 4.5 , 0 );
setMoveKey( spep_4 -3 + 92, 1, 15.6 * -1, -107.7 , 0 );
setMoveKey( spep_4 -3 + 94, 1, -32.4 * -1, -81.8 , 0 );
setMoveKey( spep_4 -3 + 96, 1, 79.5 * -1, -55.9 , 0 );
setMoveKey( spep_4 -3 + 98, 1, 41.5 * -1, -35 , 0 );
setMoveKey( spep_4 -3 + 100, 1, 114.4 * -1, -40.1 , 0 );
setMoveKey( spep_4 -3 + 102, 1, 124.4 * -1, -88.2 , 0 );
setMoveKey( spep_4 -3 + 104, 1, 133.3 * -1, -40.4 , 0 );
setMoveKey( spep_4 -3 + 106, 1, 161.6 * -1, -45.8 , 0 );
setMoveKey( spep_4 -3 + 108, 1, 189.9 * -1, -51.3 , 0 );
setMoveKey( spep_4 -3 + 110, 1, 218.1 * -1, -56.7 , 0 );
setMoveKey( spep_4 -3 + 112, 1, 269.1 * -1, 3.2 , 0 );
setMoveKey( spep_4 -3 + 114, 1, 290 * -1, -109 , 0 );
setMoveKey( spep_4 -3 + 116, 1, 241.9 * -1, -83.1 , 0 );
setMoveKey( spep_4 -3 + 118, 1, 353.9 * -1, -57.2 , 0 );
setMoveKey( spep_4 -3 + 120, 1, 315.8 * -1, -36.3 , 0 );
setMoveKey( spep_4 -3 + 122, 1, 388.8 * -1, -41.4 , 0 );
setMoveKey( spep_4 -3 + 124, 1, 398.7 * -1, -89.5 , 0 );
setMoveKey( spep_4 -3 + 126, 1, 407.6 * -1, -41.7 , 0 );
setMoveKey( spep_4 -3 + 128, 1, 438.6 * -1, -21.8 , 0 );
setMoveKey( spep_4 -3 + 130, 1, 474.3 * -1, -39.9 , 0 );
setMoveKey( spep_4 -3 + 132, 1, 485.1 * -1, -52.5 , 0 );
setMoveKey( spep_4 -3 + 134, 1, 519.1 * -1, -49.1 , 0 );
setMoveKey( spep_4 -3 + 136, 1, 526.3 * -1, -47.7 , 0 );
setMoveKey( spep_4 -3 + 138, 1, 557.3 * -1, -42.4 , 0 );
setMoveKey( spep_4 -3 + 140, 1, 582.2 * -1, -42.5 , 0 );
setMoveKey( spep_4 -3 + 142, 1, 607.2 * -1, -42.6 , 0 );
setMoveKey( spep_4 -3 + 144, 1, 632.1 * -1, -42.7 , 0 );
setMoveKey( spep_4 -3 + 146, 1, 657.1 * -1, -42.8 , 0 );
setMoveKey( spep_4 -3 + 148, 1, 682 * -1, -43 , 0 );
setMoveKey( spep_4 -4 + 152, 1, 682 * -1, -43 , 0 );

setScaleKey( spep_4 -3 + 46, 1, 2.9, 2.9 );
setScaleKey( spep_4 -4 + 152, 1, 2.9, 2.9 );

setRotateKey( spep_4 -3 + 46, 1, 88.7 * -1 );
setRotateKey( spep_4 -3 + 48, 1, 88.9 * -1 );
setRotateKey( spep_4 -3 + 50, 1, 89.1 * -1 );
setRotateKey( spep_4 -3 + 52, 1, 89.3 * -1 );
setRotateKey( spep_4 -3 + 54, 1, 89.4 * -1 );
setRotateKey( spep_4 -3 + 56, 1, 89.6 * -1 );
setRotateKey( spep_4 -3 + 58, 1, 89.8 * -1 );
setRotateKey( spep_4 -3 + 60, 1, 90 * -1 );
setRotateKey( spep_4 -3 + 62, 1, 90.2 * -1 );
setRotateKey( spep_4 -3 + 64, 1, 90.4 * -1 );
setRotateKey( spep_4 -3 + 66, 1, 90.5 * -1 );
setRotateKey( spep_4 -3 + 68, 1, 90.7 * -1 );
setRotateKey( spep_4 -3 + 70, 1, 90.9 * -1 );
setRotateKey( spep_4 -3 + 72, 1, 91.1 * -1 );
setRotateKey( spep_4 -3 + 74, 1, 91.3 * -1 );
setRotateKey( spep_4 -3 + 76, 1, 91.5 * -1 );
setRotateKey( spep_4 -3 + 78, 1, 91.7 * -1 );
setRotateKey( spep_4 -3 + 80, 1, 91.8 * -1 );
setRotateKey( spep_4 -3 + 82, 1, 92 * -1 );
setRotateKey( spep_4 -3 + 84, 1, 92.2 * -1 );
setRotateKey( spep_4 -3 + 86, 1, 92.4 * -1 );
setRotateKey( spep_4 -3 + 88, 1, 92.6 * -1 );
setRotateKey( spep_4 -3 + 90, 1, 92.8 * -1 );
setRotateKey( spep_4 -3 + 92, 1, 93 * -1 );
setRotateKey( spep_4 -3 + 94, 1, 93.1 * -1 );
setRotateKey( spep_4 -3 + 96, 1, 93.3 * -1 );
setRotateKey( spep_4 -3 + 98, 1, 93.5 * -1 );
setRotateKey( spep_4 -3 + 100, 1, 93.7 * -1 );
setRotateKey( spep_4 -3 + 102, 1, 93.9 * -1 );
setRotateKey( spep_4 -3 + 104, 1, 94.1 * -1 );
setRotateKey( spep_4 -3 + 106, 1, 94.3 * -1 );
setRotateKey( spep_4 -3 + 108, 1, 94.4 * -1 );
setRotateKey( spep_4 -3 + 110, 1, 94.6 * -1 );
setRotateKey( spep_4 -3 + 112, 1, 94.8 * -1 );
setRotateKey( spep_4 -3 + 114, 1, 95 * -1 );
setRotateKey( spep_4 -3 + 116, 1, 95.2 * -1 );
setRotateKey( spep_4 -3 + 118, 1, 95.4 * -1 );
setRotateKey( spep_4 -3 + 120, 1, 95.6 * -1 );
setRotateKey( spep_4 -3 + 122, 1, 95.7 * -1 );
setRotateKey( spep_4 -3 + 124, 1, 95.9 * -1 );
setRotateKey( spep_4 -3 + 126, 1, 96.1 * -1 );
setRotateKey( spep_4 -3 + 128, 1, 96.3 * -1 );
setRotateKey( spep_4 -3 + 130, 1, 96.5 * -1 );
setRotateKey( spep_4 -3 + 132, 1, 96.7 * -1 );
setRotateKey( spep_4 -3 + 134, 1, 96.9 * -1 );
setRotateKey( spep_4 -3 + 136, 1, 97 * -1 );
setRotateKey( spep_4 -3 + 138, 1, 97.2 * -1 );
setRotateKey( spep_4 -3 + 140, 1, 97.4 * -1 );
setRotateKey( spep_4 -3 + 142, 1, 97.6 * -1 );
setRotateKey( spep_4 -3 + 144, 1, 97.8 * -1 );
setRotateKey( spep_4 -3 + 146, 1, 98 * -1 );
setRotateKey( spep_4 -3 + 148, 1, 98.2 * -1 );
setRotateKey( spep_4 -4 + 152, 1, 98.2 * -1 );
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_5 = entryEffect( spep_5 + 0, SP_05r, 0x80, -1, 0, 0, 0); --フィニッシュ	ef_005
setEffMoveKey( spep_5 + 0, base_5, 0, 0 , 0);
setEffMoveKey( spep_5 + 180 -4, base_5, 0, 0 , 0);
setEffScaleKey( spep_5 + 0, base_5, -1.0, 1.0);
setEffScaleKey( spep_5 + 180 -4, base_5, -1.0, 1.0);
