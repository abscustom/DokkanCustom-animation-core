...
entryFade( SP_start+ 160, 4, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    -- ** 集中線 ** --
    shuchusen = entryEffectLife( SP_start+170 + 0, 906, 86, 0x100, -1, 0, 0, 0 );  --集中線
    setEffShake( SP_start+170 + 0, shuchusen, 86, 20 );
    
    setEffMoveKey( SP_start+170 + 0, shuchusen, 0, 0 , 0 );
    setEffMoveKey( SP_start+170 + 86, shuchusen, 0, 0 , 0 );
    
    setEffScaleKey( SP_start+170 + 0, shuchusen, 1.6, 1.6 );
    setEffScaleKey( SP_start+170 + 86, shuchusen, 1.6, 1.6 );
    
    setEffRotateKey( SP_start+170 + 0, shuchusen, 0 );
    setEffRotateKey( SP_start+170 + 86, shuchusen, 0 );
    
    setEffAlphaKey( SP_start+170 + 0, shuchusen, 255 );
    setEffAlphaKey( SP_start+170 + 86, shuchusen, 255 );
    
    -- ** くろ背景 ** --
    entryFadeBg( SP_start+170 , 0, 98, 0,  0, 0, 0, 255 ); --くろ 背景
    
    --白フェード
    entryFade( SP_start+170 + 80, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
entryFade( tyo+156, 4, 8, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    -- ** 集中線 ** --
    shuchusen = entryEffectLife( tyo2+170 + 0, 906, 86, 0x100, -1, 0, 0, 0 );  --集中線
    setEffShake( tyo2+170 + 0, shuchusen, 86, 20 );
    
    setEffMoveKey( tyo2+170 + 0, shuchusen, 0, 0 , 0 );
    setEffMoveKey( tyo2+170 + 86, shuchusen, 0, 0 , 0 );
    
    setEffScaleKey( tyo2+170 + 0, shuchusen, 1.6, 1.6 );
    setEffScaleKey( tyo2+170 + 86, shuchusen, 1.6, 1.6 );
    
    setEffRotateKey( tyo2+170 + 0, shuchusen, 0 );
    setEffRotateKey( tyo2+170 + 86, shuchusen, 0 );
    
    setEffAlphaKey( tyo2+170 + 0, shuchusen, 255 );
    setEffAlphaKey( tyo2+170 + 86, shuchusen, 255 );
    
    -- ** くろ背景 ** --
    entryFadeBg( tyo2+170 , 0, 98, 0,  0, 0, 0, 255 ); --くろ 背景
...
--endPhase( tyo2+580);
endPhase( tyo2+SP_ATK_4+120 -10 -10);
