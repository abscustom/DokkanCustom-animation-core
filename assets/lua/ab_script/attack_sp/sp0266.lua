...
-- ** 集中線 ** --
shuchusen = entryEffectLife( spep_x + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_x + 0, shuchusen, 90, 20 );

setEffMoveKey( spep_x + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( spep_x + 90, shuchusen, 0, 0 , 0 );

setEffScaleKey( spep_x + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( spep_x + 90, shuchusen, 1.6, 1.6 );

setEffRotateKey( spep_x + 0, shuchusen, 0 );
setEffRotateKey( spep_x + 90, shuchusen, 0 );

setEffAlphaKey( spep_x + 0, shuchusen, 255 );
...
-- ** 次の準備 ** --
entryFade( spep_x + 82, 6, 6, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
