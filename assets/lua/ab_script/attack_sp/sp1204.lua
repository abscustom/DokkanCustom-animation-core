...
--***SE***
SE01=playSe(  spep_1+12,  1002);  --風の音
...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    -- ** 集中線 ** --
    shuchusen = entryEffectLife( spep_10 + 0, 906, 86, 0x100, -1, 0, 0, 0 );  --集中線
    setEffShake( spep_10 + 0, shuchusen, 86, 20 );
    
    setEffMoveKey( spep_10 + 0, shuchusen, 0, 0 , 0 );
    setEffMoveKey( spep_10 + 86, shuchusen, 0, 0 , 0 );
    
    setEffScaleKey( spep_10 + 0, shuchusen, 1.6, 1.6 );
    setEffScaleKey( spep_10 + 86, shuchusen, 1.6, 1.6 );
    
    setEffRotateKey( spep_10 + 0, shuchusen, 0 );
    setEffRotateKey( spep_10 + 86, shuchusen, 0 );
    
    setEffAlphaKey( spep_10 + 0, shuchusen, 255 );
    setEffAlphaKey( spep_10 + 86, shuchusen, 255 );
    
    -- ** くろ背景 ** --
    entryFadeBg( spep_10 , 0, 98, 0,  0, 0, 0, 255 ); --くろ 背景
