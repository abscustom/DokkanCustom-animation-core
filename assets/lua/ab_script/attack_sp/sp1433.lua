...
-- ** 音 ** --
--気弾溜め
SE7 = playSe( spep_c + 93, 1191 );
setSeVolume( spep_c + 93, 1191, 141 );

SE8 = playSe( spep_c + 93, 1204 );
setSeVolume( spep_c + 93, 1204, 125 );

SE9 = playSe( spep_c + 93, 1184 );
setSeVolume( spep_c + 93, 1184, 29 );

SE10 = playSe( spep_c + 93, 1154 );
setSeVolume( spep_c + 93, 1154, 71 );
