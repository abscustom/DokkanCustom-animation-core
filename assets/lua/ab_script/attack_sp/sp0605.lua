--1020040：UR_ジャッキー・チュン(MAXパワー)_必殺技：かめはめ波
--sp_effect_a1_00209
--sp0605
...
--味方側
SP_01 = 154730; --敵とフレームイン ef_001
SP_02 = 154731; --腕を動かしてかめはめ波を構える ef_002
SP_03 = 154733; --顔アップ ef_003
SP_04 = 154734; --発射 ef_004
SP_05 = 154736; --発射背景 ef_005
SP_06 = 154737; --かめはめ波が奥から迫る ef_006
SP_07 = 154738; --フィニッシュ ef_007
SP_08 = 154739; --フィニッシュ背景 ef_008

--敵側
SP_02r = 154732; --腕を動かしてかめはめ波を構える ef_002r
SP_04r = 154735; --発射 ef_004r
...
------------------------------------------------------
-- ** エフェクト等 ** --
kamae = entryEffect( spep_1 + 0, SP_02r, 0x80, -1, 0, 0, 0 ); --腕を動かしてかめはめ波を構える(ef_002r)
setEffMoveKey( spep_1 + 0, kamae, 0, 0, 0 );
setEffMoveKey( spep_1 + 136, kamae, 0, 0, 0 );
setEffScaleKey( spep_1 + 0, kamae, 1.0, 1.0 );
setEffScaleKey( spep_1 + 136, kamae, 1.0, 1.0 );
