...
--味方側
SP_01 = 161085;	--冒頭セリフカットイン	ef_001
SP_02 = 161086;	--気弾連続なげ	ef_002
SP_03 = 161087;	--気弾敵ヒット：敵より前	ef_003
SP_04 = 161088;	--気弾敵ヒット：敵より後ろ	ef_004
SP_05 = 161089;	--かめはめ波発射	ef_005
SP_06 = 161090;	--かめはめ波敵ヒット：敵より前	ef_006
SP_07 = 161091;	--かめはめ波敵ヒット：敵より後ろ	ef_007
SP_08 = 161092;	--ラスト爆発シーン	ef_008

--敵側
SP_03r = 161093;	--気弾敵ヒット：敵より前：反転	ef_003_r
SP_05r = 161094;	--かめはめ波発射：反転	ef_005_r
SP_06r = 161095;	--かめはめ波敵ヒット：敵より前：反転	ef_006_r
SP_08r = 161096;	--ラスト爆発シーン：反転	ef_008_r
...
SE021 = playSeVer2( spep_3 + 68, 1209, "",spep_3 + 142, 0, 12, -1);
setSeVolumeByWorkId( spep_3 + 68, SE021, 79 );
SE022 = playSeVer2( spep_3 + 68, 1210, "",spep_3 + 142, 0, 12, -1);
...
-- ** エフェクト等 ** --
shot = entryEffect( spep_4 + 0, SP_05, 0x100, -1, 0, 0, 0 );  --かめはめ波発射	ef_005
...
-- ** エフェクト等 ** --
attack_f = entryEffect( spep_5 + 0, SP_06, 0x100, -1, 0, 0, 0 );   --かめはめ波敵ヒット：敵より前	ef_006
setEffMoveKey( spep_5 + 0, attack_f, 0, 0 , 0 );
setEffMoveKey( spep_5 + 68, attack_f, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, attack_f, 1.0, 1.0 );
setEffScaleKey( spep_5 + 68, attack_f, 1.0, 1.0 );
setEffRotateKey( spep_5 + 0, attack_f, 0 );
setEffRotateKey( spep_5 + 68, attack_f, 0 );
setEffAlphaKey( spep_5 + 0, attack_f, 255 );
setEffAlphaKey( spep_5 + 68 -2, attack_f, 255 );
setEffAlphaKey( spep_5 + 68 -1, attack_f, 255 );
setEffAlphaKey( spep_5 + 68, attack_f, 0 );

attack_b = entryEffect( spep_5 + 0, SP_07, 0x80, -1, 0, 0, 0 ); --かめはめ波敵ヒット：敵より後ろ	ef_007
setEffMoveKey( spep_5 + 0, attack_b, 0, 0 , 0 );
setEffMoveKey( spep_5 + 68, attack_b, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, attack_b, 1.0, 1.0 );
setEffScaleKey( spep_5 + 68, attack_b, 1.0, 1.0 );
setEffRotateKey( spep_5 + 0, attack_b, 0 );
setEffRotateKey( spep_5 + 68, attack_b, 0 );
setEffAlphaKey( spep_5 + 0, attack_b, 255 );
setEffAlphaKey( spep_5 + 68 -2, attack_b, 255 );
setEffAlphaKey( spep_5 + 68 -1, attack_b, 255 );
setEffAlphaKey( spep_5 + 68, attack_b, 0 );
...
-- ** エフェクト等 ** --
shot = entryEffect( spep_4 + 0, SP_05r, 0x100, -1, 0, 0, 0 );  --かめはめ波発射	ef_005
setEffMoveKey( spep_4 + 0, shot, 0, 0 , 0 );
setEffMoveKey( spep_4 + 108, shot, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, shot, 1.0, 1.0 );
setEffScaleKey( spep_4 + 108, shot, 1.0, 1.0 );
...
-- ** エフェクト等 ** --
attack_f = entryEffect( spep_5 + 0, SP_06r, 0x100, -1, 0, 0, 0 );   --かめはめ波敵ヒット：敵より前	ef_006
setEffMoveKey( spep_5 + 0, attack_f, 0, 0 , 0 );
setEffMoveKey( spep_5 + 68, attack_f, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, attack_f, 1.0, 1.0 );
setEffScaleKey( spep_5 + 68, attack_f, 1.0, 1.0 );
...
-- ** エフェクト等 ** --
finish = entryEffect( spep_6 + 0, SP_08r, 0x100, -1, 0, 0, 0 );  --ラスト爆発シーン	ef_008
setEffMoveKey( spep_6 + 0, finish, 0, 0 , 0 );
setEffMoveKey( spep_6 + 150, finish, 0, 0 , 0 );
setEffScaleKey( spep_6 + 0, finish, 1.0, 1.0 );
setEffScaleKey( spep_6 + 150, finish, 1.0, 1.0 );
