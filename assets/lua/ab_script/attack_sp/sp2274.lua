--1023060:UR超サイヤ人孫悟空_乱調メテオスマッシュ_sp2274
--sp_effect_a1_00321
...
--味方側
SP_01 = 158509;	--顔アップ、オーラ発生	ef_001
SP_02 = 158510;	--正面突進	ef_002
SP_03 = 158511;	--背後登場、蹴り飛ばし：キャラ、文字	ef_003
SP_04 = 158512;	--背後登場、蹴り飛ばし背景	ef_004
SP_05 = 158513;	--空中戦：エフェクト文字	ef_005
SP_06 = 158514;	--空中戦：キャラ	ef_006
SP_07 = 158515;	--空中戦：背景	ef_007
SP_08 = 158516;	--苦しむ悟空	ef_008
SP_09 = 158517;	--かめはめ波発射	ef_009
SP_10 = 158518;	--地面爆発	ef_010

--敵側
SP_03r = 158519;	--背後登場、蹴り飛ばし：反転	ef_003_r
SP_05r = 158520;	--空中戦：エフェクト文字：反転	ef_005_r
SP_09r = 158572;    --かめはめ波発射：反転   ef_009_r
...
-- ** エフェクト等 ** --
antenna_f = entryEffect( spep_3 + 0, SP_05, 0x100, -1, 0, 0, 0 );  --空中戦：エフェクト文字	ef_005
setEffMoveKey( spep_3 + 0, antenna_f, 0, 0 , 0 );
setEffMoveKey( spep_3 + 156, antenna_f, 0, 0 , 0 );
setEffScaleKey( spep_3 + 0, antenna_f, 1.0, 1.0 );
setEffScaleKey( spep_3 + 156, antenna_f, 1.0, 1.0 );
setEffRotateKey( spep_3 + 0, antenna_f, 0 );
setEffRotateKey( spep_3 + 156, antenna_f, 0 );
setEffAlphaKey( spep_3 + 0, antenna_f, 255 );
setEffAlphaKey( spep_3 + 156, antenna_f, 255 );

antenna_e = entryEffectLife( spep_3 + 0, SP_07, 246, 0x80, -1, 0, 0, 0 );  --空中戦：背景	ef_007
setEffMoveKey( spep_3 + 0, antenna_e, 0, 0 , 0 );
setEffMoveKey( spep_3 + 246, antenna_e, 0, 0 , 0 );
setEffScaleKey( spep_3 + 0, antenna_e, 1.0, 1.0 );
setEffScaleKey( spep_3 + 246, antenna_e, 1.0, 1.0 );
setEffRotateKey( spep_3 + 0, antenna_e, 0 );
setEffRotateKey( spep_3 + 246, antenna_e, 0 );
setEffAlphaKey( spep_3 + 0, antenna_e, 255 );
setEffAlphaKey( spep_3 + 246 -1, antenna_e, 255 );
setEffAlphaKey( spep_3 + 246, antenna_e, 0 );

antenna_b = entryEffectLife( spep_3 + 0, SP_06, 169, 0x80, -1, 0, 0, 0 );  --空中戦：キャラ	ef_006
setEffMoveKey( spep_3 + 0, antenna_b, 0, 0 , 0 );
setEffMoveKey( spep_3 + 169, antenna_b, 0, 0 , 0 );
setEffScaleKey( spep_3 + 0, antenna_b, 1.0, 1.0 );
setEffScaleKey( spep_3 + 169, antenna_b, 1.0, 1.0 );
setEffRotateKey( spep_3 + 0, antenna_b, 0 );
setEffRotateKey( spep_3 + 169, antenna_b, 0 );
setEffAlphaKey( spep_3 + 0, antenna_b, 255 );
setEffAlphaKey( spep_3 + 169 -1, antenna_b, 255 );
setEffAlphaKey( spep_3 + 169, antenna_b, 0 );
...
-- ** 書き文字エントリー ** --
ctdogaga = entryEffectLife( spep_3 -3 + 60,  10017, 28 +1, 0x100, -1, 0, 8.7, 308.1 );	--ドガガガッ
...
setEffMoveKey( spep_3 -3 + 89, ctdogaga, 10.1, 324.7 , 0 );
...
setEffScaleKey( spep_3 -3 + 89, ctdogaga, 2.05, 2.05 );
setEffRotateKey( spep_3 -3 + 60, ctdogaga, 14.3 );
setEffRotateKey( spep_3 -3 + 89, ctdogaga, 14.3 );
setEffAlphaKey( spep_3 -3 + 60, ctdogaga, 255 );
setEffAlphaKey( spep_3 -3 + 89, ctdogaga, 255 );
...
setMoveKey( spep_3 -3 + 92, 1, 151.8, 56.3 , 0 );
...
setScaleKey( spep_3 -3 + 92, 1, 1.914, 1.914 );
...
setRotateKey( spep_3 -3 + 92, 1, -43.6 );

-- ** 敵キャラクター ** --
setDisp( spep_3 -3 + 130, 1, 1 );
setDisp( spep_3 -3 + 200, 1, 0 );
changeAnime( spep_3 -3 + 130, 1, 107 );
changeAnime( spep_3 -3 + 172, 1, 108 );

setMoveKey( spep_3 -3 + 130, 1, -21.4, 292.1 , 0 );
setMoveKey( spep_3 -3 + 132, 1, -19.7, 294.3 , 0 );
setMoveKey( spep_3 -3 + 134, 1, 15, 305.3 , 0 );
setMoveKey( spep_3 -3 + 136, 1, -13.4, 283.1 , 0 );
setMoveKey( spep_3 -3 + 138, 1, -41.4, 278.2 , 0 );
setMoveKey( spep_3 -3 + 140, 1, 15.6, 304.6 , 0 );
setMoveKey( spep_3 -3 + 142, 1, -12.7, 282.2 , 0 );
setMoveKey( spep_3 -3 + 144, 1, 16.2, 303.8 , 0 );
setMoveKey( spep_3 -3 + 146, 1, -40.2, 276.7 , 0 );
setMoveKey( spep_3 -3 + 148, 1, -17.6, 291.7 , 0 );
setMoveKey( spep_3 -3 + 150, 1, -18.8, 288.9 , 0 );
setMoveKey( spep_3 -3 + 152, 1, 9.6, 260.9 , 0 );
setMoveKey( spep_3 -3 + 154, 1, 38.4, 224.2 , 0 );
setMoveKey( spep_3 -3 + 156, 1, 74.2, 187.6 , 0 );
setMoveKey( spep_3 -3 + 158, 1, 111, 141.9 , 0 );
setMoveKey( spep_3 -3 + 160, 1, 153.6, 93.6 , 0 );
setMoveKey( spep_3 -3 + 162, 1, 200.7, 40.2 , 0 );
setMoveKey( spep_3 -3 + 164, 1, 252.7, -18.6 , 0 );
setMoveKey( spep_3 -3 + 166, 1, 309.6, -83.2 , 0 );
setMoveKey( spep_3 -3 + 168, 1, 371.9, -153.8 , 0 );
setMoveKey( spep_3 -3 + 170, 1, 439.7, -230.8 , 0 );
setMoveKey( spep_3 -3 + 171, 1, 439.7, -230.8 , 0 );
setMoveKey( spep_3 -3 + 172, 1, -218.7, 248.1 , 0 );--
setMoveKey( spep_3 -3 + 174, 1, -134.9 -60, 184.4 +20 , 0 );
setMoveKey( spep_3 -3 + 176, 1, -60.2 -100, 123.1 +15 , 0 );
setMoveKey( spep_3 -3 + 178, 1, 5.7 -140, 64.1 +25 , 0 );
setMoveKey( spep_3 -3 + 180, 1, 62.6 -165, 7.5 +30 , 0 );
setMoveKey( spep_3 -3 + 182, 1, 110.5 -185, -46.8 +40 , 0 );
setMoveKey( spep_3 -3 + 184, 1, 149.5 -195, -98.8 +45 , 0 );
setMoveKey( spep_3 -3 + 186, 1, 179.6 -195, -148.4 +45 , 0 );
setMoveKey( spep_3 -3 + 188, 1, 200.7 -190, -195.7 +45 , 0 );
setMoveKey( spep_3 -3 + 190, 1, 212.9 -170, -240.6 +27 , 0 );
setMoveKey( spep_3 -3 + 192, 1, 216.1 -155, -283.2 +30 , 0 );
setMoveKey( spep_3 -3 + 194, 1, 210.4 -115, -323.5 +30 , 0 );
setMoveKey( spep_3 -3 + 196, 1, 195.7 -70, -361.5 +20 , 0 );
setMoveKey( spep_3 -3 + 198, 1, 172.1 , -397.1 , 0 );
setMoveKey( spep_3 -3 + 200, 1, 172.1, -397.1 , 0 );

setScaleKey( spep_3 -3 + 130, 1, 0.528, 0.528 );
setScaleKey( spep_3 -3 + 138, 1, 0.528, 0.528 );
setScaleKey( spep_3 -3 + 140, 1, 0.539, 0.539 );
setScaleKey( spep_3 -3 + 146, 1, 0.539, 0.539 );
setScaleKey( spep_3 -3 + 148, 1, 0.55, 0.55 );
setScaleKey( spep_3 -3 + 150, 1, 0.55, 0.55 );
setScaleKey( spep_3 -3 + 152, 1, 0.693, 0.693 );
setScaleKey( spep_3 -3 + 154, 1, 0.847, 0.847 );
setScaleKey( spep_3 -3 + 156, 1, 1.034, 1.034 );
setScaleKey( spep_3 -3 + 158, 1, 1.232, 1.232 );
setScaleKey( spep_3 -3 + 160, 1, 1.452, 1.452 );
setScaleKey( spep_3 -3 + 162, 1, 1.705, 1.705 );
setScaleKey( spep_3 -3 + 164, 1, 1.980, 1.980 );
setScaleKey( spep_3 -3 + 166, 1, 2.277, 2.277 );
setScaleKey( spep_3 -3 + 168, 1, 2.607, 2.607 );
setScaleKey( spep_3 -3 + 170, 1, 2.97, 2.97 );
setScaleKey( spep_3 -3 + 171, 1, 2.97, 2.97 );
setScaleKey( spep_3 -3 + 172, 1, 6.49, 6.49 );--
setScaleKey( spep_3 -3 + 174, 1, 6, 6 );
setScaleKey( spep_3 -3 + 176, 1, 5.51, 5.51 );
setScaleKey( spep_3 -3 + 178, 1, 5.03, 5.02 );
setScaleKey( spep_3 -3 + 180, 1, 4.54, 4.54 );
setScaleKey( spep_3 -3 + 182, 1, 4.05, 4.05 );
setScaleKey( spep_3 -3 + 184, 1, 3.56, 3.56 );
setScaleKey( spep_3 -3 + 186, 1, 3.08, 3.07 );
setScaleKey( spep_3 -3 + 188, 1, 2.59, 2.59 );
setScaleKey( spep_3 -3 + 190, 1, 2.1, 2.1 );
setScaleKey( spep_3 -3 + 192, 1, 1.61, 1.61 );
setScaleKey( spep_3 -3 + 194, 1, 1.12, 1.12 );
setScaleKey( spep_3 -3 + 196, 1, 0.64, 0.64 );
setScaleKey( spep_3 -3 + 198, 1, 0.15, 0.15 );
setScaleKey( spep_3 -3 + 200, 1, 0.15, 0.15 );

setRotateKey( spep_3 -3 + 130, 1, 38.6 );
setRotateKey( spep_3 -3 + 171, 1, 38.6 );
setRotateKey( spep_3 -3 + 172, 1, 38.6 );--
setRotateKey( spep_3 -3 + 198, 1, 38.6 );
setRotateKey( spep_3 -3 + 200, 1, 38.6 );
...
--宙返り
SE035 = playSeVer2( spep_3 + 88, 1116, "",spep_3 + 122, 0, 14, -1);
setSeVolumeByWorkId( spep_3 + 88, SE035, 119 );
SE036 = playSeVer2( spep_3 + 92, 1003, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_3 + 92, SE036, 79 );
SE037 = playSeVer2( spep_3 + 102, 1004, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_3 + 102, SE037, 68 );

--蹴り落とし
SE038 = playSeVer2( spep_3 + 124, 1187, "", 0, 0, 0, -1);

--敵飛んでいく
SE039 = playSeVer2( spep_3 + 144, 1121, "",spep_3 + 214, 0, 22, -1);
setSeVolumeByWorkId( spep_3 + 144, SE039, 65 );
SE040 = playSeVer2( spep_3 + 144, 1183, "",spep_3 + 214, 0, 22, -1);
setSeVolumeByWorkId( spep_3 + 144, SE040, 91 );

--地面爆発
SE041 = playSeVer2( spep_3 + 192, 1159, "",spep_3 +246 +86 + 140, 0, -6, -1);
setSeVolumeByWorkId( spep_3 + 192, SE041, 71 );

--オーラ
SE042 = playSeVer2( spep_3 + 242, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_3 + 242, SE042, 79 );
...
-- ** エフェクト等 ** --
suffer = entryEffectLife( spep_4 + 0, SP_08, 86, 0x100, -1, 0, 0, 0 );  --苦しむ悟空	ef_008
setEffMoveKey( spep_4 + 0, suffer, 0, 0 , 0 );
setEffMoveKey( spep_4 + 86, suffer, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, suffer, 1.0, 1.0 );
setEffScaleKey( spep_4 + 86, suffer, 1.0, 1.0 );
setEffRotateKey( spep_4 + 0, suffer, 0 );
setEffRotateKey( spep_4 + 86, suffer, 0 );
setEffAlphaKey( spep_4 + 0, suffer, 255 );
setEffAlphaKey( spep_4 + 86 -1, suffer, 255 );
setEffAlphaKey( spep_4 + 86, suffer, 0 );

-- ** 音 ** --
--オーラ
SE043 = playSeVer2( spep_4 + 20, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_4 + 20, SE043, 79 );
SE044 = playSeVer2( spep_4 + 44, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_4 + 44, SE044, 79 );
SE045 = playSeVer2( spep_4 + 68, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_4 + 68, SE045, 79 );
...
--かめはめ波溜め
SE047 = playSeVer2( spep_5 + 92, 1210, "",spep_5 +94 + 52, 8, 10, -1);
setStartTimeMs( SE047,  1133 );
SE048 = playSeVer2( spep_5 + 86, 1209, "",spep_5 +94 + 52, 0, 10, -1);
setSeVolumeByWorkId( spep_5 + 86, SE048, 79 );
...
-- ** エフェクト等 ** --
shot = entryEffectLife( spep_6 + 0, SP_09, 105, 0x100, -1, 0, 0, 0 );  --かめはめ波発射	ef_009
setEffMoveKey( spep_6 + 0, shot, 0, 0 , 0 );
setEffMoveKey( spep_6 + 105, shot, 0, 0 , 0 );
setEffScaleKey( spep_6 + 0, shot, 1.0, 1.0 );
setEffScaleKey( spep_6 + 105, shot, 1.0, 1.0 );
setEffRotateKey( spep_6 + 0, shot, 0 );
setEffRotateKey( spep_6 + 105, shot, 0 );
setEffAlphaKey( spep_6 + 0, shot, 255 );
setEffAlphaKey( spep_6 + 105 -1, shot, 255 );
setEffAlphaKey( spep_6 + 105, shot, 0 );

-- ** 書き文字エントリー ** --
ctzuo = entryEffectLife( spep_6 -3 + 42,  10012, 66 -1, 0x100, -1, 0, -22.2, -105.4 );	--ズオッ
setEffMoveKey( spep_6 -3 + 42, ctzuo, -22.2, -105.4 , 0 );
setEffMoveKey( spep_6 -3 + 44, ctzuo, -36.7, -83.4 , 0 );
setEffMoveKey( spep_6 -3 + 46, ctzuo, -70.8, -78.3 , 0 );
setEffMoveKey( spep_6 -3 + 48, ctzuo, -55.7, -64.8 , 0 );
setEffMoveKey( spep_6 -3 + 50, ctzuo, -71.7, -78.4 , 0 );
setEffMoveKey( spep_6 -3 + 52, ctzuo, -56.4, -64.7 , 0 );
setEffMoveKey( spep_6 -3 + 54, ctzuo, -72.5, -78.4 , 0 );
setEffMoveKey( spep_6 -3 + 56, ctzuo, -57, -64.6 , 0 );
setEffMoveKey( spep_6 -3 + 58, ctzuo, -73.4, -78.5 , 0 );
setEffMoveKey( spep_6 -3 + 60, ctzuo, -57.7, -64.5 , 0 );
setEffMoveKey( spep_6 -3 + 62, ctzuo, -74.2, -78.5 , 0 );
setEffMoveKey( spep_6 -3 + 64, ctzuo, -58.3, -64.4 , 0 );
setEffMoveKey( spep_6 -3 + 66, ctzuo, -75, -78.6 , 0 );
setEffMoveKey( spep_6 -3 + 68, ctzuo, -59, -64.3 , 0 );
setEffMoveKey( spep_6 -3 + 70, ctzuo, -75.9, -78.6 , 0 );
setEffMoveKey( spep_6 -3 + 72, ctzuo, -59.6, -64.2 , 0 );
setEffMoveKey( spep_6 -3 + 74, ctzuo, -76.7, -78.7 , 0 );
setEffMoveKey( spep_6 -3 + 76, ctzuo, -60.3, -64.1 , 0 );
setEffMoveKey( spep_6 -3 + 78, ctzuo, -77.6, -78.7 , 0 );
setEffMoveKey( spep_6 -3 + 80, ctzuo, -60.9, -64 , 0 );
setEffMoveKey( spep_6 -3 + 82, ctzuo, -78.4, -78.8 , 0 );
setEffMoveKey( spep_6 -3 + 84, ctzuo, -61.6, -63.9 , 0 );
setEffMoveKey( spep_6 -3 + 86, ctzuo, -79.3, -78.8 , 0 );
setEffMoveKey( spep_6 -3 + 88, ctzuo, -62.3, -63.8 , 0 );
setEffMoveKey( spep_6 -3 + 90, ctzuo, -80.1, -78.9 , 0 );
setEffMoveKey( spep_6 -3 + 92, ctzuo, -62.9, -63.7 , 0 );
setEffMoveKey( spep_6 -3 + 94, ctzuo, -80.9, -78.9 , 0 );
setEffMoveKey( spep_6 -3 + 96, ctzuo, -63.6, -63.6 , 0 );
setEffMoveKey( spep_6 -3 + 98, ctzuo, -81.8, -79 , 0 );
setEffMoveKey( spep_6 -3 + 100, ctzuo, -64.2, -63.4 , 0 );
setEffMoveKey( spep_6 -3 + 102, ctzuo, -82.6, -79.1 , 0 );
setEffMoveKey( spep_6 -3 + 104, ctzuo, -64.9, -63.3 , 0 );
setEffMoveKey( spep_6 -3 + 106, ctzuo, -83.4, -79.1 , 0 );
setEffMoveKey( spep_6 -3 + 107, ctzuo, -83.9, -79.1 , 0 );
setEffScaleKey( spep_6 -3 + 42, ctzuo, 0.7, 0.7 );
setEffScaleKey( spep_6 -3 + 44, ctzuo, 1.68, 1.68 );
setEffScaleKey( spep_6 -3 + 46, ctzuo, 2.695, 2.695 );
setEffScaleKey( spep_6 -3 + 50, ctzuo, 2.695, 2.695 );
setEffScaleKey( spep_6 -3 + 52, ctzuo, 2.73, 2.73 );
setEffScaleKey( spep_6 -3 + 54, ctzuo, 2.73, 2.73 );
setEffScaleKey( spep_6 -3 + 56, ctzuo, 2.765, 2.765 );
setEffScaleKey( spep_6 -3 + 58, ctzuo, 2.765, 2.765 );
setEffScaleKey( spep_6 -3 + 60, ctzuo, 2.8, 2.8 );
setEffScaleKey( spep_6 -3 + 62, ctzuo, 2.8, 2.8 );
setEffScaleKey( spep_6 -3 + 64, ctzuo, 2.835, 2.835 );
setEffScaleKey( spep_6 -3 + 66, ctzuo, 2.835, 2.835 );
setEffScaleKey( spep_6 -3 + 68, ctzuo, 2.87, 2.87 );
setEffScaleKey( spep_6 -3 + 70, ctzuo, 2.87, 2.87 );
setEffScaleKey( spep_6 -3 + 72, ctzuo, 2.905, 2.905 );
setEffScaleKey( spep_6 -3 + 76, ctzuo, 2.905, 2.905 );
setEffScaleKey( spep_6 -3 + 78, ctzuo, 2.94, 2.94 );
setEffScaleKey( spep_6 -3 + 80, ctzuo, 2.94, 2.94 );
setEffScaleKey( spep_6 -3 + 82, ctzuo, 2.975, 2.975 );
setEffScaleKey( spep_6 -3 + 84, ctzuo, 2.975, 2.975 );
setEffScaleKey( spep_6 -3 + 86, ctzuo, 3.01, 3.01 );
setEffScaleKey( spep_6 -3 + 88, ctzuo, 3.01, 3.01 );
setEffScaleKey( spep_6 -3 + 90, ctzuo, 3.045, 3.045 );
setEffScaleKey( spep_6 -3 + 92, ctzuo, 3.045, 3.045 );
setEffScaleKey( spep_6 -3 + 94, ctzuo, 3.08, 3.08 );
setEffScaleKey( spep_6 -3 + 96, ctzuo, 3.08, 3.08 );
setEffScaleKey( spep_6 -3 + 98, ctzuo, 3.115, 3.115 );
setEffScaleKey( spep_6 -3 + 102, ctzuo, 3.115, 3.115 );
setEffScaleKey( spep_6 -3 + 104, ctzuo, 3.15, 3.15 );
setEffScaleKey( spep_6 -3 + 106, ctzuo, 3.15, 3.15 );
setEffScaleKey( spep_6 -3 + 107, ctzuo, 3.185, 3.185 );
r6 = 30;
setEffRotateKey( spep_6 -3 + 42, ctzuo, -33.4 +r6 );
setEffRotateKey( spep_6 -3 + 44, ctzuo, -33.4 +r6 );
setEffRotateKey( spep_6 -3 + 46, ctzuo, -33.5 +r6 );
setEffRotateKey( spep_6 -3 + 58, ctzuo, -33.5 +r6 );
setEffRotateKey( spep_6 -3 + 60, ctzuo, -33.4 +r6 );
setEffRotateKey( spep_6 -3 + 107, ctzuo, -33.4 +r6 );
setEffAlphaKey( spep_6 -3 + 42, ctzuo, 255 );
setEffAlphaKey( spep_6 -3 + 107, ctzuo, 255 );

-- ** 音 ** --
--かめはめ波発射
SE049 = playSeVer2( spep_6 + 32, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_6 + 32, SE049, 79 );
SE050 = playSeVer2( spep_6 + 32, 1022, "", 0, 0, 0, -1);
SE051 = playSeVer2( spep_6 + 32, 1145, "", 0, 0, 0, -1);

--気弾飛んでいく
SE052 = playSeVer2( spep_6 + 80, 1202, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_6 + 80, SE052, 214 );

-- ** 黒背景 ** --
entryFadeBg( spep_6 + 0, 0, 107 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景

-- ** 白フェード ** --
entryFade( spep_6 + 0, 0, 0, 8, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( spep_6 + 96, 10 -1, 0, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
-- ** エフェクト等 ** --
finish = entryEffect( spep_7 + 0, SP_10, 0x100, -1, 0, 0, 0 );  --地面爆発	ef_010
setEffMoveKey( spep_7 + 0, finish, 0, 0 , 0 );
setEffMoveKey( spep_7 + 156, finish, 0, 0 , 0 );
setEffScaleKey( spep_7 + 0, finish, 1.0, 1.0 );
setEffScaleKey( spep_7 + 156, finish, 1.0, 1.0 );
setEffRotateKey( spep_7 + 0, finish, 0 );
setEffRotateKey( spep_7 + 156, finish, 0 );
setEffAlphaKey( spep_7 + 0, finish, 255 );
setEffAlphaKey( spep_7 + 156, finish, 255 );

-- ** 集中線 ** --
shuchusen1 = entryEffectLife( spep_7 + 0, 906, 156, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_7 + 0, shuchusen1, 90, 20 );
setEffMoveKey( spep_7 + 0, shuchusen1, 0, 0 , 0 );
setEffMoveKey( spep_7 + 156, shuchusen1, 0, 0 , 0 );
setEffScaleKey( spep_7 + 0, shuchusen1, 1.8, 2.2 );
setEffScaleKey( spep_7 + 156, shuchusen1,1.8, 2.2 );
setEffRotateKey( spep_7 + 0, shuchusen1, 0 );
setEffRotateKey( spep_7 + 156, shuchusen1, 0 );
setEffAlphaKey( spep_7 + 0, shuchusen1, 255 );
setEffAlphaKey( spep_7 + 156, shuchusen1, 255 );

-- ** 音 ** --
--爆発
SE053 = playSeVer2( spep_7 + 22, 1023, "", 0, 0, 0, -1);
SE054 = playSeVer2( spep_7 + 22, 1159, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_7 + 22, SE054, 69 );
SE055 = playSeVer2( spep_7 + 22, 1024, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_7 + 22, SE055, 91 );

-- ** 黒背景 ** --
entryFadeBg( spep_7 + 0, 0, 156 + 2, 0, 0, 0, 0, 255);       -- ベース暗め　背景

-- ** 白フェード ** --
entryFade( spep_7 + 0, 0, 0, 24, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
-- ** エフェクト等 ** --
antenna_f = entryEffect( spep_3 + 0, SP_05r, 0x100, -1, 0, 0, 0 );  --空中戦：エフェクト文字    ef_005
setEffMoveKey( spep_3 + 0, antenna_f, 0, 0 , 0 );
setEffMoveKey( spep_3 + 156, antenna_f, 0, 0 , 0 );
setEffScaleKey( spep_3 + 0, antenna_f, 1.0, 1.0 );
setEffScaleKey( spep_3 + 156, antenna_f, 1.0, 1.0 );
...
-- ** エフェクト等 ** --
shot = entryEffectLife( spep_6 + 0, SP_09r, 105, 0x100, -1, 0, 0, 0 );  --かめはめ波発射    ef_009
setEffMoveKey( spep_6 + 0, shot, 0, 0 , 0 );
setEffMoveKey( spep_6 + 105, shot, 0, 0 , 0 );
setEffScaleKey( spep_6 + 0, shot, 1.0, 1.0 );
setEffScaleKey( spep_6 + 105, shot, 1.0, 1.0 );
