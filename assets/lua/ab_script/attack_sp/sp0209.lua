-- 1008031:UR_トランクス(ゼノ)_必殺技：ヒートドームアタック
--sp0209
...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    setEffMoveKey(  spep_x+90,  shuchusen,  0,  0);
    setEffScaleKey(  spep_x+90,  shuchusen,  1.0,  1.0);
    setEffRotateKey(  spep_x+90,  shuchusen,  0);
    setEffAlphaKey(  spep_x+90,  shuchusen,  255);
...
SE004 = playSe( SP_start+ 390, SE_06);
...
SE006 = playSe( SP_start+ 455, SE_09);
-- 敵吹っ飛ぶモーション
...
SE005 = playSe( SP_start+ 414, SE_07);
------------------------------------------------------
-- 爆発 ( 110F)
------------------------------------------------------
...
bakuhatu = entryEffect( SP_start2+ SP_start+ 470, SP_04,  0x80,  -1,  0,  0,  0);   -- 爆発
setEffScaleKey( SP_start2, bakuhatu, 1.1, 1.1);
setEffScaleKey( SP_start2+ SP_start+ 470, bakuhatu, 1.1, 1.1);
