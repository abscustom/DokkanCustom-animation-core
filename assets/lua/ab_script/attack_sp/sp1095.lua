...
stopSe( SP_dodge - 12, SE1018, 0);
stopSe( SP_dodge - 12, SE1018_2, 0);
...
-- ** 白フェード ** --
entryFade( spep_4 + 94, 3, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
spep_8=spep_7+60;
spep_9=spep_8;
entryFade( spep_8-5, 3, 9, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
entryFadeBg( spep_9, 0, 114, 0, 0, 0, 0, 210);          -- ベース暗め　背景
