...
-- ** 音 ** --
SE001 = playSe( 5, SE_01);
SE002 = playSe( 92, SE_02);
...
-- ** 音 ** --434
playSe( spep_5, SE_07); --435
playSe( spep_5+20, SE_08); --455

------------------------------------------------------
-- 命中(514F開始)
------------------------------------------------------

spep_6 = (spep_5+79); --514F
...
setMoveKey( spep_7+8, 1, 0, 0, 128); --479
