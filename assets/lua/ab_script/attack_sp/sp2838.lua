-- 1000041：ベジータ_ギャリック砲 sp0002流用
-- 1030250：ベジータ(DAIMA)大人状態_必殺技：ギャリック砲
--sp2838
...
sen = entryEffectLife( 264, 920, 109, 0x80,  -1,  0,  0,  0); -- 流線
setEffAlphaKey(264, sen, 255);
...
entryFade( 466, 6,  12, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
