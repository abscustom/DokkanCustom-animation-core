-- 1024770：SSR_トランクス(GT)&ギル_トランクスとギルの作戦
-- sp_effect_a2_00186
-- sp2428
...
--エフェクト(味方)
SP_01 = 160171;	-- 待機	ef_001
SP_02 = 160173;	-- 突進	ef_002
SP_03 = 160175;	-- 回転から連続攻撃	ef_003
SP_03b = 160176;	-- 回転から連続攻撃　裏	ef_003_back
SP_04 = 160179;	-- KO	ef_004
SP_04b = 160180;	-- KO 裏　	ef_004_back

--エフェクト(てき)
SP_01r = 160172;	-- 待機　敵側	ef_001_re
SP_02r = 160174;	-- 突進　敵側	ef_002_re
SP_03r = 160178;	-- 回転から連続攻撃　敵側	ef_003_re
SP_03br = 160177;	-- 回転から連続攻撃　敵側　裏	ef_003_back_re
...
setScaleKey( spep_2 -2 + 2, 1, 1.71, 1.71 );
setScaleKey( spep_2 -3 + 4, 1, 1.64, 1.64 );
setScaleKey( spep_2 -3 + 6, 1, 1.59, 1.59 );
setScaleKey( spep_2 -3 + 8, 1, 1.54, 1.54 );
setScaleKey( spep_2 -3 + 10, 1, 1.49, 1.49 );
setScaleKey( spep_2 -3 + 12, 1, 1.46, 1.46 );
setScaleKey( spep_2 -3 + 14, 1, 1.43, 1.43 );
setScaleKey( spep_2 -3 + 17, 1, 1.4, 1.4 );
setScaleKey( spep_2 -3 + 18, 1, 1.4, 1.4 );
setScaleKey( spep_2 -3 + 20, 1, 1.39, 1.39 );
setScaleKey( spep_2 -3 + 22, 1, 1.37, 1.37 );
setScaleKey( spep_2 -3 + 24, 1, 1.36, 1.36 );
setScaleKey( spep_2 -3 + 28, 1, 1.36, 1.36 );
setScaleKey( spep_2 -3 + 30, 1, 1.35, 1.35 );
setScaleKey( spep_2 -3 + 38, 1, 1.35, 1.35 );
setScaleKey( spep_2 -3 + 40, 1, 1.36, 1.36 );
setScaleKey( spep_2 -3 + 42, 1, 1.37, 1.37 );
setScaleKey( spep_2 -3 + 44, 1, 1.38, 1.38 );
setScaleKey( spep_2 -3 + 46, 1, 1.4, 1.4 );
setScaleKey( spep_2 -3 + 48, 1, 1.41, 1.41 );
setScaleKey( spep_2 -3 + 50, 1, 1.42, 1.42 );
setScaleKey( spep_2 -3 + 142, 1, 1.42, 1.42 );
...
--気弾発射＆爆発
SE033 = playSeVer2( spep_2 + 276, 1027, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_2 + 276, SE033, 72 );
SE034 = playSeVer2( spep_2 + 276, 1023, "", 0, 0, 0, 0.6);
SE035 = playSeVer2( spep_2 + 276, 1024, "", 0, 0, 0, 0.6);
SE036 = playSeVer2( spep_2 + 276, 1145, "", 0, 0, 0, 0.6);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_3f = entryEffect( spep_3 + 0, SP_04, 0x100, -1, 0, 0, 0); -- KO	ef_004
setEffMoveKey( spep_3 + 0, base_3f, 0, 0 , 0);
setEffMoveKey( spep_3 + 200 -4, base_3f, 0, 0 , 0);
setEffScaleKey( spep_3 + 0, base_3f, 1.0, 1.0);
setEffScaleKey( spep_3 + 200 -4, base_3f, 1.0, 1.0);
setEffRotateKey( spep_3 + 0, base_3f, 0);
setEffRotateKey( spep_3 + 200 -4, base_3f, 0);
setEffAlphaKey( spep_3 + 0, base_3f, 255);
setEffAlphaKey( spep_3 + 200 -5, base_3f, 255);
setEffAlphaKey( spep_3 + 200 -4, base_3f, 0);

base_3b = entryEffect( spep_3 + 0, SP_04b, 0x80, -1, 0, 0, 0); -- KO 裏　	ef_004_back
setEffMoveKey( spep_3 + 0, base_3b, 0, 0 , 0);
setEffMoveKey( spep_3 + 200 -4, base_3b, 0, 0 , 0);
setEffScaleKey( spep_3 + 0, base_3b, 1.0, 1.0);
setEffScaleKey( spep_3 + 200 -4, base_3b, 1.0, 1.0);
setEffRotateKey( spep_3 + 0, base_3b, 0);
setEffRotateKey( spep_3 + 200 -4, base_3b, 0);
setEffAlphaKey( spep_3 + 0, base_3b, 255);
setEffAlphaKey( spep_3 + 200 -5, base_3b, 255);
setEffAlphaKey( spep_3 + 200 -4, base_3b, 0);

-- ** 黒背景 ** --
entryFadeBg( spep_3 + 0, 0, 200 -5, 0, 0, 0, 0, 255);  --黒 背景


-- ** 敵キャラクター ** --
setDisp( spep_3 -3 + 4, 1, 1 );
changeAnime( spep_3 -3 + 4, 1, 107 );

setMoveKey( spep_3 -3 + 4, 1, 2.1, -53.9 , 0 );
setMoveKey( spep_3 -3 + 6, 1, -2.3, -59.7 , 0 );
setMoveKey( spep_3 -3 + 8, 1, -6.6, -64.9 , 0 );
setMoveKey( spep_3 -3 + 10, 1, -10.4, -70.8 , 0 );
setMoveKey( spep_3 -3 + 12, 1, -15.2, -76.7 , 0 );
setMoveKey( spep_3 -3 + 14, 1, -19.3, -81.6 , 0 );
setMoveKey( spep_3 -3 + 16, 1, -23, -87.9 , 0 );
setMoveKey( spep_3 -3 + 18, 1, -28.1, -93.6 , 0 );
setMoveKey( spep_3 -3 + 20, 1, -28.1, -93.7 , 0 );
setMoveKey( spep_3 -3 + 22, 1, -28.1, -93.6 , 0 );
setMoveKey( spep_3 -3 + 24, 1, -28.1, -93.7 , 0 );
setMoveKey( spep_3 -3 + 26, 1, -28.1, -93.6 , 0 );
setMoveKey( spep_3 -3 + 28, 1, -28.1, -93.7 , 0 );
setMoveKey( spep_3 -3 + 30, 1, -28.1, -93.6 , 0 );
setMoveKey( spep_3 -3 + 32, 1, -28.1, -93.7 , 0 );
setMoveKey( spep_3 -3 + 34, 1, -28.1, -93.6 , 0 );
setMoveKey( spep_3 -4 + 200, 1, -28.1, -93.6 , 0 );

setScaleKey( spep_3 -3 + 4, 1, 0.21, 0.21 );
setScaleKey( spep_3 -3 + 6, 1, 0.435, 0.435 );
setScaleKey( spep_3 -3 + 8, 1, 0.66, 0.66 );
setScaleKey( spep_3 -3 + 10, 1, 0.89, 0.885 );
setScaleKey( spep_3 -3 + 12, 1, 1.115, 1.115 );
setScaleKey( spep_3 -3 + 14, 1, 1.345, 1.34 );
setScaleKey( spep_3 -3 + 16, 1, 1.57, 1.565 );
setScaleKey( spep_3 -3 + 18, 1, 1.8, 1.795 );
setScaleKey( spep_3 -3 + 20, 1, 1.98, 1.975 );
setScaleKey( spep_3 -3 + 22, 1, 1.8, 1.795 );
setScaleKey( spep_3 -3 + 24, 1, 1.98, 1.975 );
setScaleKey( spep_3 -3 + 26, 1, 1.8, 1.795 );
setScaleKey( spep_3 -3 + 28, 1, 1.98, 1.975 );
setScaleKey( spep_3 -3 + 30, 1, 1.8, 1.795 );
setScaleKey( spep_3 -3 + 32, 1, 1.98, 1.975 );
setScaleKey( spep_3 -3 + 34, 1, 1.8, 1.795 );
setScaleKey( spep_3 -4 + 200, 1, 1.8, 1.795 );

setRotateKey( spep_3 -3 + 4, 1, -122.8 );
...
setRotateKey( spep_3 -4 + 200, 1, 729.5 );


-- ** 音 ** --
--画面割れる
SE037 = playSeVer2( spep_3 + 12, 1054, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_3 + 12, 1025, "", 0, 0, 0, -1);


-- ** ダメージ表示 ** --
dealDamage( spep_3 + 10 -3); -- ダメージ表示フレーム
