--4027300:LR_超サイヤ人トランクス(未来)_必殺技：フラッシュブレード（スタンバイ後）
--sp_effect_a9_00110
--sp2611
...
--エフェクト(味方)
SP_01 = 162245; --ef_001 登場、攻撃
SP_01b = 162246; --ef_001_back 登場、攻撃　裏側
SP_02 = 162249; --ef_002 フィニッシュ
SP_02b = 162250; --ef_002_back フィニッシュ

--エフェクト(てき)
SP_01r = 162247; --ef_001_r 登場、攻撃　敵側
SP_01rb = 162248; --ef_001_r_back 登場、攻撃　敵側裏側
SP_02r = 162251; --ef_002_r フィニッシュ　敵側
SP_02rb = 162252; --ef_002_r_back フィニッシュ 敵側裏側
...
-- ** 音 ** --
--オーラ
SE001 = playSeVer2( spep_0 + 0, 1181, "",spep_0 + 272, 0, 24, -1);
setSeVolumeByWorkId( spep_0 + 0, SE001, 158 );
SE002 = playSeVer2( spep_0 + 0, 1407, "",spep_0 + 270, 0, 22, -1);

--入り
SE003 = playSeVer2( spep_0 + 4, 1232, "", 0, 0, 0, -1);

--剣構える
SE004 = playSeVer2( spep_0 + 42, 1004, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 46, 1035, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 46, SE005, 89 );
setTimeStretch( SE005, 0.75, 30, 4 );
SE006 = playSeVer2( spep_0 + 50, 1122, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 50, SE006, 89 );
setTimeStretch( SE006, 0.77, 30, 4 );
SE007 = playSeVer2( spep_0 + 50, 1061, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 52, 1252, "",spep_0 + 176, 0, 22, -1);

--飛び込んでいく
SE010 = playSeVer2( spep_0 + 154, 1182, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_0 + 154, 1117, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 154, 1314, "",spep_0 + 248, 0, 36, -1);
SE013 = playSeVer2( spep_0 + 154, 1011, "", 0, 0, 0, -1);
...
SE016 = playSeVer2( spep_0 + 246, 1141, "",spep_0 + 344, 0, 12, -1);
SE017 = playSeVer2( spep_0 + 250, 1009, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 250, SE017, 82 );

--連続斬り２
SE018 = playSeVer2( spep_0 + 262, 1031, "", 0, 0, 0, -1);
SE019 = playSeVer2( spep_0 + 264, 1141, "",spep_0 + 340, 0, 10, -1);
SE020 = playSeVer2( spep_0 + 268, 1010, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 268, SE020, 82 );

--連続斬り３
SE021 = playSeVer2( spep_0 + 282, 1032, "", 0, 0, 0, -1);
SE022 = playSeVer2( spep_0 + 286, 1141, "",spep_0 + 338, 0, 8, -1);
SE023 = playSeVer2( spep_0 + 290, 1009, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 290, SE023, 80 );

--敵吹き飛ぶ
SE024 = playSeVer2( spep_0 + 302, 1027, "",spep_0 + 338, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 302, SE024, 60 );
...
SE027 = playSeVer2( spep_1 + 92, 1117, "", 0, 0, 0, -1);
SE028 = playSeVer2( spep_1 + 92, 1167, "",spep_2 + 58, 0, 14, -1);
setSeVolumeByWorkId( spep_1 + 92, SE028, 46 );
...
-- ** 音 ** --
--袈裟斬り１
SE029 = playSeVer2( spep_2 + 40, 1061, "", 0, 0, 0, -1);
SE030 = playSeVer2( spep_2 + 40, 1032, "", 0, 0, 0, -1);
SE031 = playSeVer2( spep_2 + 40, 1143, "", 0, 0, 0, -1);
setPitch( spep_2 + 40, SE031, 300 );
setTimeStretch( SE031, 1.2, 30, 4 );
SE032 = playSeVer2( spep_2 + 40, 1187, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 40, SE032, 59 );

--袈裟斬り２
SE033 = playSeVer2( spep_2 + 88, 1061, "", 0, 0, 0, -1);
SE034 = playSeVer2( spep_2 + 88, 1032, "", 0, 0, 0, -1);
SE035 = playSeVer2( spep_2 + 88, 1187, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 88, SE035, 63 );
SE037 = playSeVer2( spep_2 + 92, 1141, "", 0, 0, 0, -1);
setPitch( spep_2 + 92, SE037, 200 );
setTimeStretch( SE037, 1.13, 30, 4 );

--環境音
SE036 = playSeVer2( spep_2 + 92, 1269, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 92, SE036, 25 );

--オーラ
SE038 = playSeVer2( spep_2 + 130, 1181, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 130, SE038, 141 );
SE039 = playSeVer2( spep_2 + 130, 1407, "",spep_2 + 478, 0, 10, -1);

--画面遷移
SE040 = playSeVer2( spep_2 + 132, 1072, "", 0, 0, 0, 0.6);

--ラスト水平斬り
SE041 = playSeVer2( spep_2 + 198, 1032, "", 0, 0, 0, -1);
SE042 = playSeVer2( spep_2 + 202, 1061, "", 0, 0, 0, -1);
SE043 = playSeVer2( spep_2 + 202, 1120, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 202, SE043, 81 );
SE044 = playSeVer2( spep_2 + 206, 1187, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 206, SE044, 83 );
SE045 = playSeVer2( spep_2 + 208, 1143, "", 0, 0, 0, -1);
