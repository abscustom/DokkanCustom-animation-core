--1023280:UR_超サイヤ人3ゴテンクス(ゼノ)_必殺技：超ウルトラバーニングかめはめ波
--sp_effect_a1_00325
--sp2290
...
--味方側
SP_01  = 158580; --登場〜構えて気弾溜め (ef_001)
SP_02  = 158582; --充填 (ef_002)
SP_03  = 158584; --気弾を放つ (ef_003)
SP_04  = 158586; --気弾を放つ_軌道 (ef_004)
SP_05  = 158587; --気弾を放つ_集中線 (ef_005)

--敵側
SP_01x = 158581; --登場〜構えて気弾溜め：敵側反転 (ef_001r)
SP_02x = 158583; --充填：敵側反転 (ef_002r)
SP_03x = 158585; --気弾を放つ：敵側反転 (ef_003r)
SP_04x = 158586; --気弾を放つ_軌道 (ef_004)
SP_05x = 158587; --気弾を放つ_集中線 (ef_005)
...
-- ** エフェクト等 ** --
kamae = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0 );  --登場〜構えて気弾溜め (ef_001)
...
SE0X4 = playSe( spep_0 + 174, 1132 );
setSeVolume( spep_0 + 174, 1132, 80 );

SE0X5 = playSe( spep_0 + 186, 1036 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
tame = entryEffect( spep_1 + 0, SP_02, 0x100, -1, 0, 0, 0 );  --充填 (ef_002)
...
-- ** 音 ** --
--気弾溜め
playSe( spep_1 +14, 1036 );
setSeVolume( spep_1 + 14, 1036, 90 );

--ゴゴゴ
playSe( spep_1 +22, 1018 );

--気弾溜め
playSe( spep_1 +38, 1036 );
setSeVolume( spep_1 + 38, 1036, 90 );

--気弾溜め
playSe( spep_1 +62, 1036 );
...
-- ** エフェクト等 ** --
hhassya = entryEffect( spep_3 + 0, SP_03, 0x100, -1, 0, 0, 0 );  --気弾を放つ (ef_003)
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge - 12, SE0X5, 0 );
    --stopSe( SP_dodge - 12, SE1, 0 );
    --stopSe( SP_dodge - 12, SE2, 0 );
    setSeVolume( SP_dodge - 12, 43, 100 );
...
-- ** エフェクト等 ** --
tyakudanf = entryEffect( spep_4 + 0, SP_04,  0x100, -1, 0, 0, 0 );  --気弾を放つ_軌道 (ef_004)
...
tyakudanb = entryEffect( spep_4 + 0, SP_05, 0x80, -1, 0, 0, 0 );  --気弾を放つ_集中線 (ef_005)
...
-- ** エフェクト等 ** --
kamae = entryEffect( spep_0 + 0, SP_01x, 0x100, -1, 0, 0, 0 );  --登場〜構えて気弾溜め：敵側反転 (ef_001r)
setEffMoveKey( spep_0 + 0, kamae, 0, 0 , 0 );
setEffMoveKey( spep_0 + 196, kamae, 0, 0 , 0 );
setEffScaleKey( spep_0 + 0, kamae, 1.0, 1.0 );
setEffScaleKey( spep_0 + 196, kamae, 1.0, 1.0 );
...
SE0X7 = playSe( spep_0 + 174, 1132 );
setSeVolume( spep_0 + 174, 1132, 80 );

SE0X8 = playSe( spep_0 + 186, 1036 );
setSeVolume( spep_0 + 186, 1036, 90 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
tame = entryEffect( spep_1 + 0, SP_02x, 0x100, -1, 0, 0, 0 );  --充填：敵側反転 (ef_002r)
setEffMoveKey( spep_1 + 0, tame, 0, 0 , 0 );
setEffMoveKey( spep_1 + 100, tame, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, tame, 1.0, 1.0 );
setEffScaleKey( spep_1 + 100, tame, 1.0, 1.0 );
...
-- ** エフェクト等 ** --
hhassya = entryEffect( spep_3 + 0, SP_03x, 0x100, -1, 0, 0, 0 );  --気弾を放つ：敵側反転 (ef_003r)
setEffMoveKey( spep_3 + 0, hhassya, 0, 0 , 0 );
setEffMoveKey( spep_3 + 90, hhassya, 0, 0 , 0 );
setEffScaleKey( spep_3 + 0, hhassya, 1.0, 1.0 );
setEffScaleKey( spep_3 + 90, hhassya, 1.0, 1.0 );
...
if(_IS_DODGE_ == 1) then
    ...
    --playSe( SP_dodge - 12, 1042 );
    stopSe( SP_dodge - 12, SE0, 0 );
    stopSe( SP_dodge - 12, SE0X6, 0 );
    stopSe( SP_dodge - 12, SE0X7, 0 );
    stopSe( SP_dodge - 12, SE0X8, 0 );
    --stopSe( SP_dodge - 12, SE1, 0 );
    --stopSe( SP_dodge - 12, SE2, 0 );
    setSeVolume( SP_dodge - 12, 43, 100 );
...
-- ** エフェクト等 ** --
tyakudanf = entryEffect( spep_4 + 0, SP_04x,  0x100, -1, 0, 0, 0 );  --気弾を放つ_軌道 (ef_004)
setEffMoveKey( spep_4 + 0, tyakudanf, 0, 0 , 0 );
setEffMoveKey( spep_4 + 98, tyakudanf, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, tyakudanf, 1.0, 1.0 );
setEffScaleKey( spep_4 + 98, tyakudanf, 1.0, 1.0 );
...
tyakudanb = entryEffect( spep_4 + 0, SP_05x, 0x80, -1, 0, 0, 0 );  --気弾を放つ_集中線 (ef_005)
setEffMoveKey( spep_4 + 0, tyakudanb, 0, 0 , 0 );
setEffMoveKey( spep_4 + 98, tyakudanb, 0, 0 , 0 );
setEffScaleKey( spep_4 + 0, tyakudanb, 1.0, 1.0 );
setEffScaleKey( spep_4 + 98, tyakudanb, 1.0, 1.0 );
