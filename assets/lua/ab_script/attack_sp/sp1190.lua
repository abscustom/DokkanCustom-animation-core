--1014640 人造人間21号(善)_エクセレントフルコース
--sp1190
...
SE01 = playSe(  spep_1+26,  SE_01);  --気溜め
SE02 = playSe(  spep_1+80,  SE_04);  --カットイン音
...
-- ** 白フェード ** --
entryFade( spep_c + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( spep_c + 76, 6, 14, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
