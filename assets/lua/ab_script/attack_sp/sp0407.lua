...
-- カードカットイン(94F)
------------------------------------------------------
--entryFade( 165 -1, 3-1, 5+3, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- ** 白フェード ** --
entryFade( spep_c + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( spep_c + 80, 10, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
