...
-- 書き文字エントリー
ct = entryEffectLife( SP_start+ 90, 10008, 80, 0x100, -1, 0, -240, 350);    -- ゴゴゴ・・・
...
SE00 = playSe( SP_start+ 170+64, SE_06);
------------------------------------------------------
-- カメハメハ発射(110F)
------------------------------------------------------
...
SE01 = playSe( SP_start+ 260, SE_07);
...
SE02 = playSe( SP_start+ 300, SE_07);
...
SE03 = playSe( SP_start+ 390, SE_06);
...
SE04 = playSe( SP_start+ 455, SE_09);
-- 敵吹っ飛ぶモーション
