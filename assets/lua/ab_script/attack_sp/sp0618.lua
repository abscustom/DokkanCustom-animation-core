...
-- ** 音 ** --
playSe( spep_c + 90, 1004 );
stopSe( spep_c + 2, SE0, 0 );
stopSe( spep_c + 0, SE01, 0 );
...
setDisp( spep_2 -3 + 612, 1, 1 );
setDisp( spep_2 -3 + 726, 1, 0 );
changeAnime( spep_2 -3 + 218, 1,17 );
changeAnime( spep_2 -3 + 350, 1,4 );
changeAnime( spep_2 -3 + 538, 1,8 );
