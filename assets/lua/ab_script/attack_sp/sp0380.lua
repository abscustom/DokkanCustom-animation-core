--1012020_ゴールデンフリーザ(天使)_エンペラーデスビーム_sp0380
--1021360
...
speff1 = entryEffect( spep_1, 1505, 0, -1, 0, 0, 0);   -- eff_006 (セリフ)
setEffReplaceTexture( speff1, 4, 5);                     -- セリフ差し替え

-- ** 書き文字エントリー ** --
gogogo = entryEffectLife( spep_1+14, 190006, 73, 0, -1, 0, -110-60, 480); -- ゴゴゴゴゴ
