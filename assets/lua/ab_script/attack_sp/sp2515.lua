--1026340:ゴテンクス(失敗)A_イノシシアタック(極限あり)
--sp_effect_b1_00242
...
--味方側
SP_01 = 161622; --冒頭シーン ef_001
SP_02 = 161624; --横突進   ef_002
SP_03 = 161626; --ヒット   ef_003
SP_04 = 161628; --ヒット　奥 ef_004
SP_05 = 161629; --ダメージ　手前   ef_005
SP_06 = 161630; --ダメージ　奥    ef_006


--敵側
SP_01r = 161623; --冒頭シーン　敵  ef_001r
SP_02r = 161625; --横突進　敵    ef_002r
SP_03r = 161627; --ヒット　敵    ef_003r
SP_04r = 161628; --ヒット　奥    ef_004
SP_05r = 161629; --ダメージ　手前  ef_005
SP_06r = 161630; --ダメージ　奥   ef_006
...
--画面遷移
SE007 = playSeVer2( spep_0 + 74, 8, "", 0, 0, 0, -1);

--構える
SE008 = playSeVer2( spep_0 + 114, 1003, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_0 + 116, 1007, "", 0, 0, 0, -1);
...
-- ** 音 ** --
--走ってくる
SE010 = playSeVer2( spep_0 + 140, 1111, "", 0, 0, 0, 0.6);
setSeVolumeByWorkId( spep_0 + 140, SE010, 174 );
SE011 = playSeVer2( spep_0 + 140, 1293, "",spep_0 + 162, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 140, SE011, 67 );
SE012 = playSeVer2( spep_0 + 158, 1293, "",spep_0 + 180, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 158, SE012, 87 );
SE013 = playSeVer2( spep_0 + 176, 1293, "",spep_0 + 198, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 176, SE013, 77 );
SE014 = playSeVer2( spep_0 + 194, 1293, "",spep_0 + 210, 0, 10, -1);
setSeVolumeByWorkId( spep_0 + 194, SE014, 67 );
