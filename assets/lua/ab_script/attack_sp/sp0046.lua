...
------------------------------------------------------
-- ** カードカットイン ** --
speff2 = entryEffectLife( 170 + 0, 1507, 90, 0x100, -1, 0, 0, 0 );   -- カード
...
stopSe( SP_dodge-12, SE996, 0);
stopSe( SP_dodge-12, SE997, 0);
stopSe( SP_dodge-8, SE998, 0);
...
------------------------------------------------------
-- ** カードカットイン ** --
speff2 = entryEffectLife( SP_ATK_1 + 0, 1507, 90, 0x100, -1, 0, 0, 0 );   -- カード
setEffReplaceTexture( speff2, 1, 1 );
setEffReplaceTexture( speff2, 2, 0 );-- カード差し替え
setEffReplaceTexture( speff2, 5, 4 );-- 技名テクスチャ差し替え

-- ** 集中線 ** --
shuchusen = entryEffectLife( SP_ATK_1 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( SP_ATK_1 + 0, shuchusen, 90, 20 );
setEffMoveKey( SP_ATK_1 + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( SP_ATK_1 + 70, shuchusen, 0, 0 , 0 );
setEffScaleKey( SP_ATK_1 + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( SP_ATK_1 + 70, shuchusen, 1.6, 1.6 );
setEffRotateKey( SP_ATK_1 + 0, shuchusen, 0 );
setEffRotateKey( SP_ATK_1 + 70, shuchusen, 0 );
setEffAlphaKey( SP_ATK_1 + 0, shuchusen, 255 );
setEffAlphaKey( SP_ATK_1 + 70, shuchusen, 255 );

-- ** 音 ** --
SE994 =  playSe( SP_ATK_1+0, SE_05 );

-- ** 白背景 ** --
entryFadeBg( SP_ATK_1 + 0, 0, 96, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景
 
-- ** 白フェード ** --
entryFade( 15 , 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- ** エフェクト等 ** --
entryFadeBg( SP_ATK_2, 0, 120, 0, 10, 10, 10, 180);       -- ベース暗め　背景
...
SE996 = playSe( SP_ATK_2+90, SE_06);
...
SE997 = playSe( SP_ATK_3, SE_08);

--end

setDisp( SP_ATK_3, 0, 0);
setDisp( SP_ATK_3, 1, 1);
setDisp( SP_ATK_3+ 34, 1, 0);
...
playSe( SP_dodge-12, 1042);
stopSe( SP_dodge-12, SE993, 0);
stopSe( SP_dodge-12, SE994, 0);
stopSe( SP_dodge-12, SE995, 0);
stopSe( SP_dodge-12, SE996, 0);
stopSe( SP_dodge-12, SE997, 0);
stopSe( SP_dodge-1, SE998, 0);
stopSe( SP_dodge-12, SE999, 0);
