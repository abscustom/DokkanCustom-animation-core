...
-- 文字エントリー --
ctgogo = entryEffectLife( spep_0-4 +16, 190006, 72, 0x100, -1, 0, 50, 510);-- ゴゴゴゴ

setEffMoveKey(  spep_0-4 +16,  ctgogo,  50,  510);
setEffMoveKey(  spep_0-4 +88,  ctgogo,  50,  510);
...
--SE
SE008_re = playSeVer2( spep_2 + 0, 1117, "",spep_2 + 68, 6, 10, -1);
setStartTimeMs( SE008_re,  217 );
se_1109 = playSe( spep_2 + 0, 1109 );
setSeVolume( spep_2 + 0, 1109, 81 );
se_0044 = playSe( spep_2 + 0, 44 );
setSeVolume( spep_2 + 0, 44, 71 );

--気ダメ
SE0=playSe( spep_2 + 40, 1035 );
SE1=playSe( spep_2 + 42, 1011 );
se_1182 = playSe( spep_2 + 42, 1182 );
setSeVolume( spep_2 + 42, 1182, 158 );

--垂直に飛び上がる
se_0063 = playSe( spep_2 + 64, 63 );
SE2=playSe( spep_2 + 70, 148 );
se_0044_02 = playSe( spep_2 + 70, 44 );
setSeVolume( spep_2 + 70, 44, 79 );

stopSe( spep_2 + 26, se_1109, 7 );
stopSe( spep_2 + 58, se_0044, 4 );
stopSe( spep_2 + 60, se_1182, 20 );
...
--SE
--奥で十字に光る
SE017_re = playSeVer2( spep_2 + 96, 1143, "", 0, 2, 0, -1);   
setSeVolumeByWorkId( spep_2 + 96, SE017_re, 56 ); 
setStartTimeMs( SE017_re,  167 );
SE018_re = playSeVer2( spep_2 + 96, 1042, "",spep_2 + 96 + 46, 0, 36, -1);    
setSeVolumeByWorkId( spep_2 + 96, SE018_re, 63 );

--手前に飛んでくる
SE020_re = playSeVer2( spep_2 + 106, 1183, "",spep_2 + 204, 82, 10, -1);   
setSeVolumeByWorkId( spep_2 + 106, SE020_re, 178 );
SE019_re = playSeVer2( spep_2 + 140, 1121, "",spep_2 + 204, 46, 10, -1);   
setSeVolumeByWorkId( spep_2 + 140, SE019_re, 158 );
setStartTimeMs( SE019_re,  600 );

SE021_re = playSeVer2( spep_2 + 152, 1072, "", 0, 0, 0, 0.6);
SE022_re = playSeVer2( spep_2 + 182, 1182, "", 0, 12, 0, -1);
setStartTimeMs( SE022_re,  183 );
...
SE035 = playSeVer2( spep_2 + 306, 1004, "", 0, 0, 0, -1);
SE036 = playSeVer2( spep_2 + 316, 1190, "",spep_2 + 362, 0, 22, -1);
setSeVolumeByWorkId( spep_2 + 316, SE036, 79 );
SE037 = playSeVer2( spep_2 + 316, 1182, "",spep_0 + 338, 0, 14, -1);
setSeVolumeByWorkId( spep_2 + 316, SE037, 158 );
SE038 = playSeVer2( spep_2 + 316, 1110, "", 0, 0, 0, -1);
SE039 = playSeVer2( spep_2 + 354, 1183, "",spep_2 + 382, 14, 0, -1);    
setSeVolumeByWorkId( spep_2 + 354, SE039, 158 );    
setStartTimeMs( SE039,  483 );
SE040 = playSeVer2( spep_2 + 370, 1190, "",spep_2 + 418, 0, 20, -1);
SE041 = playSeVer2( spep_2 + 370, 1182, "",spep_2 + 394, 0, 14, -1);    
setSeVolumeByWorkId( spep_2 + 370, SE041, 200 );
SE042 = playSeVer2( spep_2 + 370, 1110, "", 0, 0, 0, -1);   
setSeVolumeByWorkId( spep_2 + 370, SE042, 112 );
SE043 = playSeVer2( spep_2 + 370, 1047, "", 0, 0, 0, -1);
SE044 = playSeVer2( spep_2 + 374, 1001, "", 0, 0, 0, -1);

se_1116 = playSe( spep_2 + 400, 1116 );
stopSe( spep_2 + 426, se_1116, 26 );

SE046 = playSeVer2( spep_2 + 438, 1128, "",spep_2 + 566, 48, 6, -1);    
setSeVolumeByWorkId( spep_2 + 438, SE046, 25 ); 
setStartTimeMs( SE046,  283 );
SE047 = playSeVer2( spep_2 + 436, 1209, "", 0, 0, 0, -1);   
setSeVolumeByWorkId( spep_2 + 436, SE047, 56 );
SE048 = playSeVer2( spep_2 + 436, 1109, "", 0, 0, 0, -1);   
setSeVolumeByWorkId( spep_2 + 436, SE048, 79 );
SE049 = playSeVer2( spep_2 + 436, 1119, "",spep_2 + 492, 0, 10, -1); 
setSeVolumeByWorkId( spep_2 + 436, SE049, 32 );
SE050 = playSeVer2( spep_2 + 436, 1210, "",spep_2 + 566, 0, 6, -1);
