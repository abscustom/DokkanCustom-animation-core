--1021710:トランクス(青年期)_バーニングアタック(衣装替え)
--sp_effect_a1_00286
...
--エフェクト(味方)
SP_01 = 156991;  --突進→瞬間移動 ef_001
SP_02 = 156993;  --トランクス蹴りエフェクト    ef_002
SP_03 = 156994;  --瞬間移動→蹴り ef_003
SP_04 = 156996;  --瞬間移動→背景 ef_004
SP_05 = 156997;  --瞬間移動→裏拳 ef_005
SP_06 = 156999;  --敵地面激突   ef_006
SP_07 = 157000;  --バーニングアタック   ef_007
SP_08 = 157002;  --気弾追撃    ef_008
SP_09 = 157003;  --大爆発 ef_009

--エフェクト(敵)
SP_01r = 156992;  --突進→瞬間移動(敵側) ef_001_r
SP_03r = 156995;  --瞬間移動→(敵側)   ef_003_r
SP_05r = 156998;  --瞬間移動→裏拳(敵側) ef_005_r
SP_07r = 157001;  --バーニングアタック(敵側)   ef_007_r
SP_09r = 157004;  --大爆発(敵側) ef_009_r
...
-- 文字エントリー --
ctgogo = entryEffectLife( spep_5 -12 +18, 190006, 72, 0x100, -1, 0, 100 -30, 510);-- ゴゴゴゴ

setEffMoveKey(  spep_5 -12 +18,  ctgogo,  100 -30,  510);
setEffMoveKey(  spep_5 -12 +90,  ctgogo,  100 -30,  510);
...
-- ** エフェクト等 ** --
fighting_n = entryEffect( spep_1 + 0, SP_03r, 0x80, -1, 0, 0, 0 ); 
setEffMoveKey( spep_1 + 0, fighting_n, 0, 0, 0 );
setEffMoveKey( spep_1 + 70, fighting_n, 0, 0, 0 );
setEffScaleKey( spep_1 + 0, fighting_n, 1.0, 1.0 );
setEffScaleKey( spep_1 + 70, fighting_n, 1.0, 1.0 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
backhander = entryEffect( spep_2 + 0, SP_05r, 0x80, -1, 0, 0, 0 ); 
setEffMoveKey( spep_2 + 0, backhander, 0, 0, 0 );
setEffMoveKey( spep_2 + 56, backhander, 0, 0, 0 );
setEffScaleKey( spep_2 + 0, backhander, 1.0, 1.0 );
setEffScaleKey( spep_2 + 56, backhander, 1.0, 1.0 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
tame = entryEffect( spep_5 + 0, SP_07r, 0x80, -1, 0, 0, 0 ); 
setEffMoveKey( spep_5 + 0, tame, 0, 0, 0 );
setEffMoveKey( spep_5 + 130, tame, 0, 0, 0 );
setEffScaleKey( spep_5 + 0, tame, 1.0, 1.0 );
setEffScaleKey( spep_5 + 130, tame, 1.0, 1.0 );
...
------------------------------------------------------
-- ** エフェクト等 ** --
explosion = entryEffect( spep_7 + 0, SP_09r, 0x80, -1, 0, 0, 0 ); 
setEffMoveKey( spep_7 + 0, explosion, 0, 0, 0 );
setEffMoveKey( spep_7 + 120, explosion, 0, 0, 0 );
setEffScaleKey( spep_7 + 0, explosion, 1.0, 1.0 );
setEffScaleKey( spep_7 + 120, explosion, 1.0, 1.0 );
