...
playSe( spep_1, SE_05);
speff = entryEffect( spep_1, 1507, 0x80, -1, 0, 0, 0); -- カード
...
playSe( spep_1, SE_05);
speff = entryEffect( spep_1, 1120, 0x80, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( spep_1, SE_05);
speff = entryEffect( spep_1, 1121, 0x80, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
