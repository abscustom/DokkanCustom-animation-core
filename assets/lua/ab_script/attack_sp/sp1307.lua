...
setEffScaleKey( spep_0 + 0, rushf, 1.1, 1.1 );
setEffScaleKey( spep_0 + 266, rushf, 1.1, 1.1 );
...
setEffScaleKey( spep_0 + 0, rushb, 1.1, 1.1 );
setEffScaleKey( spep_0 + 266, rushb, 1.1, 1.1 );
...
-- ** 音 ** --
SE001 = playSe( spep_0 + 0, 9 );  --ダッシュ
SE002 = playSe( spep_0 + 5, 1072 );
