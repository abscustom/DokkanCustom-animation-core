...
SP_01 = 102152; --溜め ef_001
SP_02 = 102153; --突撃 ef_002
SP_03 = 102154; --発射 ef_003
SP_04 = 102155; --迫る ef_004
SP_05 = 190003; --ギャン ef_004(汎用)

SP_02e = 102156; --突撃（敵） ef_005
...
entryFadeBg( spep_1, 0, 146, 0, 20, 20, 20, 150);       -- ベース暗め 背景
...
SE003X = playSe( spep_4+20, SE_06);

entryFade( spep_4+35-4, 5,  5+4, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
setEffScaleKey( spep_5 + 0, bakuhatu, 1.1, 1.1);
setEffScaleKey( spep_5 + 120, bakuhatu, 1.1, 1.1);
