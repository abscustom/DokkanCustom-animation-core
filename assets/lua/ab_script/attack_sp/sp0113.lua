...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
print ("_SPECIAL_SKILL_LEVEL_ == 0");
playSe( SP_ATK_1+10, SE_05);
speff = entryEffect( SP_ATK_1+10, 1507, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
print ("_SPECIAL_SKILL_LEVEL_ == 1");
playSe( SP_ATK_1+10, SE_05);
speff = entryEffect( SP_ATK_1+10, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
print ("_SPECIAL_SKILL_LEVEL_ == 2");
playSe( SP_ATK_1+10, SE_05);
speff = entryEffect( SP_ATK_1+10, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
...
entryFade( SP_ATK_1 -5, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE002 = playSe( SP_ATK_2+90, SE_06);
