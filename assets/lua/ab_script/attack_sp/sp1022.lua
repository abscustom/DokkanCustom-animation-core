--1003280:超サイヤ人トランクス(青年期)_必殺技:シャイニングソードアタック
--sp_effect_b2_00003
--sp1022
...
-- 白フェード
entryFade( 166, 0, 4, 2, fcolor_r, fcolor_g, fcolor_b,  255);     -- white fade
entryFade( 248, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
stopSe( SP_dodge-12, SE_CUT);
stopSe( SP_dodge-12, se001);
stopSe( SP_dodge-12, se002);
stopSe( SP_dodge-12, se003);
...
entryFade( SP_ATK_1+45, 0, 5, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
se001 = playSe( SP_ATK_2+47, SE_06);
...
playSe( SP_dodge-12, 1042);
stopSe( SP_dodge-12, SE_CUT);
stopSe( SP_dodge-2, se001);
stopSe( SP_dodge-12, se002);
stopSe( SP_dodge-12, se000);
