--1013770 LR ビルス＆ウイス_デコピン sp0448
...
SE000 = playSe( spep_3, 1022);

SE001 = playSe( spep_3+38, 1011);
setSeVolume( spep_3+38, 1011, 130 );
stopSe( spep_3+48, SE001, 10 );

SE002 = playSe( spep_3+46, 1011);
setSeVolume( spep_3+46, 1011, 90 );
stopSe( spep_3+54, SE002, 10 );

SE003 = playSe( spep_3+52, 1011);
setSeVolume( spep_3+52, 1011, 100 );
stopSe( spep_3+60, SE003, 10 );

SE004 = playSe( spep_3+58, 1011);
setSeVolume( spep_3+58, 1011, 90 );
stopSe( spep_3+84, SE004, 10 );
...
-- ** 集中線 ** --
shuchusen3 = entryEffectLife( spep_5 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_5 + 0, shuchusen3, 90, 20 );
setEffMoveKey( spep_5 + 0, shuchusen3, 0, 0 , 0 );
setEffMoveKey( spep_5 + 90, shuchusen3, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, shuchusen3, 1.6, 1.6 );
setEffScaleKey( spep_5 + 90, shuchusen3, 1.6, 1.6 );
setEffRotateKey( spep_5 + 0, shuchusen3, 0 );
setEffRotateKey( spep_5 + 90, shuchusen3, 0 );
setEffAlphaKey( spep_5 + 0, shuchusen3, 255 );
setEffAlphaKey( spep_5 + 90, shuchusen3, 255 );
