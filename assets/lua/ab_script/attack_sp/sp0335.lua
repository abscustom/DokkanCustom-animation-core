--1019471:超サイヤ人トランクス(幼年期)_必殺技：トリプルかめはめ波
--sp_effect_a1_00070
--sp0334
...
-- 白フェード
entryFade( SPstart + 166, 0, 2, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
--カードカットイン(94F)
--------------------------------------
setScaleKey( spep_c,   0, 1.5, 1.5);
setScaleKey( spep_c+1,   0, 1.0, 1.0);
-- ** カードカットイン ** --
...
SE00=playSe( spep_2, SE_07);
SE01=playSe( spep_2+36, 43);
--playSe( spep_2+48, SE_03);
SE02=playSe( spep_2+58, SE_07);
SE03=playSe( spep_2+120, SE_06);
