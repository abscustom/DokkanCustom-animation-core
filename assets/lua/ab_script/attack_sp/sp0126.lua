...
entryFade( 255, 3-2, 2 +4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( SP_ATK_1, 3-2, 2+4, 4, fcolor_r, fcolor_g, fcolor_b, 90);     -- white fade
...
-- ダメージ表示
dealDamage(SP_ATK_4+15 -5 -2);

--entryFade( SP_ATK_4+100, 9,  10, 1, 8, 8, 8, 255);             -- black fade

endPhase(SP_ATK_4+120 -10 -2);
