--4029370:LR_超サイヤ人孫悟空_フィニッシュ(成功)：奇跡の拳(エネミー側)
--sp_effect_b1_00296
--sp2741
...
--エフェクト(敵)
SP_01r = 163114 --うつむき〜KOまで ef_001_r
...
-- ** エフェクト等 ** --
base_f = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0 );  --うつむき〜KOまで(ef_001)
...
changeAnime( spep_0 + 796 + OFFSET_X, 1, 110 );
...
changeAnime( spep_0 + 962 + OFFSET_X, 1, 106 );
...
changeAnime( spep_0 + 1164 + OFFSET_X, 1, 7 );
changeAnime( spep_0 + 1210 + OFFSET_X, 1, 8 );
changeAnime( spep_0 + 1232 + OFFSET_X, 1, 5 );
changeAnime( spep_0 + 1266 + OFFSET_X, 1, 6 );
changeAnime( spep_0 + 1268 + OFFSET_X, 1, 105 );
changeAnime( spep_0 + 1270 + OFFSET_X, 1, 6 );
changeAnime( spep_0 + 1272 + OFFSET_X, 1, 105 );
changeAnime( spep_0 + 1274 + OFFSET_X, 1, 6 );
changeAnime( spep_0 + 1276 + OFFSET_X, 1, 105 );
changeAnime( spep_0 + 1282 + OFFSET_X, 1, 6 );
...
--エネルギー送る
SE002 = playSeVer2( spep_0 + 64, 1266, "",spep_0 + 302, 16, 32, -1);
setSeVolumeByWorkId( spep_0 + 64, SE002, 45 );
setStartTimeMs( SE002,  1300 );
SE003 = playSeVer2( spep_0 + 52, 1249, "",spep_0 + 246, 40, 30, -1);
setSeVolumeByWorkId( spep_0 + 52, SE003, 126 );
