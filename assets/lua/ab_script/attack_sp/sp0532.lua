--1016400:スーパーベビー2(リベンジファイナルフラッシュ)
--sp_effect_a9_00055
--sp0532
...
--***フェードと背景***
entryFade( spep_2 + 152, 6, 10, 0, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** 白背景 ** --
entryFadeBg( spep_2 + 0, 0, 166 + 2, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景
