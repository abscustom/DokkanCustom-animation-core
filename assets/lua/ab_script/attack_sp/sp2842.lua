--9030450:LR_超ベジット_アクティブ必殺技_エネミー側
--sp_effect_a3_00115
--sp2842
...
--エフェクト(敵)
SP_01r = 163629;  --ef_001_r オーラ出し→崖
...
-- ** エフェクト等 ** --
base_0f = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0); -- オーラ出し→崖(ef_001_r)
...
changeAnime( spep_0 + 194 + OFFSET_X, 1, 4 );
changeAnime( spep_0 + 222 + OFFSET_X, 1, 5 );
...
changeAnime( spep_0 + 388 + OFFSET_X, 1, 7 );
changeAnime( spep_0 + 426 + OFFSET_X, 1, 8 );
changeAnime( spep_0 + 432 + OFFSET_X, 1, 105 );
...
changeAnime( spep_0 + 694 + OFFSET_X, 1, 7 );
...
changeAnime( spep_0 + 758 + OFFSET_X, 1, 107 );
...
changeAnime( spep_0 + 802 + OFFSET_X, 1, 5 );
changeAnime( spep_0 + 806 + OFFSET_X, 1, 6 );
...
changeAnime( spep_0 + 862 + OFFSET_X, 1, 106 );
changeAnime( spep_0 + 870 + OFFSET_X, 1, 6 );
changeAnime( spep_0 + 878 + OFFSET_X, 1, 108 );
changeAnime( spep_0 + 886 + OFFSET_X, 1, 106 );
changeAnime( spep_0 + 894 + OFFSET_X, 1, 5 );
changeAnime( spep_0 + 902 + OFFSET_X, 1, 105 );
changeAnime( spep_0 + 910 + OFFSET_X, 1, 108 );
changeAnime( spep_0 + 918 + OFFSET_X, 1, 6 );
changeAnime( spep_0 + 926 + OFFSET_X, 1, 108 );
changeAnime( spep_0 + 930 + OFFSET_X, 1, 6 );
changeAnime( spep_0 + 938 + OFFSET_X, 1, 108 );
...
changeAnime( spep_0 + 1064 + OFFSET_X, 1, 107 );
...
changeAnime( spep_0 + 1082 + OFFSET_X, 1, 8 );
...
changeAnime( spep_0 + 1246 + OFFSET_X, 1, 8 );
...
changeAnime( spep_0 + 1386 + OFFSET_X, 1, 6 );
...
-- ** ボイス ** --
--「ポタラの威力を見せてやるか！」
--playVoice( spep_0 + 12, 911 );
--setVoiceVolume( spep_0 + 12, 911, 120 );
...
-- ** ボイス ** --
--「遠慮はしねえぞ…くらえ！！！」
--playVoice( spep_0 + 1166, 912 );
--setVoiceVolume( spep_0 + 1166, 912, 120 );
