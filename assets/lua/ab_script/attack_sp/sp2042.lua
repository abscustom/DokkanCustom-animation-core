...
setMoveKey( spep_0-3 + 5, 1, 187.3, -146.2 , 0 );
setMoveKey( spep_0-3 + 6, 1, 188.8, -146.2 , 0 );
setMoveKey( spep_0-3 + 7, 1, 188.8, -146.2 , 0 );
setMoveKey( spep_0-3 + 8, 1, 190.3, -146.2 , 0 );
setMoveKey( spep_0-3 + 9, 1, 190.3, -146.2 , 0 );
...
setScaleKey( spep_0 + 6, 1, 3.46, 3.46 );
