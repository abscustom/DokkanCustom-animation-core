--1006410:超一星龍_必殺技：マイナスエネルギーパワーボール
--sp_effect_a2_00046
--sp0244
...
-- ** エフェクト等 ** --
SE_000 = playSe( spep_2+64, SE_06);

spep_3=spep_2+94; --211 260
...
finish = entryEffect( spep_5,SP_05,0,-1,0,0,0);
setEffMoveKey( spep_5 + 0, finish, 0, 0 , 0 );
setEffMoveKey( spep_5 + 210, finish, 0, 0 , 0 );
setEffScaleKey( spep_5 + 0, finish, 1.0+0.1, 1.0+0.1 );
setEffScaleKey( spep_5 + 210, finish, 1.0+0.1, 1.0+0.1 );
setEffRotateKey( spep_5 + 0, finish, 0 );
setEffRotateKey( spep_5 + 210, finish, 0 );
setEffAlphaKey( spep_5 + 0, finish, 255 );
setEffAlphaKey( spep_5 + 210, finish, 255 );
