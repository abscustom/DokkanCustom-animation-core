...
--エフェクト不具合対応
entryFade( spep_0 + 33, 0, 5, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( spep_0 + 34, 0, 4, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
se_1000 = playSe( spep_0 + 0, 1036 );
se_1100 = playSe( spep_0 + 24, 1036 );
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge - 12, se_1000, 0 );
    stopSe( SP_dodge - 12, se_1100, 0 );
