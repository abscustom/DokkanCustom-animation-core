...
--SE
SE_1018 = playSe( spep_3 + 14, 1018 );
SE_0020 = playSe( spep_3 + 18, 20 );
se_1213 = playSe( spep_3 + 18, 1213 );
setSeVolume( spep_3 + 18, 1213, 71 );
SE_1024 = playSe( spep_3 + 19, 1024 );
se_1044 = playSe( spep_3 + 19, 1044 );
SE_1068 = playSe( spep_3 + 23, 1068 );
SE_1014 = playSe( spep_3 + 24, 1014 );
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge - 12, SE_0020, 0 );
    stopSe( SP_dodge - 12, SE_1024, 0 );
    stopSe( SP_dodge - 12, SE_1068, 0 );
    stopSe( SP_dodge - 12, SE_1014, 0 );
