-- 9028790: UR_超サイヤ人3孫悟空(天使)_アクティブ必殺技：フルパワーかめはめ波(敵側)
-- sp_effect_a1_00435
-- sp2720
...
-- 敵側
SP_01r  = 162840;  -- 気ダメ〜フィニッシュ ef_001r
...
if (_IS_PLAYER_SIDE_ == 1) then else
...
-- ** エフェクト等 ** --
base_0f = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0); -- 気ダメ〜フィニッシュ(ef_001r)
...
changeAnime( spep_0 + 620 + OFFSET_X, 1, 0 );
changeAnime( spep_0 + 720 + OFFSET_X, 1, 4 );
changeAnime( spep_0 + 730 + OFFSET_X, 1, 8 );
...
--気が弾ける1
SE007 = playSeVer2( spep_0 + 48, 1043, "", spep_0 + 126, 0, 10, 0.5);
...
setSeVolumeByWorkId( spep_0 + 378, SE030, 74 );
SE031 = playSeVer2( spep_0 + 378, 1300, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 378, SE031, 74 );
