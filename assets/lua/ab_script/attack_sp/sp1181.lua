...
-- ** カードカットイン ** --
-- speff2 = entryEffectLife( spep2 + 0, 1507, 90, 0x100, -1, 0, 0, 0 );   -- カード
...
-- ** 集中線 ** --
shuchusen = entryEffectLife( spep2 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep2 + 0, shuchusen, 90, 20 );
setEffMoveKey( spep2 + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( spep2 + 90, shuchusen, 0, 0 , 0 );
setEffScaleKey( spep2 + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( spep2 + 90, shuchusen, 1.6, 1.6 );
setEffRotateKey( spep2 + 0, shuchusen, 0 );
setEffRotateKey( spep2 + 90, shuchusen, 0 );
setEffAlphaKey( spep2 + 0, shuchusen, 255 );
setEffAlphaKey( spep2 + 90, shuchusen, 255 );
 
-- ** 音 ** --
-- playSe( spep2 + 0, SE_05 );
 
-- ** 白背景 ** --
entryFadeBg( spep2 + 0, 0, 94, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景
 
-- ** 白フェード ** --
entryFade( spep2 + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( spep2 + 80, 6, 10, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --whi
