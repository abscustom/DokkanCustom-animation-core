--1012961：超サイヤ人トランクス(未来)_必殺技：バーニングアタック
--sp1146
...
-- ** 書き文字エントリ ** --
gogogo = entryEffectLife( spep_2+103, 190006, 76, 0x100, -1, 0, 270, 500); -- ゴゴゴゴゴ
