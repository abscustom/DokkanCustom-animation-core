...
--SE
SE0001 = playSe( spep_0 , SE_04 );  --ゴゴゴ
...
setEffScaleKey( spep_4 + 0, shutter, 1.02, 1.02 );
setEffScaleKey( spep_4 + 256, shutter, 1.02, 1.02 );
