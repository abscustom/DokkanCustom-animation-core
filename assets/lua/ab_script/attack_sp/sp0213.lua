...
entryFade( spep_c + 80, 6, 12, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade

------------------------------------------------------
-- カメハメハ発射(110F)
------------------------------------------------------
spep_3=spep_c+94; --204
...
entryFade( spep_3+145, 8,  18, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- ** 音 ** --
SE01 = playSe( spep_c + 0, SE_05 );
SE02 = playSe( spep_c + 64, SE_06);
...
SP_dodge = 250; --エンドフェイズのフレーム数を置き換える +48
setMoveKey(SP_dodge ,   0,   -800,  70,   0);
