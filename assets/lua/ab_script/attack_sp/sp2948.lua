...
--エフェクト(共通)
SP_01  = 164087; --巨大化マジュニア登場〜フィニッシュ ef_002
SP_01b = 164102; --巨大化マジュニア登場〜フィニッシュ ef_003b
...
-- ** 音 ** --
--画面遷移
SE002 = playSeVer2( spep_0 + 78, 8, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 78, SE002, 73 );

--空気音
SE003 = playSeVer2( spep_0 + 88, 1175, "",spep_0 + 298, 0, 118, -1);
setSeVolumeByWorkId( spep_0 + 88, SE003, 32 );
...
-- ** エフェクト等 ** --
start = entryEffect( spep_1 + 0, SP_01, 0x80, -1, 0, 0, 0); -- 巨大化マジュニア登場〜フィニッシュ(ef_002)
...
-- ** 音 ** --
--画面遷移
SE004 = playSeVer2( spep_1 + 68, 1509, "", 0, 0, 0, 0.6);

--気弾発射
SE005 = playSeVer2( spep_1 + 134, 1027, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 134, SE005, 65 );
SE006 = playSeVer2( spep_1 + 134, 1022, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_1 + 134, 1424, "", 0, 0, 0, -1);
...
SP_dodge = spep_1 + 156; --エンドフェイズのフレーム数を置き換える
...
-- ** 音 ** --
--敵ヒット
SE008 = playSeVer2( spep_1 + 208, 1024, "",spep_1 + 342, 0, 78, -1);
SE009 = playSeVer2( spep_1 + 208, 1159, "",spep_1 + 346, 0, 58, -1);
setSeVolumeByWorkId( spep_1 + 208, SE009, 68 );


-- ** 次の準備 ** --
spep_N = spep_1 + MAX_FRAME_1; -- 288f
...
-- 背景差し替えがある場合のみ
finish_1b = entryEffectLife( spep_N + 0, SP_01b , spep_N + 108, 0x80, -1, 0, 0, 0 );  --ガッ 差し替え背景(ef_003b)
