--9028810:UR_魔人ブウ(善)_アクティブ必殺技_エネミー側
--sp_effect_a9_00129
--sp2705
...
--エフェクト(てき)
SP_01r = 162814;	--演出前半　前面　敵側	ef_001r
...
--敵ヒット
SE027 = playSeVer2( spep_0 + 520, 1023, "", 0, 0, 0, 0.74);
SE028 = playSeVer2( spep_0 + 524, 1024, "", 0, 0, 0, 0.74);
setSeVolumeByWorkId( spep_0 + 524, SE028, 72 );

--煙に包まれる
SE029 = playSeVer2( spep_0 + 582, 20, "", 0, 0, 0, 0.74);
SE030 = playSeVer2( spep_0 + 588, 31, "", 0, 0, 0, 0.74);
SE031 = playSeVer2( spep_0 + 588, 1214, "",spep_0 + 718, 0, 74, 0.74);

--クッキーになる
SE032 = playSeVer2( spep_0 + 682, 1237, "", 0, 0, 0, 0.6);
...
--落ちてくる
SE034 = playSeVer2( spep_0 + 718, 1118, "", 0, 0, 0, 0.6);
...
--終わり
-- hideKoScreen();
dealDamage( spep_1 + 214);
endPhase( spep_1 + MAX_FRAME_1);--314
