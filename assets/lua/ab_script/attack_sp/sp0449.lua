--9013770  ビルス＆ウイス_破壊神の裁き 気弾sp0449
...
-- ** 集中線 ** --
shuchusen3 = entryEffectLife( spep3 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep3 + 0, shuchusen3, 90, 20 );
setEffMoveKey( spep3 + 0, shuchusen3, 0, 0 , 0 );
setEffMoveKey( spep3 + 90, shuchusen3, 0, 0 , 0 );
setEffScaleKey( spep3 + 0, shuchusen3, 1.6, 1.6 );
setEffScaleKey( spep3 + 90, shuchusen3, 1.6, 1.6 );
setEffRotateKey( spep3 + 0, shuchusen3, 0 );
setEffRotateKey( spep3 + 90, shuchusen3, 0 );
setEffAlphaKey( spep3 + 0, shuchusen3, 255 );
setEffAlphaKey( spep3 + 90, shuchusen3, 255 );

-- ** 音 ** --
-- playSe( spep3+5, SE_05);
-- ** 白背景 ** --
entryFadeBg( spep3 + 0, 0, 96, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景
-- ** 白フェード ** --
entryFade( spep3 + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( spep3 + 80, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
------------------------------------------------------
-- 正面に放つ(60F)　
------------------------------------------------------
...
setEffScaleKey(spep12,Exp3,1.1,1.1);
setEffScaleKey(spep12+130,Exp3,1.1,1.1);
