...
SE005 = playSeVer2( spep_0 + 36, 1159, "",spep_0 + 86, 0, 14, 0.6);  
setSeVolumeByWorkId( spep_0 + 36, SE005, 79 );
SE006 = playSeVer2( spep_0 + 36, 1182, "",spep_0 + 86, 0, 14, 0.6);
setSeVolumeByWorkId( spep_0 + 36, SE005, 158 );
...
SE047 = playSeVer2( spep_3 + 397, 1216, "",spep_3 + 512, 0, 6, 0.6);
...
SE049 = playSeVer2( spep_3 + 520, 1184, "", 0, 7, 0, -1);   
setSeVolumeByWorkId( spep_3 + 520, SE049, 71 ); 
setStartTimeMs( SE049,  900 );
