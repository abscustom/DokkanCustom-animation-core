...
entryFade( spep_1 + 92, 5, 15, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE001 = playSe( spep_3+25, 1022);
--playSe( spep_3+60, SE_03);
SE002 = playSe( spep_3+60, 1018);
--playSe( spep_3+60, SE_03);
...
SE003 = playSe( spep_4+11, 1042);
SE004 = playSe( spep_4+58, SE_07);
