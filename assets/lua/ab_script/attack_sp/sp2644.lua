-- 1027670:SSR_人造人間21号(変身・悪)_必殺技(↓簡易版)：アブソリュートリリースボール
-- sp_effect_a2_00230
-- sp2644
...
--動画用
SP_001m = 164464;  -- （簡易版）冒頭カットイン～カードカットインまで(動画用) ef_003

-- 味方側
SP_001 = 162475;  -- （簡易版）冒頭カットイン～カードカットインまでef_003
...
setMoveKey( spep_0 + 212 + OFFSET_X, 1, -337, 126.7 , 0 );
setMoveKey( spep_0 + 213 + OFFSET_X, 1, -337, 126.7 , 0 );
setMoveKey( spep_0 + 214 + OFFSET_X, 1, -301.9, 113.8 , 0 );
setMoveKey( spep_0 + 215 + OFFSET_X, 1, -301.9, 113.8 , 0 );
setMoveKey( spep_0 + 216 + OFFSET_X, 1, -288.5, 109.5 , 0 );
setMoveKey( spep_0 + 217 + OFFSET_X, 1, -288.5, 109.5 , 0 );
setMoveKey( spep_0 + 218 + OFFSET_X, 1, -266.3, 102.5 , 0 );
setMoveKey( spep_0 + 219 + OFFSET_X, 1, -266.3, 102.5 , 0 );
setMoveKey( spep_0 + 220 + OFFSET_X, 1, -235.1, 92.7 , 0 );
setMoveKey( spep_0 + 221 + OFFSET_X, 1, -235.1, 92.7 , 0 );
setMoveKey( spep_0 + 222 + OFFSET_X, 1, -195.1, 80 , 0 );
setMoveKey( spep_0 + 223 + OFFSET_X, 1, -195.1, 80 , 0 );
setMoveKey( spep_0 + 224 + OFFSET_X, 1, -146.1, 64.6 , 0 );
setMoveKey( spep_0 + 225 + OFFSET_X, 1, -146.1, 64.6 , 0 );
setMoveKey( spep_0 + 226 + OFFSET_X, 1, -88.3, 46.3 , 0 );
setMoveKey( spep_0 + 227 + OFFSET_X, 1, -88.3, 46.3 , 0 );
setMoveKey( spep_0 + 228 + OFFSET_X, 1, -21.5, 25.2 , 0 );
setMoveKey( spep_0 + 229 + OFFSET_X, 1, -21.5, 25.2 , 0 );
setMoveKey( spep_0 + 230 + OFFSET_X, 1, 54.1, 1.3 , 0 );
setMoveKey( spep_0 + 232 + OFFSET_X, 1, 54.1, 1.3 , 0 );
...
setScaleKey( spep_0 + 211 + OFFSET_X, 1, 1.96, 1.96 );
setScaleKey( spep_0 + 212 + OFFSET_X, 1, 0.4, 0.4 );
setScaleKey( spep_0 + 213 + OFFSET_X, 1, 0.4, 0.4 );
setScaleKey( spep_0 + 214 + OFFSET_X, 1, 0.36, 0.36 );
setScaleKey( spep_0 + 232 + OFFSET_X, 1, 0.36, 0.36 );
...
setRotateKey( spep_0 + 212 + OFFSET_X, 1, 15 );
setRotateKey( spep_0 + 232 + OFFSET_X, 1, 15 );
...
--飛んでいく
SE017 = playSeVer2( spep_0 + 202, 1121, "",spep_0 + 250, 0, 12, -1);
--岩激突
SE018 = playSeVer2( spep_0 + 234, 1159, "",spep_0 + 316, 0, 14, -1);
--瞬間移動
SE019 = playSeVer2( spep_0 + 270, 1235, "",spep_0 + 316, 0, 22, -1);

-- ** 次の準備 ** --
spep_1 = spep_0 + MAX_FRAME_0;  -- 304
...
-- ** 音 ** --
--気弾溜め
SE021 = playSeVer2( spep_2 + 0, 1248, "", 0, 8, 0, -1);
setStartTimeMs( SE021,  233 );
SE023 = playSeVer2( spep_2 + 2, 1158, "",spep_2 + 102, 0, 24, -1);
SE024 = playSeVer2( spep_2 + 2, 1199, "", 0, 0, 0, -1);
SE025 = playSeVer2( spep_2 + 2, 1240, "",spep_2 + 86, 0, 16, -1);
SE026 = playSeVer2( spep_2 + 2, 1296, "",spep_2 + 80, 0, 10, -1);
--オーラ
SE022 = playSeVer2( spep_2 + 0, 1036, "", 0, 0, 0, -1);
SE027 = playSeVer2( spep_2 + 24, 1036, "", 0, 0, 0, -1);
SE028 = playSeVer2( spep_2 + 48, 1036, "", 0, 0, 0, -1);
SE037 = playSeVer2( spep_2 + 168, 1036, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_2 + 192, 1036, "", 0, 0, 0, -1);
SE039 = playSeVer2( spep_2 + 216, 1036, "", 0, 0, 0, -1);
SE040 = playSeVer2( spep_2 + 240, 1036, "", 0, 0, 0, -1);
--気弾発射
SE029 = playSeVer2( spep_2 + 86, 1212, "",spep_2 + 144, 18, 12, -1);
setStartTimeMs( SE029,  600 );
SE030 = playSeVer2( spep_2 + 70, 1027, "", 0, 0, 0, -1);
SE031 = playSeVer2( spep_2 + 70, 1193, "",spep_2 + 138, 0, 12, 0.6);
SE032 = playSeVer2( spep_2 + 70, 1201, "", 0, 0, 0, 0.6);
--気弾飛んでいく
SE033 = playSeVer2( spep_2 + 90, 1202, "",spep_2 + 138, 0, 6, 0.6);
--爆発
SE034 = playSeVer2( spep_2 + 136, 1159, "", 0, 0, 0, -1);
SE035 = playSeVer2( spep_2 + 140, 1024, "", 0, 0, 0, -1);
SE036 = playSeVer2( spep_2 + 156, 1067, "", 0, 0, 0, -1);
...
changeAnime( spep_0 + 180 + OFFSET_X, 1, 105 );
changeAnime( spep_0 + 212 + OFFSET_X, 1, 8 );
