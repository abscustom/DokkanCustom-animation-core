...
if (_IS_PLAYER_SIDE_ == 1) then
    if (_IS_SKIP_ == 1 and _IS_DODGE_ == 0) then
        ...
        spep_1 = spep_0 + 48;  -- MAX_FRAME_0のフレーム数を記載。
        spep_2 = spep_1 + 114;
        spep_3 = spep_2 + 94;
        spep_4 = spep_3 + 58;
        spep_5 = spep_4 + 170;
        ...
        timing_skip = 10;
        skipFrame(0, spep_5 + timing_skip );  -- スキップ先フレーム指定
...
-- ** エフェクト等 ** --
entryFade(spep_3-2,0,0,6,fcolor_r,fcolor_g,fcolor_b,255);     -- white fade
...
setMoveKey( spep_6 + 102, 1, -33.9, -162.5 , 0 );
...
setScaleKey( spep_6 + 102, 1, 1.446, 1.446 );
...
setRotateKey( spep_6 + 102, 1, 1038.3 );
