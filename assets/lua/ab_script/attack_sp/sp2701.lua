-- 9028500:UR_超サイヤ人ベジータ_アクティブ必殺：ビッグ・バン・アタック(エネミー側)
-- sp_effect_a2_00236
-- sp2701
...
-- 敵側
SP_01r  = 162732;  -- 開幕～フィニッシュまで ef_001r
SP_01br = 162733;  -- 開幕～フィニッシュまで背景 ef_001br
SP_02r  = 162782;  -- KO ef_002
...
base_0b = entryEffect( spep_0 + 0, SP_01br, 0x80, -1, 0, 0, 0); -- 開幕～フィニッシュまで背景(ef_001br)
setEffMoveKey( spep_0 + 0, base_0b, 0, 0 , 0);
setEffMoveKey( spep_0 + MAX_FRAME_0, base_0b, 0, 0 , 0);
setEffScaleKey( spep_0 + 0, base_0b, -1.0, 1.0);
setEffScaleKey( spep_0 + MAX_FRAME_0, base_0b, -1.0, 1.0);
...
KO = entryEffectLife( spep_0 + 890, SP_02r, 108, 0x100, -1, 0, 0, 0); -- KO(ef_002r)
setEffMoveKey( spep_0 + 890, KO, 0, 0 , 0);
setEffMoveKey( spep_0 + MAX_FRAME_0 + 108, KO, 0, 0 , 0);
setEffScaleKey( spep_0 + 890, KO, -1.0, 1.0);
setEffScaleKey( spep_0 + MAX_FRAME_0 + 108, KO, -1.0, 1.0);
...
changeAnime( spep_0 + 706 + OFFSET_X, 1, 104 );
