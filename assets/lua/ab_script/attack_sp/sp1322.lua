...
setEffMoveKey( spep_6 + 100 +10, bakuhatsu, 0, 0 , 0 );
...
setEffScaleKey( spep_6 + 100 +10, bakuhatsu, 0.9, 0.9 );

setEffRotateKey( spep_6 + 0, bakuhatsu, 0 );
setEffRotateKey( spep_6 + 100 +10, bakuhatsu, 0 );

setEffAlphaKey( spep_6 + 0, bakuhatsu, 255 );
setEffAlphaKey( spep_6 + 100 +10, bakuhatsu, 255 );
...
kuroshuchusen_g = entryEffectLife( spep_6 + 14,  1657, 86 +10, 0x80, -1, 0, 0, 0 );  --黒い細い集中線
setEffMoveKey( spep_6 + 14, kuroshuchusen_g, 0, 0 , 0 );
setEffMoveKey( spep_6 + 100 +10, kuroshuchusen_g, 0, 0 , 0 );

setEffScaleKey( spep_6 + 14, kuroshuchusen_g, 1, 1 );
setEffScaleKey( spep_6 + 100 +10, kuroshuchusen_g, 1, 1 );

setEffRotateKey( spep_6 + 14, kuroshuchusen_g, 0 );
setEffRotateKey( spep_6 + 100 +10, kuroshuchusen_g, 0 );

setEffAlphaKey( spep_6 + 14, kuroshuchusen_g, 255 );
setEffAlphaKey( spep_6 + 100 +10, kuroshuchusen_g, 255 );

-- ** 書き文字エントリー ** --
ctga = entryEffectLife( spep_6 + 14,  10005, 86 +10, 0x100, -1, 0, 3.9, 316.1 );  --ガッ
setEffShake( spep_6 + 14, ctga, 14, 20 );

setEffMoveKey( spep_6 + 14, ctga, 3.9, 316.1 , 0 );
setEffMoveKey( spep_6 + 28, ctga, 3.9, 316.1 , 0 );
setEffMoveKey( spep_6 + 100 +10, ctga, 3.9, 316.1 , 0 );

setEffScaleKey( spep_6 + 14, ctga, 3.2, 3.2 );
setEffScaleKey( spep_6 + 100 +10, ctga, 3.2, 3.2 );
...
setEffRotateKey( spep_6 + 100 +10, ctga, -14.9 );

setEffAlphaKey( spep_6 + 14, ctga, 255 );
setEffAlphaKey( spep_6 + 100 +10, ctga, 255 );
