...
playSe( 130, SE_05);
speff = entryEffect( 130, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( 130, SE_05);
speff = entryEffect( 130, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end

entryFade( 220 -5 -4, 3+2, 5+4+4, 3, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( 220 -8, 3, 5 +10, 3, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
