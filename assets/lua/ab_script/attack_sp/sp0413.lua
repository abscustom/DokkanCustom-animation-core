...
-- 書き文字エントリー
ctgogo = entryEffectLife( spep2+20, 190006, 70, 0x100, -1, 0, 150,530, 0);    -- ゴゴゴゴ
...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    shuchusen = entryEffectLife( spep3, 906, 90, 0x100,  -1, 0,  0,  0);  --集中線
    
    setEffMoveKey(  spep3,  shuchusen,  0,  0);
    setEffScaleKey(  spep3,  shuchusen,  1.0,  1.0);
    setEffRotateKey(  spep3,  shuchusen,  0);
    setEffAlphaKey(  spep3,  shuchusen,  255);
    setEffMoveKey(  spep3+90,  shuchusen,  0,  0);
    setEffScaleKey(  spep3+90,  shuchusen,  1.0,  1.0);
    setEffRotateKey(  spep3+90,  shuchusen,  0);
    setEffAlphaKey(  spep3+90,  shuchusen,  255);
