...
if (_IS_PLAYER_SIDE_ == 1) then
	...
	speff = entryEffect(  30,   1504,   0,     -1,  0,  0,  0, 2000);   -- eff_005 (カットイン) 117で終了
	setEffReplaceTexture( speff, 3, 2);                           -- カットイン差し替え
	speff = entryEffect(  30,   1505,   0,     -1,  0,  0,  0, 3000);   -- eff_006 (セリフ)
...
-- 書き文字エントリー
ct = entryEffectLife( 30, 10008, 95, 0x100, -1, 0, -190 -40, 300, 4000);    -- ゴゴゴ・・・
setEffShake(30, ct, 95, 8);
setEffScaleKey(30, ct, 1.4, 1.4);

shuchusen5 = entryEffectLife( 30, 906, 95, 0x00,  -1, 0,  0,  0, 1000);   -- 集中線
...
entryFade( spep_2+85 -2, 3, 5+2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
