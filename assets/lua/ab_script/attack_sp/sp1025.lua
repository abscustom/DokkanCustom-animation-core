...
-- ** 集中線 ** --
shuchusen = entryEffectLife( 170, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( 170, shuchusen, 90, 20 );
setEffMoveKey( 170, shuchusen, 0, 0 , 0 );
setEffMoveKey( 260, shuchusen, 0, 0 , 0 );
setEffScaleKey( 170, shuchusen, 1.6, 1.6 );
setEffScaleKey( 260, shuchusen, 1.6, 1.6 );
setEffRotateKey( 170, shuchusen, 0 );
setEffRotateKey( 260, shuchusen, 0 );
setEffAlphaKey( 170, shuchusen, 255 );
...
-- ** 白背景 ** --
entryFadeBg( 170, 0, 96, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景

-- ** 白フェード ** --
entryFade( 166, 0, 4, 6, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( 250, 6, 8, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
entryFade( SP_ATK_1+45, 0, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryEffectLife( SP_ATK_2+1, 920, 75, 0x80,  -1,  0,  0,  0); -- 流線
