...
ctgogo = entryEffectLife( 80 + 16,  190006, 68, 0x100, -1, 0, 105, 515.5, 3000 ); --ゴゴゴ
setEffShake( 80 + 16, ctgogo, 68, 10 );
setEffMoveKey( 80 + 16, ctgogo, 105, 515.5 , 0 );
setEffMoveKey( 80 + 84, ctgogo, 105, 515.5 , 0 );
setEffScaleKey( 80 + 16, ctgogo, 0.7, 0.7 );
setEffScaleKey( 80 + 76, ctgogo, 0.7, 0.7 );
setEffScaleKey( 80 + 78, ctgogo, 1.0, 1.0 );
setEffScaleKey( 80 + 80, ctgogo, 1.09, 1.09 );
setEffScaleKey( 80 + 82, ctgogo, 1.39, 1.39 );
setEffScaleKey( 80 + 84, ctgogo, 1.69, 1.69 );
setEffRotateKey( 80 + 16, ctgogo, 0 );
setEffRotateKey( 80 + 84, ctgogo, 0 );
setEffAlphaKey( 80 + 16, ctgogo, 255 );
setEffAlphaKey( 80 + 84, ctgogo, 255 );
...
playSe( 166, SE_05);
speff = entryEffect( 166, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( 166, SE_05);
speff = entryEffect( 166, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
-- ** 集中線 ** --
shuchusenz = entryEffectLife( 166 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( 166 + 0, shuchusenz, 90, 20 );
setEffMoveKey( 166 + 0, shuchusenz, 0, 0 , 0 );
setEffMoveKey( 166 + 90, shuchusenz, 0, 0 , 0 );
setEffScaleKey( 166 + 0, shuchusenz, 1.6, 1.6 );
setEffScaleKey( 166 + 90, shuchusenz, 1.6, 1.6 );
setEffRotateKey( 166 + 0, shuchusenz, 0 );
setEffRotateKey( 166 + 90, shuchusenz, 0 );
setEffAlphaKey( 166 + 0, shuchusenz, 255 );
setEffAlphaKey( 166 + 90, shuchusenz, 255 );
