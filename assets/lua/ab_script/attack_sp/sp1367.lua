...
-- 文字エントリー --
ctgogo = entryEffectLife( spep_6 +34, 190006, 72, 0x106, -1, 0, 200, 510);-- ゴゴゴゴ

setEffMoveKey(  spep_6 +34,  ctgogo,  200,  510);
setEffMoveKey(  spep_6 +106,  ctgogo,  200,  510);
