...
-- ** 集中線 ** --
shuchusenz = entryEffectLife( SP_start + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( SP_start + 0, shuchusenz, 90, 20 );
setEffMoveKey( SP_start + 0, shuchusenz, 0, 0 , 0 );
setEffMoveKey( SP_start + 90, shuchusenz, 0, 0 , 0 );
setEffScaleKey( SP_start + 0, shuchusenz, 1.6, 1.6 );
setEffScaleKey( SP_start + 90, shuchusenz, 1.6, 1.6 );
setEffRotateKey( SP_start + 0, shuchusenz, 0 );
setEffRotateKey( SP_start + 90, shuchusenz, 0 );
setEffAlphaKey( SP_start + 0, shuchusenz, 255 );
setEffAlphaKey( SP_start + 90, shuchusenz, 255 );

entryFade( SP_start+85, 3, 5, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
