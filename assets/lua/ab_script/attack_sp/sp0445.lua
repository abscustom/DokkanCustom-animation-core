...
-- ** 集中線 ** --
shuchusenct = entryEffectLife( spep2, 906, 94, 0x100,  -1, 0,  0,  0); -- 集中線ct
...
-- ** 白背景 ** --
entryFadeBg( spep2 + 0, 0, 96, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景

-- ** 白フェード
entryFade( spep2+89, 3, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE001 = playSe( spep3+2, SE_06);
SE002 = playSe( spep3+40, SE_07);
...
SP_dodge = spep4 + 30; --エンドフェイズのフレーム数を置き換える
