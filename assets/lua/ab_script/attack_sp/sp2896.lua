--4031440:LR_ザマス+ゴクウブラック(超サイヤ人ロゼ)_アクティブ必殺技：合体ザマス爆誕!!_エネミー側
--sp_effect_a3_00119
--sp2896
...
SP_01r = 163904;  -- 開始〜フィニッシュまで：手前 ef_001r
...
-- ** エフェクト等 ** --
start_f = entryEffect( spep_0 + 2, SP_01r, 0x100, -1, 0, 0, 0); -- 開始〜フィニッシュまで：手前(ef_001r)
...
changeAnime( spep_0 + 930 + OFFSET_X, 1, 17 );
...
changeAnime( spep_0 + 1072 + OFFSET_X, 1, 6 );
...
--「神の光の力をみせてくれる! 」
--playVoice( spep_0 + 576, 1027 );
--setVoiceVolume( spep_0 + 576, 1027, 100 );

--「裁きの刃 」
--playVoice( spep_0 + 784, 1028 );
--setVoiceVolume( spep_0 + 784, 1028, 100 );
