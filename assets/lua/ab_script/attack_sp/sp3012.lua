--4033600:LR_超サイヤ人ゴッドベジータ_必殺技：ワイルドスティンガー
--sp_effect_b1_00369
--sp3012
...
--エフェクト(共通)
SP_02  = 164482; --カード後〜フィニッシュ ef_001
...
if (_IS_PLAYER_SIDE_ == 1) then
    ...
    if (_IS_SKIP_ == 1 and _IS_DODGE_ == 0) then
        ...
        -- ** 音 ** --
        --向かってくる
        SE019 = playSeVer2( spep_2 + 191, 1508, "",spep_2 + 244, 0, 16, -1);
        SE020 = playSeVer2( spep_2 + 191, 1117, "", 0, 0, 0, -1);
    else
...
--環境音
SE002 = playSeVer2( spep_0 + 0, 1175, "",spep_0 + 126, 0, 30, -1);
...
SE008 = playSeVer2( spep_0 + 84, 1036, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 84, SE008, 50 );
...
--向かってくる
SE010 = playSeVer2( spep_1 + 78, 1182, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_1 + 82, 1167, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 82, SE011, 56 );
setTimeStretch( SE011, 2, 30, 4 );
SE012 = playSeVer2( spep_1 + 82, 1117, "", 0, 0, 0, -1);
SE013 = playSeVer2( spep_1 + 82, 1019, "", 0, 0, 0, -1);
...
--調整後の値
setRotateKey( spep_2 + 96 + OFFSET_X, 1, rotate_ad * mirror );
setRotateKey( spep_2 + 102 + OFFSET_X, 1, rotate_ad * mirror );
...
--調整後の値
setRotateKey( spep_2 + 112 + OFFSET_X, 1, rotate_ad * mirror );
setRotateKey( spep_2 + 147 + OFFSET_X, 1, rotate_ad * mirror );
...
--向かってくる
SE014 = playSeVer2( spep_2 + 56, 1019, "",spep_2 + 116, 0, 18, -1);
...
--蹴りヒット
SE015 = playSeVer2( spep_2 + 72, 1004, "", 0, 0, 0, -1);
SE016 = playSeVer2( spep_2 + 86, 1153, "", 0, 0, 0, -1);
SE017 = playSeVer2( spep_2 + 86, 1187, "", 0, 0, 0, -1);

--吹き飛ばす
SE018 = playSeVer2( spep_2 + 134, 1027, "", 0, 0, 0, -1);

--向かってくる
SE019 = playSeVer2( spep_2 + 172, 1508, "",spep_2 + 244, 0, 16, -1);
SE020 = playSeVer2( spep_2 + 172, 1117, "", 0, 0, 0, -1);

--気ダメ
SE021 = playSeVer2( spep_2 + 232, 1035, "", 0, 0, 0, -1);
SE022 = playSeVer2( spep_2 + 232, 1503, "", 0, 0, 0, -1);

--向かっていく
SE023 = playSeVer2( spep_2 + 262, 1277, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 262, SE023, 200 );

--ラスト蹴り
SE024 = playSeVer2( spep_2 + 286, 1190, "",spep_2 + 348, 0, 28, -1);
SE025 = playSeVer2( spep_2 + 286, 1120, "", 0, 0, 0, -1);

--爆発
SE026 = playSeVer2( spep_2 + 316, 1159, "", 0, 0, 0, -1);
