...
--エフェクト(味方)
SP_01 = 159531;	--ナッパ:気だめ、セリフカットイン	ef_001		キャラ、エフェクト、背景、集中線
SP_02 = 159533;	--ナッパ:踏ん張って跳躍→手前に突進	ef_002		キャラ、エフェクト、背景、描き文字、白フェード
SP_03 = 159535;	--ナッパ:拳を振りかぶる	ef_003		キャラ、エフェクト、背景、白フェード
SP_04 = 159537;	--敵を殴る→敵がビリビリで身動き取れず	ef_004		キャラ、エフェクト(敵用ビリビリ含む)、描き文字
SP_04b = 159539;	--敵を殴る→敵がビリビリで身動き取れず	ef_005		空背景 ef_004,ef_004_rと同時表示
SP_05 = 159540;	--ナッパ回り込んでオーバーヘッドキック	ef_006		キャラ、エフェクト手前(敵用ビリビリ含む)ef_007と同時表示
SP_05b = 159542;	--ナッパ回り込んでオーバーヘッドキック	ef_007		キャラ、エフェクト敵より後ろ、背景、ef_006と同時表示
SP_06 = 159544;	--敵地面に叩きつけられ落下	ef_008		エフェクト手前、描き文字、白フェード、ef_009と同時表示
SP_06b = 159546;	--敵地面に叩きつけられ落下	ef_009		エフェクト、背景、集中線、ef_008と同時表示
SP_07 = 159548;	--ナッパ追攻撃→爆発	ef_010		キャラ、エフェクト、背景、描き文字
SP_08 = 159550;	--ラスト爆発背景	ef_011		エフェクト、背景、描き文字 反転なし共通

--エフェクト(てき)
SP_01r = 159532;	--ナッパ:気だめ、セリフカットイン	ef_001_r		キャラ、エフェクト、背景 、集中線（反転用）
SP_02r = 159534;	--ナッパ:踏ん張って跳躍→手前に突進	ef_002_r		キャラ、エフェクト、背景、描き文字 、白フェード（反転用）
SP_03r = 159536;	--ナッパ:拳を振りかぶる	ef_003_r		キャラ、エフェクト、背景、白フェード（反転用）
SP_04r = 159538;	--敵を殴る→敵がビリビリで身動き取れず	ef_004_r		キャラ、エフェクト(敵用ビリビリ含む)、描き文字（反転用）
SP_05r = 159541;	--ナッパ回り込んでオーバーヘッドキック	ef_006_r		キャラ、エフェクト手前(敵用ビリビリ含む)、ef_007_rと同時表示(反転用）
SP_05br = 159543;	--ナッパ回り込んでオーバーヘッドキック	ef_007_r		キャラ、エフェクト敵より後ろ、背景、ef_006_rと同時表示（反転用）
SP_06r = 159545;	--敵地面に叩きつけられ落下	ef_008_r		エフェクト手前、描き文字、白フェード（反転用）、ef_009_rと同時表示
SP_06br = 159547;	--敵地面に叩きつけられ落下	ef_009_r		エフェクト、背景、集中線、ef_007_rと同時表示（反転用）
SP_07r = 159549;	--ナッパ追攻撃→爆発	ef_010_r		キャラ、エフェクト、背景、描き文字 （反転用）
...
--イナヅマと地割れ
SE002 = playSeVer2( spep_1 + 14, 1147, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 14, SE002, 63 );

--構える
SE003 = playSeVer2( spep_1 + 20, 1004, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_1 + 20, 1003, "", 0, 0, 0, -1);

--イナヅマと地割れ
SE005 = playSeVer2( spep_1 + 20, 1044, "",spep_1 + 192, 26, 26, -1);
...
--画面遷移
SE008 = playSeVer2( spep_1 + 156, 8, "", 0, 0, 0, -1);
...
-- ** 音 ** --
--飛び上がる
SE009 = playSeVer2( spep_2 + 24, 1182, "", 0, 0, 0, -1);
SE010 = playSeVer2( spep_2 + 24, 1207, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_2 + 24, 1278, "",spep_2 + 124, 0, 42, -1);
SE012 = playSeVer2( spep_2 + 24, 1314, "",spep_2 + 124, 0, 42, -1);

--画面遷移
SE013 = playSeVer2( spep_2 + 72, 1072, "", 0, 0, 0, -1);
...
-- ** 音 ** --
--殴る
SE014 = playSeVer2( spep_3 + 20, 1004, "", 0, 0, 0, -1);
SE015 = playSeVer2( spep_3 + 30, 1187, "", 0, 0, 0, -1);
SE016 = playSeVer2( spep_3 + 30, 1043, "", 0, 0, 0, -1);
SE017 = playSeVer2( spep_3 + 30, 1038, "", 0, 0, 0, -1);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_4f = entryEffect( spep_4 + 0, SP_04, 0x100, -1, 0, 0, 0); --敵を殴る→敵がビリビリで身動き取れず	ef_004		キャラ、エフェクト(敵用ビリビリ含む)、描き文字
...
base_4b = entryEffect( spep_4 + 0, SP_04b, 0x80, -1, 0, 0, 0); --敵を殴る→敵がビリビリで身動き取れず	ef_005		空背景 ef_004,ef_004_rと同時表示
...
-- ** 音 ** --
--旋回
SE018 = playSeVer2( spep_4 + 46, 1116, "",spep_4 + 96, 0, 20, -1);

--敵痺れる
SE019 = playSeVer2( spep_4 + 54, 1056, "", 0, 0, 0, -1);

--旋回
SE020 = playSeVer2( spep_4 + 56, 1167, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_4 + 56, SE020, 40 );
...
-- ** 音 ** --
--旋回
SE021 = playSeVer2( spep_5 + 10, 1004, "", 0, 0, 0, -1);

--敵痺れる
SE022 = playSeVer2( spep_5 + 40, 1056, "", 0, 0, 0, -1);

--蹴り落とし
SE023 = playSeVer2( spep_5 + 48, 1003, "", 0, 0, 0, -1);
SE024 = playSeVer2( spep_5 + 56, 1120, "", 0, 0, 0, -1);

--敵飛んでいく
SE025 = playSeVer2( spep_5 + 68, 1183, "",spep_5 + 152, 0, 20, -1);
SE026 = playSeVer2( spep_5 + 68, 1121, "",spep_5 + 152, 0, 20, -1);
setSeVolumeByWorkId( spep_5 + 68, SE026, 71 );
...
setEffMoveKey( spep_6 + 68 -4, base_6f, 0, 0 , 0);
setEffScaleKey( spep_6 + 0, base_6f, 1.0, 1.0);
setEffScaleKey( spep_6 + 68 -4, base_6f, 1.0, 1.0);
setEffRotateKey( spep_6 + 0, base_6f, 0);
setEffRotateKey( spep_6 + 68 -4, base_6f, 0);
setEffAlphaKey( spep_6 + 0, base_6f, 255);
setEffAlphaKey( spep_6 + 68 -5, base_6f, 255);
setEffAlphaKey( spep_6 + 68 -4, base_6f, 0);
...
setEffMoveKey( spep_6 + 68 -4, base_6b, 0, 0 , 0);
setEffScaleKey( spep_6 + 0, base_6b, 1.0, 1.0);
setEffScaleKey( spep_6 + 68 -4, base_6b, 1.0, 1.0);
setEffRotateKey( spep_6 + 0, base_6b, 0);
setEffRotateKey( spep_6 + 68 -4, base_6b, 0);
setEffAlphaKey( spep_6 + 0, base_6b, 255);
setEffAlphaKey( spep_6 + 68 -5, base_6b, 255);
setEffAlphaKey( spep_6 + 68 -4, base_6b, 0);
...
-- ** 黒背景 ** --
entryFadeBg( spep_6 + 0, 0, 68 -2, 0, 0, 0, 0, 255);       -- ベース暗め 背景

-- ** 音 ** --
--地面激突
SE027 = playSeVer2( spep_6 + 36, 1159, "",spep_6 + 90, 0, 14, -1);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_7 = entryEffect( spep_7 + 0, SP_07, 0x80, -1, 0, 0, 0); --ナッパ追攻撃→爆発	ef_010		キャラ、エフェクト、背景、描き文字
setEffMoveKey( spep_7 + 0, base_7, 0, 0 , 0);
setEffMoveKey( spep_7 + 168 -4, base_7, 0, 0 , 0);
setEffScaleKey( spep_7 + 0, base_7, 1.0, 1.0);
setEffScaleKey( spep_7 + 168 -4, base_7, 1.0, 1.0);
setEffRotateKey( spep_7 + 0, base_7, 0);
setEffRotateKey( spep_7 + 168 -4, base_7, 0);
setEffAlphaKey( spep_7 + 0, base_7, 255);
setEffAlphaKey( spep_7 + 168 -5, base_7, 255);
setEffAlphaKey( spep_7 + 168 -4, base_7, 0);


-- ** 白フェード ** --
entryFade( spep_7 + 168 -4 -6, 4, 2, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade

-- ** 黒背景 ** --
entryFadeBg( spep_7 + 0, 0, 168 -2, 0, 0, 0, 0, 255);       -- ベース暗め 背景

-- ** 音 ** --
--腕振りかぶる
SE029 = playSeVer2( spep_7 + 0, 1004, "", 0, 0, 0, -1);
setPitch( spep_7 + 0, SE029, -400 );
setTimeStretch( SE029, 0.73, 30, 4 );
SE030 = playSeVer2( spep_7 + 0, 1330, "",spep_7 + 704, 0, 26, -1);

--腕を振る
SE032 = playSeVer2( spep_7 + 48, 1233, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_7 + 48, SE032, 76 );
SE033 = playSeVer2( spep_7 + 54, 1189, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_7 + 54, SE033, 158 );
SE034 = playSeVer2( spep_7 + 54, 1048, "", 0, 0, 0, -1);

--連続爆発
SE035 = playSeVer2( spep_7 + 74 + 4, 1023, "", 0, 0, 0, -1);
SE036 = playSeVer2( spep_7 + 94 + 4, 1025, "", 0, 0, 0, -1);
SE037 = playSeVer2( spep_7 + 106 + 4, 1024, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_7 + 122 + 4, 1160, "", 0, 0, 0, -1);
SE039 = playSeVer2( spep_7 + 142 + 4, 1023, "", 0, 0, 0, -1);
SE040 = playSeVer2( spep_7 + 142 + 4, 1188, "", 0, 0, 0, -1);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_8 = entryEffect( spep_8 + 0, SP_08, 0x80, -1, 0, 0, 0); --ラスト爆発背景	ef_011		エフェクト、背景、描き文字 反転なし共通
setEffMoveKey( spep_8 + 0, base_8, 0, 0 , 0);
setEffMoveKey( spep_8 + 154 -4, base_8, 0, 0 , 0);
setEffScaleKey( spep_8 + 0, base_8, 1.0, 1.0);
setEffScaleKey( spep_8 + 154 -4, base_8, 1.0, 1.0);
setEffRotateKey( spep_8 + 0, base_8, 0);
setEffRotateKey( spep_8 + 154 -4, base_8, 0);
setEffAlphaKey( spep_8 + 0, base_8, 255);
setEffAlphaKey( spep_8 + 154 -4, base_8, 255);

-- ** 黒背景 ** --
entryFadeBg( spep_8 + 0, 0, 154 -2, 0, 0, 0, 0, 255);       -- ベース暗め 背景

-- ** 音 ** --
--連続爆発
SE031 = playSeVer2( spep_8 + 24 + 8, 1067, "", 0, 0, 0, -1);

--連続爆発
SE041 = playSeVer2( spep_8 + 24, 1159, "", 0, 0, 0, -1);


-- ** ダメージ表示 ** --
dealDamage( spep_8 + 40 -3); -- ダメージ表示フレーム
endPhase( spep_8 + 154 -8); -- 終了フレーム
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_1 = entryEffect( spep_1 + 0, SP_01r, 0x80, -1, 0, 0, 0); --ナッパ:気だめ、セリフカットイン	ef_001_r		キャラ、エフェクト、背景 、集中線（反転用）
setEffMoveKey( spep_1 + 0, base_1, 0, 0 , 0);
setEffMoveKey( spep_1 + 180 -4, base_1, 0, 0 , 0);
setEffScaleKey( spep_1 + 0, base_1, 1.0, 1.0);
setEffScaleKey( spep_1 + 180 -4, base_1, 1.0, 1.0);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_2 = entryEffect( spep_2 + 0, SP_02r, 0x80, -1, 0, 0, 0); --ナッパ:踏ん張って跳躍→手前に突進	ef_002_r		キャラ、エフェクト、背景、描き文字 、白フェード（反転用）
setEffMoveKey( spep_2 + 0, base_2, 0, 0 , 0);
setEffMoveKey( spep_2 + 108 -4, base_2, 0, 0 , 0);
setEffScaleKey( spep_2 + 0, base_2, 1.0, 1.0);
setEffScaleKey( spep_2 + 108 -4, base_2, 1.0, 1.0);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_3 = entryEffect( spep_3 + 0, SP_03r, 0x80, -1, 0, 0, 0); --ナッパ:拳を振りかぶる	ef_003_r		キャラ、エフェクト、背景、白フェード（反転用）
setEffMoveKey( spep_3 + 0, base_3, 0, 0 , 0);
setEffMoveKey( spep_3 + 40 -4, base_3, 0, 0 , 0);
setEffScaleKey( spep_3 + 0, base_3, 1.0, 1.0);
setEffScaleKey( spep_3 + 40 -4, base_3, 1.0, 1.0);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_4f = entryEffect( spep_4 + 0, SP_04r, 0x100, -1, 0, 0, 0); --敵を殴る→敵がビリビリで身動き取れず	ef_004_r		キャラ、エフェクト(敵用ビリビリ含む)、描き文字（反転用）
setEffMoveKey( spep_4 + 0, base_4f, 0, 0 , 0);
setEffMoveKey( spep_4 + 60 -4, base_4f, 0, 0 , 0);
setEffScaleKey( spep_4 + 0, base_4f, 1.0, 1.0);
setEffScaleKey( spep_4 + 60 -4, base_4f, 1.0, 1.0);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_5f = entryEffect( spep_5 + 0, SP_05r, 0x100, -1, 0, 0, 0); --ナッパ回り込んでオーバーヘッドキック	ef_006_r		キャラ、エフェクト手前(敵用ビリビリ含む)、ef_007_rと同時表示(反転用）
setEffMoveKey( spep_5 + 0, base_5f, 0, 0 , 0);
setEffMoveKey( spep_5 + 100 -4, base_5f, 0, 0 , 0);
setEffScaleKey( spep_5 + 0, base_5f, 1.0, 1.0);
setEffScaleKey( spep_5 + 100 -4, base_5f, 1.0, 1.0);
...
base_5b = entryEffect( spep_5 + 0, SP_05br, 0x80, -1, 0, 0, 0); --ナッパ回り込んでオーバーヘッドキック	ef_007_r		キャラ、エフェクト敵より後ろ、背景、ef_006_rと同時表示（反転用）
setEffMoveKey( spep_5 + 0, base_5b, 0, 0 , 0);
setEffMoveKey( spep_5 + 100 -4, base_5b, 0, 0 , 0);
setEffScaleKey( spep_5 + 0, base_5b, 1.0, 1.0);
setEffScaleKey( spep_5 + 100 -4, base_5b, 1.0, 1.0);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_6f = entryEffect( spep_6 + 0, SP_06r, 0x100, -1, 0, 0, 0); --敵地面に叩きつけられ落下	ef_008_r		エフェクト手前、描き文字、白フェード（反転用）、ef_009_rと同時表示
setEffMoveKey( spep_6 + 0, base_6f, 0, 0 , 0);
setEffMoveKey( spep_6 + 68 -4, base_6f, 0, 0 , 0);
setEffScaleKey( spep_6 + 0, base_6f, 1.0, 1.0);
setEffScaleKey( spep_6 + 68 -4, base_6f, 1.0, 1.0);
...
base_6b = entryEffect( spep_6 + 0, SP_06br, 0x80, -1, 0, 0, 0); --敵地面に叩きつけられ落下	ef_009_r		エフェクト、背景、集中線、ef_007_rと同時表示（反転用）
setEffMoveKey( spep_6 + 0, base_6b, 0, 0 , 0);
setEffMoveKey( spep_6 + 68 -4, base_6b, 0, 0 , 0);
setEffScaleKey( spep_6 + 0, base_6b, 1.0, 1.0);
setEffScaleKey( spep_6 + 68 -4, base_6b, 1.0, 1.0);
...
-------------------------------------------------
-- ** エフェクト等 ** --
base_7 = entryEffect( spep_7 + 0, SP_07r, 0x80, -1, 0, 0, 0); --ナッパ追攻撃→爆発	ef_010_r		キャラ、エフェクト、背景、描き文字 （反転用）
setEffMoveKey( spep_7 + 0, base_7, 0, 0 , 0);
setEffMoveKey( spep_7 + 168 -4, base_7, 0, 0 , 0);
setEffScaleKey( spep_7 + 0, base_7, 1.0, 1.0);
setEffScaleKey( spep_7 + 168 -4, base_7, 1.0, 1.0);
