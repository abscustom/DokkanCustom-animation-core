--4008291:UR_超サイヤ人3孫悟空(GT)(黄金大猿)_必殺技：超火炎砲
--sp_effect_a2_00035
--sp0188
...
playSe( SP_start+ 170+64 + add_f, SE_06);
...
setMoveKey( SP_start+  260 + add_f,    0,      0,  0,   -20);
setMoveKey( SP_start+  270 + add_f,    0,      0,  0,   -10);
setMoveKey( SP_start+  290 + add_f,    0,   -30,  0,   0);

kamehame_beam = entryEffectLife( SP_start+ 257 + add_f, SP_02, 115, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
stop03 = playSe( SP_start+ 260 + add_f, 1002);
setEffAlphaKey( SP_start+260 + add_f, kamehame_beam, 0);
setEffAlphaKey( SP_start+262 + add_f, kamehame_beam, 0);
setEffAlphaKey( SP_start+263 + add_f, kamehame_beam, 255);

shuchusen = entryEffectLife( SP_start+ 257 + add_f, 906, 49, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( SP_start+ 257 + add_f, shuchusen, 1.0, 1.0);
...
-- 途中からカメハメハが伸びる
setMoveKey( SP_start+  300 + add_f,    0,   -250,  40,   50);
setMoveKey( SP_start+  305 + add_f,    0,   -850,  70,   80);
setDisp( SP_start+  305 + add_f, 0, 0);
setMoveKey( SP_start+  308 + add_f,    0,   -450,  70,   80);

-- ** エフェクト等 ** --
entryFadeBg( SP_start+ 260 + add_f, 0, 119, 0, 10, 10, 10, 200);       -- ベース暗め　背景

sen2 = entryEffectLife( SP_start+ 260 + add_f, 921, 119, 0x80,  -1,  0,  0,  0); -- 流線921
setEffRotateKey( SP_start+260 + add_f, sen2, 180);
setShakeChara( SP_start+ 305 + add_f, 0, 54, 50);
setEffScaleKey( SP_start+ 260 + add_f, sen2, 1.6, 1.6);
...
stop02 = playSe( SP_start+ 300 + add_f, SE_07);
...
SP_dodge = 339  + add_f; --エンドフェイズのフレーム数を置き換える

stopSe( SP_dodge-12, stop02, 0);
stopSe( SP_dodge-12, stop03, 0);
