...
if (_IS_PLAYER_SIDE_ == 1) then
    ...
    if (_IS_SKIP_ == 1 and _IS_DODGE_ == 0) then
        ...
        timing_skip = 62;
        skipFrame(0, spep_4 + timing_skip );  -- スキップ先フレーム指定

        -- ** 音 ** --
        playSe( spep_4 + 62 + 3, 1024);
    end
------------------------------------------------------
-- Scene01
------------------------------------------------------
...
entryFade(spep_0+124,6,2,0,255,255,255,255);
...
--背景・白フェード--
entryFade(spep_4-4,2,2,10,255,255,255,255);
