...
--]]
setMoveKey(  259 + OFFSET_X,    0,      0,  200,   0);
setMoveKey(  270 + OFFSET_X,    0,      0,  200,   0);
setMoveKey(  290 + OFFSET_X,    0,   -30,  200,   20);

kamehame_beam = entryEffectLife( 260 + OFFSET_X, SP_02, 109, 0x40,  0,  300,  0,  0);   -- 伸びるかめはめ波
SE001 = playSe( 260 + OFFSET_X, SE_07);
...
setMoveKey(  300 + OFFSET_X,    0,   -150,  200,   50);
setMoveKey(  305 + OFFSET_X,    0,   -550,  200,   80);
--setMoveKey(  308,    0,   -1100,  0,   0);
setDisp( 306 + OFFSET_X, 0, 0);


entryFade( 365 + OFFSET_X, 3, 2, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
entryFadeBg( 260 + OFFSET_X, 0, 109, 0, 255, 255, 255, 255);       -- ベース暗め　背景
entryFadeBg( 260 + OFFSET_X, 0, 40, 0, 230, 230, 230, 255);    -- 最初だけ明るい　背景
--entryFadeBg( 300, 0, 2, 8, 100, 140, 250, 250);     -- 青い　背景
entryFadeBg( 300 + OFFSET_X, 0, 2, 8, 0, 0, 0, 250);     -- 青い　背景

sen2 = entryEffectLife( 260 + OFFSET_X, 921, 109, 0x80,  -1,  0,  0,  0); -- 流線
setEffRotateKey(260 + OFFSET_X, sen2, 190);
setEffScaleKey( 260 + OFFSET_X, sen2, 1.3, 1.3);
...
SE002 = playSe( 300 + OFFSET_X, SE_07);
entryFade( 355 + OFFSET_X, 10,  5, 10, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE003 = playSe( 390 + OFFSET_X, SE_06);
...
SE004 = playSe( 455 + OFFSET_X, SE_09);
-- 敵吹っ飛ぶモーション
...
entryFadeBg( 370 + OFFSET_X, 0, 99, 0,0, 0, 0, 255);          -- ベース暗め　背景
...
SP_dodge = 420 + OFFSET_X; --エンドフェイズのフレーム数を置き換える
...
shuchusenkuro = entryEffectLife( 473 + OFFSET_X, 1657, 120, 0x80,  -1, 0,  0,  0);   -- 集中線黒
