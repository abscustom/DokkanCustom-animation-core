...
-- タックル開始
---------------------
SE000 = playSe( 130, 1018);
SE001 = playSe( 289, SE_11);
...
SP_dodge = 145; --エンドフェイズのフレーム数を置き換える(SP_ATK_1 + 35)
...
playSe( SP_ATK_3, SE_05);
speff = entryEffect( SP_ATK_3, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( SP_ATK_3, SE_05);
speff = entryEffect( SP_ATK_3, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
...
-- ** 集中線 ** --
shuchusen = entryEffectLife( SP_ATK_3 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( SP_ATK_3 + 0, shuchusen, 90, 20 );

setEffMoveKey( SP_ATK_3 + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( SP_ATK_3 + 90, shuchusen, 0, 0 , 0 );

setEffScaleKey( SP_ATK_3 + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( SP_ATK_3 + 90, shuchusen, 1.6, 1.6 );

setEffRotateKey( SP_ATK_3 + 0, shuchusen, 0 );
setEffRotateKey( SP_ATK_3 + 90, shuchusen, 0 );

setEffAlphaKey( SP_ATK_3 + 0, shuchusen, 255 );
setEffAlphaKey( SP_ATK_3 + 90, shuchusen, 255 );

--entryFade( SP_ATK_3+85, 3, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
entryFade( SP_ATK_3 + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( SP_ATK_3 + 80, 6, 8+2, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
playSe( SP_ATK_3+64 + 10, SE_06);

SP_ATK_4 = SP_ATK_3+94;
