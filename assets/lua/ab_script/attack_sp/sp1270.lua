--4016531:超サイヤ人2ベジータ_ファイナルバーストキャノン
--sp_effect_a1_00021
--sp1270
...
setEffScaleKey( spep_5 + 0, bakuhatsu, 1.005, 1.005 );
setEffScaleKey( spep_5 + 216, bakuhatsu, 1.005, 1.005 );
...
-- ** ダメージ表示 ** --
dealDamage( spep_5 + 44 );
endPhase( spep_5 + 216 - 2 );
