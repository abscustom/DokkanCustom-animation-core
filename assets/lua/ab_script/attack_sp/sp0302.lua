...
playSe( 10, SE_05);
speff = entryEffect( 10, 1120, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
...
playSe( 10, SE_05);
speff = entryEffect( 10, 1121, 0, -1, 0, 0, 0); -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0); -- カード差し替え
setEffReplaceTexture( speff, 5, 4); -- 技名テクスチャ差し替え
end
...
entryFade( 94, 3, 6, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE002 = playSe( spep_1, 43);
SE003 = playSe( spep_1+20, SE_03);
SE004 = playSe( spep_1+40, SE_03);
...
setEffScaleKey( spep_11, last, 1.02, 1.02 );
setEffScaleKey( spep_11 +170, last, 1.02, 1.02 );
