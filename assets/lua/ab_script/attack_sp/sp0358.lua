...
-- ** 集中線 ** --
shuchusen = entryEffectLife( 170 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  -- 集中線
setEffShake( 170 + 0, shuchusen, 90, 20 );
setEffMoveKey( 170 + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( 170 + 90, shuchusen, 0, 0 , 0 );
setEffScaleKey( 170 + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( 170 + 90, shuchusen, 1.6, 1.6 );
setEffRotateKey( 170 + 0, shuchusen, 0 );
setEffRotateKey( 170 + 90, shuchusen, 0 );
setEffAlphaKey( 170 + 0, shuchusen, 255 );
setEffAlphaKey( 170 + 90, shuchusen, 255 );

-- ** 白背景 ** --
entryFadeBg( 170 + 0, 0, 94, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  -- 白　背景

-- ** 白フェード ** --
--entryFade( 170 + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  -- white fade
...
-- カメハメハ発射(110F)
------------------------------------------------------
changeAnime( 260 + n, 0, 31);                                    -- かめはめ発射ポーズ
setAnimeLoop( 260 + n, 0, 1);

setMoveKey(  259 + n,    0,      0,  0,   0);
setMoveKey(  260 + n,    0,   -600,  0,   0);
setMoveKey(  261 + n,    0,   -600,  0,   0);
setMoveKey(  270 + n,    0,   -100,  0,   0);

kamehame_beam = entryEffectLife( 260 + n, SP_02, 109, 0x40,  0,  300,  90,  220);   -- 伸びるかめはめ波

SE0001 = playSe( 260 + n, SE_07);

--spname = entryEffect( 260, 1508,  0,  -1,  0,  0,  0);               -- かめはめ波文字
--setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え

-- 途中からカメハメハが伸びる
setMoveKey(  299 + n,    0,   -100,  0,   0);
setMoveKey(  300 + n,    0,   -100,  0,   0);
setMoveKey(  308 + n,    0,   -1100,  0,   0);

entryFade( 365 + n, 3, 2, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade

-- ** エフェクト等 ** --
entryFadeBg( 260 + n, 0, 109, 0, 10, 10, 10, 180);       -- ベース暗め　背景
entryFadeBg( 260 + n, 0, 40, 0, 230, 230, 230, 255);    -- 最初だけ明るい　背景
entryFadeBg( 300 + n, 0, 2, 8, 100, 140, 250, 250);     -- 青い　背景

entryEffectLife( 260 + n, 920, 109, 0x80,  -1,  0,  0,  0); -- 流線

setShakeChara( 305 + n, 0, 54, 50);

shuchusen = entryEffectLife( 260, 906, 49, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( 260 + n, shuchusen, 1.0, 1.0);
setEffScaleKey( 300 + n, shuchusen, 1.0, 1.0);
setEffScaleKey( 309 + n, shuchusen, 2.0, 2.0);
...
-- 書き文字エントリー
ct = entryEffectLife( 268 + n, 10012, 32, 0, -1, 0, 200, 300); -- ズオッ
setEffShake(268 + n, ct, 32, 5);
setEffAlphaKey(268 + n, ct, 255);
setEffAlphaKey(290 + n, ct, 255);
setEffAlphaKey(300 + n, ct, 0);
setEffScaleKey(268 + n, ct, 0.0, 0.0);
setEffScaleKey(272 + n, ct, 1.3, 1.3);
setEffScaleKey(292 + n, ct, 1.3, 1.3);
setEffScaleKey(300 + n, ct, 6.0, 6.0);
--playSe( 300, SE_07);
...
SP_dodge = 391 + n; --エンドフェイズのフレーム数を置き換える

playSe( SP_dodge-12, 1042);
stopSe( SP_dodge - 12, SE0001, 0 );
...
setScaleKey( SP_ATK_41+17,    1,  1.0, 1.0);
setScaleKey( SP_ATK_41+114,    1,  1.0, 1.0);
...
setMoveKey(  SP_ATK_41+114,   1,  -60,  -200,  -100);
...
setRotateKey( SP_ATK_41+114,  1,   0 );
...
--spname = entryEffect( 260 + n, 1508,  0,  -1,  0,  0,  0);               -- かめはめ波文字
--setEffReplaceTexture(spname, 7, 4);                                  -- 技名テクスチャ差し替え
...
shuchusen = entryEffectLife( 260 + n, 906, 49, 0x00,  -1, 0,  0,  0);   -- 集中線
setEffScaleKey( 260 + n, shuchusen, 1.0, 1.0);
setEffScaleKey( 300 + n, shuchusen, 1.0, 1.0);
setEffScaleKey( 309 + n, shuchusen, 2.0, 2.0);
