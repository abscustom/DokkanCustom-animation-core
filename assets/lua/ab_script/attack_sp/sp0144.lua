...
if (_SPECIAL_SKILL_LEVEL_ == 0) then
    ...
    spname = entryEffectLife( spep_2 + 0, 1512, 90, 0x100, -1, 0, 0, -155 );
...
elseif(_SPECIAL_SKILL_LEVEL_ == 1) then
    ...
    spname = entryEffectLife( spep_2 + 0, 3246, 90, 0x100, -1, 0, 0, -155 );
    setEffReplaceTexture( spname, 5, 4 );-- 技名テクスチャ差し替え
...
elseif(_SPECIAL_SKILL_LEVEL_ == 2) then
    ...
    spname = entryEffectLife( spep_2 + 0, 3250, 90, 0x100, -1, 0, 0, -155 );
    setEffReplaceTexture( spname, 5, 4 );-- 技名テクスチャ差し替え
...
finish = entryEffect( spep_5,1560,0,-1,0,0,0);
setEffMoveKey( spep_5 + 0, finish, 0, 0, 0 );
setEffMoveKey( spep_5 + 110, finish, 0, 0, 0 );
setEffScaleKey( spep_5 + 0, finish, 1.1, 1.1 );
setEffScaleKey( spep_5 + 110, finish, 1.1, 1.1 );
