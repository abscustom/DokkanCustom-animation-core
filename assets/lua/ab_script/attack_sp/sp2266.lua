--1023100:URトランクス(青年期)_フラッシュブレード_sp2266
--sp_effect_b2_00048
...
--味方側
SP_01 = 158424;  --敵と対峙する(味方側) ef_001
SP_02 = 158425;  --敵と対峙する(味方側) ef_001_back
SP_03 = 158428;  --前髪を直すトランクス  ef_002
SP_04 = 158429;  --画面に向かってダッシュしてくる ef_003
SP_05 = 158430;  --打撃で敵を飛ばす（味方側）   ef_004
SP_06 = 158431;  --打撃で敵を飛ばす（味方側）   ef_004_back
SP_07 = 158434;  --敵に向かって踏み込む（味方側） ef_005
SP_08 = 158436;  --敵に向かって飛ぶ（味方側）   ef_006
SP_09 = 158437;  --敵に向かって飛ぶ（味方側）   ef_006_back
SP_10 = 158440;  --剣を抜く    ef_007
SP_11 = 158441;  --斬撃ラッシュ終了（味方側）   ef_008
SP_12 = 158442;  --斬撃ラッシュ終了（味方側）   ef_008_back

--敵側
SP_01r = 158426;  --敵と対峙する(敵側)  ef_001_r
SP_02r = 158427;  --敵と対峙する(敵側)  ef_001_r_back
SP_05r = 158432;  --打撃で敵を飛ばす（敵側）    ef_004_r
SP_06r = 158433;  --打撃で敵を飛ばす（敵側）    ef_004_r_back
SP_07r = 158435;  --敵に向かって踏み込む（敵側）  ef_005_r
SP_08r = 158438;  --敵に向かって飛ぶ（敵側）    ef_006_r
SP_09r = 158439;  --敵に向かって飛ぶ（敵側）    ef_006_r_back
SP_11r = 158443;  --斬撃ラッシュ終了（敵側）    ef_008_r
SP_12r = 158444;  --斬撃ラッシュ終了（敵側）    ef_008_r_back
...
--ラスト剣撃ヒット
SE019 = playSeVer2( spep_7 + 64, 1318, "", 0, 0, 0, -1);
SE020 = playSeVer2( spep_7 + 64, 1011, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_7 + 64, SE020, 66 );
SE021 = playSeVer2( spep_7 + 64, 1172, "",spep_7 +66 + 76, 0, 24, -1);
setSeVolumeByWorkId( spep_7 + 64, SE021, 64 );
...
-- ** エフェクト等 ** --
finish_f = entryEffect( spep_8 + 0, SP_11, 0x100, -1, 0, 0, 0 );  --斬撃ラッシュ終了   ef_009
setEffMoveKey( spep_8 + 0, finish_f, 0, 0 , 0 );
setEffMoveKey( spep_8 + 176, finish_f, 0, 0 , 0 );
setEffScaleKey( spep_8 + 0, finish_f, 1.0, 1.0 );
setEffScaleKey( spep_8 + 176, finish_f, 1.0, 1.0 );
setEffRotateKey( spep_8 + 0, finish_f, 0 );
setEffRotateKey( spep_8 + 176, finish_f, 0 );
setEffAlphaKey( spep_8 + 0, finish_f, 255 );
setEffAlphaKey( spep_8 + 176, finish_f, 255 );

finish_b = entryEffect( spep_8 + 0, SP_12, 0x80, -1, 0, 0, 0 );  --斬撃ラッシュ終了    ef_009_back
setEffMoveKey( spep_8 + 0, finish_b, 0, 0 , 0 );
setEffMoveKey( spep_8 + 176, finish_b, 0, 0 , 0 );
setEffScaleKey( spep_8 + 0, finish_b, 1.0, 1.0 );
setEffScaleKey( spep_8 + 176, finish_b, 1.0, 1.0 );
setEffRotateKey( spep_8 + 0, finish_b, 0 );
setEffRotateKey( spep_8 + 176, finish_b, 0 );
setEffAlphaKey( spep_8 + 0, finish_b, 255 );
setEffAlphaKey( spep_8 + 176, finish_b, 255 );

-- ** 敵キャラクター ** --
setDisp( spep_8 + 0, 1, 1 );
setDisp( spep_8 -3 + 179, 1, 0 );
changeAnime( spep_8 + 0, 1, 105 );

setMoveKey( spep_8 + 0, 1, -24.7, -69.5 , 0 );
setMoveKey( spep_8 + 1, 1, -17.2, -35.3 , 0 );
setMoveKey( spep_8 + 2, 1, -9.7, -1.2 , 0 );
setMoveKey( spep_8 -3 + 6, 1, -2.3, 32.9 , 0 );
setMoveKey( spep_8 -3 + 8, 1, 5.2, 67 , 0 );
setMoveKey( spep_8 -3 + 10, 1, -61.1, -15.2 , 0 );
setMoveKey( spep_8 -3 + 12, 1, 77.4, 159.6 , 0 );
setMoveKey( spep_8 -3 + 14, 1, 71.5, -76.6 , 0 );
setMoveKey( spep_8 -3 + 16, 1, 5.2, 66.2 , 0 );
setMoveKey( spep_8 -3 + 18, 1, 5.3, 66 , 0 );
setMoveKey( spep_8 -3 + 20, 1, 5.3, 65.8 , 0 );
setMoveKey( spep_8 -3 + 22, 1, 5.2, 65.6 , 0 );
setMoveKey( spep_8 -3 + 24, 1, 5.2, 65.5 , 0 );
setMoveKey( spep_8 -3 + 26, 1, 5.3, 65.3 , 0 );
setMoveKey( spep_8 -3 + 28, 1, 5.3, 65.1 , 0 );
setMoveKey( spep_8 -3 + 30, 1, 5.2, 64.9 , 0 );
setMoveKey( spep_8 -3 + 32, 1, 5.2, 64.7 , 0 );
setMoveKey( spep_8 -3 + 34, 1, 5.3, 64.5 , 0 );
setMoveKey( spep_8 -3 + 36, 1, 5.3, 64.3 , 0 );
setMoveKey( spep_8 -3 + 38, 1, 5.2, 64.1 , 0 );
setMoveKey( spep_8 -3 + 40, 1, 5.2, 63.9 , 0 );
setMoveKey( spep_8 -3 + 42, 1, 5.3, 63.7 , 0 );
setMoveKey( spep_8 -3 + 44, 1, 5.3, 63.6 , 0 );
setMoveKey( spep_8 -3 + 46, 1, 5.2, 63.4 , 0 );
setMoveKey( spep_8 -3 + 48, 1, 5.2, 63.2 , 0 );
setMoveKey( spep_8 -3 + 50, 1, 5.3, 63 , 0 );
setMoveKey( spep_8 -3 + 52, 1, 5.3, 62.8 , 0 );
setMoveKey( spep_8 -3 + 54, 1, 5.2, 62.6 , 0 );
setMoveKey( spep_8 -3 + 56, 1, 5.2, 62.5 , 0 );
setMoveKey( spep_8 -3 + 58, 1, 5.3, 62.3 , 0 );
setMoveKey( spep_8 -3 + 60, 1, 18.6, 67 , 0 );
setMoveKey( spep_8 -3 + 62, 1, 33, 73.3 , 0 );
setMoveKey( spep_8 -3 + 64, 1, 48.6, 81.2 , 0 );
setMoveKey( spep_8 -3 + 66, 1, 26.5, 36 , 0 );
setMoveKey( spep_8 -3 + 68, 1, 30.5, 39.7 , 0 );
setMoveKey( spep_8 -3 + 70, 1, 20.9, 36.7 , 0 );
setMoveKey( spep_8 -3 + 72, 1, 32, 40.6 , 0 );
setMoveKey( spep_8 -3 + 74, 1, 29.3, 37.5 , 0 );
setMoveKey( spep_8 -3 + 76, 1, 22.7, 37.9 , 0 );
setMoveKey( spep_8 -3 + 78, 1, 30.7, 38.2 , 0 );
setMoveKey( spep_8 -3 + 80, 1, 14, 49.7 , 0 );
setMoveKey( spep_8 -3 + 82, 1, 24.5, 39 , 0 );
setMoveKey( spep_8 -3 + 84, 1, 36.4, 43.1 , 0 );
setMoveKey( spep_8 -3 + 86, 1, 37.2, 43.5 , 0 );
setMoveKey( spep_8 -3 + 88, 1, 26.2, 40.1 , 0 );
setMoveKey( spep_8 -3 + 90, 1, 38.6, 44.3 , 0 );
setMoveKey( spep_8 -3 + 92, 1, 39.4, 44.8 , 0 );
setMoveKey( spep_8 -3 + 94, 1, 19.8, 46.1 , 0 );
setMoveKey( spep_8 -3 + 96, 1, 40.8, 45.6 , 0 );
setMoveKey( spep_8 -3 + 98, 1, 41.6, 46.1 , 0 );
setMoveKey( spep_8 -3 + 100, 1, 29.8, 42.4 , 0 );
setMoveKey( spep_8 -3 + 102, 1, 42.8, 46.5 , 0 );
setMoveKey( spep_8 -3 + 104, 1, 43.3, 46.4 , 0 );
setMoveKey( spep_8 -3 + 106, 1, 41.7, 44.3 , 0 );
setMoveKey( spep_8 -3 + 108, 1, 42.2, 44.2 , 0 );
setMoveKey( spep_8 -3 + 110, 1, 42.6, 44.2 , 0 );
setMoveKey( spep_8 -3 + 112, 1, 43.1, 44.2 , 0 );
setMoveKey( spep_8 -3 + 114, 1, 43.6, 44.1 , 0 );
setMoveKey( spep_8 -3 + 116, 1, 44, 44.1 , 0 );
setMoveKey( spep_8 -3 + 118, 1, 44.5, 44.1 , 0 );
setMoveKey( spep_8 -3 + 120, 1, 45, 44 , 0 );
setMoveKey( spep_8 -3 + 122, 1, 45.5, 43.9 , 0 );
setMoveKey( spep_8 -3 + 124, 1, 45.9, 43.8 , 0 );
setMoveKey( spep_8 -3 + 126, 1, 46.4, 43.8 , 0 );
setMoveKey( spep_8 -3 + 128, 1, 46.9, 43.8 , 0 );
setMoveKey( spep_8 -3 + 130, 1, 47.3, 43.8 , 0 );
setMoveKey( spep_8 -3 + 132, 1, 47.8, 43.7 , 0 );
setMoveKey( spep_8 -3 + 134, 1, 48.3, 43.7 , 0 );
setMoveKey( spep_8 -3 + 136, 1, 48.8, 43.6 , 0 );
setMoveKey( spep_8 -3 + 138, 1, 49.2, 43.6 , 0 );
setMoveKey( spep_8 -3 + 140, 1, 49.7, 43.5 , 0 );
setMoveKey( spep_8 -3 + 142, 1, 50.2, 43.5 , 0 );
setMoveKey( spep_8 -3 + 144, 1, 50.5, 43.4 , 0 );
setMoveKey( spep_8 -3 + 146, 1, 51, 43.4 , 0 );
setMoveKey( spep_8 -3 + 148, 1, 51.5, 43.3 , 0 );
setMoveKey( spep_8 -3 + 150, 1, 52, 43.3 , 0 );
setMoveKey( spep_8 -3 + 152, 1, 52.4, 43.3 , 0 );
setMoveKey( spep_8 -3 + 154, 1, 52.9, 43.2 , 0 );
setMoveKey( spep_8 -3 + 156, 1, 53.4, 43.2 , 0 );
setMoveKey( spep_8 -3 + 158, 1, 53.8, 43.1 , 0 );
setMoveKey( spep_8 -3 + 179, 1, 53.8, 43.1 , 0 );

setScaleKey( spep_8 + 0, 1, 3.88, 3.88 );
setScaleKey( spep_8 + 1, 1, 3.43, 3.43 );
setScaleKey( spep_8 + 2, 1, 2.99, 2.99 );
setScaleKey( spep_8 -3 + 6, 1, 2.54, 2.54 );
setScaleKey( spep_8 -3 + 8, 1, 2.09, 2.09 );
setScaleKey( spep_8 -3 + 10, 1, 2.08, 2.08 );
setScaleKey( spep_8 -3 + 12, 1, 2.07, 2.07 );
setScaleKey( spep_8 -3 + 14, 1, 2.07, 2.07 );
setScaleKey( spep_8 -3 + 16, 1, 2.06, 2.06 );
setScaleKey( spep_8 -3 + 18, 1, 2.05, 2.05 );
setScaleKey( spep_8 -3 + 20, 1, 2.04, 2.04 );
setScaleKey( spep_8 -3 + 22, 1, 2.03, 2.03 );
setScaleKey( spep_8 -3 + 24, 1, 2.02, 2.02 );
setScaleKey( spep_8 -3 + 26, 1, 2.01, 2.01 );
setScaleKey( spep_8 -3 + 28, 1, 2.01, 2.01 );
setScaleKey( spep_8 -3 + 30, 1, 2, 2 );
setScaleKey( spep_8 -3 + 32, 1, 1.99, 1.99 );
setScaleKey( spep_8 -3 + 34, 1, 1.98, 1.98 );
setScaleKey( spep_8 -3 + 36, 1, 1.97, 1.97 );
setScaleKey( spep_8 -3 + 38, 1, 1.96, 1.96 );
setScaleKey( spep_8 -3 + 40, 1, 1.95, 1.95 );
setScaleKey( spep_8 -3 + 42, 1, 1.95, 1.95 );
setScaleKey( spep_8 -3 + 44, 1, 1.94, 1.94 );
setScaleKey( spep_8 -3 + 46, 1, 1.93, 1.93 );
setScaleKey( spep_8 -3 + 48, 1, 1.92, 1.92 );
setScaleKey( spep_8 -3 + 50, 1, 1.91, 1.91 );
setScaleKey( spep_8 -3 + 52, 1, 1.9, 1.9 );
setScaleKey( spep_8 -3 + 54, 1, 1.89, 1.89 );
setScaleKey( spep_8 -3 + 56, 1, 1.89, 1.89 );
setScaleKey( spep_8 -3 + 58, 1, 1.88, 1.88 );
setScaleKey( spep_8 -3 + 60, 1, 1.55, 1.55 );
setScaleKey( spep_8 -3 + 62, 1, 1.21, 1.21 );
setScaleKey( spep_8 -3 + 64, 1, 0.85, 0.85 );
setScaleKey( spep_8 -3 + 66, 1, 0.87, 0.87 );
setScaleKey( spep_8 -3 + 68, 1, 0.88, 0.88 );
setScaleKey( spep_8 -3 + 70, 1, 0.89, 0.89 );
setScaleKey( spep_8 -3 + 72, 1, 0.9, 0.9 );
setScaleKey( spep_8 -3 + 74, 1, 0.92, 0.92 );
setScaleKey( spep_8 -3 + 76, 1, 0.93, 0.93 );
setScaleKey( spep_8 -3 + 78, 1, 0.94, 0.94 );
setScaleKey( spep_8 -3 + 80, 1, 0.96, 0.96 );
setScaleKey( spep_8 -3 + 82, 1, 0.97, 0.97 );
setScaleKey( spep_8 -3 + 84, 1, 0.98, 0.98 );
setScaleKey( spep_8 -3 + 86, 1, 0.99, 0.99 );
setScaleKey( spep_8 -3 + 88, 1, 1.01, 1.01 );
setScaleKey( spep_8 -3 + 90, 1, 1.02, 1.02 );
setScaleKey( spep_8 -3 + 92, 1, 1.03, 1.03 );
setScaleKey( spep_8 -3 + 94, 1, 1.04, 1.04 );
setScaleKey( spep_8 -3 + 96, 1, 1.06, 1.06 );
setScaleKey( spep_8 -3 + 98, 1, 1.07, 1.07 );
setScaleKey( spep_8 -3 + 100, 1, 1.08, 1.08 );
setScaleKey( spep_8 -3 + 102, 1, 1.09, 1.09 );
setScaleKey( spep_8 -3 + 104, 1, 1.1, 1.1 );
setScaleKey( spep_8 -3 + 106, 1, 1.11, 1.11 );
setScaleKey( spep_8 -3 + 108, 1, 1.13, 1.13 );
setScaleKey( spep_8 -3 + 110, 1, 1.14, 1.14 );
setScaleKey( spep_8 -3 + 112, 1, 1.15, 1.15 );
setScaleKey( spep_8 -3 + 114, 1, 1.16, 1.16 );
setScaleKey( spep_8 -3 + 116, 1, 1.17, 1.17 );
setScaleKey( spep_8 -3 + 118, 1, 1.18, 1.18 );
setScaleKey( spep_8 -3 + 120, 1, 1.19, 1.19 );
setScaleKey( spep_8 -3 + 122, 1, 1.2, 1.2 );
setScaleKey( spep_8 -3 + 124, 1, 1.21, 1.21 );
setScaleKey( spep_8 -3 + 126, 1, 1.22, 1.22 );
setScaleKey( spep_8 -3 + 128, 1, 1.23, 1.23 );
setScaleKey( spep_8 -3 + 130, 1, 1.24, 1.24 );
setScaleKey( spep_8 -3 + 132, 1, 1.26, 1.26 );
setScaleKey( spep_8 -3 + 134, 1, 1.27, 1.27 );
setScaleKey( spep_8 -3 + 136, 1, 1.28, 1.28 );
setScaleKey( spep_8 -3 + 138, 1, 1.29, 1.29 );
setScaleKey( spep_8 -3 + 140, 1, 1.3, 1.3 );
setScaleKey( spep_8 -3 + 142, 1, 1.31, 1.31 );
setScaleKey( spep_8 -3 + 144, 1, 1.32, 1.32 );
setScaleKey( spep_8 -3 + 146, 1, 1.33, 1.33 );
setScaleKey( spep_8 -3 + 148, 1, 1.34, 1.34 );
setScaleKey( spep_8 -3 + 150, 1, 1.35, 1.35 );
setScaleKey( spep_8 -3 + 152, 1, 1.36, 1.36 );
setScaleKey( spep_8 -3 + 154, 1, 1.37, 1.37 );
setScaleKey( spep_8 -3 + 156, 1, 1.38, 1.38 );
setScaleKey( spep_8 -3 + 158, 1, 1.4, 1.4 );
setScaleKey( spep_8 -3 + 179, 1, 1.4, 1.4 );

setRotateKey( spep_8 + 0, 1, 0 );
setRotateKey( spep_8 -3 + 179, 1, 0 );

-- ** 音 ** --
--爆発
SE037 = playSeVer2( spep_8 + 56, 1023, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_8 + 56, 1159, "", 0, 0, 0, -1);
...
-- ** エフェクト等 ** --
finish_f = entryEffect( spep_8 + 0, SP_11r, 0x100, -1, 0, 0, 0 );  --斬撃ラッシュ終了   ef_009
setEffMoveKey( spep_8 + 0, finish_f, 0, 0 , 0 );
setEffMoveKey( spep_8 + 176, finish_f, 0, 0 , 0 );
setEffScaleKey( spep_8 + 0, finish_f, 1.0, 1.0 );
setEffScaleKey( spep_8 + 176, finish_f, 1.0, 1.0 );
...
finish_b = entryEffect( spep_8 + 0, SP_12r, 0x80, -1, 0, 0, 0 );  --斬撃ラッシュ終了    ef_009_back
setEffMoveKey( spep_8 + 0, finish_b, 0, 0 , 0 );
setEffMoveKey( spep_8 + 176, finish_b, 0, 0 , 0 );
setEffScaleKey( spep_8 + 0, finish_b, 1.0, 1.0 );
setEffScaleKey( spep_8 + 176, finish_b, 1.0, 1.0 );
