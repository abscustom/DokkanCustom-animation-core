...
--SE
se_1018 = playSe( spep_0 + 140, 1018 );--ごごご
...
se_1003 = playSe( spep_0 + 57, 1003 );
setSeVolume( spep_0 + 57, 1003, 112 );
se_1116 = playSe( spep_0 + 90, 1116 );
se_1004 = playSe( spep_0 + 93, 1004 );
setSeVolume( spep_0 + 93, 1004, 63 );
se_1025 = playSe( spep_0 + 111, 1025 );
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge - 12, se_1018, 0 );
    stopSe( SP_dodge - 12, se_0008, 0 );
    stopSe( SP_dodge - 12, se_1072, 0 );
    stopSe( SP_dodge - 12, se_1067, 0 );
    stopSe( SP_dodge - 12, se_1116, 0 );
    stopSe( SP_dodge - 12, se_1003, 0 );
    stopSe( SP_dodge - 12, se_1004, 0 );
    stopSe( SP_dodge - 12, se_1025, 0 );
