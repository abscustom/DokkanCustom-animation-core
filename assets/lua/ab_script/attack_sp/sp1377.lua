...
--強気溜め
SE1068 = playSe( spep_0 + 119 -10, 1068 );
...
setEffScaleKey( spep_10 + 0, bakuhatsu, 1.1, 1.1 );
setEffScaleKey( spep_10 + 176, bakuhatsu, 1.1, 1.1 );
