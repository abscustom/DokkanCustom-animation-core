...
entryFade( SP_start2+ 255, 3, 2+4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
SE002 = playSe( SP_start2+ 260, SE_07);
SE003 = playSe( SP_start2+ 280, SE_07);
SE004 = playSe( SP_start2+ 300, SE_07);
SE005 = playSe( SP_start2+ 320, SE_07);
SE006 = playSe( SP_start2+ 340, SE_07);
SE007 = playSe( SP_start2+ 360, SE_07);
...
SE001 = playSe( SP_start2+ 370, SE_06);
...
SP_dodge = 460; --エンドフェイズのフレーム数を置き換える(SP_start2+390)
