--9209531 UR 超サイヤ人ゴッドSS孫悟空_超かめはめ波 sp0268
...
-- ** 集中線 ** --
shuchusen_x = entryEffectLife( spep_x, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_x + 0, shuchusen_x, 90, 20 );
setEffMoveKey( spep_x + 0, shuchusen_x, 0, 0 , 0 );
setEffMoveKey( spep_x + 90, shuchusen_x, 0, 0 , 0 );
setEffScaleKey( spep_x + 0, shuchusen_x, 1.6, 1.6 );
setEffScaleKey( spep_x + 90, shuchusen_x, 1.6, 1.6 );
setEffRotateKey( spep_x + 0, shuchusen_x, 0 );
setEffRotateKey( spep_x + 90, shuchusen_x, 0 );
setEffAlphaKey( spep_x + 0, shuchusen_x, 255 );
setEffAlphaKey( spep_x + 90, shuchusen_x, 255 );
...
SP_dodge = 185+125; --エンドフェイズのフレーム数を置き換える
