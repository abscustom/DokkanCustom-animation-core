...
-- ** 白フェード ** --
entryFade( 166, 0, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
...
entryFade( SP_ATK_1, 0, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( SP_ATK_1 + 60, 2, 4, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
