...
SE_0007 = playSe( SP_start_02+80, SE_07);
...
SE_0006 = playSe( SP_start_02+100, SE_06);
--エフェクト表示
...
setDisp( SP_start_04+90, 1, 0);
setEffAlphaKey( SP_start_04+80, speff3, 0);
setEffAlphaKey( SP_start_04+80, speff4, 0);

setMoveKey( SP_start_04+90, 1, 100, -450, 0);
--setMoveKey( SP_start_04+80, 1, 50, -300, 0);
setScaleKey( SP_start_04+90, 1,  1.5, 1.5);
setRotateKey( SP_start_04+90,  1, 60 );
changeAnime( SP_start_04+90, 1, 108);
setAnimeLoop( SP_start_04+90, 1, 1);
...
SE_CUTIN = playSe( SP_start_02, SE_05);
speff = entryEffect(  SP_start_02,   1507,   0,  -1,  0,  0,  0);   -- カード
--speff = entryEffect(  170,   1507,   0,  -1,  0,  0,  0);   -- カード
setEffReplaceTexture( speff, 1, 1);
setEffReplaceTexture( speff, 2, 0);                         -- カード差し替え
