...
-- ** 音 ** --
stop1 = playSe( spep_2+2, SE_03);
stop2 = playSe( spep_2+52, SE_03);
...
stopSe( SP_dodge - 12, stop1, 0);
stopSe( SP_dodge - 6, stop2, 0);
