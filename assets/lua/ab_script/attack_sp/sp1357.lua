...
se_1036 = playSe( spep_0 + 0, 1036 );
setSeVolume( spep_0 + 0, 1036, 32 );
se_1036_2 = playSe( spep_0 + 24, 1036 );
setSeVolume( spep_0 + 24, 1036, 32 );
se_1036_3 = playSe( spep_0 + 48, 1036 );
...
if(_IS_DODGE_ == 1) then
    ...
    stopSe( SP_dodge - 12, se_1036_2, 0 );
    stopSe( SP_dodge - 12, se_1036_3, 0 );
