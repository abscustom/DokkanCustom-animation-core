--1026170:SSRガンマ1号_ガンマ・ブラスター_sp2511
--sp_effect_a2_00197
...
--味方側
SP_01 = 161103;  --ピストル構え、溜め    ef_001
SP_02 = 161104;  --着弾発射    ef_002
SP_03 = 161105;  --飛んでいく着弾    ef_003
SP_04 = 161106;  --集中線    ef_004

--敵側
SP_02r = 161194;  --ピストル構え、溜め    ef_002_e
SP_01r = 161195;  --着弾発射    ef_001_e
SP_03r = 161196;  --飛んでいく着弾    ef_003_e
SP_04r = 161197;  --集中線    ef_004_e
...
--気弾溜め
SE003 = playSeVer2( spep_0 + 60, 1257, "", 0, 0, 0, -1);
SE004 = playSeVer2( spep_0 + 60, 1356, "",spep_0 + 162, 0, 12, -1);

--顔カットイン
SE005 = playSeVer2( spep_x + 12, 1018, "", 0, 0, 0, -1);

--気弾溜め
SE006 = playSeVer2( spep_0 + 64, 1282, "",spep_0 + 162, 0, 12, -1);
setSeVolumeByWorkId( spep_0 + 64, SE006, 72 );
...
-- ** 音 ** --
--気弾発射
SE008 = playSeVer2( spep_2 + 14, 1027, "", 0, 0, 0, -1);
SE009 = playSeVer2( spep_2 + 14, 1145, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 14, SE009, 83 );
SE010 = playSeVer2( spep_2 + 14, 1312, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 14, SE010, 89 );
...
-- ** 音 ** --
--気弾飛んでいく
SE011 = playSeVer2( spep_3 + 27, 1021, "", 0, 0, 0, -1);
