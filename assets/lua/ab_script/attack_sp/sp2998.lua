--XXXXXXX:LR_超サイヤ人ゴッドSSべジータ(進化)+孫悟空(身勝手の極意"兆")_アクティブ必殺_エネミー側
--sp_effect_a1_00522
--sp2998
...
-- ** エフェクト等 ** --
start_f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0); -- 全編(ef_001r)
...
changeAnime( spep_0 + 30 + OFFSET_X, 1, 104 );
...
changeAnime( spep_0 + 272 + OFFSET_X, 1, 8 );

setMoveKey( spep_0 + 230 + OFFSET_X, 1, 59.7, 80 , 0 );
setMoveKey( spep_0 + 241 + OFFSET_X, 1, 59.7, 80 , 0 );
setMoveKey( spep_0 + 242 + OFFSET_X, 1, 6.8, 255.5 , 0 );
setMoveKey( spep_0 + 243 + OFFSET_X, 1, 6.8, 255.5 , 0 );
setMoveKey( spep_0 + 244 + OFFSET_X, 1, -2, 393.7 , 0 );
setMoveKey( spep_0 + 245 + OFFSET_X, 1, -2, 393.7 , 0 );
...
changeAnime( spep_0 + 310 + OFFSET_X, 1, 107 );
...
changeAnime( spep_0 + 330 + OFFSET_X, 1, 108 );
...
changeAnime( spep_0 + 688 + OFFSET_X, 1, 106 );
...
--左手握る
SE020 = playSeVer2( spep_0 + 360, 1189, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 360, SE020, 158 );
SE021 = playSeVer2( spep_0 + 360, 1233, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 360, SE021, 141 );
...
-- ** ダメージ表示 ** --
dealDamage( spep_0 + 1106); -- ダメージ表示フレーム
endPhase( spep_0 + MAX_FRAME_0 -0); -- 1228f -0f
