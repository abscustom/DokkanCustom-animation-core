--1022750:フリーザ(フルパワー)_オレに殺されるべきなんだ！(アクティブ)_敵側
--sp_effect_a1_00308
--sp3068
...
--エフェクト(味方)
SP_01r = 164498;  --冒頭から発射前まで ef_001
...
-- ** エフェクト等 ** --
tame_f = entryEffect( spep_0 + 0, SP_01r, 0x100, -1, 0, 0, 0 ); 
...
changeAnime( spep_1 -3 + 122, 1, 2 );
changeAnime( spep_1 -3 + 170, 1, 4 );
changeAnime( spep_1 -3 + 188, 1, 6 );
