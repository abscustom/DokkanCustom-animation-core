...
-- ** 白背景 ** --
entryFadeBg( 170 + 0, 0, 90, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景
...
SE002 = playSe( 300, SE_07);
entryFade( 356, 10,  10, 10, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade( tyo2 + 163, 3, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
-- ** 集中線 ** --
shuchusen = entryEffectLife( 170 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( tyo2 + 170 + 0, shuchusen, 90, 20 );
setEffMoveKey( tyo2 + 170 + 0, shuchusen, 0, 0 , 0 );
setEffMoveKey( tyo2 + 170 + 90, shuchusen, 0, 0 , 0 );
setEffScaleKey( tyo2 + 170 + 0, shuchusen, 1.6, 1.6 );
setEffScaleKey( tyo2 + 170 + 90, shuchusen, 1.6, 1.6 );
setEffRotateKey( tyo2 + 170 + 0, shuchusen, 0 );
setEffRotateKey( tyo2 + 170 + 90, shuchusen, 0 );
setEffAlphaKey( tyo2 + 170 + 0, shuchusen, 255 );
setEffAlphaKey( tyo2 + 170 + 90, shuchusen, 255 );

-- ** 白背景 ** --
entryFadeBg( tyo2 + 170 + 0, 0, 90, 0, fcolor_r, fcolor_g, fcolor_b, 255 );  --白　背景

-- ** 白フェード ** --
entryFade( tyo2 + 170 + 0, 0, 2, 4, fcolor_r, fcolor_g, fcolor_b, 255 );  --white fade
entryFade( tyo2 + 255, 3, 4, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
...
entryFade(tyo2+356, 10, 10, 5, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
