...
-- 書き文字エントリー
ct = entryEffectLife( 90, 10008, 39, 0x100, -1, 0, -220, 300);    -- ゴゴゴ・・・
...
SE05 = playSe( SP_start+455, SE_09);
-- 敵吹っ飛ぶモーション
...
entryFadeBg( SP_start+370, 0, 66, 0, 10, 10, 10, 150);          -- ベース暗め　背景
...
entryFade( SP_start+415, 4, 14, 4, fcolor_r, fcolor_g, fcolor_b, 255);     -- white fade
