--1031760:UR_ゴクウブラック(超サイヤ人ロゼ)(分身)[速]_必殺技B：混沌の円舞曲
--sp_effect_a1_00497
--sp2889
...
--エフェクト(共通)
SP_01  = 163960; --登場 ef_001
SP_02  = 163961; --攻撃 ef_002
SP_02b = 163962; --攻撃_裏 ef_002b
...
setMoveKey( spep_2 + 286 + OFFSET_X, 1, 104, 93.6 , 0 );
setMoveKey( spep_2 + 291 + OFFSET_X, 1, 104, 93.6 , 0 );
setMoveKey( spep_2 + 292 + OFFSET_X, 1, 104, 93.5 , 0 );
setMoveKey( spep_2 + 293 + OFFSET_X, 1, 104, 93.5 , 0 );
setMoveKey( spep_2 + 294 + OFFSET_X, 1, 103.9, 93.4 , 0 );
setMoveKey( spep_2 + 295 + OFFSET_X, 1, 103.9, 93.4 , 0 );
setMoveKey( spep_2 + 296 + OFFSET_X, 1, 129.4, 220 , 0 );
setMoveKey( spep_2 + 297 + OFFSET_X, 1, 129.4, 220 , 0 );
setMoveKey( spep_2 + 298 + OFFSET_X, 1, 63.2, 183.5 , 0 );
setMoveKey( spep_2 + 299 + OFFSET_X, 1, 63.2, 183.5 , 0 );
setMoveKey( spep_2 + 300 + OFFSET_X, 1, 69, 236.8 , 0 );
setMoveKey( spep_2 + 301 + OFFSET_X, 1, 69, 236.8 , 0 );
setMoveKey( spep_2 + 302 + OFFSET_X, 1, 98.6, 179.9 , 0 );
setMoveKey( spep_2 + 303 + OFFSET_X, 1, 98.6, 179.9 , 0 );
setMoveKey( spep_2 + 304 + OFFSET_X, 1, 100.2, 200.7 , 0 );
setMoveKey( spep_2 + 305 + OFFSET_X, 1, 100.2, 200.7 , 0 );
setMoveKey( spep_2 + 306 + OFFSET_X, 1, 56, 162.6 , 0 );
setMoveKey( spep_2 + 307 + OFFSET_X, 1, 56, 162.6 , 0 );
setMoveKey( spep_2 + 308 + OFFSET_X, 1, 67.3, 119.3 , 0 );
setMoveKey( spep_2 + 309 + OFFSET_X, 1, 67.3, 119.3 , 0 );
setMoveKey( spep_2 + 310 + OFFSET_X, 1, 11.4, 45.1 , 0 );
setMoveKey( spep_2 + 311 + OFFSET_X, 1, 11.4, 45.1 , 0 );
setMoveKey( spep_2 + 312 + OFFSET_X, 1, 25.4, 5.5 , 0 );
setMoveKey( spep_2 + 313 + OFFSET_X, 1, 25.4, 5.5 , 0 );
setMoveKey( spep_2 + 314 + OFFSET_X, 1, -0.7, 22 , 0 );
setMoveKey( spep_2 + 315 + OFFSET_X, 1, -0.7, 22 , 0 );
setMoveKey( spep_2 + 316 + OFFSET_X, 1, 11.2, -7.4 , 0 );
setMoveKey( spep_2 + 317 + OFFSET_X, 1, 11.2, -7.4 , 0 );
setMoveKey( spep_2 + 318 + OFFSET_X, 1, 28.9, 7.4 , 0 );
setMoveKey( spep_2 + 319 + OFFSET_X, 1, 28.9, 7.4 , 0 );
setMoveKey( spep_2 + 320 + OFFSET_X, 1, 18.5, -1.6 , 0 );
setMoveKey( spep_2 + 321 + OFFSET_X, 1, 18.5, -1.6 , 0 );
setMoveKey( spep_2 + 322 + OFFSET_X, 1, 20, -6.3 , 0 );
setMoveKey( spep_2 + 323 + OFFSET_X, 1, 20, -6.3 , 0 );
setMoveKey( spep_2 + 324 + OFFSET_X, 1, 21.5, -10.9 , 0 );
setMoveKey( spep_2 + 325 + OFFSET_X, 1, 21.5, -10.9 , 0 );
setMoveKey( spep_2 + 326 + OFFSET_X, 1, 23, -15.3 , 0 );
setMoveKey( spep_2 + 327 + OFFSET_X, 1, 23, -15.3 , 0 );
setMoveKey( spep_2 + 328 + OFFSET_X, 1, 24.5, -19.6 , 0 );
setMoveKey( spep_2 + 329 + OFFSET_X, 1, 24.5, -19.6 , 0 );
setMoveKey( spep_2 + 330 + OFFSET_X, 1, 26, -23.9 , 0 );
setMoveKey( spep_2 + 331 + OFFSET_X, 1, 26, -23.9 , 0 );
setMoveKey( spep_2 + 332 + OFFSET_X, 1, 27.5, -28.1 , 0 );
setMoveKey( spep_2 + 333 + OFFSET_X, 1, 27.5, -28.1 , 0 );
setMoveKey( spep_2 + 334 + OFFSET_X, 1, 29, -32.2 , 0 );
setMoveKey( spep_2 + 335 + OFFSET_X, 1, 29, -32.2 , 0 );
setMoveKey( spep_2 + 336 + OFFSET_X, 1, 30.6, -36.3 , 0 );
setMoveKey( spep_2 + 337 + OFFSET_X, 1, 30.6, -36.3 , 0 );
setMoveKey( spep_2 + 338 + OFFSET_X, 1, 32.1, -40.5 , 0 );
setMoveKey( spep_2 + 339 + OFFSET_X, 1, 32.1, -40.5 , 0 );
setMoveKey( spep_2 + 340 + OFFSET_X, 1, 33.7, -44.6 , 0 );
setMoveKey( spep_2 + 341 + OFFSET_X, 1, 33.7, -44.6 , 0 );
setMoveKey( spep_2 + 342 + OFFSET_X, 1, 35.4, -48.8 , 0 );
setMoveKey( spep_2 + 343 + OFFSET_X, 1, 35.4, -48.8 , 0 );
setMoveKey( spep_2 + 344 + OFFSET_X, 1, 37, -53 , 0 );
setMoveKey( spep_2 + 345 + OFFSET_X, 1, 37, -53 , 0 );
setMoveKey( spep_2 + 346 + OFFSET_X, 1, 38.7, -57.2 , 0 );
setMoveKey( spep_2 + 347 + OFFSET_X, 1, 38.7, -57.2 , 0 );
setMoveKey( spep_2 + 348 + OFFSET_X, 1, 40.4, -61.5 , 0 );
setMoveKey( spep_2 + 349 + OFFSET_X, 1, 40.4, -61.5 , 0 );
setMoveKey( spep_2 + 350 + OFFSET_X, 1, 42.1, -65.7 , 0 );
setMoveKey( spep_2 + 362 + OFFSET_X, 1, 42.1, -65.7 , 0 );

setScaleKey( spep_2 + 286 + OFFSET_X, 1, 6.58, 6.58 );
setScaleKey( spep_2 + 293 + OFFSET_X, 1, 6.58, 6.58 );
setScaleKey( spep_2 + 294 + OFFSET_X, 1, 6.57, 6.57 );
setScaleKey( spep_2 + 295 + OFFSET_X, 1, 6.57, 6.57 );
setScaleKey( spep_2 + 296 + OFFSET_X, 1, 5.44, 5.44 );
setScaleKey( spep_2 + 297 + OFFSET_X, 1, 5.44, 5.44 );
setScaleKey( spep_2 + 298 + OFFSET_X, 1, 5.43, 5.43 );
setScaleKey( spep_2 + 299 + OFFSET_X, 1, 5.43, 5.43 );
setScaleKey( spep_2 + 300 + OFFSET_X, 1, 5.41, 5.41 );
setScaleKey( spep_2 + 301 + OFFSET_X, 1, 5.41, 5.41 );
setScaleKey( spep_2 + 302 + OFFSET_X, 1, 5.39, 5.39 );
setScaleKey( spep_2 + 303 + OFFSET_X, 1, 5.39, 5.39 );
setScaleKey( spep_2 + 304 + OFFSET_X, 1, 5.35, 5.35 );
setScaleKey( spep_2 + 305 + OFFSET_X, 1, 5.35, 5.35 );
setScaleKey( spep_2 + 306 + OFFSET_X, 1, 3.92, 3.92 );
setScaleKey( spep_2 + 307 + OFFSET_X, 1, 3.92, 3.92 );
setScaleKey( spep_2 + 308 + OFFSET_X, 1, 3.89, 3.89 );
setScaleKey( spep_2 + 309 + OFFSET_X, 1, 3.89, 3.89 );
setScaleKey( spep_2 + 310 + OFFSET_X, 1, 2.43, 2.43 );
setScaleKey( spep_2 + 311 + OFFSET_X, 1, 2.43, 2.43 );
setScaleKey( spep_2 + 312 + OFFSET_X, 1, 2.3, 2.3 );
setScaleKey( spep_2 + 313 + OFFSET_X, 1, 2.3, 2.3 );
setScaleKey( spep_2 + 314 + OFFSET_X, 1, 2.17, 2.17 );
setScaleKey( spep_2 + 315 + OFFSET_X, 1, 2.17, 2.17 );
setScaleKey( spep_2 + 316 + OFFSET_X, 1, 2.04, 2.04 );
setScaleKey( spep_2 + 317 + OFFSET_X, 1, 2.04, 2.04 );
setScaleKey( spep_2 + 318 + OFFSET_X, 1, 1.9, 1.9 );
setScaleKey( spep_2 + 319 + OFFSET_X, 1, 1.9, 1.9 );
setScaleKey( spep_2 + 320 + OFFSET_X, 1, 1.77, 1.77 );
setScaleKey( spep_2 + 321 + OFFSET_X, 1, 1.77, 1.77 );
setScaleKey( spep_2 + 322 + OFFSET_X, 1, 1.64, 1.64 );
setScaleKey( spep_2 + 323 + OFFSET_X, 1, 1.64, 1.64 );
setScaleKey( spep_2 + 324 + OFFSET_X, 1, 1.52, 1.52 );
setScaleKey( spep_2 + 325 + OFFSET_X, 1, 1.52, 1.52 );
setScaleKey( spep_2 + 326 + OFFSET_X, 1, 1.41, 1.41 );
setScaleKey( spep_2 + 327 + OFFSET_X, 1, 1.41, 1.41 );
setScaleKey( spep_2 + 328 + OFFSET_X, 1, 1.31, 1.31 );
setScaleKey( spep_2 + 329 + OFFSET_X, 1, 1.31, 1.31 );
setScaleKey( spep_2 + 330 + OFFSET_X, 1, 1.21, 1.21 );
setScaleKey( spep_2 + 331 + OFFSET_X, 1, 1.21, 1.21 );
setScaleKey( spep_2 + 332 + OFFSET_X, 1, 1.12, 1.12 );
setScaleKey( spep_2 + 333 + OFFSET_X, 1, 1.12, 1.12 );
setScaleKey( spep_2 + 334 + OFFSET_X, 1, 1.03, 1.03 );
setScaleKey( spep_2 + 335 + OFFSET_X, 1, 1.03, 1.03 );
setScaleKey( spep_2 + 336 + OFFSET_X, 1, 0.94, 0.94 );
setScaleKey( spep_2 + 337 + OFFSET_X, 1, 0.94, 0.94 );
setScaleKey( spep_2 + 338 + OFFSET_X, 1, 0.85, 0.85 );
setScaleKey( spep_2 + 339 + OFFSET_X, 1, 0.85, 0.85 );
setScaleKey( spep_2 + 340 + OFFSET_X, 1, 0.77, 0.77 );
setScaleKey( spep_2 + 341 + OFFSET_X, 1, 0.77, 0.77 );
setScaleKey( spep_2 + 342 + OFFSET_X, 1, 0.69, 0.69 );
setScaleKey( spep_2 + 343 + OFFSET_X, 1, 0.69, 0.69 );
setScaleKey( spep_2 + 344 + OFFSET_X, 1, 0.61, 0.61 );
setScaleKey( spep_2 + 345 + OFFSET_X, 1, 0.61, 0.61 );
setScaleKey( spep_2 + 346 + OFFSET_X, 1, 0.53, 0.53 );
setScaleKey( spep_2 + 347 + OFFSET_X, 1, 0.53, 0.53 );
setScaleKey( spep_2 + 348 + OFFSET_X, 1, 0.45, 0.45 );
setScaleKey( spep_2 + 349 + OFFSET_X, 1, 0.45, 0.45 );
setScaleKey( spep_2 + 350 + OFFSET_X, 1, 0.37, 0.37 );
...
--敵の動き3
setDisp( spep_2 + 502 + OFFSET_X, 1, 1 );
setDisp( spep_2 + 540 + OFFSET_X, 1, 0 );

changeAnime( spep_2 + 502 + OFFSET_X, 1, 106 );

setMoveKey( spep_2 + 502 + OFFSET_X, 1, -241.3, 147.7 , 0 );
setMoveKey( spep_2 + 503 + OFFSET_X, 1, -241.3, 147.7 , 0 );
setMoveKey( spep_2 + 504 + OFFSET_X, 1, -209.6, 123 , 0 );
setMoveKey( spep_2 + 505 + OFFSET_X, 1, -209.6, 123 , 0 );
setMoveKey( spep_2 + 506 + OFFSET_X, 1, -177.8, 98.2 , 0 );
setMoveKey( spep_2 + 507 + OFFSET_X, 1, -177.8, 98.2 , 0 );
setMoveKey( spep_2 + 508 + OFFSET_X, 1, -146.1, 73.5 , 0 );
setMoveKey( spep_2 + 509 + OFFSET_X, 1, -146.1, 73.5 , 0 );
setMoveKey( spep_2 + 510 + OFFSET_X, 1, -114.3, 48.7 , 0 );
setMoveKey( spep_2 + 511 + OFFSET_X, 1, -114.3, 48.7 , 0 );
setMoveKey( spep_2 + 512 + OFFSET_X, 1, -82.6, 24 , 0 );
setMoveKey( spep_2 + 513 + OFFSET_X, 1, -82.6, 24 , 0 );
setMoveKey( spep_2 + 514 + OFFSET_X, 1, -50.8, -0.8 , 0 );
setMoveKey( spep_2 + 515 + OFFSET_X, 1, -50.8, -0.8 , 0 );
setMoveKey( spep_2 + 516 + OFFSET_X, 1, -19.1, -25.5 , 0 );
setMoveKey( spep_2 + 517 + OFFSET_X, 1, -19.1, -25.5 , 0 );
setMoveKey( spep_2 + 518 + OFFSET_X, 1, 12.7, -50.3 , 0 );
setMoveKey( spep_2 + 519 + OFFSET_X, 1, 12.7, -50.3 , 0 );
setMoveKey( spep_2 + 520 + OFFSET_X, 1, 44.5, -75.1 , 0 );
setMoveKey( spep_2 + 521 + OFFSET_X, 1, 44.5, -75.1 , 0 );
setMoveKey( spep_2 + 522 + OFFSET_X, 1, 76.2, -99.8 , 0 );
setMoveKey( spep_2 + 523 + OFFSET_X, 1, 76.2, -99.8 , 0 );
setMoveKey( spep_2 + 524 + OFFSET_X, 1, 108, -124.6 , 0 );
setMoveKey( spep_2 + 525 + OFFSET_X, 1, 108, -124.6 , 0 );
setMoveKey( spep_2 + 526 + OFFSET_X, 1, 139.7, -149.3 , 0 );
setMoveKey( spep_2 + 527 + OFFSET_X, 1, 139.7, -149.3 , 0 );
setMoveKey( spep_2 + 528 + OFFSET_X, 1, 171.5, -174.1 , 0 );
setMoveKey( spep_2 + 529 + OFFSET_X, 1, 171.5, -174.1 , 0 );
setMoveKey( spep_2 + 530 + OFFSET_X, 1, 213.2, -220.8 , 0 );
setMoveKey( spep_2 + 531 + OFFSET_X, 1, 213.2, -220.8 , 0 );
setMoveKey( spep_2 + 532 + OFFSET_X, 1, 215, -219.6 , 0 );
setMoveKey( spep_2 + 533 + OFFSET_X, 1, 215, -219.6 , 0 );
setMoveKey( spep_2 + 534 + OFFSET_X, 1, 268.8, -226.4 , 0 );
setMoveKey( spep_2 + 540 + OFFSET_X, 1, 268.8, -226.4 , 0 );

setScaleKey( spep_2 + 502 + OFFSET_X, 1, 0.27, 0.27 );
setScaleKey( spep_2 + 540 + OFFSET_X, 1, 0.27, 0.27 );

setRotateKey( spep_2 + 502 + OFFSET_X, 1, 63 );
setRotateKey( spep_2 + 540 + OFFSET_X, 1, 63 );
...
--敵飛んでいく
SE026 = playSeVer2( spep_2 + 312, 1121, "",spep_2 + 528, 0, 164, -1);

--構える
SE027 = playSeVer2( spep_2 + 346, 1004, "", 0, 0, 0, -1);
SE028 = playSeVer2( spep_2 + 366, 8, "", 0, 0, 0, -1);

--気弾溜め
SE029 = playSeVer2( spep_2 + 394, 1191, "",spep_2 + 486, 0, 30, -1);
SE030 = playSeVer2( spep_2 + 394, 1209, "",spep_2 + 486, 0, 32, -1);
setSeVolumeByWorkId( spep_2 + 394, SE030, 67 );
SE031 = playSeVer2( spep_2 + 394, 1360, "",spep_2 + 490, 0, 36, -1);

--連続気弾発射
SE032 = playSeVer2( spep_2 + 454, 1448, "",spep_2 + 638, 0, 36, -1);
SE033 = playSeVer2( spep_2 + 454, 1463, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 454, SE033, 158 );

--気弾飛んでくる
SE034 = playSeVer2( spep_2 + 504, 1021, "", 0, 0, 0, -1);

--爆発
SE035 = playSeVer2( spep_2 + 522, 1159, "", 0, 0, 0, -1);

--連続気弾発射
SE036 = playSeVer2( spep_2 + 538, 1463, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 538, SE036, 158 );

--爆発
SE037 = playSeVer2( spep_2 + 560, 1067, "", 0, 0, 0, -1);
SE038 = playSeVer2( spep_2 + 592, 1188, "", 0, 0, 0, -1);


-- ** ダメージ表示 ** --
dealDamage( spep_2 + 540); -- ダメージ表示フレーム
endPhase( spep_2 + MAX_FRAME_2 ); --674f
...
changeAnime( spep_2 + 502 + OFFSET_X, 1, 6 );
