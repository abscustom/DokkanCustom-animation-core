--1030610：UR_トランクス(幼年期)+孫悟天(幼年期)_必殺技：気合砲
--sp_effect_a1_00477
--sp2835
...
--エフェクト(共通)
SP_01  = 163599; --開始カットイン～連続攻撃→カードカットイン ef_001
SP_01b = 163600; --開始カットイン～連続攻撃→カードカットイン ef_001b
SP_02  = 163601; --カードカットイン～フィニッシュ ef_002
SP_02b = 163602; --カードカットイン～フィニッシュ ef_002b
...
-------------------------------------------------
-- 開始カットイン～連続攻撃→カードカットイン
-------------------------------------------------
MAX_FRAME_0 = 250;

-- ** エフェクト等 ** --
start_f = entryEffect( spep_0 + 0, SP_01, 0x100, -1, 0, 0, 0); -- 開始カットイン～連続攻撃→カードカットイン(ef_001)
...
start_b = entryEffect( spep_0 + 0, SP_01b, 0x80, -1, 0, 0, 0); -- 開始カットイン～連続攻撃→カードカットイン (ef_001b)
...
setMoveKey( spep_0 + 150 + OFFSET_X, 1, 127, -4 , 0 );
setMoveKey( spep_0 + 151 + OFFSET_X, 1, 127, -4 , 0 );
setMoveKey( spep_0 + 152 + OFFSET_X, 1, 127.1, -4 , 0 );
setMoveKey( spep_0 + 153 + OFFSET_X, 1, 127.1, -4 , 0 );
setMoveKey( spep_0 + 154 + OFFSET_X, 1, 127.8, -4 , 0 );
setMoveKey( spep_0 + 155 + OFFSET_X, 1, 127.8, -4 , 0 );
setMoveKey( spep_0 + 156 + OFFSET_X, 1, 129.5, -4.2 , 0 );
setMoveKey( spep_0 + 157 + OFFSET_X, 1, 129.5, -4.2 , 0 );
setMoveKey( spep_0 + 158 + OFFSET_X, 1, 132.7, -4.4 , 0 );
setMoveKey( spep_0 + 159 + OFFSET_X, 1, 132.7, -4.4 , 0 );
setMoveKey( spep_0 + 160 + OFFSET_X, 1, 137.3, -4.7 , 0 );
setMoveKey( spep_0 + 161 + OFFSET_X, 1, 137.3, -4.7 , 0 );
setMoveKey( spep_0 + 162 + OFFSET_X, 1, 146.9, -5.2 , 0 );
setMoveKey( spep_0 + 163 + OFFSET_X, 1, 146.9, -5.2 , 0 );
setMoveKey( spep_0 + 164 + OFFSET_X, 1, 137, -6 , 0 );
setMoveKey( spep_0 + 165 + OFFSET_X, 1, 137, -6 , 0 );
setMoveKey( spep_0 + 166 + OFFSET_X, 1, 98.3, -6 , 0 );
setMoveKey( spep_0 + 167 + OFFSET_X, 1, 98.3, -6 , 0 );
setMoveKey( spep_0 + 168 + OFFSET_X, 1, 119.6, 14 , 0 );
setMoveKey( spep_0 + 169 + OFFSET_X, 1, 119.6, 14 , 0 );
setMoveKey( spep_0 + 170 + OFFSET_X, 1, 120.8, -26 , 0 );
setMoveKey( spep_0 + 171 + OFFSET_X, 1, 120.8, -26 , 0 );
setMoveKey( spep_0 + 172 + OFFSET_X, 1, 132.1, -6 , 0 );
setMoveKey( spep_0 + 173 + OFFSET_X, 1, 132.1, -6 , 0 );
setMoveKey( spep_0 + 174 + OFFSET_X, 1, 113.4, -6 , 0 );
setMoveKey( spep_0 + 175 + OFFSET_X, 1, 113.4, -6 , 0 );
setMoveKey( spep_0 + 176 + OFFSET_X, 1, 124.7, 4 , 0 );
setMoveKey( spep_0 + 177 + OFFSET_X, 1, 124.7, 4 , 0 );
setMoveKey( spep_0 + 178 + OFFSET_X, 1, 125.9, -16 , 0 );
setMoveKey( spep_0 + 179 + OFFSET_X, 1, 125.9, -16 , 0 );
setMoveKey( spep_0 + 180 + OFFSET_X, 1, 127.2, -6 , 0 );
setMoveKey( spep_0 + 181 + OFFSET_X, 1, 127.2, -6 , 0 );
setMoveKey( spep_0 + 182 + OFFSET_X, 1, 128.5, -6 , 0 );
setMoveKey( spep_0 + 183 + OFFSET_X, 1, 128.5, -6 , 0 );
setMoveKey( spep_0 + 184 + OFFSET_X, 1, 129.8, -6 , 0 );
setMoveKey( spep_0 + 185 + OFFSET_X, 1, 129.8, -6 , 0 );
setMoveKey( spep_0 + 186 + OFFSET_X, 1, 131.1, -6 , 0 );
setMoveKey( spep_0 + 187 + OFFSET_X, 1, 131.1, -6 , 0 );
setMoveKey( spep_0 + 188 + OFFSET_X, 1, 132.3, -6 , 0 );
setMoveKey( spep_0 + 189 + OFFSET_X, 1, 132.3, -6 , 0 );
setMoveKey( spep_0 + 190 + OFFSET_X, 1, 133.6, -6 , 0 );
setMoveKey( spep_0 + 191 + OFFSET_X, 1, 133.6, -6 , 0 );
setMoveKey( spep_0 + 192 + OFFSET_X, 1, 134.9, -6 , 0 );
setMoveKey( spep_0 + 193 + OFFSET_X, 1, 134.9, -6 , 0 );
setMoveKey( spep_0 + 194 + OFFSET_X, 1, 136.2, -6 , 0 );
setMoveKey( spep_0 + 195 + OFFSET_X, 1, 136.2, -6 , 0 );
setMoveKey( spep_0 + 196 + OFFSET_X, 1, 137.4, -6 , 0 );
setMoveKey( spep_0 + 197 + OFFSET_X, 1, 137.4, -6 , 0 );
setMoveKey( spep_0 + 198 + OFFSET_X, 1, 138.7, -6 , 0 );
setMoveKey( spep_0 + 199 + OFFSET_X, 1, 138.7, -6 , 0 );
setMoveKey( spep_0 + 200 + OFFSET_X, 1, 140, -6 , 0 );
setMoveKey( spep_0 + 201 + OFFSET_X, 1, 140, -6 , 0 );
setMoveKey( spep_0 + 202 + OFFSET_X, 1, 141.3, -6 , 0 );
setMoveKey( spep_0 + 203 + OFFSET_X, 1, 141.3, -6 , 0 );
setMoveKey( spep_0 + 204 + OFFSET_X, 1, 142.6, -6 , 0 );
setMoveKey( spep_0 + 205 + OFFSET_X, 1, 142.6, -6 , 0 );
setMoveKey( spep_0 + 206 + OFFSET_X, 1, 143.8, -6 , 0 );
setMoveKey( spep_0 + 207 + OFFSET_X, 1, 143.8, -6 , 0 );
setMoveKey( spep_0 + 208 + OFFSET_X, 1, 145.1, -6 , 0 );
setMoveKey( spep_0 + 209 + OFFSET_X, 1, 145.1, -6 , 0 );
setMoveKey( spep_0 + 210 + OFFSET_X, 1, 146.4, -6 , 0 );
setMoveKey( spep_0 + 211 + OFFSET_X, 1, 146.4, -6 , 0 );
setMoveKey( spep_0 + 212 + OFFSET_X, 1, 147.7, -6 , 0 );
setMoveKey( spep_0 + 213 + OFFSET_X, 1, 147.7, -6 , 0 );
setMoveKey( spep_0 + 214 + OFFSET_X, 1, 148.9, -6 , 0 );
setMoveKey( spep_0 + 215 + OFFSET_X, 1, 148.9, -6 , 0 );
setMoveKey( spep_0 + 216 + OFFSET_X, 1, 150.2, -6 , 0 );
setMoveKey( spep_0 + 217 + OFFSET_X, 1, 150.2, -6 , 0 );
setMoveKey( spep_0 + 218 + OFFSET_X, 1, 151.5, -6 , 0 );
setMoveKey( spep_0 + 219 + OFFSET_X, 1, 151.5, -6 , 0 );
setMoveKey( spep_0 + 220 + OFFSET_X, 1, 122, -45 , 0 );
setMoveKey( spep_0 + 221 + OFFSET_X, 1, 122, -45 , 0 );
setMoveKey( spep_0 + 222 + OFFSET_X, 1, 351.3, -45 , 0 );
setMoveKey( spep_0 + 223 + OFFSET_X, 1, 351.3, -45 , 0 );
setMoveKey( spep_0 + 224 + OFFSET_X, 1, 640.5, -25 , 0 );
setMoveKey( spep_0 + 225 + OFFSET_X, 1, 640.5, -25 , 0 );
setMoveKey( spep_0 + 226 + OFFSET_X, 1, 909.8, -65 , 0 );
setMoveKey( spep_0 + 227 + OFFSET_X, 1, 909.8, -65 , 0 );
setMoveKey( spep_0 + 228 + OFFSET_X, 1, 1189, -45 , 0 );
setMoveKey( spep_0 + 230 + OFFSET_X, 1, 1189, -45 , 0 );
...
--構える
SE003 = playSeVer2( spep_0 + 66, 1007, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 66, SE003, 63 );

--向かってくる
SE004 = playSeVer2( spep_0 + 106, 1182, "", 0, 0, 0, -1);
SE005 = playSeVer2( spep_0 + 106, 1117, "", 0, 0, 0, -1);
...
-- ** 音 ** --
--タックル
SE006 = playSeVer2( spep_0 + 158, 1189, "", 0, 0, 0, -1);
SE007 = playSeVer2( spep_0 + 162, 1009, "", 0, 0, 0, -1);
SE008 = playSeVer2( spep_0 + 162, 1153, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_0 + 162, SE008, 63 );
SE009 = playSeVer2( spep_0 + 164, 1110, "", 0, 0, 0, -1);

--蹴り飛ばす
SE010 = playSeVer2( spep_0 + 194, 1004, "", 0, 0, 0, -1);
SE011 = playSeVer2( spep_0 + 212, 1189, "", 0, 0, 0, -1);
SE012 = playSeVer2( spep_0 + 214, 1120, "",0 , 0, 0, 0.5);
...
-- ** 音 ** --
--気が高まる
SE014 = playSeVer2( spep_1 + 88, 1229, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_1 + 88, SE014, 71 );
SE015 = playSeVer2( spep_1 + 88, 1331, "", 0, 0, 0, -1);
...
-- ** 音 ** --
--気弾溜める
SE016 = playSeVer2( spep_2 + 26, 1296, "",spep_2 + 226, 0, 18, -1);
SE017 = playSeVer2( spep_2 + 26, 1204, "",spep_2 + 228, 0, 18, -1);
SE018 = playSeVer2( spep_2 + 26, 1295, "",spep_2 + 228, 0, 18, -1);

--腕前に出す
SE019 = playSeVer2( spep_2 + 126, 1004, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 126, SE019, 78 );

--気弾発射
SE020 = playSeVer2( spep_2 + 198, 1145, "", 0, 0, 0, -1);
SE021 = playSeVer2( spep_2 + 204, 1202, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 204, SE021, 158 );

--爆発
SE022 = playSeVer2( spep_2 + 256, 1024, "", 0, 0, 0, -1);
SE023 = playSeVer2( spep_2 + 256, 1159, "", 0, 0, 0, -1);
setSeVolumeByWorkId( spep_2 + 256, SE023, 87 );


-- ** ダメージ表示 ** --
dealDamage( spep_2 + 270); -- ダメージ表示フレーム
endPhase( spep_2 + MAX_FRAME_2); -- 456f -0f
