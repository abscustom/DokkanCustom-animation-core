...
a1 = 110;
-- ** 書き文字エントリー ** --
ctgogo = entryEffectLife( spep_0 + 76,  190006, 64, 0x100, -1, 0, -8.5 +a1, 515.5 ); --ゴゴゴ

setEffMoveKey( spep_0 + 76, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 78, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 80, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 82, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 84, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 86, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 88, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 90, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 92, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 94, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 96, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 98, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 100, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 102, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 104, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 106, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 108, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 110, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 112, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 114, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 116, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 118, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 120, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 122, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 124, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 126, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 128, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 130, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 132, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 134, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 136, ctgogo, -8.5 +a1, 515.5 , 0 );
setEffMoveKey( spep_0 + 138, ctgogo, -9.9 +a1, 521.8 , 0 );
setEffMoveKey( spep_0 + 140, ctgogo, -9.9 +a1, 521.8 , 0 );
...
-- ** 集中線 ** --
shuchusenz = entryEffectLife( spep_1 + 0, 906, 90, 0x100, -1, 0, 0, 0 );  --集中線
setEffShake( spep_1 + 0, shuchusenz, 90, 20 );
setEffMoveKey( spep_1 + 0, shuchusenz, 0, 0 , 0 );
setEffMoveKey( spep_1 + 90, shuchusenz, 0, 0 , 0 );
setEffScaleKey( spep_1 + 0, shuchusenz, 1.6, 1.6 );
setEffScaleKey( spep_1 + 90, shuchusenz, 1.6, 1.6 );
setEffRotateKey( spep_1 + 0, shuchusenz, 0 );
setEffRotateKey( spep_1 + 90, shuchusenz, 0 );
setEffAlphaKey( spep_1 + 0, shuchusenz, 255 );
setEffAlphaKey( spep_1 + 90, shuchusenz, 255 );
