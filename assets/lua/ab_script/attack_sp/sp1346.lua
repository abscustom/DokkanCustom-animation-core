...
-- 文字エントリー --
ctgogo = entryEffectLife( spep_0 +12, 190006, 72, 0x100, -1, 0, 90, 510);    -- ゴゴゴゴ

setEffMoveKey(  spep_0 +12,  ctgogo,  90,  510);
setEffMoveKey(  spep_0 +84,  ctgogo,  90,  510);
