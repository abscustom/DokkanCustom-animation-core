--4019641:超サイヤ人ゴテンクス_スーパーゴーストカミカゼアタック
--sp_effect_a1_00236
--sp1428
...
--敵に向かっていく
SE5 = playSe( spep_c + 19, 1242 );
setSeVolume( spep_c + 19, 1242, 0 );
setSeVolume( spep_c + 92, 1242, 10 );
setSeVolume( spep_c + 94, 1242, 18 );
SE6 = playSe( spep_c + 90, 1116 );
SE7 = playSe( spep_c + 90, 9 );
setSeVolume( spep_c + 90, 9, 50 );
...
changeAnime( spep_3 -3 + 90, 1, 101);
changeAnime( spep_3 -3 + 104, 1, 104);
