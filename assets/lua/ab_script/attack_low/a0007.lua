...
naname = entryEffectLife( 5, 72, 60, 0x80,  -1,  0,  -500,  0); -- 流線斜め
setEffScaleKey(5, naname, 2,2);
setEffRotateKey(5, naname, -45);
...
setEffScaleKey(ATK_01+1, hit01, 1.4, 1.4);
...
hit02 = entryEffectLife(  ATK_01+4,  65,  10,  0x40,    1,  -180,  0,0);
setEffScaleKey(ATK_01+4, hit02, 1.0, 1.0);
...
-- stopSe( ATK_02, SE1, 6 );
hit03 = entryEffectLife(  ATK_02,  65,  10,  0x40,  1,   0,  0,  0);
setEffScaleKey(ATK_02, hit03, 1.0, 1.0);
setEffAlphaKey(ATK_02, hit03,255);
setEffAlphaKey(ATK_02 + 10, hit03, 0);
...
hit04 = entryEffectLife(  ATK_02+5,  65,  6,  0,  1,   0,  -20,  0);
setEffScaleKey(ATK_02+5, hit04, 1.0, 1.0);
setEffAlphaKey(ATK_02+5, hit04,255);
setEffAlphaKey(ATK_02+5 + 6, hit04, 0);

flash = entryEffectLife(  ATK_02+5-4,  50,  12,  0,  1,   0,  -60,  0);
setEffAlphaKey(ATK_02+5-4, flash,0);
setEffAlphaKey(ATK_02+5, flash, 255);
...
-- ** 音 ** --
--蹴り
SE001 = playSeVer2( 0, 1004, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 0, SE001, 82 );
SE002 = playSeVer2( 2, 1010, "", 0, 0, 0, 0.6);	
SE003 = playSeVer2( 2, 1001, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 2, SE003, 68 );
--パンチ
SE004 = playSeVer2( 16, 1110, "", 0, 0, 0, -1);	
