...
naname = entryEffectLife(5, 72, 54, 0x80,  -1,  0,  -500,  0); -- 流線斜め
...
shock01 = entryEffectLife( ATK_01+1,  55, 8,  0,  -1,   0,  0,  0);
setEffScaleKey(ATK_01+1,shock01,0.7, 0.7);
setEffAlphaKey(ATK_01+1,shock01,255);
setEffAlphaKey(ATK_01+1 + 4,shock01,255);
setEffAlphaKey(ATK_01+1 + 8,shock01,0);
shock02 = entryEffectLife( ATK_01+1+4,  56, 6, 0,  -1,   0,  0,  0);
setEffScaleKey(ATK_01+1 + 4,shock02,0.7, 0.7);
setEffAlphaKey(ATK_01+1 + 4,shock02,255);
setEffAlphaKey(ATK_01+1 + 8,shock02,255);
setEffAlphaKey(ATK_01+1 + 10,shock02,0);
...
entryEffectLife( ATK_01+1,   65, 2, 0x40,  1,   0,  0,  0);
entryEffectLife( ATK_01+4,   67, 2, 0x40,  1,   0,  0,  0);
shock01 = entryEffectLife( ATK_01+1,  55, 8,  0,  -1,   0,  0,  0);
setEffScaleKey(ATK_01+1,shock01,0.7, 0.7);
setEffAlphaKey(ATK_01+1,shock01,255);
setEffAlphaKey(ATK_01+1 + 4,shock01,255);
...
-- shuchusen01 = entryEffectLife( ATK_01+1, 70, 2, 0,  1,  0,  0,  0);
-- setEffScaleKey(ATK_01+1 , shuchusen01, 1.0, 1.2);

-- ** 音 ** --
--蹴り
SE001 = playSeVer2( 0, 1004, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 0, SE001, 75 );
SE002 = playSeVer2( 4, 1110, "", 0, 0, 0, -1);
SE003 = playSeVer2( 4, 1001, "", 0, 0, 0, -1);
setSeVolumeByWorkId( 4, SE003, 67 );
