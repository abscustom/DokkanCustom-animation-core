...
do return end
    ...
    hamon00 = entryEffect( 25+ATK_01,  54,  0x80,  0,  0,  0,  0);--波紋
    setEffScaleKey(25+ATK_01,hamon00,0.8,0.8);
    setEffAlphaKey(25+ATK_01,hamon00,255);
    setEffAlphaKey(30+ATK_01,hamon00,255);
    setEffAlphaKey(35+ATK_01,hamon00,0);
    hamon01 = entryEffect( 25+ATK_01,  56,  0x80,  0,  0,  0,  0);--波紋
    setEffScaleKey(25+ATK_01,hamon01,0.4,0.4);
    setEffAlphaKey(25+ATK_01,hamon01,255);
    setEffAlphaKey(28+ATK_01,hamon01,255);
    setEffAlphaKey(32+ATK_01,hamon01,0);
    ...
    hamon02 = entryEffect(  36+ATK_01,  54,  0,  -1,  0,  0,  0);
    setEffScaleKey(36 + ATK_01, hamon02, 2.0, 2.0);
    setEffAlphaKey(36 + ATK_01, hamon02, 255);
    setEffAlphaKey(46 + ATK_01, hamon02, 0);
    hamon03 = entryEffect(  36+ATK_01,  56,  0,  -1,  0,  0,  0);--はもん
    setEffScaleKey(36 + ATK_01, hamon03,0.5,0.5);
    setEffAlphaKey(36 + ATK_01, hamon03, 255);
    setEffAlphaKey(41 + ATK_01, hamon03, 0);
    ...
    setMoveKey( 40+ATK_01,  1, -200,  -100, -50);     -- 吹っ飛び中
    shuchusen01 =  entryEffectLife( 36+ATK_01, 70, 25, 0x00,  -1, 0,  0,  0);   -- 集中線
    setEffScaleKey(36+ATK_01, shuchusen01, 1.0, 1.2);
    ...
    hit01 = entryEffectLife( 35+ATK_01,  61,  12,  0,  1,  0,  0,  0);--HIT
    setEffScaleKey(35+ATK_01, hit01, 0.5, 0.5);
    setEffScaleKey(47+ATK_01, hit01, 1.5, 1.5);
    setEffAlphaKey(35+ATK_01, hit01, 255);
    setEffAlphaKey(40+ATK_01, hit01, 255);
    setEffAlphaKey(47+ATK_01, hit01, 0);
    hit02 = entryEffectLife( 35+ATK_01-6,  50,  12,  0,  -1,  0,  0,  0);--HIT
    setEffAlphaKey(35+ATK_01-6, hit02, 0);
    setEffAlphaKey(35+ATK_01-1, hit02, 0);
    setEffAlphaKey(35+ATK_01, hit02, 255);
    hit03 = entryEffectLife( 35+ATK_01-6,  53,  12,  0,  -1,  0,  0,  0);--HIT
    setEffRotateKey(35+ATK_01-6, hit03, -45);
    setEffAlphaKey(35+ATK_01-6, hit03, 0);
    setEffAlphaKey(35+ATK_01-1, hit03, 0);
    setEffAlphaKey(35+ATK_01, hit03, 255);
    ...
    -- ** 音 ** --
    --回転する
    SE001 = playSeVer2( -14, 1167, "",38, 0, 14, -1);
    setSeVolumeByWorkId( -14, SE001, 38 );
    SE002 = playSeVer2( -14, 1019, "",32, 0, 8, -1);	
    --向かっていく
    SE003 = playSeVer2( 12, 20, "",54, 0, 26, -1);
    setSeVolumeByWorkId( 12, SE003, 68 );
    --攻撃
    SE004 = playSeVer2( 14, 1004, "", 0, 0, 0, -1);	
    SE005 = playSeVer2( 24, 1110, "", 0, 0, 0, -1);	
    SE006 = playSeVer2( 24, 1153, "", 0, 0, 0, -1);
    setSeVolumeByWorkId( 24, SE006, 66 );
    ...
    ATK_dead = 35+5+ATK_01;
      ...
      shunkan01 = entryEffect( 50+ATK_01, 57, 0x00,  1, 0,    0,  0);
      setEffScaleKey(50+ATK_01, shunkan01, 1.5, 1.5);
      setEffRotateKey(50+ATK_01, shunkan01, 90);
